...
public:
		...
		VectorSIMD28(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD28& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD28& operator += (VectorSIMD28 a){
	...
	inline VectorSIMD28 operator*(double a, VectorSIMD28 b){
		VectorSIMD28 c;
	...
	inline VectorSIMD28 operator*(VectorSIMD28 a ,double b){
		VectorSIMD28 c;
	...
	inline VectorSIMD28 operator*(int a, VectorSIMD28 b){
		if(a==1){return b;}
		VectorSIMD28 c;
	...
	inline VectorSIMD28 operator*(VectorSIMD28 a, int b){
		if(b==1){return a;}
		VectorSIMD28 c;
	...
	inline VectorSIMD28 operator*(VectorSIMD28 a, VectorSIMD28 b){
		VectorSIMD28 c;
	...
	inline VectorSIMD28 exp(VectorSIMD28 a){
		double a_d[28]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD28 sqrt(VectorSIMD28 a){
		double a_d[28]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD28 a){ 
		double ad[28];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << ","  << ad[23] << ","  << ad[24] << ","  << ad[25] << ","  << ad[26] << ","  << ad[27] << "}";
		return os;
		}