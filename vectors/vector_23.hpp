...
public:
		...
		VectorSIMD23(double a){
			...
			_avx5=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD23(double (&a)[23]){
			...
			_avx5=_mm256_set_pd(0,a[22],a[21],a[20]);
		}

		VectorSIMD23(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17,double _18,double _19,double _20,double _21,double _22){
			...
			_avx5=_mm256_set_pd( 0,_22,_21,_20);
		}

		VectorSIMD23(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD23& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD23& operator += (VectorSIMD23 a){
	...
	inline VectorSIMD23 operator*(double a, VectorSIMD23 b){
		VectorSIMD23 c;
	...
	inline VectorSIMD23 operator*(VectorSIMD23 a ,double b){
		VectorSIMD23 c;
	...
	inline VectorSIMD23 operator*(int a, VectorSIMD23 b){
		if(a==1){return b;}
		VectorSIMD23 c;
	...
	inline VectorSIMD23 operator*(VectorSIMD23 a, int b){
		if(b==1){return a;}
		VectorSIMD23 c;
	...
	inline VectorSIMD23 operator*(VectorSIMD23 a, VectorSIMD23 b){
		VectorSIMD23 c;
	...
	inline VectorSIMD23 exp(VectorSIMD23 a){
		double a_d[23]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD23 sqrt(VectorSIMD23 a){
		double a_d[23]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD23 a){ 
		double ad[23];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << "}";
		return os;
		}
