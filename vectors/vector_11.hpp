...
public:
		...
		VectorSIMD11& operator += (VectorSIMD11 a){
	...
	inline VectorSIMD11 operator*(double a, VectorSIMD11 b){
		VectorSIMD11 c;
	...
	inline VectorSIMD11 operator*(VectorSIMD11 a ,double b){
		VectorSIMD11 c;
	...
	inline VectorSIMD11 operator*(int a, VectorSIMD11 b){
		if(a==1){return b;}
		VectorSIMD11 c;
	...
	inline VectorSIMD11 operator*(VectorSIMD11 a, int b){
		if(b==1){return a;}
		VectorSIMD11 c;
	...
	inline VectorSIMD11 operator*(VectorSIMD11 a, VectorSIMD11 b){
		VectorSIMD11 c;
	...
	inline VectorSIMD11 exp(VectorSIMD11 a){
	...
	inline VectorSIMD11 sqrt(VectorSIMD11 a){
		double a_d[11]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD11 a){ 
		double ad[11];
		a.convert(ad);
