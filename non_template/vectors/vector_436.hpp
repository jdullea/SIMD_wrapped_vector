...
public:
		...
		VectorSIMD436& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD436& operator += (VectorSIMD436 a){
	...
	inline VectorSIMD436 operator*(double a, VectorSIMD436 b){
		VectorSIMD436 c;
	...
	inline VectorSIMD436 operator*(VectorSIMD436 a ,double b){
		VectorSIMD436 c;
	...
	inline VectorSIMD436 operator*(int a, VectorSIMD436 b){
		if(a==1){return b;}
		VectorSIMD436 c;
	...
	inline VectorSIMD436 operator*(VectorSIMD436 a, int b){
		if(b==1){return a;}
		VectorSIMD436 c;
	...
	inline VectorSIMD436 operator*(VectorSIMD436 a, VectorSIMD436 b){
		VectorSIMD436 c;
	...
	inline VectorSIMD436 exp(VectorSIMD436 a){
		double a_d[436]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD436 sqrt(VectorSIMD436 a){
		double a_d[436]; a.convert(a_d);
