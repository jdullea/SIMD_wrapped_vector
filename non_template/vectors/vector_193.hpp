...
public:
		...
		VectorSIMD193(double a){
			...
			_avx48=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD193(double (&a)[193]){
		...
		VectorSIMD193& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD193& operator += (VectorSIMD193 a){
	...
	inline VectorSIMD193 operator*(double a, VectorSIMD193 b){
		VectorSIMD193 c;
	...
	inline VectorSIMD193 operator*(VectorSIMD193 a ,double b){
		VectorSIMD193 c;
	...
	inline VectorSIMD193 operator*(int a, VectorSIMD193 b){
		if(a==1){return b;}
		VectorSIMD193 c;
	...
	inline VectorSIMD193 operator*(VectorSIMD193 a, int b){
		if(b==1){return a;}
		VectorSIMD193 c;
	...
	inline VectorSIMD193 operator*(VectorSIMD193 a, VectorSIMD193 b){
		VectorSIMD193 c;
	...
	inline VectorSIMD193 exp(VectorSIMD193 a){
		double a_d[193]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD193 sqrt(VectorSIMD193 a){
		double a_d[193]; a.convert(a_d);
