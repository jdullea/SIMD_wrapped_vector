...
public:
		...
		VectorSIMD479(double a){
			...
			_avx119=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD479(double (&a)[479]){
		...
		VectorSIMD479& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD479& operator += (VectorSIMD479 a){
	...
	inline VectorSIMD479 operator*(double a, VectorSIMD479 b){
		VectorSIMD479 c;
	...
	inline VectorSIMD479 operator*(VectorSIMD479 a ,double b){
		VectorSIMD479 c;
	...
	inline VectorSIMD479 operator*(int a, VectorSIMD479 b){
		if(a==1){return b;}
		VectorSIMD479 c;
	...
	inline VectorSIMD479 operator*(VectorSIMD479 a, int b){
		if(b==1){return a;}
		VectorSIMD479 c;
	...
	inline VectorSIMD479 operator*(VectorSIMD479 a, VectorSIMD479 b){
		VectorSIMD479 c;
	...
	inline VectorSIMD479 exp(VectorSIMD479 a){
		double a_d[479]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD479 sqrt(VectorSIMD479 a){
		double a_d[479]; a.convert(a_d);
