...
public:
		...
		VectorSIMD295(double a){
			...
			_avx73=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD295(double (&a)[295]){
		...
		VectorSIMD295& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD295& operator += (VectorSIMD295 a){
	...
	inline VectorSIMD295 operator*(double a, VectorSIMD295 b){
		VectorSIMD295 c;
	...
	inline VectorSIMD295 operator*(VectorSIMD295 a ,double b){
		VectorSIMD295 c;
	...
	inline VectorSIMD295 operator*(int a, VectorSIMD295 b){
		if(a==1){return b;}
		VectorSIMD295 c;
	...
	inline VectorSIMD295 operator*(VectorSIMD295 a, int b){
		if(b==1){return a;}
		VectorSIMD295 c;
	...
	inline VectorSIMD295 operator*(VectorSIMD295 a, VectorSIMD295 b){
		VectorSIMD295 c;
	...
	inline VectorSIMD295 exp(VectorSIMD295 a){
		double a_d[295]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD295 sqrt(VectorSIMD295 a){
		double a_d[295]; a.convert(a_d);
