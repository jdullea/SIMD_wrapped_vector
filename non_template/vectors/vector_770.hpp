...
public:
		...
		VectorSIMD770(double a){
			...
			_avx192=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD770(double (&a)[770]){
		...
		VectorSIMD770& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD770& operator += (VectorSIMD770 a){
	...
	inline VectorSIMD770 operator*(double a, VectorSIMD770 b){
		VectorSIMD770 c;
	...
	inline VectorSIMD770 operator*(VectorSIMD770 a ,double b){
		VectorSIMD770 c;
	...
	inline VectorSIMD770 operator*(int a, VectorSIMD770 b){
		if(a==1){return b;}
		VectorSIMD770 c;
	...
	inline VectorSIMD770 operator*(VectorSIMD770 a, int b){
		if(b==1){return a;}
		VectorSIMD770 c;
	...
	inline VectorSIMD770 operator*(VectorSIMD770 a, VectorSIMD770 b){
		VectorSIMD770 c;
	...
	inline VectorSIMD770 exp(VectorSIMD770 a){
		double a_d[770]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD770 sqrt(VectorSIMD770 a){
		double a_d[770]; a.convert(a_d);
