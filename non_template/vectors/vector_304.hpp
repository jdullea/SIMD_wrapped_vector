...
public:
		...
		VectorSIMD304& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD304& operator += (VectorSIMD304 a){
	...
	inline VectorSIMD304 operator*(double a, VectorSIMD304 b){
		VectorSIMD304 c;
	...
	inline VectorSIMD304 operator*(VectorSIMD304 a ,double b){
		VectorSIMD304 c;
	...
	inline VectorSIMD304 operator*(int a, VectorSIMD304 b){
		if(a==1){return b;}
		VectorSIMD304 c;
	...
	inline VectorSIMD304 operator*(VectorSIMD304 a, int b){
		if(b==1){return a;}
		VectorSIMD304 c;
	...
	inline VectorSIMD304 operator*(VectorSIMD304 a, VectorSIMD304 b){
		VectorSIMD304 c;
	...
	inline VectorSIMD304 exp(VectorSIMD304 a){
		double a_d[304]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD304 sqrt(VectorSIMD304 a){
		double a_d[304]; a.convert(a_d);
