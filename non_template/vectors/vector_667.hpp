...
public:
		...
		VectorSIMD667(double a){
			...
			_avx166=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD667(double (&a)[667]){
		...
		VectorSIMD667& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD667& operator += (VectorSIMD667 a){
	...
	inline VectorSIMD667 operator*(double a, VectorSIMD667 b){
		VectorSIMD667 c;
	...
	inline VectorSIMD667 operator*(VectorSIMD667 a ,double b){
		VectorSIMD667 c;
	...
	inline VectorSIMD667 operator*(int a, VectorSIMD667 b){
		if(a==1){return b;}
		VectorSIMD667 c;
	...
	inline VectorSIMD667 operator*(VectorSIMD667 a, int b){
		if(b==1){return a;}
		VectorSIMD667 c;
	...
	inline VectorSIMD667 operator*(VectorSIMD667 a, VectorSIMD667 b){
		VectorSIMD667 c;
	...
	inline VectorSIMD667 exp(VectorSIMD667 a){
		double a_d[667]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD667 sqrt(VectorSIMD667 a){
		double a_d[667]; a.convert(a_d);
