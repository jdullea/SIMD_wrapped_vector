...
public:
		...
		VectorSIMD1009(double a){
			...
			_avx252=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD1009(double (&a)[1009]){
		...
		VectorSIMD1009& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1009& operator += (VectorSIMD1009 a){
	...
	inline VectorSIMD1009 operator*(double a, VectorSIMD1009 b){
		VectorSIMD1009 c;
	...
	inline VectorSIMD1009 operator*(VectorSIMD1009 a ,double b){
		VectorSIMD1009 c;
	...
	inline VectorSIMD1009 operator*(int a, VectorSIMD1009 b){
		if(a==1){return b;}
		VectorSIMD1009 c;
	...
	inline VectorSIMD1009 operator*(VectorSIMD1009 a, int b){
		if(b==1){return a;}
		VectorSIMD1009 c;
	...
	inline VectorSIMD1009 operator*(VectorSIMD1009 a, VectorSIMD1009 b){
		VectorSIMD1009 c;
	...
	inline VectorSIMD1009 exp(VectorSIMD1009 a){
		double a_d[1009]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1009 r(a_d);
		return r;
	}

	inline VectorSIMD1009 sqrt(VectorSIMD1009 a){
		double a_d[1009]; a.convert(a_d);
