...
public:
		...
		VectorSIMD875(double a){
			...
			_avx218=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD875(double (&a)[875]){
		...
		VectorSIMD875& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD875& operator += (VectorSIMD875 a){
	...
	inline VectorSIMD875 operator*(double a, VectorSIMD875 b){
		VectorSIMD875 c;
	...
	inline VectorSIMD875 operator*(VectorSIMD875 a ,double b){
		VectorSIMD875 c;
	...
	inline VectorSIMD875 operator*(int a, VectorSIMD875 b){
		if(a==1){return b;}
		VectorSIMD875 c;
	...
	inline VectorSIMD875 operator*(VectorSIMD875 a, int b){
		if(b==1){return a;}
		VectorSIMD875 c;
	...
	inline VectorSIMD875 operator*(VectorSIMD875 a, VectorSIMD875 b){
		VectorSIMD875 c;
	...
	inline VectorSIMD875 exp(VectorSIMD875 a){
		double a_d[875]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD875 sqrt(VectorSIMD875 a){
		double a_d[875]; a.convert(a_d);
