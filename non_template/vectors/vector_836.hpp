...
public:
		...
		VectorSIMD836& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD836& operator += (VectorSIMD836 a){
	...
	inline VectorSIMD836 operator*(double a, VectorSIMD836 b){
		VectorSIMD836 c;
	...
	inline VectorSIMD836 operator*(VectorSIMD836 a ,double b){
		VectorSIMD836 c;
	...
	inline VectorSIMD836 operator*(int a, VectorSIMD836 b){
		if(a==1){return b;}
		VectorSIMD836 c;
	...
	inline VectorSIMD836 operator*(VectorSIMD836 a, int b){
		if(b==1){return a;}
		VectorSIMD836 c;
	...
	inline VectorSIMD836 operator*(VectorSIMD836 a, VectorSIMD836 b){
		VectorSIMD836 c;
	...
	inline VectorSIMD836 exp(VectorSIMD836 a){
		double a_d[836]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD836 sqrt(VectorSIMD836 a){
		double a_d[836]; a.convert(a_d);
