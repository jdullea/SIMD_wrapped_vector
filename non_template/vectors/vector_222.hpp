...
public:
		...
		VectorSIMD222(double a){
			...
			_avx55=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD222(double (&a)[222]){
		...
		VectorSIMD222& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD222& operator += (VectorSIMD222 a){
	...
	inline VectorSIMD222 operator*(double a, VectorSIMD222 b){
		VectorSIMD222 c;
	...
	inline VectorSIMD222 operator*(VectorSIMD222 a ,double b){
		VectorSIMD222 c;
	...
	inline VectorSIMD222 operator*(int a, VectorSIMD222 b){
		if(a==1){return b;}
		VectorSIMD222 c;
	...
	inline VectorSIMD222 operator*(VectorSIMD222 a, int b){
		if(b==1){return a;}
		VectorSIMD222 c;
	...
	inline VectorSIMD222 operator*(VectorSIMD222 a, VectorSIMD222 b){
		VectorSIMD222 c;
	...
	inline VectorSIMD222 exp(VectorSIMD222 a){
		double a_d[222]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD222 sqrt(VectorSIMD222 a){
		double a_d[222]; a.convert(a_d);
