...
public:
		...
		VectorSIMD463(double a){
			...
			_avx115=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD463(double (&a)[463]){
		...
		VectorSIMD463& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD463& operator += (VectorSIMD463 a){
	...
	inline VectorSIMD463 operator*(double a, VectorSIMD463 b){
		VectorSIMD463 c;
	...
	inline VectorSIMD463 operator*(VectorSIMD463 a ,double b){
		VectorSIMD463 c;
	...
	inline VectorSIMD463 operator*(int a, VectorSIMD463 b){
		if(a==1){return b;}
		VectorSIMD463 c;
	...
	inline VectorSIMD463 operator*(VectorSIMD463 a, int b){
		if(b==1){return a;}
		VectorSIMD463 c;
	...
	inline VectorSIMD463 operator*(VectorSIMD463 a, VectorSIMD463 b){
		VectorSIMD463 c;
	...
	inline VectorSIMD463 exp(VectorSIMD463 a){
		double a_d[463]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD463 sqrt(VectorSIMD463 a){
		double a_d[463]; a.convert(a_d);
