...
public:
		...
		VectorSIMD980& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD980& operator += (VectorSIMD980 a){
	...
	inline VectorSIMD980 operator*(double a, VectorSIMD980 b){
		VectorSIMD980 c;
	...
	inline VectorSIMD980 operator*(VectorSIMD980 a ,double b){
		VectorSIMD980 c;
	...
	inline VectorSIMD980 operator*(int a, VectorSIMD980 b){
		if(a==1){return b;}
		VectorSIMD980 c;
	...
	inline VectorSIMD980 operator*(VectorSIMD980 a, int b){
		if(b==1){return a;}
		VectorSIMD980 c;
	...
	inline VectorSIMD980 operator*(VectorSIMD980 a, VectorSIMD980 b){
		VectorSIMD980 c;
	...
	inline VectorSIMD980 exp(VectorSIMD980 a){
		double a_d[980]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD980 sqrt(VectorSIMD980 a){
		double a_d[980]; a.convert(a_d);
