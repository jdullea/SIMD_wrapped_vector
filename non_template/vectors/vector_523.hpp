...
public:
		...
		VectorSIMD523(double a){
			...
			_avx130=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD523(double (&a)[523]){
		...
		VectorSIMD523& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD523& operator += (VectorSIMD523 a){
	...
	inline VectorSIMD523 operator*(double a, VectorSIMD523 b){
		VectorSIMD523 c;
	...
	inline VectorSIMD523 operator*(VectorSIMD523 a ,double b){
		VectorSIMD523 c;
	...
	inline VectorSIMD523 operator*(int a, VectorSIMD523 b){
		if(a==1){return b;}
		VectorSIMD523 c;
	...
	inline VectorSIMD523 operator*(VectorSIMD523 a, int b){
		if(b==1){return a;}
		VectorSIMD523 c;
	...
	inline VectorSIMD523 operator*(VectorSIMD523 a, VectorSIMD523 b){
		VectorSIMD523 c;
	...
	inline VectorSIMD523 exp(VectorSIMD523 a){
		double a_d[523]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD523 sqrt(VectorSIMD523 a){
		double a_d[523]; a.convert(a_d);
