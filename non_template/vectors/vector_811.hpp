...
public:
		...
		VectorSIMD811(double a){
			...
			_avx202=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD811(double (&a)[811]){
		...
		VectorSIMD811& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD811& operator += (VectorSIMD811 a){
	...
	inline VectorSIMD811 operator*(double a, VectorSIMD811 b){
		VectorSIMD811 c;
	...
	inline VectorSIMD811 operator*(VectorSIMD811 a ,double b){
		VectorSIMD811 c;
	...
	inline VectorSIMD811 operator*(int a, VectorSIMD811 b){
		if(a==1){return b;}
		VectorSIMD811 c;
	...
	inline VectorSIMD811 operator*(VectorSIMD811 a, int b){
		if(b==1){return a;}
		VectorSIMD811 c;
	...
	inline VectorSIMD811 operator*(VectorSIMD811 a, VectorSIMD811 b){
		VectorSIMD811 c;
	...
	inline VectorSIMD811 exp(VectorSIMD811 a){
		double a_d[811]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD811 sqrt(VectorSIMD811 a){
		double a_d[811]; a.convert(a_d);
