...
public:
		...
		VectorSIMD582(double a){
			...
			_avx145=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD582(double (&a)[582]){
		...
		VectorSIMD582& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD582& operator += (VectorSIMD582 a){
	...
	inline VectorSIMD582 operator*(double a, VectorSIMD582 b){
		VectorSIMD582 c;
	...
	inline VectorSIMD582 operator*(VectorSIMD582 a ,double b){
		VectorSIMD582 c;
	...
	inline VectorSIMD582 operator*(int a, VectorSIMD582 b){
		if(a==1){return b;}
		VectorSIMD582 c;
	...
	inline VectorSIMD582 operator*(VectorSIMD582 a, int b){
		if(b==1){return a;}
		VectorSIMD582 c;
	...
	inline VectorSIMD582 operator*(VectorSIMD582 a, VectorSIMD582 b){
		VectorSIMD582 c;
	...
	inline VectorSIMD582 exp(VectorSIMD582 a){
		double a_d[582]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD582 sqrt(VectorSIMD582 a){
		double a_d[582]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD582 a){ 
		double ad[582];
		a.convert(ad);
