...
public:
		...
		VectorSIMD764& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD764& operator += (VectorSIMD764 a){
	...
	inline VectorSIMD764 operator*(double a, VectorSIMD764 b){
		VectorSIMD764 c;
	...
	inline VectorSIMD764 operator*(VectorSIMD764 a ,double b){
		VectorSIMD764 c;
	...
	inline VectorSIMD764 operator*(int a, VectorSIMD764 b){
		if(a==1){return b;}
		VectorSIMD764 c;
	...
	inline VectorSIMD764 operator*(VectorSIMD764 a, int b){
		if(b==1){return a;}
		VectorSIMD764 c;
	...
	inline VectorSIMD764 operator*(VectorSIMD764 a, VectorSIMD764 b){
		VectorSIMD764 c;
	...
	inline VectorSIMD764 exp(VectorSIMD764 a){
		double a_d[764]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD764 sqrt(VectorSIMD764 a){
		double a_d[764]; a.convert(a_d);
