...
public:
		...
		VectorSIMD355(double a){
			...
			_avx88=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD355(double (&a)[355]){
		...
		VectorSIMD355& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD355& operator += (VectorSIMD355 a){
	...
	inline VectorSIMD355 operator*(double a, VectorSIMD355 b){
		VectorSIMD355 c;
	...
	inline VectorSIMD355 operator*(VectorSIMD355 a ,double b){
		VectorSIMD355 c;
	...
	inline VectorSIMD355 operator*(int a, VectorSIMD355 b){
		if(a==1){return b;}
		VectorSIMD355 c;
	...
	inline VectorSIMD355 operator*(VectorSIMD355 a, int b){
		if(b==1){return a;}
		VectorSIMD355 c;
	...
	inline VectorSIMD355 operator*(VectorSIMD355 a, VectorSIMD355 b){
		VectorSIMD355 c;
	...
	inline VectorSIMD355 exp(VectorSIMD355 a){
		double a_d[355]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD355 sqrt(VectorSIMD355 a){
		double a_d[355]; a.convert(a_d);
