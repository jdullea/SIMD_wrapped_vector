...
public:
		...
		VectorSIMD937(double a){
			...
			_avx234=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD937(double (&a)[937]){
		...
		VectorSIMD937& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD937& operator += (VectorSIMD937 a){
	...
	inline VectorSIMD937 operator*(double a, VectorSIMD937 b){
		VectorSIMD937 c;
	...
	inline VectorSIMD937 operator*(VectorSIMD937 a ,double b){
		VectorSIMD937 c;
	...
	inline VectorSIMD937 operator*(int a, VectorSIMD937 b){
		if(a==1){return b;}
		VectorSIMD937 c;
	...
	inline VectorSIMD937 operator*(VectorSIMD937 a, int b){
		if(b==1){return a;}
		VectorSIMD937 c;
	...
	inline VectorSIMD937 operator*(VectorSIMD937 a, VectorSIMD937 b){
		VectorSIMD937 c;
	...
	inline VectorSIMD937 exp(VectorSIMD937 a){
		double a_d[937]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD937 sqrt(VectorSIMD937 a){
		double a_d[937]; a.convert(a_d);
