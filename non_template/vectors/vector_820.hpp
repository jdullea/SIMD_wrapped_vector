...
public:
		...
		VectorSIMD820& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD820& operator += (VectorSIMD820 a){
	...
	inline VectorSIMD820 operator*(double a, VectorSIMD820 b){
		VectorSIMD820 c;
	...
	inline VectorSIMD820 operator*(VectorSIMD820 a ,double b){
		VectorSIMD820 c;
	...
	inline VectorSIMD820 operator*(int a, VectorSIMD820 b){
		if(a==1){return b;}
		VectorSIMD820 c;
	...
	inline VectorSIMD820 operator*(VectorSIMD820 a, int b){
		if(b==1){return a;}
		VectorSIMD820 c;
	...
	inline VectorSIMD820 operator*(VectorSIMD820 a, VectorSIMD820 b){
		VectorSIMD820 c;
	...
	inline VectorSIMD820 exp(VectorSIMD820 a){
		double a_d[820]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD820 sqrt(VectorSIMD820 a){
		double a_d[820]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD820 a){ 
		double ad[820];
		a.convert(ad);
