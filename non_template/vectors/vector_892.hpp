...
public:
		...
		VectorSIMD892& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD892& operator += (VectorSIMD892 a){
	...
	inline VectorSIMD892 operator*(double a, VectorSIMD892 b){
		VectorSIMD892 c;
	...
	inline VectorSIMD892 operator*(VectorSIMD892 a ,double b){
		VectorSIMD892 c;
	...
	inline VectorSIMD892 operator*(int a, VectorSIMD892 b){
		if(a==1){return b;}
		VectorSIMD892 c;
	...
	inline VectorSIMD892 operator*(VectorSIMD892 a, int b){
		if(b==1){return a;}
		VectorSIMD892 c;
	...
	inline VectorSIMD892 operator*(VectorSIMD892 a, VectorSIMD892 b){
		VectorSIMD892 c;
	...
	inline VectorSIMD892 exp(VectorSIMD892 a){
		double a_d[892]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD892 sqrt(VectorSIMD892 a){
		double a_d[892]; a.convert(a_d);
