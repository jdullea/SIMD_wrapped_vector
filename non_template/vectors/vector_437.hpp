...
public:
		...
		VectorSIMD437(double a){
			...
			_avx109=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD437(double (&a)[437]){
		...
		VectorSIMD437& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD437& operator += (VectorSIMD437 a){
	...
	inline VectorSIMD437 operator*(double a, VectorSIMD437 b){
		VectorSIMD437 c;
	...
	inline VectorSIMD437 operator*(VectorSIMD437 a ,double b){
		VectorSIMD437 c;
	...
	inline VectorSIMD437 operator*(int a, VectorSIMD437 b){
		if(a==1){return b;}
		VectorSIMD437 c;
	...
	inline VectorSIMD437 operator*(VectorSIMD437 a, int b){
		if(b==1){return a;}
		VectorSIMD437 c;
	...
	inline VectorSIMD437 operator*(VectorSIMD437 a, VectorSIMD437 b){
		VectorSIMD437 c;
	...
	inline VectorSIMD437 exp(VectorSIMD437 a){
		double a_d[437]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD437 sqrt(VectorSIMD437 a){
		double a_d[437]; a.convert(a_d);
