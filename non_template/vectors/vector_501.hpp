...
public:
		...
		VectorSIMD501(double a){
			...
			_avx125=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD501(double (&a)[501]){
		...
		VectorSIMD501& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD501& operator += (VectorSIMD501 a){
	...
	inline VectorSIMD501 operator*(double a, VectorSIMD501 b){
		VectorSIMD501 c;
	...
	inline VectorSIMD501 operator*(VectorSIMD501 a ,double b){
		VectorSIMD501 c;
	...
	inline VectorSIMD501 operator*(int a, VectorSIMD501 b){
		if(a==1){return b;}
		VectorSIMD501 c;
	...
	inline VectorSIMD501 operator*(VectorSIMD501 a, int b){
		if(b==1){return a;}
		VectorSIMD501 c;
	...
	inline VectorSIMD501 operator*(VectorSIMD501 a, VectorSIMD501 b){
		VectorSIMD501 c;
	...
	inline VectorSIMD501 exp(VectorSIMD501 a){
		double a_d[501]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD501 sqrt(VectorSIMD501 a){
		double a_d[501]; a.convert(a_d);
