...
public:
		...
		VectorSIMD861(double a){
			...
			_avx215=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD861(double (&a)[861]){
		...
		VectorSIMD861& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD861& operator += (VectorSIMD861 a){
	...
	inline VectorSIMD861 operator*(double a, VectorSIMD861 b){
		VectorSIMD861 c;
	...
	inline VectorSIMD861 operator*(VectorSIMD861 a ,double b){
		VectorSIMD861 c;
	...
	inline VectorSIMD861 operator*(int a, VectorSIMD861 b){
		if(a==1){return b;}
		VectorSIMD861 c;
	...
	inline VectorSIMD861 operator*(VectorSIMD861 a, int b){
		if(b==1){return a;}
		VectorSIMD861 c;
	...
	inline VectorSIMD861 operator*(VectorSIMD861 a, VectorSIMD861 b){
		VectorSIMD861 c;
	...
	inline VectorSIMD861 exp(VectorSIMD861 a){
		double a_d[861]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD861 sqrt(VectorSIMD861 a){
		double a_d[861]; a.convert(a_d);
