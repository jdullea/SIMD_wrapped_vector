...
public:
		...
		VectorSIMD905(double a){
			...
			_avx226=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD905(double (&a)[905]){
		...
		VectorSIMD905& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD905& operator += (VectorSIMD905 a){
	...
	inline VectorSIMD905 operator*(double a, VectorSIMD905 b){
		VectorSIMD905 c;
	...
	inline VectorSIMD905 operator*(VectorSIMD905 a ,double b){
		VectorSIMD905 c;
	...
	inline VectorSIMD905 operator*(int a, VectorSIMD905 b){
		if(a==1){return b;}
		VectorSIMD905 c;
	...
	inline VectorSIMD905 operator*(VectorSIMD905 a, int b){
		if(b==1){return a;}
		VectorSIMD905 c;
	...
	inline VectorSIMD905 operator*(VectorSIMD905 a, VectorSIMD905 b){
		VectorSIMD905 c;
	...
	inline VectorSIMD905 exp(VectorSIMD905 a){
		double a_d[905]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD905 sqrt(VectorSIMD905 a){
		double a_d[905]; a.convert(a_d);
