...
public:
		...
		VectorSIMD744& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD744& operator += (VectorSIMD744 a){
	...
	inline VectorSIMD744 operator*(double a, VectorSIMD744 b){
		VectorSIMD744 c;
	...
	inline VectorSIMD744 operator*(VectorSIMD744 a ,double b){
		VectorSIMD744 c;
	...
	inline VectorSIMD744 operator*(int a, VectorSIMD744 b){
		if(a==1){return b;}
		VectorSIMD744 c;
	...
	inline VectorSIMD744 operator*(VectorSIMD744 a, int b){
		if(b==1){return a;}
		VectorSIMD744 c;
	...
	inline VectorSIMD744 operator*(VectorSIMD744 a, VectorSIMD744 b){
		VectorSIMD744 c;
	...
	inline VectorSIMD744 exp(VectorSIMD744 a){
		double a_d[744]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD744 sqrt(VectorSIMD744 a){
		double a_d[744]; a.convert(a_d);
