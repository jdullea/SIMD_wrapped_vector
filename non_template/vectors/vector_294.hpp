...
public:
		...
		VectorSIMD294(double a){
			...
			_avx73=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD294(double (&a)[294]){
		...
		VectorSIMD294& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD294& operator += (VectorSIMD294 a){
	...
	inline VectorSIMD294 operator*(double a, VectorSIMD294 b){
		VectorSIMD294 c;
	...
	inline VectorSIMD294 operator*(VectorSIMD294 a ,double b){
		VectorSIMD294 c;
	...
	inline VectorSIMD294 operator*(int a, VectorSIMD294 b){
		if(a==1){return b;}
		VectorSIMD294 c;
	...
	inline VectorSIMD294 operator*(VectorSIMD294 a, int b){
		if(b==1){return a;}
		VectorSIMD294 c;
	...
	inline VectorSIMD294 operator*(VectorSIMD294 a, VectorSIMD294 b){
		VectorSIMD294 c;
	...
	inline VectorSIMD294 exp(VectorSIMD294 a){
		double a_d[294]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD294 sqrt(VectorSIMD294 a){
		double a_d[294]; a.convert(a_d);
