...
public:
		...
		VectorSIMD484& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD484& operator += (VectorSIMD484 a){
	...
	inline VectorSIMD484 operator*(double a, VectorSIMD484 b){
		VectorSIMD484 c;
	...
	inline VectorSIMD484 operator*(VectorSIMD484 a ,double b){
		VectorSIMD484 c;
	...
	inline VectorSIMD484 operator*(int a, VectorSIMD484 b){
		if(a==1){return b;}
		VectorSIMD484 c;
	...
	inline VectorSIMD484 operator*(VectorSIMD484 a, int b){
		if(b==1){return a;}
		VectorSIMD484 c;
	...
	inline VectorSIMD484 operator*(VectorSIMD484 a, VectorSIMD484 b){
		VectorSIMD484 c;
	...
	inline VectorSIMD484 exp(VectorSIMD484 a){
		double a_d[484]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD484 sqrt(VectorSIMD484 a){
		double a_d[484]; a.convert(a_d);
