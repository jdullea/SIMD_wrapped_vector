...
public:
		...
		VectorSIMD590(double a){
			...
			_avx147=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD590(double (&a)[590]){
		...
		VectorSIMD590& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD590& operator += (VectorSIMD590 a){
	...
	inline VectorSIMD590 operator*(double a, VectorSIMD590 b){
		VectorSIMD590 c;
	...
	inline VectorSIMD590 operator*(VectorSIMD590 a ,double b){
		VectorSIMD590 c;
	...
	inline VectorSIMD590 operator*(int a, VectorSIMD590 b){
		if(a==1){return b;}
		VectorSIMD590 c;
	...
	inline VectorSIMD590 operator*(VectorSIMD590 a, int b){
		if(b==1){return a;}
		VectorSIMD590 c;
	...
	inline VectorSIMD590 operator*(VectorSIMD590 a, VectorSIMD590 b){
		VectorSIMD590 c;
	...
	inline VectorSIMD590 exp(VectorSIMD590 a){
		double a_d[590]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD590 sqrt(VectorSIMD590 a){
		double a_d[590]; a.convert(a_d);
