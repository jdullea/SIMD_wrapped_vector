...
public:
		...
		VectorSIMD311(double a){
			...
			_avx77=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD311(double (&a)[311]){
		...
		VectorSIMD311& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD311& operator += (VectorSIMD311 a){
	...
	inline VectorSIMD311 operator*(double a, VectorSIMD311 b){
		VectorSIMD311 c;
	...
	inline VectorSIMD311 operator*(VectorSIMD311 a ,double b){
		VectorSIMD311 c;
	...
	inline VectorSIMD311 operator*(int a, VectorSIMD311 b){
		if(a==1){return b;}
		VectorSIMD311 c;
	...
	inline VectorSIMD311 operator*(VectorSIMD311 a, int b){
		if(b==1){return a;}
		VectorSIMD311 c;
	...
	inline VectorSIMD311 operator*(VectorSIMD311 a, VectorSIMD311 b){
		VectorSIMD311 c;
	...
	inline VectorSIMD311 exp(VectorSIMD311 a){
		double a_d[311]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD311 sqrt(VectorSIMD311 a){
		double a_d[311]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD311 a){ 
		double ad[311];
		a.convert(ad);
