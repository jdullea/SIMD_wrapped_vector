...
public:
		...
		VectorSIMD998(double a){
			...
			_avx249=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD998(double (&a)[998]){
		...
		VectorSIMD998& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD998& operator += (VectorSIMD998 a){
	...
	inline VectorSIMD998 operator*(double a, VectorSIMD998 b){
		VectorSIMD998 c;
	...
	inline VectorSIMD998 operator*(VectorSIMD998 a ,double b){
		VectorSIMD998 c;
	...
	inline VectorSIMD998 operator*(int a, VectorSIMD998 b){
		if(a==1){return b;}
		VectorSIMD998 c;
	...
	inline VectorSIMD998 operator*(VectorSIMD998 a, int b){
		if(b==1){return a;}
		VectorSIMD998 c;
	...
	inline VectorSIMD998 operator*(VectorSIMD998 a, VectorSIMD998 b){
		VectorSIMD998 c;
	...
	inline VectorSIMD998 exp(VectorSIMD998 a){
		double a_d[998]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD998 sqrt(VectorSIMD998 a){
		double a_d[998]; a.convert(a_d);
