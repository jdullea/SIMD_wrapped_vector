...
public:
		...
		VectorSIMD842(double a){
			...
			_avx210=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD842(double (&a)[842]){
		...
		VectorSIMD842& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD842& operator += (VectorSIMD842 a){
	...
	inline VectorSIMD842 operator*(double a, VectorSIMD842 b){
		VectorSIMD842 c;
	...
	inline VectorSIMD842 operator*(VectorSIMD842 a ,double b){
		VectorSIMD842 c;
	...
	inline VectorSIMD842 operator*(int a, VectorSIMD842 b){
		if(a==1){return b;}
		VectorSIMD842 c;
	...
	inline VectorSIMD842 operator*(VectorSIMD842 a, int b){
		if(b==1){return a;}
		VectorSIMD842 c;
	...
	inline VectorSIMD842 operator*(VectorSIMD842 a, VectorSIMD842 b){
		VectorSIMD842 c;
	...
	inline VectorSIMD842 exp(VectorSIMD842 a){
		double a_d[842]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD842 sqrt(VectorSIMD842 a){
		double a_d[842]; a.convert(a_d);
