...
public:
		...
		VectorSIMD888& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD888& operator += (VectorSIMD888 a){
	...
	inline VectorSIMD888 operator*(double a, VectorSIMD888 b){
		VectorSIMD888 c;
	...
	inline VectorSIMD888 operator*(VectorSIMD888 a ,double b){
		VectorSIMD888 c;
	...
	inline VectorSIMD888 operator*(int a, VectorSIMD888 b){
		if(a==1){return b;}
		VectorSIMD888 c;
	...
	inline VectorSIMD888 operator*(VectorSIMD888 a, int b){
		if(b==1){return a;}
		VectorSIMD888 c;
	...
	inline VectorSIMD888 operator*(VectorSIMD888 a, VectorSIMD888 b){
		VectorSIMD888 c;
	...
	inline VectorSIMD888 exp(VectorSIMD888 a){
		double a_d[888]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD888 sqrt(VectorSIMD888 a){
		double a_d[888]; a.convert(a_d);
