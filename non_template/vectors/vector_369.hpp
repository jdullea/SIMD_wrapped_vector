...
public:
		...
		VectorSIMD369(double a){
			...
			_avx92=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD369(double (&a)[369]){
		...
		VectorSIMD369& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD369& operator += (VectorSIMD369 a){
	...
	inline VectorSIMD369 operator*(double a, VectorSIMD369 b){
		VectorSIMD369 c;
	...
	inline VectorSIMD369 operator*(VectorSIMD369 a ,double b){
		VectorSIMD369 c;
	...
	inline VectorSIMD369 operator*(int a, VectorSIMD369 b){
		if(a==1){return b;}
		VectorSIMD369 c;
	...
	inline VectorSIMD369 operator*(VectorSIMD369 a, int b){
		if(b==1){return a;}
		VectorSIMD369 c;
	...
	inline VectorSIMD369 operator*(VectorSIMD369 a, VectorSIMD369 b){
		VectorSIMD369 c;
	...
	inline VectorSIMD369 exp(VectorSIMD369 a){
		double a_d[369]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD369 sqrt(VectorSIMD369 a){
		double a_d[369]; a.convert(a_d);
