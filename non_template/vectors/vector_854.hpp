...
public:
		...
		VectorSIMD854(double a){
			...
			_avx213=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD854(double (&a)[854]){
		...
		VectorSIMD854& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD854& operator += (VectorSIMD854 a){
	...
	inline VectorSIMD854 operator*(double a, VectorSIMD854 b){
		VectorSIMD854 c;
	...
	inline VectorSIMD854 operator*(VectorSIMD854 a ,double b){
		VectorSIMD854 c;
	...
	inline VectorSIMD854 operator*(int a, VectorSIMD854 b){
		if(a==1){return b;}
		VectorSIMD854 c;
	...
	inline VectorSIMD854 operator*(VectorSIMD854 a, int b){
		if(b==1){return a;}
		VectorSIMD854 c;
	...
	inline VectorSIMD854 operator*(VectorSIMD854 a, VectorSIMD854 b){
		VectorSIMD854 c;
	...
	inline VectorSIMD854 exp(VectorSIMD854 a){
		double a_d[854]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD854 sqrt(VectorSIMD854 a){
		double a_d[854]; a.convert(a_d);
