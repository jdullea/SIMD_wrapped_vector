...
public:
		...
		VectorSIMD390(double a){
			...
			_avx97=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD390(double (&a)[390]){
		...
		VectorSIMD390& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD390& operator += (VectorSIMD390 a){
	...
	inline VectorSIMD390 operator*(double a, VectorSIMD390 b){
		VectorSIMD390 c;
	...
	inline VectorSIMD390 operator*(VectorSIMD390 a ,double b){
		VectorSIMD390 c;
	...
	inline VectorSIMD390 operator*(int a, VectorSIMD390 b){
		if(a==1){return b;}
		VectorSIMD390 c;
	...
	inline VectorSIMD390 operator*(VectorSIMD390 a, int b){
		if(b==1){return a;}
		VectorSIMD390 c;
	...
	inline VectorSIMD390 operator*(VectorSIMD390 a, VectorSIMD390 b){
		VectorSIMD390 c;
	...
	inline VectorSIMD390 exp(VectorSIMD390 a){
		double a_d[390]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD390 sqrt(VectorSIMD390 a){
		double a_d[390]; a.convert(a_d);
