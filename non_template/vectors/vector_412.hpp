...
public:
		...
		VectorSIMD412& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD412& operator += (VectorSIMD412 a){
	...
	inline VectorSIMD412 operator*(double a, VectorSIMD412 b){
		VectorSIMD412 c;
	...
	inline VectorSIMD412 operator*(VectorSIMD412 a ,double b){
		VectorSIMD412 c;
	...
	inline VectorSIMD412 operator*(int a, VectorSIMD412 b){
		if(a==1){return b;}
		VectorSIMD412 c;
	...
	inline VectorSIMD412 operator*(VectorSIMD412 a, int b){
		if(b==1){return a;}
		VectorSIMD412 c;
	...
	inline VectorSIMD412 operator*(VectorSIMD412 a, VectorSIMD412 b){
		VectorSIMD412 c;
	...
	inline VectorSIMD412 exp(VectorSIMD412 a){
		double a_d[412]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD412 sqrt(VectorSIMD412 a){
		double a_d[412]; a.convert(a_d);
