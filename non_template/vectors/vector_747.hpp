...
public:
		...
		VectorSIMD747(double a){
			...
			_avx186=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD747(double (&a)[747]){
		...
		VectorSIMD747& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD747& operator += (VectorSIMD747 a){
	...
	inline VectorSIMD747 operator*(double a, VectorSIMD747 b){
		VectorSIMD747 c;
	...
	inline VectorSIMD747 operator*(VectorSIMD747 a ,double b){
		VectorSIMD747 c;
	...
	inline VectorSIMD747 operator*(int a, VectorSIMD747 b){
		if(a==1){return b;}
		VectorSIMD747 c;
	...
	inline VectorSIMD747 operator*(VectorSIMD747 a, int b){
		if(b==1){return a;}
		VectorSIMD747 c;
	...
	inline VectorSIMD747 operator*(VectorSIMD747 a, VectorSIMD747 b){
		VectorSIMD747 c;
	...
	inline VectorSIMD747 exp(VectorSIMD747 a){
		double a_d[747]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD747 sqrt(VectorSIMD747 a){
		double a_d[747]; a.convert(a_d);
