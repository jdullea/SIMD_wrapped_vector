...
public:
		...
		VectorSIMD415(double a){
			...
			_avx103=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD415(double (&a)[415]){
		...
		VectorSIMD415& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD415& operator += (VectorSIMD415 a){
	...
	inline VectorSIMD415 operator*(double a, VectorSIMD415 b){
		VectorSIMD415 c;
	...
	inline VectorSIMD415 operator*(VectorSIMD415 a ,double b){
		VectorSIMD415 c;
	...
	inline VectorSIMD415 operator*(int a, VectorSIMD415 b){
		if(a==1){return b;}
		VectorSIMD415 c;
	...
	inline VectorSIMD415 operator*(VectorSIMD415 a, int b){
		if(b==1){return a;}
		VectorSIMD415 c;
	...
	inline VectorSIMD415 operator*(VectorSIMD415 a, VectorSIMD415 b){
		VectorSIMD415 c;
	...
	inline VectorSIMD415 exp(VectorSIMD415 a){
		double a_d[415]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD415 sqrt(VectorSIMD415 a){
		double a_d[415]; a.convert(a_d);
