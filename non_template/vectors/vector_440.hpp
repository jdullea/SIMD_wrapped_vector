...
public:
		...
		VectorSIMD440& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD440& operator += (VectorSIMD440 a){
	...
	inline VectorSIMD440 operator*(double a, VectorSIMD440 b){
		VectorSIMD440 c;
	...
	inline VectorSIMD440 operator*(VectorSIMD440 a ,double b){
		VectorSIMD440 c;
	...
	inline VectorSIMD440 operator*(int a, VectorSIMD440 b){
		if(a==1){return b;}
		VectorSIMD440 c;
	...
	inline VectorSIMD440 operator*(VectorSIMD440 a, int b){
		if(b==1){return a;}
		VectorSIMD440 c;
	...
	inline VectorSIMD440 operator*(VectorSIMD440 a, VectorSIMD440 b){
		VectorSIMD440 c;
	...
	inline VectorSIMD440 exp(VectorSIMD440 a){
		double a_d[440]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD440 sqrt(VectorSIMD440 a){
		double a_d[440]; a.convert(a_d);
