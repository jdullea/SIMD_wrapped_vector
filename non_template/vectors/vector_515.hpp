...
public:
		...
		VectorSIMD515(double a){
			...
			_avx128=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD515(double (&a)[515]){
		...
		VectorSIMD515& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD515& operator += (VectorSIMD515 a){
	...
	inline VectorSIMD515 operator*(double a, VectorSIMD515 b){
		VectorSIMD515 c;
	...
	inline VectorSIMD515 operator*(VectorSIMD515 a ,double b){
		VectorSIMD515 c;
	...
	inline VectorSIMD515 operator*(int a, VectorSIMD515 b){
		if(a==1){return b;}
		VectorSIMD515 c;
	...
	inline VectorSIMD515 operator*(VectorSIMD515 a, int b){
		if(b==1){return a;}
		VectorSIMD515 c;
	...
	inline VectorSIMD515 operator*(VectorSIMD515 a, VectorSIMD515 b){
		VectorSIMD515 c;
	...
	inline VectorSIMD515 exp(VectorSIMD515 a){
		double a_d[515]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD515 sqrt(VectorSIMD515 a){
		double a_d[515]; a.convert(a_d);
