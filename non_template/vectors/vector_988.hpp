...
public:
		...
		VectorSIMD988& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD988& operator += (VectorSIMD988 a){
	...
	inline VectorSIMD988 operator*(double a, VectorSIMD988 b){
		VectorSIMD988 c;
	...
	inline VectorSIMD988 operator*(VectorSIMD988 a ,double b){
		VectorSIMD988 c;
	...
	inline VectorSIMD988 operator*(int a, VectorSIMD988 b){
		if(a==1){return b;}
		VectorSIMD988 c;
	...
	inline VectorSIMD988 operator*(VectorSIMD988 a, int b){
		if(b==1){return a;}
		VectorSIMD988 c;
	...
	inline VectorSIMD988 operator*(VectorSIMD988 a, VectorSIMD988 b){
		VectorSIMD988 c;
	...
	inline VectorSIMD988 exp(VectorSIMD988 a){
		double a_d[988]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD988 sqrt(VectorSIMD988 a){
		double a_d[988]; a.convert(a_d);
