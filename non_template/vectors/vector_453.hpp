...
public:
		...
		VectorSIMD453(double a){
			...
			_avx113=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD453(double (&a)[453]){
		...
		VectorSIMD453& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD453& operator += (VectorSIMD453 a){
	...
	inline VectorSIMD453 operator*(double a, VectorSIMD453 b){
		VectorSIMD453 c;
	...
	inline VectorSIMD453 operator*(VectorSIMD453 a ,double b){
		VectorSIMD453 c;
	...
	inline VectorSIMD453 operator*(int a, VectorSIMD453 b){
		if(a==1){return b;}
		VectorSIMD453 c;
	...
	inline VectorSIMD453 operator*(VectorSIMD453 a, int b){
		if(b==1){return a;}
		VectorSIMD453 c;
	...
	inline VectorSIMD453 operator*(VectorSIMD453 a, VectorSIMD453 b){
		VectorSIMD453 c;
	...
	inline VectorSIMD453 exp(VectorSIMD453 a){
		double a_d[453]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD453 sqrt(VectorSIMD453 a){
		double a_d[453]; a.convert(a_d);
