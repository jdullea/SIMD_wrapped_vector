...
public:
		...
		VectorSIMD755(double a){
			...
			_avx188=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD755(double (&a)[755]){
		...
		VectorSIMD755& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD755& operator += (VectorSIMD755 a){
	...
	inline VectorSIMD755 operator*(double a, VectorSIMD755 b){
		VectorSIMD755 c;
	...
	inline VectorSIMD755 operator*(VectorSIMD755 a ,double b){
		VectorSIMD755 c;
	...
	inline VectorSIMD755 operator*(int a, VectorSIMD755 b){
		if(a==1){return b;}
		VectorSIMD755 c;
	...
	inline VectorSIMD755 operator*(VectorSIMD755 a, int b){
		if(b==1){return a;}
		VectorSIMD755 c;
	...
	inline VectorSIMD755 operator*(VectorSIMD755 a, VectorSIMD755 b){
		VectorSIMD755 c;
	...
	inline VectorSIMD755 exp(VectorSIMD755 a){
		double a_d[755]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD755 sqrt(VectorSIMD755 a){
		double a_d[755]; a.convert(a_d);
