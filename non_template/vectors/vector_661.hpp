...
public:
		...
		VectorSIMD661(double a){
			...
			_avx165=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD661(double (&a)[661]){
		...
		VectorSIMD661& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD661& operator += (VectorSIMD661 a){
	...
	inline VectorSIMD661 operator*(double a, VectorSIMD661 b){
		VectorSIMD661 c;
	...
	inline VectorSIMD661 operator*(VectorSIMD661 a ,double b){
		VectorSIMD661 c;
	...
	inline VectorSIMD661 operator*(int a, VectorSIMD661 b){
		if(a==1){return b;}
		VectorSIMD661 c;
	...
	inline VectorSIMD661 operator*(VectorSIMD661 a, int b){
		if(b==1){return a;}
		VectorSIMD661 c;
	...
	inline VectorSIMD661 operator*(VectorSIMD661 a, VectorSIMD661 b){
		VectorSIMD661 c;
	...
	inline VectorSIMD661 exp(VectorSIMD661 a){
		double a_d[661]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD661 sqrt(VectorSIMD661 a){
		double a_d[661]; a.convert(a_d);
