...
public:
		...
		VectorSIMD429(double a){
			...
			_avx107=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD429(double (&a)[429]){
		...
		VectorSIMD429& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD429& operator += (VectorSIMD429 a){
	...
	inline VectorSIMD429 operator*(double a, VectorSIMD429 b){
		VectorSIMD429 c;
	...
	inline VectorSIMD429 operator*(VectorSIMD429 a ,double b){
		VectorSIMD429 c;
	...
	inline VectorSIMD429 operator*(int a, VectorSIMD429 b){
		if(a==1){return b;}
		VectorSIMD429 c;
	...
	inline VectorSIMD429 operator*(VectorSIMD429 a, int b){
		if(b==1){return a;}
		VectorSIMD429 c;
	...
	inline VectorSIMD429 operator*(VectorSIMD429 a, VectorSIMD429 b){
		VectorSIMD429 c;
	...
	inline VectorSIMD429 exp(VectorSIMD429 a){
		double a_d[429]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD429 sqrt(VectorSIMD429 a){
		double a_d[429]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD429 a){ 
		double ad[429];
		a.convert(ad);
