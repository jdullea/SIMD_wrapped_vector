...
public:
		...
		VectorSIMD424& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD424& operator += (VectorSIMD424 a){
	...
	inline VectorSIMD424 operator*(double a, VectorSIMD424 b){
		VectorSIMD424 c;
	...
	inline VectorSIMD424 operator*(VectorSIMD424 a ,double b){
		VectorSIMD424 c;
	...
	inline VectorSIMD424 operator*(int a, VectorSIMD424 b){
		if(a==1){return b;}
		VectorSIMD424 c;
	...
	inline VectorSIMD424 operator*(VectorSIMD424 a, int b){
		if(b==1){return a;}
		VectorSIMD424 c;
	...
	inline VectorSIMD424 operator*(VectorSIMD424 a, VectorSIMD424 b){
		VectorSIMD424 c;
	...
	inline VectorSIMD424 exp(VectorSIMD424 a){
		double a_d[424]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD424 sqrt(VectorSIMD424 a){
		double a_d[424]; a.convert(a_d);
