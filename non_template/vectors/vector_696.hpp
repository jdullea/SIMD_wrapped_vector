...
public:
		...
		VectorSIMD696& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD696& operator += (VectorSIMD696 a){
	...
	inline VectorSIMD696 operator*(double a, VectorSIMD696 b){
		VectorSIMD696 c;
	...
	inline VectorSIMD696 operator*(VectorSIMD696 a ,double b){
		VectorSIMD696 c;
	...
	inline VectorSIMD696 operator*(int a, VectorSIMD696 b){
		if(a==1){return b;}
		VectorSIMD696 c;
	...
	inline VectorSIMD696 operator*(VectorSIMD696 a, int b){
		if(b==1){return a;}
		VectorSIMD696 c;
	...
	inline VectorSIMD696 operator*(VectorSIMD696 a, VectorSIMD696 b){
		VectorSIMD696 c;
	...
	inline VectorSIMD696 exp(VectorSIMD696 a){
		double a_d[696]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD696 sqrt(VectorSIMD696 a){
		double a_d[696]; a.convert(a_d);
