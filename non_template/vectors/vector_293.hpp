...
public:
		...
		VectorSIMD293(double a){
			...
			_avx73=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD293(double (&a)[293]){
		...
		VectorSIMD293& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD293& operator += (VectorSIMD293 a){
	...
	inline VectorSIMD293 operator*(double a, VectorSIMD293 b){
		VectorSIMD293 c;
	...
	inline VectorSIMD293 operator*(VectorSIMD293 a ,double b){
		VectorSIMD293 c;
	...
	inline VectorSIMD293 operator*(int a, VectorSIMD293 b){
		if(a==1){return b;}
		VectorSIMD293 c;
	...
	inline VectorSIMD293 operator*(VectorSIMD293 a, int b){
		if(b==1){return a;}
		VectorSIMD293 c;
	...
	inline VectorSIMD293 operator*(VectorSIMD293 a, VectorSIMD293 b){
		VectorSIMD293 c;
	...
	inline VectorSIMD293 exp(VectorSIMD293 a){
		double a_d[293]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD293 sqrt(VectorSIMD293 a){
		double a_d[293]; a.convert(a_d);
