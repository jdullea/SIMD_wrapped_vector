...
public:
		...
		VectorSIMD568& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD568& operator += (VectorSIMD568 a){
	...
	inline VectorSIMD568 operator*(double a, VectorSIMD568 b){
		VectorSIMD568 c;
	...
	inline VectorSIMD568 operator*(VectorSIMD568 a ,double b){
		VectorSIMD568 c;
	...
	inline VectorSIMD568 operator*(int a, VectorSIMD568 b){
		if(a==1){return b;}
		VectorSIMD568 c;
	...
	inline VectorSIMD568 operator*(VectorSIMD568 a, int b){
		if(b==1){return a;}
		VectorSIMD568 c;
	...
	inline VectorSIMD568 operator*(VectorSIMD568 a, VectorSIMD568 b){
		VectorSIMD568 c;
	...
	inline VectorSIMD568 exp(VectorSIMD568 a){
		double a_d[568]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD568 sqrt(VectorSIMD568 a){
		double a_d[568]; a.convert(a_d);
