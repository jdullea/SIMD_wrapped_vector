...
public:
		...
		VectorSIMD776& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD776& operator += (VectorSIMD776 a){
	...
	inline VectorSIMD776 operator*(double a, VectorSIMD776 b){
		VectorSIMD776 c;
	...
	inline VectorSIMD776 operator*(VectorSIMD776 a ,double b){
		VectorSIMD776 c;
	...
	inline VectorSIMD776 operator*(int a, VectorSIMD776 b){
		if(a==1){return b;}
		VectorSIMD776 c;
	...
	inline VectorSIMD776 operator*(VectorSIMD776 a, int b){
		if(b==1){return a;}
		VectorSIMD776 c;
	...
	inline VectorSIMD776 operator*(VectorSIMD776 a, VectorSIMD776 b){
		VectorSIMD776 c;
	...
	inline VectorSIMD776 exp(VectorSIMD776 a){
		double a_d[776]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD776 sqrt(VectorSIMD776 a){
		double a_d[776]; a.convert(a_d);
