...
public:
		...
		VectorSIMD962(double a){
			...
			_avx240=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD962(double (&a)[962]){
		...
		VectorSIMD962& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD962& operator += (VectorSIMD962 a){
	...
	inline VectorSIMD962 operator*(double a, VectorSIMD962 b){
		VectorSIMD962 c;
	...
	inline VectorSIMD962 operator*(VectorSIMD962 a ,double b){
		VectorSIMD962 c;
	...
	inline VectorSIMD962 operator*(int a, VectorSIMD962 b){
		if(a==1){return b;}
		VectorSIMD962 c;
	...
	inline VectorSIMD962 operator*(VectorSIMD962 a, int b){
		if(b==1){return a;}
		VectorSIMD962 c;
	...
	inline VectorSIMD962 operator*(VectorSIMD962 a, VectorSIMD962 b){
		VectorSIMD962 c;
	...
	inline VectorSIMD962 exp(VectorSIMD962 a){
		double a_d[962]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD962 sqrt(VectorSIMD962 a){
		double a_d[962]; a.convert(a_d);
