...
public:
		...
		VectorSIMD592& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD592& operator += (VectorSIMD592 a){
	...
	inline VectorSIMD592 operator*(double a, VectorSIMD592 b){
		VectorSIMD592 c;
	...
	inline VectorSIMD592 operator*(VectorSIMD592 a ,double b){
		VectorSIMD592 c;
	...
	inline VectorSIMD592 operator*(int a, VectorSIMD592 b){
		if(a==1){return b;}
		VectorSIMD592 c;
	...
	inline VectorSIMD592 operator*(VectorSIMD592 a, int b){
		if(b==1){return a;}
		VectorSIMD592 c;
	...
	inline VectorSIMD592 operator*(VectorSIMD592 a, VectorSIMD592 b){
		VectorSIMD592 c;
	...
	inline VectorSIMD592 exp(VectorSIMD592 a){
		double a_d[592]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD592 sqrt(VectorSIMD592 a){
		double a_d[592]; a.convert(a_d);
