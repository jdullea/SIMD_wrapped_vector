...
public:
		...
		VectorSIMD360& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD360& operator += (VectorSIMD360 a){
	...
	inline VectorSIMD360 operator*(double a, VectorSIMD360 b){
		VectorSIMD360 c;
	...
	inline VectorSIMD360 operator*(VectorSIMD360 a ,double b){
		VectorSIMD360 c;
	...
	inline VectorSIMD360 operator*(int a, VectorSIMD360 b){
		if(a==1){return b;}
		VectorSIMD360 c;
	...
	inline VectorSIMD360 operator*(VectorSIMD360 a, int b){
		if(b==1){return a;}
		VectorSIMD360 c;
	...
	inline VectorSIMD360 operator*(VectorSIMD360 a, VectorSIMD360 b){
		VectorSIMD360 c;
	...
	inline VectorSIMD360 exp(VectorSIMD360 a){
		double a_d[360]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD360 sqrt(VectorSIMD360 a){
		double a_d[360]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD360 a){ 
		double ad[360];
		a.convert(ad);
