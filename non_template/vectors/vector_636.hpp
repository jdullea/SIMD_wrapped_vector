...
public:
		...
		VectorSIMD636& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD636& operator += (VectorSIMD636 a){
	...
	inline VectorSIMD636 operator*(double a, VectorSIMD636 b){
		VectorSIMD636 c;
	...
	inline VectorSIMD636 operator*(VectorSIMD636 a ,double b){
		VectorSIMD636 c;
	...
	inline VectorSIMD636 operator*(int a, VectorSIMD636 b){
		if(a==1){return b;}
		VectorSIMD636 c;
	...
	inline VectorSIMD636 operator*(VectorSIMD636 a, int b){
		if(b==1){return a;}
		VectorSIMD636 c;
	...
	inline VectorSIMD636 operator*(VectorSIMD636 a, VectorSIMD636 b){
		VectorSIMD636 c;
	...
	inline VectorSIMD636 exp(VectorSIMD636 a){
		double a_d[636]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD636 sqrt(VectorSIMD636 a){
		double a_d[636]; a.convert(a_d);
