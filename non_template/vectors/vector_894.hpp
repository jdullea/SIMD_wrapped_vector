...
public:
		...
		VectorSIMD894(double a){
			...
			_avx223=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD894(double (&a)[894]){
		...
		VectorSIMD894& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD894& operator += (VectorSIMD894 a){
	...
	inline VectorSIMD894 operator*(double a, VectorSIMD894 b){
		VectorSIMD894 c;
	...
	inline VectorSIMD894 operator*(VectorSIMD894 a ,double b){
		VectorSIMD894 c;
	...
	inline VectorSIMD894 operator*(int a, VectorSIMD894 b){
		if(a==1){return b;}
		VectorSIMD894 c;
	...
	inline VectorSIMD894 operator*(VectorSIMD894 a, int b){
		if(b==1){return a;}
		VectorSIMD894 c;
	...
	inline VectorSIMD894 operator*(VectorSIMD894 a, VectorSIMD894 b){
		VectorSIMD894 c;
	...
	inline VectorSIMD894 exp(VectorSIMD894 a){
		double a_d[894]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD894 sqrt(VectorSIMD894 a){
		double a_d[894]; a.convert(a_d);
