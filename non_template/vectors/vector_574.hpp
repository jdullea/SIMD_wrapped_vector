...
public:
		...
		VectorSIMD574(double a){
			...
			_avx143=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD574(double (&a)[574]){
		...
		VectorSIMD574& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD574& operator += (VectorSIMD574 a){
	...
	inline VectorSIMD574 operator*(double a, VectorSIMD574 b){
		VectorSIMD574 c;
	...
	inline VectorSIMD574 operator*(VectorSIMD574 a ,double b){
		VectorSIMD574 c;
	...
	inline VectorSIMD574 operator*(int a, VectorSIMD574 b){
		if(a==1){return b;}
		VectorSIMD574 c;
	...
	inline VectorSIMD574 operator*(VectorSIMD574 a, int b){
		if(b==1){return a;}
		VectorSIMD574 c;
	...
	inline VectorSIMD574 operator*(VectorSIMD574 a, VectorSIMD574 b){
		VectorSIMD574 c;
	...
	inline VectorSIMD574 exp(VectorSIMD574 a){
		double a_d[574]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD574 sqrt(VectorSIMD574 a){
		double a_d[574]; a.convert(a_d);
