...
public:
		...
		VectorSIMD445(double a){
			...
			_avx111=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD445(double (&a)[445]){
		...
		VectorSIMD445& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD445& operator += (VectorSIMD445 a){
	...
	inline VectorSIMD445 operator*(double a, VectorSIMD445 b){
		VectorSIMD445 c;
	...
	inline VectorSIMD445 operator*(VectorSIMD445 a ,double b){
		VectorSIMD445 c;
	...
	inline VectorSIMD445 operator*(int a, VectorSIMD445 b){
		if(a==1){return b;}
		VectorSIMD445 c;
	...
	inline VectorSIMD445 operator*(VectorSIMD445 a, int b){
		if(b==1){return a;}
		VectorSIMD445 c;
	...
	inline VectorSIMD445 operator*(VectorSIMD445 a, VectorSIMD445 b){
		VectorSIMD445 c;
	...
	inline VectorSIMD445 exp(VectorSIMD445 a){
		double a_d[445]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD445 sqrt(VectorSIMD445 a){
		double a_d[445]; a.convert(a_d);
