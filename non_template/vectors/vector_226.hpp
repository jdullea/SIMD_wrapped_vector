...
public:
		...
		VectorSIMD226(double a){
			...
			_avx56=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD226(double (&a)[226]){
		...
		VectorSIMD226& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD226& operator += (VectorSIMD226 a){
	...
	inline VectorSIMD226 operator*(double a, VectorSIMD226 b){
		VectorSIMD226 c;
	...
	inline VectorSIMD226 operator*(VectorSIMD226 a ,double b){
		VectorSIMD226 c;
	...
	inline VectorSIMD226 operator*(int a, VectorSIMD226 b){
		if(a==1){return b;}
		VectorSIMD226 c;
	...
	inline VectorSIMD226 operator*(VectorSIMD226 a, int b){
		if(b==1){return a;}
		VectorSIMD226 c;
	...
	inline VectorSIMD226 operator*(VectorSIMD226 a, VectorSIMD226 b){
		VectorSIMD226 c;
	...
	inline VectorSIMD226 exp(VectorSIMD226 a){
		double a_d[226]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD226 sqrt(VectorSIMD226 a){
		double a_d[226]; a.convert(a_d);
