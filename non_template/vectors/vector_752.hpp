...
public:
		...
		VectorSIMD752& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD752& operator += (VectorSIMD752 a){
	...
	inline VectorSIMD752 operator*(double a, VectorSIMD752 b){
		VectorSIMD752 c;
	...
	inline VectorSIMD752 operator*(VectorSIMD752 a ,double b){
		VectorSIMD752 c;
	...
	inline VectorSIMD752 operator*(int a, VectorSIMD752 b){
		if(a==1){return b;}
		VectorSIMD752 c;
	...
	inline VectorSIMD752 operator*(VectorSIMD752 a, int b){
		if(b==1){return a;}
		VectorSIMD752 c;
	...
	inline VectorSIMD752 operator*(VectorSIMD752 a, VectorSIMD752 b){
		VectorSIMD752 c;
	...
	inline VectorSIMD752 exp(VectorSIMD752 a){
		double a_d[752]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD752 sqrt(VectorSIMD752 a){
		double a_d[752]; a.convert(a_d);
