...
public:
		...
		VectorSIMD677(double a){
			...
			_avx169=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD677(double (&a)[677]){
		...
		VectorSIMD677& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD677& operator += (VectorSIMD677 a){
	...
	inline VectorSIMD677 operator*(double a, VectorSIMD677 b){
		VectorSIMD677 c;
	...
	inline VectorSIMD677 operator*(VectorSIMD677 a ,double b){
		VectorSIMD677 c;
	...
	inline VectorSIMD677 operator*(int a, VectorSIMD677 b){
		if(a==1){return b;}
		VectorSIMD677 c;
	...
	inline VectorSIMD677 operator*(VectorSIMD677 a, int b){
		if(b==1){return a;}
		VectorSIMD677 c;
	...
	inline VectorSIMD677 operator*(VectorSIMD677 a, VectorSIMD677 b){
		VectorSIMD677 c;
	...
	inline VectorSIMD677 exp(VectorSIMD677 a){
		double a_d[677]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD677 sqrt(VectorSIMD677 a){
		double a_d[677]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD677 a){ 
		double ad[677];
		a.convert(ad);
