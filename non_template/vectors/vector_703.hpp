...
public:
		...
		VectorSIMD703(double a){
			...
			_avx175=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD703(double (&a)[703]){
		...
		VectorSIMD703& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD703& operator += (VectorSIMD703 a){
	...
	inline VectorSIMD703 operator*(double a, VectorSIMD703 b){
		VectorSIMD703 c;
	...
	inline VectorSIMD703 operator*(VectorSIMD703 a ,double b){
		VectorSIMD703 c;
	...
	inline VectorSIMD703 operator*(int a, VectorSIMD703 b){
		if(a==1){return b;}
		VectorSIMD703 c;
	...
	inline VectorSIMD703 operator*(VectorSIMD703 a, int b){
		if(b==1){return a;}
		VectorSIMD703 c;
	...
	inline VectorSIMD703 operator*(VectorSIMD703 a, VectorSIMD703 b){
		VectorSIMD703 c;
	...
	inline VectorSIMD703 exp(VectorSIMD703 a){
		double a_d[703]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD703 sqrt(VectorSIMD703 a){
		double a_d[703]; a.convert(a_d);
