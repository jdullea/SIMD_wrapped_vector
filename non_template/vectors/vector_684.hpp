...
public:
		...
		VectorSIMD684& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD684& operator += (VectorSIMD684 a){
	...
	inline VectorSIMD684 operator*(double a, VectorSIMD684 b){
		VectorSIMD684 c;
	...
	inline VectorSIMD684 operator*(VectorSIMD684 a ,double b){
		VectorSIMD684 c;
	...
	inline VectorSIMD684 operator*(int a, VectorSIMD684 b){
		if(a==1){return b;}
		VectorSIMD684 c;
	...
	inline VectorSIMD684 operator*(VectorSIMD684 a, int b){
		if(b==1){return a;}
		VectorSIMD684 c;
	...
	inline VectorSIMD684 operator*(VectorSIMD684 a, VectorSIMD684 b){
		VectorSIMD684 c;
	...
	inline VectorSIMD684 exp(VectorSIMD684 a){
		double a_d[684]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD684 sqrt(VectorSIMD684 a){
		double a_d[684]; a.convert(a_d);
