...
public:
		...
		VectorSIMD561(double a){
			...
			_avx140=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD561(double (&a)[561]){
		...
		VectorSIMD561& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD561& operator += (VectorSIMD561 a){
	...
	inline VectorSIMD561 operator*(double a, VectorSIMD561 b){
		VectorSIMD561 c;
	...
	inline VectorSIMD561 operator*(VectorSIMD561 a ,double b){
		VectorSIMD561 c;
	...
	inline VectorSIMD561 operator*(int a, VectorSIMD561 b){
		if(a==1){return b;}
		VectorSIMD561 c;
	...
	inline VectorSIMD561 operator*(VectorSIMD561 a, int b){
		if(b==1){return a;}
		VectorSIMD561 c;
	...
	inline VectorSIMD561 operator*(VectorSIMD561 a, VectorSIMD561 b){
		VectorSIMD561 c;
	...
	inline VectorSIMD561 exp(VectorSIMD561 a){
		double a_d[561]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD561 sqrt(VectorSIMD561 a){
		double a_d[561]; a.convert(a_d);
