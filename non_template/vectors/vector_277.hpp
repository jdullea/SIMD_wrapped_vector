...
public:
		...
		VectorSIMD277(double a){
			...
			_avx69=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD277(double (&a)[277]){
		...
		VectorSIMD277& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD277& operator += (VectorSIMD277 a){
	...
	inline VectorSIMD277 operator*(double a, VectorSIMD277 b){
		VectorSIMD277 c;
	...
	inline VectorSIMD277 operator*(VectorSIMD277 a ,double b){
		VectorSIMD277 c;
	...
	inline VectorSIMD277 operator*(int a, VectorSIMD277 b){
		if(a==1){return b;}
		VectorSIMD277 c;
	...
	inline VectorSIMD277 operator*(VectorSIMD277 a, int b){
		if(b==1){return a;}
		VectorSIMD277 c;
	...
	inline VectorSIMD277 operator*(VectorSIMD277 a, VectorSIMD277 b){
		VectorSIMD277 c;
	...
	inline VectorSIMD277 exp(VectorSIMD277 a){
		double a_d[277]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD277 sqrt(VectorSIMD277 a){
		double a_d[277]; a.convert(a_d);
