...
public:
		...
		VectorSIMD403(double a){
			...
			_avx100=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD403(double (&a)[403]){
		...
		VectorSIMD403& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD403& operator += (VectorSIMD403 a){
	...
	inline VectorSIMD403 operator*(double a, VectorSIMD403 b){
		VectorSIMD403 c;
	...
	inline VectorSIMD403 operator*(VectorSIMD403 a ,double b){
		VectorSIMD403 c;
	...
	inline VectorSIMD403 operator*(int a, VectorSIMD403 b){
		if(a==1){return b;}
		VectorSIMD403 c;
	...
	inline VectorSIMD403 operator*(VectorSIMD403 a, int b){
		if(b==1){return a;}
		VectorSIMD403 c;
	...
	inline VectorSIMD403 operator*(VectorSIMD403 a, VectorSIMD403 b){
		VectorSIMD403 c;
	...
	inline VectorSIMD403 exp(VectorSIMD403 a){
		double a_d[403]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD403 sqrt(VectorSIMD403 a){
		double a_d[403]; a.convert(a_d);
