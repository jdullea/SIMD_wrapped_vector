...
public:
		...
		VectorSIMD442(double a){
			...
			_avx110=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD442(double (&a)[442]){
		...
		VectorSIMD442& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD442& operator += (VectorSIMD442 a){
	...
	inline VectorSIMD442 operator*(double a, VectorSIMD442 b){
		VectorSIMD442 c;
	...
	inline VectorSIMD442 operator*(VectorSIMD442 a ,double b){
		VectorSIMD442 c;
	...
	inline VectorSIMD442 operator*(int a, VectorSIMD442 b){
		if(a==1){return b;}
		VectorSIMD442 c;
	...
	inline VectorSIMD442 operator*(VectorSIMD442 a, int b){
		if(b==1){return a;}
		VectorSIMD442 c;
	...
	inline VectorSIMD442 operator*(VectorSIMD442 a, VectorSIMD442 b){
		VectorSIMD442 c;
	...
	inline VectorSIMD442 exp(VectorSIMD442 a){
		double a_d[442]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD442 sqrt(VectorSIMD442 a){
		double a_d[442]; a.convert(a_d);
