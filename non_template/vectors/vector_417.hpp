...
public:
		...
		VectorSIMD417(double a){
			...
			_avx104=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD417(double (&a)[417]){
		...
		VectorSIMD417& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD417& operator += (VectorSIMD417 a){
	...
	inline VectorSIMD417 operator*(double a, VectorSIMD417 b){
		VectorSIMD417 c;
	...
	inline VectorSIMD417 operator*(VectorSIMD417 a ,double b){
		VectorSIMD417 c;
	...
	inline VectorSIMD417 operator*(int a, VectorSIMD417 b){
		if(a==1){return b;}
		VectorSIMD417 c;
	...
	inline VectorSIMD417 operator*(VectorSIMD417 a, int b){
		if(b==1){return a;}
		VectorSIMD417 c;
	...
	inline VectorSIMD417 operator*(VectorSIMD417 a, VectorSIMD417 b){
		VectorSIMD417 c;
	...
	inline VectorSIMD417 exp(VectorSIMD417 a){
		double a_d[417]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD417 sqrt(VectorSIMD417 a){
		double a_d[417]; a.convert(a_d);
