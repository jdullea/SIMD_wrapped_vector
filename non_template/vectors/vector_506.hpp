...
public:
		...
		VectorSIMD506(double a){
			...
			_avx126=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD506(double (&a)[506]){
		...
		VectorSIMD506& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD506& operator += (VectorSIMD506 a){
	...
	inline VectorSIMD506 operator*(double a, VectorSIMD506 b){
		VectorSIMD506 c;
	...
	inline VectorSIMD506 operator*(VectorSIMD506 a ,double b){
		VectorSIMD506 c;
	...
	inline VectorSIMD506 operator*(int a, VectorSIMD506 b){
		if(a==1){return b;}
		VectorSIMD506 c;
	...
	inline VectorSIMD506 operator*(VectorSIMD506 a, int b){
		if(b==1){return a;}
		VectorSIMD506 c;
	...
	inline VectorSIMD506 operator*(VectorSIMD506 a, VectorSIMD506 b){
		VectorSIMD506 c;
	...
	inline VectorSIMD506 exp(VectorSIMD506 a){
		double a_d[506]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD506 sqrt(VectorSIMD506 a){
		double a_d[506]; a.convert(a_d);
