...
public:
		...
		VectorSIMD584& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD584& operator += (VectorSIMD584 a){
	...
	inline VectorSIMD584 operator*(double a, VectorSIMD584 b){
		VectorSIMD584 c;
	...
	inline VectorSIMD584 operator*(VectorSIMD584 a ,double b){
		VectorSIMD584 c;
	...
	inline VectorSIMD584 operator*(int a, VectorSIMD584 b){
		if(a==1){return b;}
		VectorSIMD584 c;
	...
	inline VectorSIMD584 operator*(VectorSIMD584 a, int b){
		if(b==1){return a;}
		VectorSIMD584 c;
	...
	inline VectorSIMD584 operator*(VectorSIMD584 a, VectorSIMD584 b){
		VectorSIMD584 c;
	...
	inline VectorSIMD584 exp(VectorSIMD584 a){
		double a_d[584]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD584 sqrt(VectorSIMD584 a){
		double a_d[584]; a.convert(a_d);
