...
public:
		...
		VectorSIMD688& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD688& operator += (VectorSIMD688 a){
	...
	inline VectorSIMD688 operator*(double a, VectorSIMD688 b){
		VectorSIMD688 c;
	...
	inline VectorSIMD688 operator*(VectorSIMD688 a ,double b){
		VectorSIMD688 c;
	...
	inline VectorSIMD688 operator*(int a, VectorSIMD688 b){
		if(a==1){return b;}
		VectorSIMD688 c;
	...
	inline VectorSIMD688 operator*(VectorSIMD688 a, int b){
		if(b==1){return a;}
		VectorSIMD688 c;
	...
	inline VectorSIMD688 operator*(VectorSIMD688 a, VectorSIMD688 b){
		VectorSIMD688 c;
	...
	inline VectorSIMD688 exp(VectorSIMD688 a){
		double a_d[688]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD688 sqrt(VectorSIMD688 a){
		double a_d[688]; a.convert(a_d);
