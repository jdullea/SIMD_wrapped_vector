...
public:
		...
		VectorSIMD806(double a){
			...
			_avx201=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD806(double (&a)[806]){
		...
		VectorSIMD806& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD806& operator += (VectorSIMD806 a){
	...
	inline VectorSIMD806 operator*(double a, VectorSIMD806 b){
		VectorSIMD806 c;
	...
	inline VectorSIMD806 operator*(VectorSIMD806 a ,double b){
		VectorSIMD806 c;
	...
	inline VectorSIMD806 operator*(int a, VectorSIMD806 b){
		if(a==1){return b;}
		VectorSIMD806 c;
	...
	inline VectorSIMD806 operator*(VectorSIMD806 a, int b){
		if(b==1){return a;}
		VectorSIMD806 c;
	...
	inline VectorSIMD806 operator*(VectorSIMD806 a, VectorSIMD806 b){
		VectorSIMD806 c;
	...
	inline VectorSIMD806 exp(VectorSIMD806 a){
		double a_d[806]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD806 sqrt(VectorSIMD806 a){
		double a_d[806]; a.convert(a_d);
