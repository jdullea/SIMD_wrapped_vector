...
public:
		...
		VectorSIMD625(double a){
			...
			_avx156=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD625(double (&a)[625]){
		...
		VectorSIMD625& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD625& operator += (VectorSIMD625 a){
	...
	inline VectorSIMD625 operator*(double a, VectorSIMD625 b){
		VectorSIMD625 c;
	...
	inline VectorSIMD625 operator*(VectorSIMD625 a ,double b){
		VectorSIMD625 c;
	...
	inline VectorSIMD625 operator*(int a, VectorSIMD625 b){
		if(a==1){return b;}
		VectorSIMD625 c;
	...
	inline VectorSIMD625 operator*(VectorSIMD625 a, int b){
		if(b==1){return a;}
		VectorSIMD625 c;
	...
	inline VectorSIMD625 operator*(VectorSIMD625 a, VectorSIMD625 b){
		VectorSIMD625 c;
	...
	inline VectorSIMD625 exp(VectorSIMD625 a){
		double a_d[625]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD625 sqrt(VectorSIMD625 a){
		double a_d[625]; a.convert(a_d);
