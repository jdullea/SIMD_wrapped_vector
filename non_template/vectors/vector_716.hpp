...
public:
		...
		VectorSIMD716& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD716& operator += (VectorSIMD716 a){
	...
	inline VectorSIMD716 operator*(double a, VectorSIMD716 b){
		VectorSIMD716 c;
	...
	inline VectorSIMD716 operator*(VectorSIMD716 a ,double b){
		VectorSIMD716 c;
	...
	inline VectorSIMD716 operator*(int a, VectorSIMD716 b){
		if(a==1){return b;}
		VectorSIMD716 c;
	...
	inline VectorSIMD716 operator*(VectorSIMD716 a, int b){
		if(b==1){return a;}
		VectorSIMD716 c;
	...
	inline VectorSIMD716 operator*(VectorSIMD716 a, VectorSIMD716 b){
		VectorSIMD716 c;
	...
	inline VectorSIMD716 exp(VectorSIMD716 a){
		double a_d[716]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD716 sqrt(VectorSIMD716 a){
		double a_d[716]; a.convert(a_d);
