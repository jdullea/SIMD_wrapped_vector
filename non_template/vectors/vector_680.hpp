...
public:
		...
		VectorSIMD680& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD680& operator += (VectorSIMD680 a){
	...
	inline VectorSIMD680 operator*(double a, VectorSIMD680 b){
		VectorSIMD680 c;
	...
	inline VectorSIMD680 operator*(VectorSIMD680 a ,double b){
		VectorSIMD680 c;
	...
	inline VectorSIMD680 operator*(int a, VectorSIMD680 b){
		if(a==1){return b;}
		VectorSIMD680 c;
	...
	inline VectorSIMD680 operator*(VectorSIMD680 a, int b){
		if(b==1){return a;}
		VectorSIMD680 c;
	...
	inline VectorSIMD680 operator*(VectorSIMD680 a, VectorSIMD680 b){
		VectorSIMD680 c;
	...
	inline VectorSIMD680 exp(VectorSIMD680 a){
		double a_d[680]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD680 sqrt(VectorSIMD680 a){
		double a_d[680]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD680 a){ 
		double ad[680];
		a.convert(ad);
