...
public:
		...
		VectorSIMD386(double a){
			...
			_avx96=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD386(double (&a)[386]){
		...
		VectorSIMD386& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD386& operator += (VectorSIMD386 a){
	...
	inline VectorSIMD386 operator*(double a, VectorSIMD386 b){
		VectorSIMD386 c;
	...
	inline VectorSIMD386 operator*(VectorSIMD386 a ,double b){
		VectorSIMD386 c;
	...
	inline VectorSIMD386 operator*(int a, VectorSIMD386 b){
		if(a==1){return b;}
		VectorSIMD386 c;
	...
	inline VectorSIMD386 operator*(VectorSIMD386 a, int b){
		if(b==1){return a;}
		VectorSIMD386 c;
	...
	inline VectorSIMD386 operator*(VectorSIMD386 a, VectorSIMD386 b){
		VectorSIMD386 c;
	...
	inline VectorSIMD386 exp(VectorSIMD386 a){
		double a_d[386]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD386 sqrt(VectorSIMD386 a){
		double a_d[386]; a.convert(a_d);
