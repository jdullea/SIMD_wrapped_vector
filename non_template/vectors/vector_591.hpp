...
public:
		...
		VectorSIMD591(double a){
			...
			_avx147=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD591(double (&a)[591]){
		...
		VectorSIMD591& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD591& operator += (VectorSIMD591 a){
	...
	inline VectorSIMD591 operator*(double a, VectorSIMD591 b){
		VectorSIMD591 c;
	...
	inline VectorSIMD591 operator*(VectorSIMD591 a ,double b){
		VectorSIMD591 c;
	...
	inline VectorSIMD591 operator*(int a, VectorSIMD591 b){
		if(a==1){return b;}
		VectorSIMD591 c;
	...
	inline VectorSIMD591 operator*(VectorSIMD591 a, int b){
		if(b==1){return a;}
		VectorSIMD591 c;
	...
	inline VectorSIMD591 operator*(VectorSIMD591 a, VectorSIMD591 b){
		VectorSIMD591 c;
	...
	inline VectorSIMD591 exp(VectorSIMD591 a){
		double a_d[591]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD591 sqrt(VectorSIMD591 a){
		double a_d[591]; a.convert(a_d);
