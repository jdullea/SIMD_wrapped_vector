...
public:
		...
		VectorSIMD883(double a){
			...
			_avx220=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD883(double (&a)[883]){
		...
		VectorSIMD883& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD883& operator += (VectorSIMD883 a){
	...
	inline VectorSIMD883 operator*(double a, VectorSIMD883 b){
		VectorSIMD883 c;
	...
	inline VectorSIMD883 operator*(VectorSIMD883 a ,double b){
		VectorSIMD883 c;
	...
	inline VectorSIMD883 operator*(int a, VectorSIMD883 b){
		if(a==1){return b;}
		VectorSIMD883 c;
	...
	inline VectorSIMD883 operator*(VectorSIMD883 a, int b){
		if(b==1){return a;}
		VectorSIMD883 c;
	...
	inline VectorSIMD883 operator*(VectorSIMD883 a, VectorSIMD883 b){
		VectorSIMD883 c;
	...
	inline VectorSIMD883 exp(VectorSIMD883 a){
		double a_d[883]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD883 sqrt(VectorSIMD883 a){
		double a_d[883]; a.convert(a_d);
