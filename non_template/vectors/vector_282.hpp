...
public:
		...
		VectorSIMD282(double a){
			...
			_avx70=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD282(double (&a)[282]){
		...
		VectorSIMD282& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD282& operator += (VectorSIMD282 a){
	...
	inline VectorSIMD282 operator*(double a, VectorSIMD282 b){
		VectorSIMD282 c;
	...
	inline VectorSIMD282 operator*(VectorSIMD282 a ,double b){
		VectorSIMD282 c;
	...
	inline VectorSIMD282 operator*(int a, VectorSIMD282 b){
		if(a==1){return b;}
		VectorSIMD282 c;
	...
	inline VectorSIMD282 operator*(VectorSIMD282 a, int b){
		if(b==1){return a;}
		VectorSIMD282 c;
	...
	inline VectorSIMD282 operator*(VectorSIMD282 a, VectorSIMD282 b){
		VectorSIMD282 c;
	...
	inline VectorSIMD282 exp(VectorSIMD282 a){
		double a_d[282]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD282 sqrt(VectorSIMD282 a){
		double a_d[282]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD282 a){ 
		double ad[282];
		a.convert(ad);
