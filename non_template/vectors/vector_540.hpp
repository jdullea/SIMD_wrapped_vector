...
public:
		...
		VectorSIMD540& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD540& operator += (VectorSIMD540 a){
	...
	inline VectorSIMD540 operator*(double a, VectorSIMD540 b){
		VectorSIMD540 c;
	...
	inline VectorSIMD540 operator*(VectorSIMD540 a ,double b){
		VectorSIMD540 c;
	...
	inline VectorSIMD540 operator*(int a, VectorSIMD540 b){
		if(a==1){return b;}
		VectorSIMD540 c;
	...
	inline VectorSIMD540 operator*(VectorSIMD540 a, int b){
		if(b==1){return a;}
		VectorSIMD540 c;
	...
	inline VectorSIMD540 operator*(VectorSIMD540 a, VectorSIMD540 b){
		VectorSIMD540 c;
	...
	inline VectorSIMD540 exp(VectorSIMD540 a){
		double a_d[540]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD540 sqrt(VectorSIMD540 a){
		double a_d[540]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD540 a){ 
		double ad[540];
		a.convert(ad);
