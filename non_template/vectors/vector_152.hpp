...
public:
		...
		VectorSIMD152(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13,__m256d _14,__m256d _15,__m256d _16,__m256d _17,__m256d _18,__m256d _19,__m256d _20,__m256d _21,__m256d _22,__m256d _23,__m256d _24,__m256d _25,__m256d _26,__m256d _27,__m256d _28,__m256d _29,__m256d _30,__m256d _31,__m256d _32,__m256d _33,__m256d _34,__m256d _35,__m256d _36,__m256d _37){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD152& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD152& operator += (VectorSIMD152 a){
	...
	inline VectorSIMD152 operator*(double a, VectorSIMD152 b){
		VectorSIMD152 c;
	...
	inline VectorSIMD152 operator*(VectorSIMD152 a ,double b){
		VectorSIMD152 c;
	...
	inline VectorSIMD152 operator*(int a, VectorSIMD152 b){
		if(a==1){return b;}
		VectorSIMD152 c;
	...
	inline VectorSIMD152 operator*(VectorSIMD152 a, int b){
		if(b==1){return a;}
		VectorSIMD152 c;
	...
	inline VectorSIMD152 operator*(VectorSIMD152 a, VectorSIMD152 b){
		VectorSIMD152 c;
	...
	inline VectorSIMD152 exp(VectorSIMD152 a){
		double a_d[152]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD152 sqrt(VectorSIMD152 a){
		double a_d[152]; a.convert(a_d);
