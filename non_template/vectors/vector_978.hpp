...
public:
		...
		VectorSIMD978(double a){
			...
			_avx244=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD978(double (&a)[978]){
		...
		VectorSIMD978& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD978& operator += (VectorSIMD978 a){
	...
	inline VectorSIMD978 operator*(double a, VectorSIMD978 b){
		VectorSIMD978 c;
	...
	inline VectorSIMD978 operator*(VectorSIMD978 a ,double b){
		VectorSIMD978 c;
	...
	inline VectorSIMD978 operator*(int a, VectorSIMD978 b){
		if(a==1){return b;}
		VectorSIMD978 c;
	...
	inline VectorSIMD978 operator*(VectorSIMD978 a, int b){
		if(b==1){return a;}
		VectorSIMD978 c;
	...
	inline VectorSIMD978 operator*(VectorSIMD978 a, VectorSIMD978 b){
		VectorSIMD978 c;
	...
	inline VectorSIMD978 exp(VectorSIMD978 a){
		double a_d[978]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD978 sqrt(VectorSIMD978 a){
		double a_d[978]; a.convert(a_d);
