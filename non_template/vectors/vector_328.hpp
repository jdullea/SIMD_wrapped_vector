...
public:
		...
		VectorSIMD328& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD328& operator += (VectorSIMD328 a){
	...
	inline VectorSIMD328 operator*(double a, VectorSIMD328 b){
		VectorSIMD328 c;
	...
	inline VectorSIMD328 operator*(VectorSIMD328 a ,double b){
		VectorSIMD328 c;
	...
	inline VectorSIMD328 operator*(int a, VectorSIMD328 b){
		if(a==1){return b;}
		VectorSIMD328 c;
	...
	inline VectorSIMD328 operator*(VectorSIMD328 a, int b){
		if(b==1){return a;}
		VectorSIMD328 c;
	...
	inline VectorSIMD328 operator*(VectorSIMD328 a, VectorSIMD328 b){
		VectorSIMD328 c;
	...
	inline VectorSIMD328 exp(VectorSIMD328 a){
		double a_d[328]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD328 sqrt(VectorSIMD328 a){
		double a_d[328]; a.convert(a_d);
