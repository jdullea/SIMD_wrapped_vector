...
public:
		...
		VectorSIMD459(double a){
			...
			_avx114=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD459(double (&a)[459]){
		...
		VectorSIMD459& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD459& operator += (VectorSIMD459 a){
	...
	inline VectorSIMD459 operator*(double a, VectorSIMD459 b){
		VectorSIMD459 c;
	...
	inline VectorSIMD459 operator*(VectorSIMD459 a ,double b){
		VectorSIMD459 c;
	...
	inline VectorSIMD459 operator*(int a, VectorSIMD459 b){
		if(a==1){return b;}
		VectorSIMD459 c;
	...
	inline VectorSIMD459 operator*(VectorSIMD459 a, int b){
		if(b==1){return a;}
		VectorSIMD459 c;
	...
	inline VectorSIMD459 operator*(VectorSIMD459 a, VectorSIMD459 b){
		VectorSIMD459 c;
	...
	inline VectorSIMD459 exp(VectorSIMD459 a){
		double a_d[459]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD459 sqrt(VectorSIMD459 a){
		double a_d[459]; a.convert(a_d);
