...
public:
		...
		VectorSIMD845(double a){
			...
			_avx211=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD845(double (&a)[845]){
		...
		VectorSIMD845& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD845& operator += (VectorSIMD845 a){
	...
	inline VectorSIMD845 operator*(double a, VectorSIMD845 b){
		VectorSIMD845 c;
	...
	inline VectorSIMD845 operator*(VectorSIMD845 a ,double b){
		VectorSIMD845 c;
	...
	inline VectorSIMD845 operator*(int a, VectorSIMD845 b){
		if(a==1){return b;}
		VectorSIMD845 c;
	...
	inline VectorSIMD845 operator*(VectorSIMD845 a, int b){
		if(b==1){return a;}
		VectorSIMD845 c;
	...
	inline VectorSIMD845 operator*(VectorSIMD845 a, VectorSIMD845 b){
		VectorSIMD845 c;
	...
	inline VectorSIMD845 exp(VectorSIMD845 a){
		double a_d[845]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD845 sqrt(VectorSIMD845 a){
		double a_d[845]; a.convert(a_d);
