...
public:
		...
		VectorSIMD841(double a){
			...
			_avx210=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD841(double (&a)[841]){
		...
		VectorSIMD841& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD841& operator += (VectorSIMD841 a){
	...
	inline VectorSIMD841 operator*(double a, VectorSIMD841 b){
		VectorSIMD841 c;
	...
	inline VectorSIMD841 operator*(VectorSIMD841 a ,double b){
		VectorSIMD841 c;
	...
	inline VectorSIMD841 operator*(int a, VectorSIMD841 b){
		if(a==1){return b;}
		VectorSIMD841 c;
	...
	inline VectorSIMD841 operator*(VectorSIMD841 a, int b){
		if(b==1){return a;}
		VectorSIMD841 c;
	...
	inline VectorSIMD841 operator*(VectorSIMD841 a, VectorSIMD841 b){
		VectorSIMD841 c;
	...
	inline VectorSIMD841 exp(VectorSIMD841 a){
		double a_d[841]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD841 sqrt(VectorSIMD841 a){
		double a_d[841]; a.convert(a_d);
