...
public:
		...
		VectorSIMD488& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD488& operator += (VectorSIMD488 a){
	...
	inline VectorSIMD488 operator*(double a, VectorSIMD488 b){
		VectorSIMD488 c;
	...
	inline VectorSIMD488 operator*(VectorSIMD488 a ,double b){
		VectorSIMD488 c;
	...
	inline VectorSIMD488 operator*(int a, VectorSIMD488 b){
		if(a==1){return b;}
		VectorSIMD488 c;
	...
	inline VectorSIMD488 operator*(VectorSIMD488 a, int b){
		if(b==1){return a;}
		VectorSIMD488 c;
	...
	inline VectorSIMD488 operator*(VectorSIMD488 a, VectorSIMD488 b){
		VectorSIMD488 c;
	...
	inline VectorSIMD488 exp(VectorSIMD488 a){
		double a_d[488]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD488 sqrt(VectorSIMD488 a){
		double a_d[488]; a.convert(a_d);
