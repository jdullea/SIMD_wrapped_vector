...
public:
		...
		VectorSIMD788& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD788& operator += (VectorSIMD788 a){
	...
	inline VectorSIMD788 operator*(double a, VectorSIMD788 b){
		VectorSIMD788 c;
	...
	inline VectorSIMD788 operator*(VectorSIMD788 a ,double b){
		VectorSIMD788 c;
	...
	inline VectorSIMD788 operator*(int a, VectorSIMD788 b){
		if(a==1){return b;}
		VectorSIMD788 c;
	...
	inline VectorSIMD788 operator*(VectorSIMD788 a, int b){
		if(b==1){return a;}
		VectorSIMD788 c;
	...
	inline VectorSIMD788 operator*(VectorSIMD788 a, VectorSIMD788 b){
		VectorSIMD788 c;
	...
	inline VectorSIMD788 exp(VectorSIMD788 a){
		double a_d[788]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD788 sqrt(VectorSIMD788 a){
		double a_d[788]; a.convert(a_d);
