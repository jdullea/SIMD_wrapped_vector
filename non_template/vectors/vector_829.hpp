...
public:
		...
		VectorSIMD829(double a){
			...
			_avx207=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD829(double (&a)[829]){
		...
		VectorSIMD829& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD829& operator += (VectorSIMD829 a){
	...
	inline VectorSIMD829 operator*(double a, VectorSIMD829 b){
		VectorSIMD829 c;
	...
	inline VectorSIMD829 operator*(VectorSIMD829 a ,double b){
		VectorSIMD829 c;
	...
	inline VectorSIMD829 operator*(int a, VectorSIMD829 b){
		if(a==1){return b;}
		VectorSIMD829 c;
	...
	inline VectorSIMD829 operator*(VectorSIMD829 a, int b){
		if(b==1){return a;}
		VectorSIMD829 c;
	...
	inline VectorSIMD829 operator*(VectorSIMD829 a, VectorSIMD829 b){
		VectorSIMD829 c;
	...
	inline VectorSIMD829 exp(VectorSIMD829 a){
		double a_d[829]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD829 sqrt(VectorSIMD829 a){
		double a_d[829]; a.convert(a_d);
