...
public:
		...
		VectorSIMD781(double a){
			...
			_avx195=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD781(double (&a)[781]){
		...
		VectorSIMD781& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD781& operator += (VectorSIMD781 a){
	...
	inline VectorSIMD781 operator*(double a, VectorSIMD781 b){
		VectorSIMD781 c;
	...
	inline VectorSIMD781 operator*(VectorSIMD781 a ,double b){
		VectorSIMD781 c;
	...
	inline VectorSIMD781 operator*(int a, VectorSIMD781 b){
		if(a==1){return b;}
		VectorSIMD781 c;
	...
	inline VectorSIMD781 operator*(VectorSIMD781 a, int b){
		if(b==1){return a;}
		VectorSIMD781 c;
	...
	inline VectorSIMD781 operator*(VectorSIMD781 a, VectorSIMD781 b){
		VectorSIMD781 c;
	...
	inline VectorSIMD781 exp(VectorSIMD781 a){
		double a_d[781]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD781 sqrt(VectorSIMD781 a){
		double a_d[781]; a.convert(a_d);
