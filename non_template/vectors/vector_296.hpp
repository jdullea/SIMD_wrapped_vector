...
public:
		...
		VectorSIMD296& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD296& operator += (VectorSIMD296 a){
	...
	inline VectorSIMD296 operator*(double a, VectorSIMD296 b){
		VectorSIMD296 c;
	...
	inline VectorSIMD296 operator*(VectorSIMD296 a ,double b){
		VectorSIMD296 c;
	...
	inline VectorSIMD296 operator*(int a, VectorSIMD296 b){
		if(a==1){return b;}
		VectorSIMD296 c;
	...
	inline VectorSIMD296 operator*(VectorSIMD296 a, int b){
		if(b==1){return a;}
		VectorSIMD296 c;
	...
	inline VectorSIMD296 operator*(VectorSIMD296 a, VectorSIMD296 b){
		VectorSIMD296 c;
	...
	inline VectorSIMD296 exp(VectorSIMD296 a){
		double a_d[296]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD296 sqrt(VectorSIMD296 a){
		double a_d[296]; a.convert(a_d);
