...
public:
		...
		VectorSIMD428& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD428& operator += (VectorSIMD428 a){
	...
	inline VectorSIMD428 operator*(double a, VectorSIMD428 b){
		VectorSIMD428 c;
	...
	inline VectorSIMD428 operator*(VectorSIMD428 a ,double b){
		VectorSIMD428 c;
	...
	inline VectorSIMD428 operator*(int a, VectorSIMD428 b){
		if(a==1){return b;}
		VectorSIMD428 c;
	...
	inline VectorSIMD428 operator*(VectorSIMD428 a, int b){
		if(b==1){return a;}
		VectorSIMD428 c;
	...
	inline VectorSIMD428 operator*(VectorSIMD428 a, VectorSIMD428 b){
		VectorSIMD428 c;
	...
	inline VectorSIMD428 exp(VectorSIMD428 a){
		double a_d[428]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD428 sqrt(VectorSIMD428 a){
		double a_d[428]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD428 a){ 
		double ad[428];
		a.convert(ad);
