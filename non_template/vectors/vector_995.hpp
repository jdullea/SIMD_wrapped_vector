...
public:
		...
		VectorSIMD995(double a){
			...
			_avx248=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD995(double (&a)[995]){
		...
		VectorSIMD995& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD995& operator += (VectorSIMD995 a){
	...
	inline VectorSIMD995 operator*(double a, VectorSIMD995 b){
		VectorSIMD995 c;
	...
	inline VectorSIMD995 operator*(VectorSIMD995 a ,double b){
		VectorSIMD995 c;
	...
	inline VectorSIMD995 operator*(int a, VectorSIMD995 b){
		if(a==1){return b;}
		VectorSIMD995 c;
	...
	inline VectorSIMD995 operator*(VectorSIMD995 a, int b){
		if(b==1){return a;}
		VectorSIMD995 c;
	...
	inline VectorSIMD995 operator*(VectorSIMD995 a, VectorSIMD995 b){
		VectorSIMD995 c;
	...
	inline VectorSIMD995 exp(VectorSIMD995 a){
		double a_d[995]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD995 sqrt(VectorSIMD995 a){
		double a_d[995]; a.convert(a_d);
