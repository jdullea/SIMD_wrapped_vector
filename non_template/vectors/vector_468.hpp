...
public:
		...
		VectorSIMD468& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD468& operator += (VectorSIMD468 a){
	...
	inline VectorSIMD468 operator*(double a, VectorSIMD468 b){
		VectorSIMD468 c;
	...
	inline VectorSIMD468 operator*(VectorSIMD468 a ,double b){
		VectorSIMD468 c;
	...
	inline VectorSIMD468 operator*(int a, VectorSIMD468 b){
		if(a==1){return b;}
		VectorSIMD468 c;
	...
	inline VectorSIMD468 operator*(VectorSIMD468 a, int b){
		if(b==1){return a;}
		VectorSIMD468 c;
	...
	inline VectorSIMD468 operator*(VectorSIMD468 a, VectorSIMD468 b){
		VectorSIMD468 c;
	...
	inline VectorSIMD468 exp(VectorSIMD468 a){
		double a_d[468]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD468 sqrt(VectorSIMD468 a){
		double a_d[468]; a.convert(a_d);
