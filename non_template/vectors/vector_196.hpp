...
public:
		...
		VectorSIMD196& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD196& operator += (VectorSIMD196 a){
	...
	inline VectorSIMD196 operator*(double a, VectorSIMD196 b){
		VectorSIMD196 c;
	...
	inline VectorSIMD196 operator*(VectorSIMD196 a ,double b){
		VectorSIMD196 c;
	...
	inline VectorSIMD196 operator*(int a, VectorSIMD196 b){
		if(a==1){return b;}
		VectorSIMD196 c;
	...
	inline VectorSIMD196 operator*(VectorSIMD196 a, int b){
		if(b==1){return a;}
		VectorSIMD196 c;
	...
	inline VectorSIMD196 operator*(VectorSIMD196 a, VectorSIMD196 b){
		VectorSIMD196 c;
	...
	inline VectorSIMD196 exp(VectorSIMD196 a){
		double a_d[196]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD196 sqrt(VectorSIMD196 a){
		double a_d[196]; a.convert(a_d);
