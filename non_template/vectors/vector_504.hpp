...
public:
		...
		VectorSIMD504& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD504& operator += (VectorSIMD504 a){
	...
	inline VectorSIMD504 operator*(double a, VectorSIMD504 b){
		VectorSIMD504 c;
	...
	inline VectorSIMD504 operator*(VectorSIMD504 a ,double b){
		VectorSIMD504 c;
	...
	inline VectorSIMD504 operator*(int a, VectorSIMD504 b){
		if(a==1){return b;}
		VectorSIMD504 c;
	...
	inline VectorSIMD504 operator*(VectorSIMD504 a, int b){
		if(b==1){return a;}
		VectorSIMD504 c;
	...
	inline VectorSIMD504 operator*(VectorSIMD504 a, VectorSIMD504 b){
		VectorSIMD504 c;
	...
	inline VectorSIMD504 exp(VectorSIMD504 a){
		double a_d[504]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD504 sqrt(VectorSIMD504 a){
		double a_d[504]; a.convert(a_d);
