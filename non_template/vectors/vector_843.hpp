...
public:
		...
		VectorSIMD843(double a){
			...
			_avx210=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD843(double (&a)[843]){
		...
		VectorSIMD843& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD843& operator += (VectorSIMD843 a){
	...
	inline VectorSIMD843 operator*(double a, VectorSIMD843 b){
		VectorSIMD843 c;
	...
	inline VectorSIMD843 operator*(VectorSIMD843 a ,double b){
		VectorSIMD843 c;
	...
	inline VectorSIMD843 operator*(int a, VectorSIMD843 b){
		if(a==1){return b;}
		VectorSIMD843 c;
	...
	inline VectorSIMD843 operator*(VectorSIMD843 a, int b){
		if(b==1){return a;}
		VectorSIMD843 c;
	...
	inline VectorSIMD843 operator*(VectorSIMD843 a, VectorSIMD843 b){
		VectorSIMD843 c;
	...
	inline VectorSIMD843 exp(VectorSIMD843 a){
		double a_d[843]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD843 sqrt(VectorSIMD843 a){
		double a_d[843]; a.convert(a_d);
