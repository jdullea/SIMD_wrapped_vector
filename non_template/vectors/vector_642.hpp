...
public:
		...
		VectorSIMD642(double a){
			...
			_avx160=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD642(double (&a)[642]){
		...
		VectorSIMD642& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD642& operator += (VectorSIMD642 a){
	...
	inline VectorSIMD642 operator*(double a, VectorSIMD642 b){
		VectorSIMD642 c;
	...
	inline VectorSIMD642 operator*(VectorSIMD642 a ,double b){
		VectorSIMD642 c;
	...
	inline VectorSIMD642 operator*(int a, VectorSIMD642 b){
		if(a==1){return b;}
		VectorSIMD642 c;
	...
	inline VectorSIMD642 operator*(VectorSIMD642 a, int b){
		if(b==1){return a;}
		VectorSIMD642 c;
	...
	inline VectorSIMD642 operator*(VectorSIMD642 a, VectorSIMD642 b){
		VectorSIMD642 c;
	...
	inline VectorSIMD642 exp(VectorSIMD642 a){
		double a_d[642]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD642 sqrt(VectorSIMD642 a){
		double a_d[642]; a.convert(a_d);
