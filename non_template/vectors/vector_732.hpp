...
public:
		...
		VectorSIMD732& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD732& operator += (VectorSIMD732 a){
	...
	inline VectorSIMD732 operator*(double a, VectorSIMD732 b){
		VectorSIMD732 c;
	...
	inline VectorSIMD732 operator*(VectorSIMD732 a ,double b){
		VectorSIMD732 c;
	...
	inline VectorSIMD732 operator*(int a, VectorSIMD732 b){
		if(a==1){return b;}
		VectorSIMD732 c;
	...
	inline VectorSIMD732 operator*(VectorSIMD732 a, int b){
		if(b==1){return a;}
		VectorSIMD732 c;
	...
	inline VectorSIMD732 operator*(VectorSIMD732 a, VectorSIMD732 b){
		VectorSIMD732 c;
	...
	inline VectorSIMD732 exp(VectorSIMD732 a){
		double a_d[732]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD732 sqrt(VectorSIMD732 a){
		double a_d[732]; a.convert(a_d);
