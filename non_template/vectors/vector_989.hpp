...
public:
		...
		VectorSIMD989(double a){
			...
			_avx247=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD989(double (&a)[989]){
		...
		VectorSIMD989& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD989& operator += (VectorSIMD989 a){
	...
	inline VectorSIMD989 operator*(double a, VectorSIMD989 b){
		VectorSIMD989 c;
	...
	inline VectorSIMD989 operator*(VectorSIMD989 a ,double b){
		VectorSIMD989 c;
	...
	inline VectorSIMD989 operator*(int a, VectorSIMD989 b){
		if(a==1){return b;}
		VectorSIMD989 c;
	...
	inline VectorSIMD989 operator*(VectorSIMD989 a, int b){
		if(b==1){return a;}
		VectorSIMD989 c;
	...
	inline VectorSIMD989 operator*(VectorSIMD989 a, VectorSIMD989 b){
		VectorSIMD989 c;
	...
	inline VectorSIMD989 exp(VectorSIMD989 a){
		double a_d[989]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD989 sqrt(VectorSIMD989 a){
		double a_d[989]; a.convert(a_d);
