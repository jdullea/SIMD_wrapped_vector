...
public:
		...
		VectorSIMD106(double a){
			...
			_avx26=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD106(double (&a)[106]){
		...
		VectorSIMD106& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD106& operator += (VectorSIMD106 a){
	...
	inline VectorSIMD106 operator*(double a, VectorSIMD106 b){
		VectorSIMD106 c;
	...
	inline VectorSIMD106 operator*(VectorSIMD106 a ,double b){
		VectorSIMD106 c;
	...
	inline VectorSIMD106 operator*(int a, VectorSIMD106 b){
		if(a==1){return b;}
		VectorSIMD106 c;
	...
	inline VectorSIMD106 operator*(VectorSIMD106 a, int b){
		if(b==1){return a;}
		VectorSIMD106 c;
	...
	inline VectorSIMD106 operator*(VectorSIMD106 a, VectorSIMD106 b){
		VectorSIMD106 c;
	...
	inline VectorSIMD106 exp(VectorSIMD106 a){
		double a_d[106]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD106 sqrt(VectorSIMD106 a){
		double a_d[106]; a.convert(a_d);
