...
public:
		...
		VectorSIMD614(double a){
			...
			_avx153=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD614(double (&a)[614]){
		...
		VectorSIMD614& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD614& operator += (VectorSIMD614 a){
	...
	inline VectorSIMD614 operator*(double a, VectorSIMD614 b){
		VectorSIMD614 c;
	...
	inline VectorSIMD614 operator*(VectorSIMD614 a ,double b){
		VectorSIMD614 c;
	...
	inline VectorSIMD614 operator*(int a, VectorSIMD614 b){
		if(a==1){return b;}
		VectorSIMD614 c;
	...
	inline VectorSIMD614 operator*(VectorSIMD614 a, int b){
		if(b==1){return a;}
		VectorSIMD614 c;
	...
	inline VectorSIMD614 operator*(VectorSIMD614 a, VectorSIMD614 b){
		VectorSIMD614 c;
	...
	inline VectorSIMD614 exp(VectorSIMD614 a){
		double a_d[614]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD614 sqrt(VectorSIMD614 a){
		double a_d[614]; a.convert(a_d);
