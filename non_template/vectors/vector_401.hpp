...
public:
		...
		VectorSIMD401(double a){
			...
			_avx100=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD401(double (&a)[401]){
		...
		VectorSIMD401& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD401& operator += (VectorSIMD401 a){
	...
	inline VectorSIMD401 operator*(double a, VectorSIMD401 b){
		VectorSIMD401 c;
	...
	inline VectorSIMD401 operator*(VectorSIMD401 a ,double b){
		VectorSIMD401 c;
	...
	inline VectorSIMD401 operator*(int a, VectorSIMD401 b){
		if(a==1){return b;}
		VectorSIMD401 c;
	...
	inline VectorSIMD401 operator*(VectorSIMD401 a, int b){
		if(b==1){return a;}
		VectorSIMD401 c;
	...
	inline VectorSIMD401 operator*(VectorSIMD401 a, VectorSIMD401 b){
		VectorSIMD401 c;
	...
	inline VectorSIMD401 exp(VectorSIMD401 a){
		double a_d[401]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD401 sqrt(VectorSIMD401 a){
		double a_d[401]; a.convert(a_d);
