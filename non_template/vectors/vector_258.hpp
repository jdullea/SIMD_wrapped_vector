...
public:
		...
		VectorSIMD258(double a){
			...
			_avx64=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD258(double (&a)[258]){
		...
		VectorSIMD258& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD258& operator += (VectorSIMD258 a){
	...
	inline VectorSIMD258 operator*(double a, VectorSIMD258 b){
		VectorSIMD258 c;
	...
	inline VectorSIMD258 operator*(VectorSIMD258 a ,double b){
		VectorSIMD258 c;
	...
	inline VectorSIMD258 operator*(int a, VectorSIMD258 b){
		if(a==1){return b;}
		VectorSIMD258 c;
	...
	inline VectorSIMD258 operator*(VectorSIMD258 a, int b){
		if(b==1){return a;}
		VectorSIMD258 c;
	...
	inline VectorSIMD258 operator*(VectorSIMD258 a, VectorSIMD258 b){
		VectorSIMD258 c;
	...
	inline VectorSIMD258 exp(VectorSIMD258 a){
		double a_d[258]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD258 sqrt(VectorSIMD258 a){
		double a_d[258]; a.convert(a_d);
