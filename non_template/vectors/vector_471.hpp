...
public:
		...
		VectorSIMD471(double a){
			...
			_avx117=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD471(double (&a)[471]){
		...
		VectorSIMD471& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD471& operator += (VectorSIMD471 a){
	...
	inline VectorSIMD471 operator*(double a, VectorSIMD471 b){
		VectorSIMD471 c;
	...
	inline VectorSIMD471 operator*(VectorSIMD471 a ,double b){
		VectorSIMD471 c;
	...
	inline VectorSIMD471 operator*(int a, VectorSIMD471 b){
		if(a==1){return b;}
		VectorSIMD471 c;
	...
	inline VectorSIMD471 operator*(VectorSIMD471 a, int b){
		if(b==1){return a;}
		VectorSIMD471 c;
	...
	inline VectorSIMD471 operator*(VectorSIMD471 a, VectorSIMD471 b){
		VectorSIMD471 c;
	...
	inline VectorSIMD471 exp(VectorSIMD471 a){
		double a_d[471]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD471 sqrt(VectorSIMD471 a){
		double a_d[471]; a.convert(a_d);
