...
public:
		...
		VectorSIMD787(double a){
			...
			_avx196=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD787(double (&a)[787]){
		...
		VectorSIMD787& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD787& operator += (VectorSIMD787 a){
	...
	inline VectorSIMD787 operator*(double a, VectorSIMD787 b){
		VectorSIMD787 c;
	...
	inline VectorSIMD787 operator*(VectorSIMD787 a ,double b){
		VectorSIMD787 c;
	...
	inline VectorSIMD787 operator*(int a, VectorSIMD787 b){
		if(a==1){return b;}
		VectorSIMD787 c;
	...
	inline VectorSIMD787 operator*(VectorSIMD787 a, int b){
		if(b==1){return a;}
		VectorSIMD787 c;
	...
	inline VectorSIMD787 operator*(VectorSIMD787 a, VectorSIMD787 b){
		VectorSIMD787 c;
	...
	inline VectorSIMD787 exp(VectorSIMD787 a){
		double a_d[787]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD787 sqrt(VectorSIMD787 a){
		double a_d[787]; a.convert(a_d);
