...
public:
		...
		VectorSIMD275(double a){
			...
			_avx68=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD275(double (&a)[275]){
		...
		VectorSIMD275& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD275& operator += (VectorSIMD275 a){
	...
	inline VectorSIMD275 operator*(double a, VectorSIMD275 b){
		VectorSIMD275 c;
	...
	inline VectorSIMD275 operator*(VectorSIMD275 a ,double b){
		VectorSIMD275 c;
	...
	inline VectorSIMD275 operator*(int a, VectorSIMD275 b){
		if(a==1){return b;}
		VectorSIMD275 c;
	...
	inline VectorSIMD275 operator*(VectorSIMD275 a, int b){
		if(b==1){return a;}
		VectorSIMD275 c;
	...
	inline VectorSIMD275 operator*(VectorSIMD275 a, VectorSIMD275 b){
		VectorSIMD275 c;
	...
	inline VectorSIMD275 exp(VectorSIMD275 a){
		double a_d[275]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD275 sqrt(VectorSIMD275 a){
		double a_d[275]; a.convert(a_d);
