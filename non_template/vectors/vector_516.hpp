...
public:
		...
		VectorSIMD516& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD516& operator += (VectorSIMD516 a){
	...
	inline VectorSIMD516 operator*(double a, VectorSIMD516 b){
		VectorSIMD516 c;
	...
	inline VectorSIMD516 operator*(VectorSIMD516 a ,double b){
		VectorSIMD516 c;
	...
	inline VectorSIMD516 operator*(int a, VectorSIMD516 b){
		if(a==1){return b;}
		VectorSIMD516 c;
	...
	inline VectorSIMD516 operator*(VectorSIMD516 a, int b){
		if(b==1){return a;}
		VectorSIMD516 c;
	...
	inline VectorSIMD516 operator*(VectorSIMD516 a, VectorSIMD516 b){
		VectorSIMD516 c;
	...
	inline VectorSIMD516 exp(VectorSIMD516 a){
		double a_d[516]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD516 sqrt(VectorSIMD516 a){
		double a_d[516]; a.convert(a_d);
