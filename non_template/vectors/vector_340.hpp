...
public:
		...
		VectorSIMD340& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD340& operator += (VectorSIMD340 a){
	...
	inline VectorSIMD340 operator*(double a, VectorSIMD340 b){
		VectorSIMD340 c;
	...
	inline VectorSIMD340 operator*(VectorSIMD340 a ,double b){
		VectorSIMD340 c;
	...
	inline VectorSIMD340 operator*(int a, VectorSIMD340 b){
		if(a==1){return b;}
		VectorSIMD340 c;
	...
	inline VectorSIMD340 operator*(VectorSIMD340 a, int b){
		if(b==1){return a;}
		VectorSIMD340 c;
	...
	inline VectorSIMD340 operator*(VectorSIMD340 a, VectorSIMD340 b){
		VectorSIMD340 c;
	...
	inline VectorSIMD340 exp(VectorSIMD340 a){
		double a_d[340]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD340 sqrt(VectorSIMD340 a){
		double a_d[340]; a.convert(a_d);
