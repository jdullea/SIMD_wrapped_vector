...
public:
		...
		VectorSIMD736& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD736& operator += (VectorSIMD736 a){
	...
	inline VectorSIMD736 operator*(double a, VectorSIMD736 b){
		VectorSIMD736 c;
	...
	inline VectorSIMD736 operator*(VectorSIMD736 a ,double b){
		VectorSIMD736 c;
	...
	inline VectorSIMD736 operator*(int a, VectorSIMD736 b){
		if(a==1){return b;}
		VectorSIMD736 c;
	...
	inline VectorSIMD736 operator*(VectorSIMD736 a, int b){
		if(b==1){return a;}
		VectorSIMD736 c;
	...
	inline VectorSIMD736 operator*(VectorSIMD736 a, VectorSIMD736 b){
		VectorSIMD736 c;
	...
	inline VectorSIMD736 exp(VectorSIMD736 a){
		double a_d[736]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD736 sqrt(VectorSIMD736 a){
		double a_d[736]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD736 a){ 
		double ad[736];
		a.convert(ad);
