...
public:
		...
		VectorSIMD425(double a){
			...
			_avx106=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD425(double (&a)[425]){
		...
		VectorSIMD425& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD425& operator += (VectorSIMD425 a){
	...
	inline VectorSIMD425 operator*(double a, VectorSIMD425 b){
		VectorSIMD425 c;
	...
	inline VectorSIMD425 operator*(VectorSIMD425 a ,double b){
		VectorSIMD425 c;
	...
	inline VectorSIMD425 operator*(int a, VectorSIMD425 b){
		if(a==1){return b;}
		VectorSIMD425 c;
	...
	inline VectorSIMD425 operator*(VectorSIMD425 a, int b){
		if(b==1){return a;}
		VectorSIMD425 c;
	...
	inline VectorSIMD425 operator*(VectorSIMD425 a, VectorSIMD425 b){
		VectorSIMD425 c;
	...
	inline VectorSIMD425 exp(VectorSIMD425 a){
		double a_d[425]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD425 sqrt(VectorSIMD425 a){
		double a_d[425]; a.convert(a_d);
