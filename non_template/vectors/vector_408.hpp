...
public:
		...
		VectorSIMD408& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD408& operator += (VectorSIMD408 a){
	...
	inline VectorSIMD408 operator*(double a, VectorSIMD408 b){
		VectorSIMD408 c;
	...
	inline VectorSIMD408 operator*(VectorSIMD408 a ,double b){
		VectorSIMD408 c;
	...
	inline VectorSIMD408 operator*(int a, VectorSIMD408 b){
		if(a==1){return b;}
		VectorSIMD408 c;
	...
	inline VectorSIMD408 operator*(VectorSIMD408 a, int b){
		if(b==1){return a;}
		VectorSIMD408 c;
	...
	inline VectorSIMD408 operator*(VectorSIMD408 a, VectorSIMD408 b){
		VectorSIMD408 c;
	...
	inline VectorSIMD408 exp(VectorSIMD408 a){
		double a_d[408]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD408 sqrt(VectorSIMD408 a){
		double a_d[408]; a.convert(a_d);
