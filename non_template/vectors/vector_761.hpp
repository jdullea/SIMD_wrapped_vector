...
public:
		...
		VectorSIMD761(double a){
			...
			_avx190=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD761(double (&a)[761]){
		...
		VectorSIMD761& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD761& operator += (VectorSIMD761 a){
	...
	inline VectorSIMD761 operator*(double a, VectorSIMD761 b){
		VectorSIMD761 c;
	...
	inline VectorSIMD761 operator*(VectorSIMD761 a ,double b){
		VectorSIMD761 c;
	...
	inline VectorSIMD761 operator*(int a, VectorSIMD761 b){
		if(a==1){return b;}
		VectorSIMD761 c;
	...
	inline VectorSIMD761 operator*(VectorSIMD761 a, int b){
		if(b==1){return a;}
		VectorSIMD761 c;
	...
	inline VectorSIMD761 operator*(VectorSIMD761 a, VectorSIMD761 b){
		VectorSIMD761 c;
	...
	inline VectorSIMD761 exp(VectorSIMD761 a){
		double a_d[761]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD761 sqrt(VectorSIMD761 a){
		double a_d[761]; a.convert(a_d);
