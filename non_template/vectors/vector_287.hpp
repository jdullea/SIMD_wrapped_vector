...
public:
		...
		VectorSIMD287(double a){
			...
			_avx71=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD287(double (&a)[287]){
		...
		VectorSIMD287& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD287& operator += (VectorSIMD287 a){
	...
	inline VectorSIMD287 operator*(double a, VectorSIMD287 b){
		VectorSIMD287 c;
	...
	inline VectorSIMD287 operator*(VectorSIMD287 a ,double b){
		VectorSIMD287 c;
	...
	inline VectorSIMD287 operator*(int a, VectorSIMD287 b){
		if(a==1){return b;}
		VectorSIMD287 c;
	...
	inline VectorSIMD287 operator*(VectorSIMD287 a, int b){
		if(b==1){return a;}
		VectorSIMD287 c;
	...
	inline VectorSIMD287 operator*(VectorSIMD287 a, VectorSIMD287 b){
		VectorSIMD287 c;
	...
	inline VectorSIMD287 exp(VectorSIMD287 a){
		double a_d[287]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD287 sqrt(VectorSIMD287 a){
		double a_d[287]; a.convert(a_d);
