...
public:
		...
		VectorSIMD583(double a){
			...
			_avx145=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD583(double (&a)[583]){
		...
		VectorSIMD583& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD583& operator += (VectorSIMD583 a){
	...
	inline VectorSIMD583 operator*(double a, VectorSIMD583 b){
		VectorSIMD583 c;
	...
	inline VectorSIMD583 operator*(VectorSIMD583 a ,double b){
		VectorSIMD583 c;
	...
	inline VectorSIMD583 operator*(int a, VectorSIMD583 b){
		if(a==1){return b;}
		VectorSIMD583 c;
	...
	inline VectorSIMD583 operator*(VectorSIMD583 a, int b){
		if(b==1){return a;}
		VectorSIMD583 c;
	...
	inline VectorSIMD583 operator*(VectorSIMD583 a, VectorSIMD583 b){
		VectorSIMD583 c;
	...
	inline VectorSIMD583 exp(VectorSIMD583 a){
		double a_d[583]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD583 sqrt(VectorSIMD583 a){
		double a_d[583]; a.convert(a_d);
