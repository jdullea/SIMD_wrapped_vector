...
public:
		...
		VectorSIMD700& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD700& operator += (VectorSIMD700 a){
	...
	inline VectorSIMD700 operator*(double a, VectorSIMD700 b){
		VectorSIMD700 c;
	...
	inline VectorSIMD700 operator*(VectorSIMD700 a ,double b){
		VectorSIMD700 c;
	...
	inline VectorSIMD700 operator*(int a, VectorSIMD700 b){
		if(a==1){return b;}
		VectorSIMD700 c;
	...
	inline VectorSIMD700 operator*(VectorSIMD700 a, int b){
		if(b==1){return a;}
		VectorSIMD700 c;
	...
	inline VectorSIMD700 operator*(VectorSIMD700 a, VectorSIMD700 b){
		VectorSIMD700 c;
	...
	inline VectorSIMD700 exp(VectorSIMD700 a){
		double a_d[700]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD700 sqrt(VectorSIMD700 a){
		double a_d[700]; a.convert(a_d);
