...
public:
		...
		VectorSIMD456& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD456& operator += (VectorSIMD456 a){
	...
	inline VectorSIMD456 operator*(double a, VectorSIMD456 b){
		VectorSIMD456 c;
	...
	inline VectorSIMD456 operator*(VectorSIMD456 a ,double b){
		VectorSIMD456 c;
	...
	inline VectorSIMD456 operator*(int a, VectorSIMD456 b){
		if(a==1){return b;}
		VectorSIMD456 c;
	...
	inline VectorSIMD456 operator*(VectorSIMD456 a, int b){
		if(b==1){return a;}
		VectorSIMD456 c;
	...
	inline VectorSIMD456 operator*(VectorSIMD456 a, VectorSIMD456 b){
		VectorSIMD456 c;
	...
	inline VectorSIMD456 exp(VectorSIMD456 a){
		double a_d[456]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD456 sqrt(VectorSIMD456 a){
		double a_d[456]; a.convert(a_d);
