...
public:
		...
		VectorSIMD264& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD264& operator += (VectorSIMD264 a){
	...
	inline VectorSIMD264 operator*(double a, VectorSIMD264 b){
		VectorSIMD264 c;
	...
	inline VectorSIMD264 operator*(VectorSIMD264 a ,double b){
		VectorSIMD264 c;
	...
	inline VectorSIMD264 operator*(int a, VectorSIMD264 b){
		if(a==1){return b;}
		VectorSIMD264 c;
	...
	inline VectorSIMD264 operator*(VectorSIMD264 a, int b){
		if(b==1){return a;}
		VectorSIMD264 c;
	...
	inline VectorSIMD264 operator*(VectorSIMD264 a, VectorSIMD264 b){
		VectorSIMD264 c;
	...
	inline VectorSIMD264 exp(VectorSIMD264 a){
		double a_d[264]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD264 sqrt(VectorSIMD264 a){
		double a_d[264]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD264 a){ 
		double ad[264];
		a.convert(ad);
