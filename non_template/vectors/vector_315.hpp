...
public:
		...
		VectorSIMD315(double a){
			...
			_avx78=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD315(double (&a)[315]){
		...
		VectorSIMD315& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD315& operator += (VectorSIMD315 a){
	...
	inline VectorSIMD315 operator*(double a, VectorSIMD315 b){
		VectorSIMD315 c;
	...
	inline VectorSIMD315 operator*(VectorSIMD315 a ,double b){
		VectorSIMD315 c;
	...
	inline VectorSIMD315 operator*(int a, VectorSIMD315 b){
		if(a==1){return b;}
		VectorSIMD315 c;
	...
	inline VectorSIMD315 operator*(VectorSIMD315 a, int b){
		if(b==1){return a;}
		VectorSIMD315 c;
	...
	inline VectorSIMD315 operator*(VectorSIMD315 a, VectorSIMD315 b){
		VectorSIMD315 c;
	...
	inline VectorSIMD315 exp(VectorSIMD315 a){
		double a_d[315]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD315 sqrt(VectorSIMD315 a){
		double a_d[315]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD315 a){ 
		double ad[315];
		a.convert(ad);
