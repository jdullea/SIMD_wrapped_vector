...
public:
		...
		VectorSIMD271(double a){
			...
			_avx67=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD271(double (&a)[271]){
		...
		VectorSIMD271& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD271& operator += (VectorSIMD271 a){
	...
	inline VectorSIMD271 operator*(double a, VectorSIMD271 b){
		VectorSIMD271 c;
	...
	inline VectorSIMD271 operator*(VectorSIMD271 a ,double b){
		VectorSIMD271 c;
	...
	inline VectorSIMD271 operator*(int a, VectorSIMD271 b){
		if(a==1){return b;}
		VectorSIMD271 c;
	...
	inline VectorSIMD271 operator*(VectorSIMD271 a, int b){
		if(b==1){return a;}
		VectorSIMD271 c;
	...
	inline VectorSIMD271 operator*(VectorSIMD271 a, VectorSIMD271 b){
		VectorSIMD271 c;
	...
	inline VectorSIMD271 exp(VectorSIMD271 a){
		double a_d[271]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD271 sqrt(VectorSIMD271 a){
		double a_d[271]; a.convert(a_d);
