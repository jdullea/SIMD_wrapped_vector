...
public:
		...
		VectorSIMD268& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD268& operator += (VectorSIMD268 a){
	...
	inline VectorSIMD268 operator*(double a, VectorSIMD268 b){
		VectorSIMD268 c;
	...
	inline VectorSIMD268 operator*(VectorSIMD268 a ,double b){
		VectorSIMD268 c;
	...
	inline VectorSIMD268 operator*(int a, VectorSIMD268 b){
		if(a==1){return b;}
		VectorSIMD268 c;
	...
	inline VectorSIMD268 operator*(VectorSIMD268 a, int b){
		if(b==1){return a;}
		VectorSIMD268 c;
	...
	inline VectorSIMD268 operator*(VectorSIMD268 a, VectorSIMD268 b){
		VectorSIMD268 c;
	...
	inline VectorSIMD268 exp(VectorSIMD268 a){
		double a_d[268]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD268 sqrt(VectorSIMD268 a){
		double a_d[268]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD268 a){ 
		double ad[268];
		a.convert(ad);
