...
public:
		...
		VectorSIMD840& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD840& operator += (VectorSIMD840 a){
	...
	inline VectorSIMD840 operator*(double a, VectorSIMD840 b){
		VectorSIMD840 c;
	...
	inline VectorSIMD840 operator*(VectorSIMD840 a ,double b){
		VectorSIMD840 c;
	...
	inline VectorSIMD840 operator*(int a, VectorSIMD840 b){
		if(a==1){return b;}
		VectorSIMD840 c;
	...
	inline VectorSIMD840 operator*(VectorSIMD840 a, int b){
		if(b==1){return a;}
		VectorSIMD840 c;
	...
	inline VectorSIMD840 operator*(VectorSIMD840 a, VectorSIMD840 b){
		VectorSIMD840 c;
	...
	inline VectorSIMD840 exp(VectorSIMD840 a){
		double a_d[840]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD840 sqrt(VectorSIMD840 a){
		double a_d[840]; a.convert(a_d);
