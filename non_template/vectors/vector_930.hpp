...
public:
		...
		VectorSIMD930(double a){
			...
			_avx232=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD930(double (&a)[930]){
		...
		VectorSIMD930& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD930& operator += (VectorSIMD930 a){
	...
	inline VectorSIMD930 operator*(double a, VectorSIMD930 b){
		VectorSIMD930 c;
	...
	inline VectorSIMD930 operator*(VectorSIMD930 a ,double b){
		VectorSIMD930 c;
	...
	inline VectorSIMD930 operator*(int a, VectorSIMD930 b){
		if(a==1){return b;}
		VectorSIMD930 c;
	...
	inline VectorSIMD930 operator*(VectorSIMD930 a, int b){
		if(b==1){return a;}
		VectorSIMD930 c;
	...
	inline VectorSIMD930 operator*(VectorSIMD930 a, VectorSIMD930 b){
		VectorSIMD930 c;
	...
	inline VectorSIMD930 exp(VectorSIMD930 a){
		double a_d[930]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD930 sqrt(VectorSIMD930 a){
		double a_d[930]; a.convert(a_d);
