...
public:
		...
		VectorSIMD502(double a){
			...
			_avx125=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD502(double (&a)[502]){
		...
		VectorSIMD502& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD502& operator += (VectorSIMD502 a){
	...
	inline VectorSIMD502 operator*(double a, VectorSIMD502 b){
		VectorSIMD502 c;
	...
	inline VectorSIMD502 operator*(VectorSIMD502 a ,double b){
		VectorSIMD502 c;
	...
	inline VectorSIMD502 operator*(int a, VectorSIMD502 b){
		if(a==1){return b;}
		VectorSIMD502 c;
	...
	inline VectorSIMD502 operator*(VectorSIMD502 a, int b){
		if(b==1){return a;}
		VectorSIMD502 c;
	...
	inline VectorSIMD502 operator*(VectorSIMD502 a, VectorSIMD502 b){
		VectorSIMD502 c;
	...
	inline VectorSIMD502 exp(VectorSIMD502 a){
		double a_d[502]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD502 sqrt(VectorSIMD502 a){
		double a_d[502]; a.convert(a_d);
