...
public:
		...
		VectorSIMD462(double a){
			...
			_avx115=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD462(double (&a)[462]){
		...
		VectorSIMD462& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD462& operator += (VectorSIMD462 a){
	...
	inline VectorSIMD462 operator*(double a, VectorSIMD462 b){
		VectorSIMD462 c;
	...
	inline VectorSIMD462 operator*(VectorSIMD462 a ,double b){
		VectorSIMD462 c;
	...
	inline VectorSIMD462 operator*(int a, VectorSIMD462 b){
		if(a==1){return b;}
		VectorSIMD462 c;
	...
	inline VectorSIMD462 operator*(VectorSIMD462 a, int b){
		if(b==1){return a;}
		VectorSIMD462 c;
	...
	inline VectorSIMD462 operator*(VectorSIMD462 a, VectorSIMD462 b){
		VectorSIMD462 c;
	...
	inline VectorSIMD462 exp(VectorSIMD462 a){
		double a_d[462]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD462 sqrt(VectorSIMD462 a){
		double a_d[462]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD462 a){ 
		double ad[462];
		a.convert(ad);
