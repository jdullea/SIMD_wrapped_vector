...
public:
		...
		VectorSIMD285(double a){
			...
			_avx71=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD285(double (&a)[285]){
		...
		VectorSIMD285& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD285& operator += (VectorSIMD285 a){
	...
	inline VectorSIMD285 operator*(double a, VectorSIMD285 b){
		VectorSIMD285 c;
	...
	inline VectorSIMD285 operator*(VectorSIMD285 a ,double b){
		VectorSIMD285 c;
	...
	inline VectorSIMD285 operator*(int a, VectorSIMD285 b){
		if(a==1){return b;}
		VectorSIMD285 c;
	...
	inline VectorSIMD285 operator*(VectorSIMD285 a, int b){
		if(b==1){return a;}
		VectorSIMD285 c;
	...
	inline VectorSIMD285 operator*(VectorSIMD285 a, VectorSIMD285 b){
		VectorSIMD285 c;
	...
	inline VectorSIMD285 exp(VectorSIMD285 a){
		double a_d[285]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD285 sqrt(VectorSIMD285 a){
		double a_d[285]; a.convert(a_d);
