...
public:
		...
		VectorSIMD1003(double a){
			...
			_avx250=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD1003(double (&a)[1003]){
		...
		VectorSIMD1003& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1003& operator += (VectorSIMD1003 a){
	...
	inline VectorSIMD1003 operator*(double a, VectorSIMD1003 b){
		VectorSIMD1003 c;
	...
	inline VectorSIMD1003 operator*(VectorSIMD1003 a ,double b){
		VectorSIMD1003 c;
	...
	inline VectorSIMD1003 operator*(int a, VectorSIMD1003 b){
		if(a==1){return b;}
		VectorSIMD1003 c;
	...
	inline VectorSIMD1003 operator*(VectorSIMD1003 a, int b){
		if(b==1){return a;}
		VectorSIMD1003 c;
	...
	inline VectorSIMD1003 operator*(VectorSIMD1003 a, VectorSIMD1003 b){
		VectorSIMD1003 c;
	...
	inline VectorSIMD1003 exp(VectorSIMD1003 a){
		double a_d[1003]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1003 r(a_d);
		return r;
	}

	inline VectorSIMD1003 sqrt(VectorSIMD1003 a){
		double a_d[1003]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD1003 a){ 
		double ad[1003];
		a.convert(ad);
