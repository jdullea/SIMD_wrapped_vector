...
public:
		...
		VectorSIMD719(double a){
			...
			_avx179=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD719(double (&a)[719]){
		...
		VectorSIMD719& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD719& operator += (VectorSIMD719 a){
	...
	inline VectorSIMD719 operator*(double a, VectorSIMD719 b){
		VectorSIMD719 c;
	...
	inline VectorSIMD719 operator*(VectorSIMD719 a ,double b){
		VectorSIMD719 c;
	...
	inline VectorSIMD719 operator*(int a, VectorSIMD719 b){
		if(a==1){return b;}
		VectorSIMD719 c;
	...
	inline VectorSIMD719 operator*(VectorSIMD719 a, int b){
		if(b==1){return a;}
		VectorSIMD719 c;
	...
	inline VectorSIMD719 operator*(VectorSIMD719 a, VectorSIMD719 b){
		VectorSIMD719 c;
	...
	inline VectorSIMD719 exp(VectorSIMD719 a){
		double a_d[719]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD719 sqrt(VectorSIMD719 a){
		double a_d[719]; a.convert(a_d);
