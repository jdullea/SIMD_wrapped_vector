...
public:
		...
		VectorSIMD550(double a){
			...
			_avx137=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD550(double (&a)[550]){
		...
		VectorSIMD550& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD550& operator += (VectorSIMD550 a){
	...
	inline VectorSIMD550 operator*(double a, VectorSIMD550 b){
		VectorSIMD550 c;
	...
	inline VectorSIMD550 operator*(VectorSIMD550 a ,double b){
		VectorSIMD550 c;
	...
	inline VectorSIMD550 operator*(int a, VectorSIMD550 b){
		if(a==1){return b;}
		VectorSIMD550 c;
	...
	inline VectorSIMD550 operator*(VectorSIMD550 a, int b){
		if(b==1){return a;}
		VectorSIMD550 c;
	...
	inline VectorSIMD550 operator*(VectorSIMD550 a, VectorSIMD550 b){
		VectorSIMD550 c;
	...
	inline VectorSIMD550 exp(VectorSIMD550 a){
		double a_d[550]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD550 sqrt(VectorSIMD550 a){
		double a_d[550]; a.convert(a_d);
