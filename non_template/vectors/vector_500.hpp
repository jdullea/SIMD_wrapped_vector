...
public:
		...
		VectorSIMD500& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD500& operator += (VectorSIMD500 a){
	...
	inline VectorSIMD500 operator*(double a, VectorSIMD500 b){
		VectorSIMD500 c;
	...
	inline VectorSIMD500 operator*(VectorSIMD500 a ,double b){
		VectorSIMD500 c;
	...
	inline VectorSIMD500 operator*(int a, VectorSIMD500 b){
		if(a==1){return b;}
		VectorSIMD500 c;
	...
	inline VectorSIMD500 operator*(VectorSIMD500 a, int b){
		if(b==1){return a;}
		VectorSIMD500 c;
	...
	inline VectorSIMD500 operator*(VectorSIMD500 a, VectorSIMD500 b){
		VectorSIMD500 c;
	...
	inline VectorSIMD500 exp(VectorSIMD500 a){
		double a_d[500]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD500 sqrt(VectorSIMD500 a){
		double a_d[500]; a.convert(a_d);
