...
public:
		...
		VectorSIMD435(double a){
			...
			_avx108=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD435(double (&a)[435]){
		...
		VectorSIMD435& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD435& operator += (VectorSIMD435 a){
	...
	inline VectorSIMD435 operator*(double a, VectorSIMD435 b){
		VectorSIMD435 c;
	...
	inline VectorSIMD435 operator*(VectorSIMD435 a ,double b){
		VectorSIMD435 c;
	...
	inline VectorSIMD435 operator*(int a, VectorSIMD435 b){
		if(a==1){return b;}
		VectorSIMD435 c;
	...
	inline VectorSIMD435 operator*(VectorSIMD435 a, int b){
		if(b==1){return a;}
		VectorSIMD435 c;
	...
	inline VectorSIMD435 operator*(VectorSIMD435 a, VectorSIMD435 b){
		VectorSIMD435 c;
	...
	inline VectorSIMD435 exp(VectorSIMD435 a){
		double a_d[435]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD435 sqrt(VectorSIMD435 a){
		double a_d[435]; a.convert(a_d);
