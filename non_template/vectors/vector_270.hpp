...
public:
		...
		VectorSIMD270(double a){
			...
			_avx67=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD270(double (&a)[270]){
		...
		VectorSIMD270& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD270& operator += (VectorSIMD270 a){
	...
	inline VectorSIMD270 operator*(double a, VectorSIMD270 b){
		VectorSIMD270 c;
	...
	inline VectorSIMD270 operator*(VectorSIMD270 a ,double b){
		VectorSIMD270 c;
	...
	inline VectorSIMD270 operator*(int a, VectorSIMD270 b){
		if(a==1){return b;}
		VectorSIMD270 c;
	...
	inline VectorSIMD270 operator*(VectorSIMD270 a, int b){
		if(b==1){return a;}
		VectorSIMD270 c;
	...
	inline VectorSIMD270 operator*(VectorSIMD270 a, VectorSIMD270 b){
		VectorSIMD270 c;
	...
	inline VectorSIMD270 exp(VectorSIMD270 a){
		double a_d[270]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD270 sqrt(VectorSIMD270 a){
		double a_d[270]; a.convert(a_d);
