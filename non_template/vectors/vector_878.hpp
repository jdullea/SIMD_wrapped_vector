...
public:
		...
		VectorSIMD878(double a){
			...
			_avx219=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD878(double (&a)[878]){
		...
		VectorSIMD878& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD878& operator += (VectorSIMD878 a){
	...
	inline VectorSIMD878 operator*(double a, VectorSIMD878 b){
		VectorSIMD878 c;
	...
	inline VectorSIMD878 operator*(VectorSIMD878 a ,double b){
		VectorSIMD878 c;
	...
	inline VectorSIMD878 operator*(int a, VectorSIMD878 b){
		if(a==1){return b;}
		VectorSIMD878 c;
	...
	inline VectorSIMD878 operator*(VectorSIMD878 a, int b){
		if(b==1){return a;}
		VectorSIMD878 c;
	...
	inline VectorSIMD878 operator*(VectorSIMD878 a, VectorSIMD878 b){
		VectorSIMD878 c;
	...
	inline VectorSIMD878 exp(VectorSIMD878 a){
		double a_d[878]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD878 sqrt(VectorSIMD878 a){
		double a_d[878]; a.convert(a_d);
