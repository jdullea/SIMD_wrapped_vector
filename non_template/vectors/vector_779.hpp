...
public:
		...
		VectorSIMD779(double a){
			...
			_avx194=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD779(double (&a)[779]){
		...
		VectorSIMD779& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD779& operator += (VectorSIMD779 a){
	...
	inline VectorSIMD779 operator*(double a, VectorSIMD779 b){
		VectorSIMD779 c;
	...
	inline VectorSIMD779 operator*(VectorSIMD779 a ,double b){
		VectorSIMD779 c;
	...
	inline VectorSIMD779 operator*(int a, VectorSIMD779 b){
		if(a==1){return b;}
		VectorSIMD779 c;
	...
	inline VectorSIMD779 operator*(VectorSIMD779 a, int b){
		if(b==1){return a;}
		VectorSIMD779 c;
	...
	inline VectorSIMD779 operator*(VectorSIMD779 a, VectorSIMD779 b){
		VectorSIMD779 c;
	...
	inline VectorSIMD779 exp(VectorSIMD779 a){
		double a_d[779]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD779 sqrt(VectorSIMD779 a){
		double a_d[779]; a.convert(a_d);
