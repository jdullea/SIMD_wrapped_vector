...
public:
		...
		VectorSIMD611(double a){
			...
			_avx152=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD611(double (&a)[611]){
		...
		VectorSIMD611& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD611& operator += (VectorSIMD611 a){
	...
	inline VectorSIMD611 operator*(double a, VectorSIMD611 b){
		VectorSIMD611 c;
	...
	inline VectorSIMD611 operator*(VectorSIMD611 a ,double b){
		VectorSIMD611 c;
	...
	inline VectorSIMD611 operator*(int a, VectorSIMD611 b){
		if(a==1){return b;}
		VectorSIMD611 c;
	...
	inline VectorSIMD611 operator*(VectorSIMD611 a, int b){
		if(b==1){return a;}
		VectorSIMD611 c;
	...
	inline VectorSIMD611 operator*(VectorSIMD611 a, VectorSIMD611 b){
		VectorSIMD611 c;
	...
	inline VectorSIMD611 exp(VectorSIMD611 a){
		double a_d[611]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD611 sqrt(VectorSIMD611 a){
		double a_d[611]; a.convert(a_d);
