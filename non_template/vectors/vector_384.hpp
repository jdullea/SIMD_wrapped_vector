...
public:
		...
		VectorSIMD384& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD384& operator += (VectorSIMD384 a){
	...
	inline VectorSIMD384 operator*(double a, VectorSIMD384 b){
		VectorSIMD384 c;
	...
	inline VectorSIMD384 operator*(VectorSIMD384 a ,double b){
		VectorSIMD384 c;
	...
	inline VectorSIMD384 operator*(int a, VectorSIMD384 b){
		if(a==1){return b;}
		VectorSIMD384 c;
	...
	inline VectorSIMD384 operator*(VectorSIMD384 a, int b){
		if(b==1){return a;}
		VectorSIMD384 c;
	...
	inline VectorSIMD384 operator*(VectorSIMD384 a, VectorSIMD384 b){
		VectorSIMD384 c;
	...
	inline VectorSIMD384 exp(VectorSIMD384 a){
		double a_d[384]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD384 sqrt(VectorSIMD384 a){
		double a_d[384]; a.convert(a_d);
