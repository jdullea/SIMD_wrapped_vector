...
public:
		...
		VectorSIMD784& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD784& operator += (VectorSIMD784 a){
	...
	inline VectorSIMD784 operator*(double a, VectorSIMD784 b){
		VectorSIMD784 c;
	...
	inline VectorSIMD784 operator*(VectorSIMD784 a ,double b){
		VectorSIMD784 c;
	...
	inline VectorSIMD784 operator*(int a, VectorSIMD784 b){
		if(a==1){return b;}
		VectorSIMD784 c;
	...
	inline VectorSIMD784 operator*(VectorSIMD784 a, int b){
		if(b==1){return a;}
		VectorSIMD784 c;
	...
	inline VectorSIMD784 operator*(VectorSIMD784 a, VectorSIMD784 b){
		VectorSIMD784 c;
	...
	inline VectorSIMD784 exp(VectorSIMD784 a){
		double a_d[784]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD784 sqrt(VectorSIMD784 a){
		double a_d[784]; a.convert(a_d);
