...
public:
		...
		VectorSIMD309(double a){
			...
			_avx77=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD309(double (&a)[309]){
		...
		VectorSIMD309& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD309& operator += (VectorSIMD309 a){
	...
	inline VectorSIMD309 operator*(double a, VectorSIMD309 b){
		VectorSIMD309 c;
	...
	inline VectorSIMD309 operator*(VectorSIMD309 a ,double b){
		VectorSIMD309 c;
	...
	inline VectorSIMD309 operator*(int a, VectorSIMD309 b){
		if(a==1){return b;}
		VectorSIMD309 c;
	...
	inline VectorSIMD309 operator*(VectorSIMD309 a, int b){
		if(b==1){return a;}
		VectorSIMD309 c;
	...
	inline VectorSIMD309 operator*(VectorSIMD309 a, VectorSIMD309 b){
		VectorSIMD309 c;
	...
	inline VectorSIMD309 exp(VectorSIMD309 a){
		double a_d[309]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD309 sqrt(VectorSIMD309 a){
		double a_d[309]; a.convert(a_d);
