...
public:
		...
		VectorSIMD639(double a){
			...
			_avx159=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD639(double (&a)[639]){
		...
		VectorSIMD639& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD639& operator += (VectorSIMD639 a){
	...
	inline VectorSIMD639 operator*(double a, VectorSIMD639 b){
		VectorSIMD639 c;
	...
	inline VectorSIMD639 operator*(VectorSIMD639 a ,double b){
		VectorSIMD639 c;
	...
	inline VectorSIMD639 operator*(int a, VectorSIMD639 b){
		if(a==1){return b;}
		VectorSIMD639 c;
	...
	inline VectorSIMD639 operator*(VectorSIMD639 a, int b){
		if(b==1){return a;}
		VectorSIMD639 c;
	...
	inline VectorSIMD639 operator*(VectorSIMD639 a, VectorSIMD639 b){
		VectorSIMD639 c;
	...
	inline VectorSIMD639 exp(VectorSIMD639 a){
		double a_d[639]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD639 sqrt(VectorSIMD639 a){
		double a_d[639]; a.convert(a_d);
