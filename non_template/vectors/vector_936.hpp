...
public:
		...
		VectorSIMD936& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD936& operator += (VectorSIMD936 a){
	...
	inline VectorSIMD936 operator*(double a, VectorSIMD936 b){
		VectorSIMD936 c;
	...
	inline VectorSIMD936 operator*(VectorSIMD936 a ,double b){
		VectorSIMD936 c;
	...
	inline VectorSIMD936 operator*(int a, VectorSIMD936 b){
		if(a==1){return b;}
		VectorSIMD936 c;
	...
	inline VectorSIMD936 operator*(VectorSIMD936 a, int b){
		if(b==1){return a;}
		VectorSIMD936 c;
	...
	inline VectorSIMD936 operator*(VectorSIMD936 a, VectorSIMD936 b){
		VectorSIMD936 c;
	...
	inline VectorSIMD936 exp(VectorSIMD936 a){
		double a_d[936]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD936 sqrt(VectorSIMD936 a){
		double a_d[936]; a.convert(a_d);
