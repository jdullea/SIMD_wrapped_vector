...
public:
		...
		VectorSIMD929(double a){
			...
			_avx232=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD929(double (&a)[929]){
		...
		VectorSIMD929& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD929& operator += (VectorSIMD929 a){
	...
	inline VectorSIMD929 operator*(double a, VectorSIMD929 b){
		VectorSIMD929 c;
	...
	inline VectorSIMD929 operator*(VectorSIMD929 a ,double b){
		VectorSIMD929 c;
	...
	inline VectorSIMD929 operator*(int a, VectorSIMD929 b){
		if(a==1){return b;}
		VectorSIMD929 c;
	...
	inline VectorSIMD929 operator*(VectorSIMD929 a, int b){
		if(b==1){return a;}
		VectorSIMD929 c;
	...
	inline VectorSIMD929 operator*(VectorSIMD929 a, VectorSIMD929 b){
		VectorSIMD929 c;
	...
	inline VectorSIMD929 exp(VectorSIMD929 a){
		double a_d[929]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD929 sqrt(VectorSIMD929 a){
		double a_d[929]; a.convert(a_d);
