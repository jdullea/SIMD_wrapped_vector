...
public:
		...
		VectorSIMD632& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD632& operator += (VectorSIMD632 a){
	...
	inline VectorSIMD632 operator*(double a, VectorSIMD632 b){
		VectorSIMD632 c;
	...
	inline VectorSIMD632 operator*(VectorSIMD632 a ,double b){
		VectorSIMD632 c;
	...
	inline VectorSIMD632 operator*(int a, VectorSIMD632 b){
		if(a==1){return b;}
		VectorSIMD632 c;
	...
	inline VectorSIMD632 operator*(VectorSIMD632 a, int b){
		if(b==1){return a;}
		VectorSIMD632 c;
	...
	inline VectorSIMD632 operator*(VectorSIMD632 a, VectorSIMD632 b){
		VectorSIMD632 c;
	...
	inline VectorSIMD632 exp(VectorSIMD632 a){
		double a_d[632]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD632 sqrt(VectorSIMD632 a){
		double a_d[632]; a.convert(a_d);
