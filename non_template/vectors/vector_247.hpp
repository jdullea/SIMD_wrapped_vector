...
public:
		...
		VectorSIMD247(double a){
			...
			_avx61=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD247(double (&a)[247]){
		...
		VectorSIMD247& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD247& operator += (VectorSIMD247 a){
	...
	inline VectorSIMD247 operator*(double a, VectorSIMD247 b){
		VectorSIMD247 c;
	...
	inline VectorSIMD247 operator*(VectorSIMD247 a ,double b){
		VectorSIMD247 c;
	...
	inline VectorSIMD247 operator*(int a, VectorSIMD247 b){
		if(a==1){return b;}
		VectorSIMD247 c;
	...
	inline VectorSIMD247 operator*(VectorSIMD247 a, int b){
		if(b==1){return a;}
		VectorSIMD247 c;
	...
	inline VectorSIMD247 operator*(VectorSIMD247 a, VectorSIMD247 b){
		VectorSIMD247 c;
	...
	inline VectorSIMD247 exp(VectorSIMD247 a){
		double a_d[247]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD247 sqrt(VectorSIMD247 a){
		double a_d[247]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD247 a){ 
		double ad[247];
		a.convert(ad);
