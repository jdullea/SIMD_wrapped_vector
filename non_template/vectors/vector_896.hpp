...
public:
		...
		VectorSIMD896& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD896& operator += (VectorSIMD896 a){
	...
	inline VectorSIMD896 operator*(double a, VectorSIMD896 b){
		VectorSIMD896 c;
	...
	inline VectorSIMD896 operator*(VectorSIMD896 a ,double b){
		VectorSIMD896 c;
	...
	inline VectorSIMD896 operator*(int a, VectorSIMD896 b){
		if(a==1){return b;}
		VectorSIMD896 c;
	...
	inline VectorSIMD896 operator*(VectorSIMD896 a, int b){
		if(b==1){return a;}
		VectorSIMD896 c;
	...
	inline VectorSIMD896 operator*(VectorSIMD896 a, VectorSIMD896 b){
		VectorSIMD896 c;
	...
	inline VectorSIMD896 exp(VectorSIMD896 a){
		double a_d[896]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD896 sqrt(VectorSIMD896 a){
		double a_d[896]; a.convert(a_d);
