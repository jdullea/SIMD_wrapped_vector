...
public:
		...
		VectorSIMD685(double a){
			...
			_avx171=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD685(double (&a)[685]){
		...
		VectorSIMD685& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD685& operator += (VectorSIMD685 a){
	...
	inline VectorSIMD685 operator*(double a, VectorSIMD685 b){
		VectorSIMD685 c;
	...
	inline VectorSIMD685 operator*(VectorSIMD685 a ,double b){
		VectorSIMD685 c;
	...
	inline VectorSIMD685 operator*(int a, VectorSIMD685 b){
		if(a==1){return b;}
		VectorSIMD685 c;
	...
	inline VectorSIMD685 operator*(VectorSIMD685 a, int b){
		if(b==1){return a;}
		VectorSIMD685 c;
	...
	inline VectorSIMD685 operator*(VectorSIMD685 a, VectorSIMD685 b){
		VectorSIMD685 c;
	...
	inline VectorSIMD685 exp(VectorSIMD685 a){
		double a_d[685]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD685 sqrt(VectorSIMD685 a){
		double a_d[685]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD685 a){ 
		double ad[685];
		a.convert(ad);
