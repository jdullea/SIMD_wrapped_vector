...
public:
		...
		VectorSIMD818(double a){
			...
			_avx204=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD818(double (&a)[818]){
		...
		VectorSIMD818& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD818& operator += (VectorSIMD818 a){
	...
	inline VectorSIMD818 operator*(double a, VectorSIMD818 b){
		VectorSIMD818 c;
	...
	inline VectorSIMD818 operator*(VectorSIMD818 a ,double b){
		VectorSIMD818 c;
	...
	inline VectorSIMD818 operator*(int a, VectorSIMD818 b){
		if(a==1){return b;}
		VectorSIMD818 c;
	...
	inline VectorSIMD818 operator*(VectorSIMD818 a, int b){
		if(b==1){return a;}
		VectorSIMD818 c;
	...
	inline VectorSIMD818 operator*(VectorSIMD818 a, VectorSIMD818 b){
		VectorSIMD818 c;
	...
	inline VectorSIMD818 exp(VectorSIMD818 a){
		double a_d[818]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD818 sqrt(VectorSIMD818 a){
		double a_d[818]; a.convert(a_d);
