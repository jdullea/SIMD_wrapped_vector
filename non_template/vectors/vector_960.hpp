...
public:
		...
		VectorSIMD960& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD960& operator += (VectorSIMD960 a){
	...
	inline VectorSIMD960 operator*(double a, VectorSIMD960 b){
		VectorSIMD960 c;
	...
	inline VectorSIMD960 operator*(VectorSIMD960 a ,double b){
		VectorSIMD960 c;
	...
	inline VectorSIMD960 operator*(int a, VectorSIMD960 b){
		if(a==1){return b;}
		VectorSIMD960 c;
	...
	inline VectorSIMD960 operator*(VectorSIMD960 a, int b){
		if(b==1){return a;}
		VectorSIMD960 c;
	...
	inline VectorSIMD960 operator*(VectorSIMD960 a, VectorSIMD960 b){
		VectorSIMD960 c;
	...
	inline VectorSIMD960 exp(VectorSIMD960 a){
		double a_d[960]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD960 sqrt(VectorSIMD960 a){
		double a_d[960]; a.convert(a_d);
