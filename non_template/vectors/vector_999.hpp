...
public:
		...
		VectorSIMD999(double a){
			...
			_avx249=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD999(double (&a)[999]){
		...
		VectorSIMD999& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD999& operator += (VectorSIMD999 a){
	...
	inline VectorSIMD999 operator*(double a, VectorSIMD999 b){
		VectorSIMD999 c;
	...
	inline VectorSIMD999 operator*(VectorSIMD999 a ,double b){
		VectorSIMD999 c;
	...
	inline VectorSIMD999 operator*(int a, VectorSIMD999 b){
		if(a==1){return b;}
		VectorSIMD999 c;
	...
	inline VectorSIMD999 operator*(VectorSIMD999 a, int b){
		if(b==1){return a;}
		VectorSIMD999 c;
	...
	inline VectorSIMD999 operator*(VectorSIMD999 a, VectorSIMD999 b){
		VectorSIMD999 c;
	...
	inline VectorSIMD999 exp(VectorSIMD999 a){
		double a_d[999]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD999 sqrt(VectorSIMD999 a){
		double a_d[999]; a.convert(a_d);
