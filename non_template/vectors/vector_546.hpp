...
public:
		...
		VectorSIMD546(double a){
			...
			_avx136=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD546(double (&a)[546]){
		...
		VectorSIMD546& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD546& operator += (VectorSIMD546 a){
	...
	inline VectorSIMD546 operator*(double a, VectorSIMD546 b){
		VectorSIMD546 c;
	...
	inline VectorSIMD546 operator*(VectorSIMD546 a ,double b){
		VectorSIMD546 c;
	...
	inline VectorSIMD546 operator*(int a, VectorSIMD546 b){
		if(a==1){return b;}
		VectorSIMD546 c;
	...
	inline VectorSIMD546 operator*(VectorSIMD546 a, int b){
		if(b==1){return a;}
		VectorSIMD546 c;
	...
	inline VectorSIMD546 operator*(VectorSIMD546 a, VectorSIMD546 b){
		VectorSIMD546 c;
	...
	inline VectorSIMD546 exp(VectorSIMD546 a){
		double a_d[546]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD546 sqrt(VectorSIMD546 a){
		double a_d[546]; a.convert(a_d);
