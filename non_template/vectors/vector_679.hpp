...
public:
		...
		VectorSIMD679(double a){
			...
			_avx169=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD679(double (&a)[679]){
		...
		VectorSIMD679& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD679& operator += (VectorSIMD679 a){
	...
	inline VectorSIMD679 operator*(double a, VectorSIMD679 b){
		VectorSIMD679 c;
	...
	inline VectorSIMD679 operator*(VectorSIMD679 a ,double b){
		VectorSIMD679 c;
	...
	inline VectorSIMD679 operator*(int a, VectorSIMD679 b){
		if(a==1){return b;}
		VectorSIMD679 c;
	...
	inline VectorSIMD679 operator*(VectorSIMD679 a, int b){
		if(b==1){return a;}
		VectorSIMD679 c;
	...
	inline VectorSIMD679 operator*(VectorSIMD679 a, VectorSIMD679 b){
		VectorSIMD679 c;
	...
	inline VectorSIMD679 exp(VectorSIMD679 a){
		double a_d[679]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD679 sqrt(VectorSIMD679 a){
		double a_d[679]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD679 a){ 
		double ad[679];
		a.convert(ad);
