...
public:
		...
		VectorSIMD242(double a){
			...
			_avx60=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD242(double (&a)[242]){
		...
		VectorSIMD242& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD242& operator += (VectorSIMD242 a){
	...
	inline VectorSIMD242 operator*(double a, VectorSIMD242 b){
		VectorSIMD242 c;
	...
	inline VectorSIMD242 operator*(VectorSIMD242 a ,double b){
		VectorSIMD242 c;
	...
	inline VectorSIMD242 operator*(int a, VectorSIMD242 b){
		if(a==1){return b;}
		VectorSIMD242 c;
	...
	inline VectorSIMD242 operator*(VectorSIMD242 a, int b){
		if(b==1){return a;}
		VectorSIMD242 c;
	...
	inline VectorSIMD242 operator*(VectorSIMD242 a, VectorSIMD242 b){
		VectorSIMD242 c;
	...
	inline VectorSIMD242 exp(VectorSIMD242 a){
		double a_d[242]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD242 sqrt(VectorSIMD242 a){
		double a_d[242]; a.convert(a_d);
