...
public:
		...
		VectorSIMD136& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD136& operator += (VectorSIMD136 a){
	...
	inline VectorSIMD136 operator*(double a, VectorSIMD136 b){
		VectorSIMD136 c;
	...
	inline VectorSIMD136 operator*(VectorSIMD136 a ,double b){
		VectorSIMD136 c;
	...
	inline VectorSIMD136 operator*(int a, VectorSIMD136 b){
		if(a==1){return b;}
		VectorSIMD136 c;
	...
	inline VectorSIMD136 operator*(VectorSIMD136 a, int b){
		if(b==1){return a;}
		VectorSIMD136 c;
	...
	inline VectorSIMD136 operator*(VectorSIMD136 a, VectorSIMD136 b){
		VectorSIMD136 c;
	...
	inline VectorSIMD136 exp(VectorSIMD136 a){
		double a_d[136]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD136 sqrt(VectorSIMD136 a){
		double a_d[136]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD136 a){ 
		double ad[136];
		a.convert(ad);
