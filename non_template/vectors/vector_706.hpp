...
public:
		...
		VectorSIMD706(double a){
			...
			_avx176=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD706(double (&a)[706]){
		...
		VectorSIMD706& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD706& operator += (VectorSIMD706 a){
	...
	inline VectorSIMD706 operator*(double a, VectorSIMD706 b){
		VectorSIMD706 c;
	...
	inline VectorSIMD706 operator*(VectorSIMD706 a ,double b){
		VectorSIMD706 c;
	...
	inline VectorSIMD706 operator*(int a, VectorSIMD706 b){
		if(a==1){return b;}
		VectorSIMD706 c;
	...
	inline VectorSIMD706 operator*(VectorSIMD706 a, int b){
		if(b==1){return a;}
		VectorSIMD706 c;
	...
	inline VectorSIMD706 operator*(VectorSIMD706 a, VectorSIMD706 b){
		VectorSIMD706 c;
	...
	inline VectorSIMD706 exp(VectorSIMD706 a){
		double a_d[706]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD706 sqrt(VectorSIMD706 a){
		double a_d[706]; a.convert(a_d);
