...
public:
		...
		VectorSIMD882(double a){
			...
			_avx220=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD882(double (&a)[882]){
		...
		VectorSIMD882& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD882& operator += (VectorSIMD882 a){
	...
	inline VectorSIMD882 operator*(double a, VectorSIMD882 b){
		VectorSIMD882 c;
	...
	inline VectorSIMD882 operator*(VectorSIMD882 a ,double b){
		VectorSIMD882 c;
	...
	inline VectorSIMD882 operator*(int a, VectorSIMD882 b){
		if(a==1){return b;}
		VectorSIMD882 c;
	...
	inline VectorSIMD882 operator*(VectorSIMD882 a, int b){
		if(b==1){return a;}
		VectorSIMD882 c;
	...
	inline VectorSIMD882 operator*(VectorSIMD882 a, VectorSIMD882 b){
		VectorSIMD882 c;
	...
	inline VectorSIMD882 exp(VectorSIMD882 a){
		double a_d[882]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD882 sqrt(VectorSIMD882 a){
		double a_d[882]; a.convert(a_d);
