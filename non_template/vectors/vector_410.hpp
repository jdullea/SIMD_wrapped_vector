...
public:
		...
		VectorSIMD410(double a){
			...
			_avx102=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD410(double (&a)[410]){
		...
		VectorSIMD410& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD410& operator += (VectorSIMD410 a){
	...
	inline VectorSIMD410 operator*(double a, VectorSIMD410 b){
		VectorSIMD410 c;
	...
	inline VectorSIMD410 operator*(VectorSIMD410 a ,double b){
		VectorSIMD410 c;
	...
	inline VectorSIMD410 operator*(int a, VectorSIMD410 b){
		if(a==1){return b;}
		VectorSIMD410 c;
	...
	inline VectorSIMD410 operator*(VectorSIMD410 a, int b){
		if(b==1){return a;}
		VectorSIMD410 c;
	...
	inline VectorSIMD410 operator*(VectorSIMD410 a, VectorSIMD410 b){
		VectorSIMD410 c;
	...
	inline VectorSIMD410 exp(VectorSIMD410 a){
		double a_d[410]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD410 sqrt(VectorSIMD410 a){
		double a_d[410]; a.convert(a_d);
