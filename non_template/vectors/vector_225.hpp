...
public:
		...
		VectorSIMD225(double a){
			...
			_avx56=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD225(double (&a)[225]){
		...
		VectorSIMD225& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD225& operator += (VectorSIMD225 a){
	...
	inline VectorSIMD225 operator*(double a, VectorSIMD225 b){
		VectorSIMD225 c;
	...
	inline VectorSIMD225 operator*(VectorSIMD225 a ,double b){
		VectorSIMD225 c;
	...
	inline VectorSIMD225 operator*(int a, VectorSIMD225 b){
		if(a==1){return b;}
		VectorSIMD225 c;
	...
	inline VectorSIMD225 operator*(VectorSIMD225 a, int b){
		if(b==1){return a;}
		VectorSIMD225 c;
	...
	inline VectorSIMD225 operator*(VectorSIMD225 a, VectorSIMD225 b){
		VectorSIMD225 c;
	...
	inline VectorSIMD225 exp(VectorSIMD225 a){
		double a_d[225]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD225 sqrt(VectorSIMD225 a){
		double a_d[225]; a.convert(a_d);
