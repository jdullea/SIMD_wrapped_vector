...
public:
		...
		VectorSIMD551(double a){
			...
			_avx137=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD551(double (&a)[551]){
		...
		VectorSIMD551& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD551& operator += (VectorSIMD551 a){
	...
	inline VectorSIMD551 operator*(double a, VectorSIMD551 b){
		VectorSIMD551 c;
	...
	inline VectorSIMD551 operator*(VectorSIMD551 a ,double b){
		VectorSIMD551 c;
	...
	inline VectorSIMD551 operator*(int a, VectorSIMD551 b){
		if(a==1){return b;}
		VectorSIMD551 c;
	...
	inline VectorSIMD551 operator*(VectorSIMD551 a, int b){
		if(b==1){return a;}
		VectorSIMD551 c;
	...
	inline VectorSIMD551 operator*(VectorSIMD551 a, VectorSIMD551 b){
		VectorSIMD551 c;
	...
	inline VectorSIMD551 exp(VectorSIMD551 a){
		double a_d[551]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD551 sqrt(VectorSIMD551 a){
		double a_d[551]; a.convert(a_d);
