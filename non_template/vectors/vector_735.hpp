...
public:
		...
		VectorSIMD735(double a){
			...
			_avx183=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD735(double (&a)[735]){
		...
		VectorSIMD735& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD735& operator += (VectorSIMD735 a){
	...
	inline VectorSIMD735 operator*(double a, VectorSIMD735 b){
		VectorSIMD735 c;
	...
	inline VectorSIMD735 operator*(VectorSIMD735 a ,double b){
		VectorSIMD735 c;
	...
	inline VectorSIMD735 operator*(int a, VectorSIMD735 b){
		if(a==1){return b;}
		VectorSIMD735 c;
	...
	inline VectorSIMD735 operator*(VectorSIMD735 a, int b){
		if(b==1){return a;}
		VectorSIMD735 c;
	...
	inline VectorSIMD735 operator*(VectorSIMD735 a, VectorSIMD735 b){
		VectorSIMD735 c;
	...
	inline VectorSIMD735 exp(VectorSIMD735 a){
		double a_d[735]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD735 sqrt(VectorSIMD735 a){
		double a_d[735]; a.convert(a_d);
