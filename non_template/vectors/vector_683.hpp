...
public:
		...
		VectorSIMD683(double a){
			...
			_avx170=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD683(double (&a)[683]){
		...
		VectorSIMD683& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD683& operator += (VectorSIMD683 a){
	...
	inline VectorSIMD683 operator*(double a, VectorSIMD683 b){
		VectorSIMD683 c;
	...
	inline VectorSIMD683 operator*(VectorSIMD683 a ,double b){
		VectorSIMD683 c;
	...
	inline VectorSIMD683 operator*(int a, VectorSIMD683 b){
		if(a==1){return b;}
		VectorSIMD683 c;
	...
	inline VectorSIMD683 operator*(VectorSIMD683 a, int b){
		if(b==1){return a;}
		VectorSIMD683 c;
	...
	inline VectorSIMD683 operator*(VectorSIMD683 a, VectorSIMD683 b){
		VectorSIMD683 c;
	...
	inline VectorSIMD683 exp(VectorSIMD683 a){
		double a_d[683]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD683 sqrt(VectorSIMD683 a){
		double a_d[683]; a.convert(a_d);
