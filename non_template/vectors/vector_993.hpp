...
public:
		...
		VectorSIMD993(double a){
			...
			_avx248=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD993(double (&a)[993]){
		...
		VectorSIMD993& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD993& operator += (VectorSIMD993 a){
	...
	inline VectorSIMD993 operator*(double a, VectorSIMD993 b){
		VectorSIMD993 c;
	...
	inline VectorSIMD993 operator*(VectorSIMD993 a ,double b){
		VectorSIMD993 c;
	...
	inline VectorSIMD993 operator*(int a, VectorSIMD993 b){
		if(a==1){return b;}
		VectorSIMD993 c;
	...
	inline VectorSIMD993 operator*(VectorSIMD993 a, int b){
		if(b==1){return a;}
		VectorSIMD993 c;
	...
	inline VectorSIMD993 operator*(VectorSIMD993 a, VectorSIMD993 b){
		VectorSIMD993 c;
	...
	inline VectorSIMD993 exp(VectorSIMD993 a){
		double a_d[993]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD993 sqrt(VectorSIMD993 a){
		double a_d[993]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD993 a){ 
		double ad[993];
		a.convert(ad);
