...
public:
		...
		VectorSIMD655(double a){
			...
			_avx163=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD655(double (&a)[655]){
		...
		VectorSIMD655& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD655& operator += (VectorSIMD655 a){
	...
	inline VectorSIMD655 operator*(double a, VectorSIMD655 b){
		VectorSIMD655 c;
	...
	inline VectorSIMD655 operator*(VectorSIMD655 a ,double b){
		VectorSIMD655 c;
	...
	inline VectorSIMD655 operator*(int a, VectorSIMD655 b){
		if(a==1){return b;}
		VectorSIMD655 c;
	...
	inline VectorSIMD655 operator*(VectorSIMD655 a, int b){
		if(b==1){return a;}
		VectorSIMD655 c;
	...
	inline VectorSIMD655 operator*(VectorSIMD655 a, VectorSIMD655 b){
		VectorSIMD655 c;
	...
	inline VectorSIMD655 exp(VectorSIMD655 a){
		double a_d[655]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD655 sqrt(VectorSIMD655 a){
		double a_d[655]; a.convert(a_d);
