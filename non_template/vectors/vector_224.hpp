...
public:
		...
		VectorSIMD224& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD224& operator += (VectorSIMD224 a){
	...
	inline VectorSIMD224 operator*(double a, VectorSIMD224 b){
		VectorSIMD224 c;
	...
	inline VectorSIMD224 operator*(VectorSIMD224 a ,double b){
		VectorSIMD224 c;
	...
	inline VectorSIMD224 operator*(int a, VectorSIMD224 b){
		if(a==1){return b;}
		VectorSIMD224 c;
	...
	inline VectorSIMD224 operator*(VectorSIMD224 a, int b){
		if(b==1){return a;}
		VectorSIMD224 c;
	...
	inline VectorSIMD224 operator*(VectorSIMD224 a, VectorSIMD224 b){
		VectorSIMD224 c;
	...
	inline VectorSIMD224 exp(VectorSIMD224 a){
		double a_d[224]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD224 sqrt(VectorSIMD224 a){
		double a_d[224]; a.convert(a_d);
