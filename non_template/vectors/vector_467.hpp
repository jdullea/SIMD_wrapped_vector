...
public:
		...
		VectorSIMD467(double a){
			...
			_avx116=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD467(double (&a)[467]){
		...
		VectorSIMD467& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD467& operator += (VectorSIMD467 a){
	...
	inline VectorSIMD467 operator*(double a, VectorSIMD467 b){
		VectorSIMD467 c;
	...
	inline VectorSIMD467 operator*(VectorSIMD467 a ,double b){
		VectorSIMD467 c;
	...
	inline VectorSIMD467 operator*(int a, VectorSIMD467 b){
		if(a==1){return b;}
		VectorSIMD467 c;
	...
	inline VectorSIMD467 operator*(VectorSIMD467 a, int b){
		if(b==1){return a;}
		VectorSIMD467 c;
	...
	inline VectorSIMD467 operator*(VectorSIMD467 a, VectorSIMD467 b){
		VectorSIMD467 c;
	...
	inline VectorSIMD467 exp(VectorSIMD467 a){
		double a_d[467]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD467 sqrt(VectorSIMD467 a){
		double a_d[467]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD467 a){ 
		double ad[467];
		a.convert(ad);
