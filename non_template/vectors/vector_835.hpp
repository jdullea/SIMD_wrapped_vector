...
public:
		...
		VectorSIMD835(double a){
			...
			_avx208=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD835(double (&a)[835]){
		...
		VectorSIMD835& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD835& operator += (VectorSIMD835 a){
	...
	inline VectorSIMD835 operator*(double a, VectorSIMD835 b){
		VectorSIMD835 c;
	...
	inline VectorSIMD835 operator*(VectorSIMD835 a ,double b){
		VectorSIMD835 c;
	...
	inline VectorSIMD835 operator*(int a, VectorSIMD835 b){
		if(a==1){return b;}
		VectorSIMD835 c;
	...
	inline VectorSIMD835 operator*(VectorSIMD835 a, int b){
		if(b==1){return a;}
		VectorSIMD835 c;
	...
	inline VectorSIMD835 operator*(VectorSIMD835 a, VectorSIMD835 b){
		VectorSIMD835 c;
	...
	inline VectorSIMD835 exp(VectorSIMD835 a){
		double a_d[835]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD835 sqrt(VectorSIMD835 a){
		double a_d[835]; a.convert(a_d);
