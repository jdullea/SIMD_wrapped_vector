...
public:
		...
		VectorSIMD996& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD996& operator += (VectorSIMD996 a){
	...
	inline VectorSIMD996 operator*(double a, VectorSIMD996 b){
		VectorSIMD996 c;
	...
	inline VectorSIMD996 operator*(VectorSIMD996 a ,double b){
		VectorSIMD996 c;
	...
	inline VectorSIMD996 operator*(int a, VectorSIMD996 b){
		if(a==1){return b;}
		VectorSIMD996 c;
	...
	inline VectorSIMD996 operator*(VectorSIMD996 a, int b){
		if(b==1){return a;}
		VectorSIMD996 c;
	...
	inline VectorSIMD996 operator*(VectorSIMD996 a, VectorSIMD996 b){
		VectorSIMD996 c;
	...
	inline VectorSIMD996 exp(VectorSIMD996 a){
		double a_d[996]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD996 sqrt(VectorSIMD996 a){
		double a_d[996]; a.convert(a_d);
