...
public:
		...
		VectorSIMD487(double a){
			...
			_avx121=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD487(double (&a)[487]){
		...
		VectorSIMD487& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD487& operator += (VectorSIMD487 a){
	...
	inline VectorSIMD487 operator*(double a, VectorSIMD487 b){
		VectorSIMD487 c;
	...
	inline VectorSIMD487 operator*(VectorSIMD487 a ,double b){
		VectorSIMD487 c;
	...
	inline VectorSIMD487 operator*(int a, VectorSIMD487 b){
		if(a==1){return b;}
		VectorSIMD487 c;
	...
	inline VectorSIMD487 operator*(VectorSIMD487 a, int b){
		if(b==1){return a;}
		VectorSIMD487 c;
	...
	inline VectorSIMD487 operator*(VectorSIMD487 a, VectorSIMD487 b){
		VectorSIMD487 c;
	...
	inline VectorSIMD487 exp(VectorSIMD487 a){
		double a_d[487]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD487 sqrt(VectorSIMD487 a){
		double a_d[487]; a.convert(a_d);
