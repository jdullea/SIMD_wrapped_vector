...
public:
		...
		VectorSIMD394(double a){
			...
			_avx98=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD394(double (&a)[394]){
		...
		VectorSIMD394& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD394& operator += (VectorSIMD394 a){
	...
	inline VectorSIMD394 operator*(double a, VectorSIMD394 b){
		VectorSIMD394 c;
	...
	inline VectorSIMD394 operator*(VectorSIMD394 a ,double b){
		VectorSIMD394 c;
	...
	inline VectorSIMD394 operator*(int a, VectorSIMD394 b){
		if(a==1){return b;}
		VectorSIMD394 c;
	...
	inline VectorSIMD394 operator*(VectorSIMD394 a, int b){
		if(b==1){return a;}
		VectorSIMD394 c;
	...
	inline VectorSIMD394 operator*(VectorSIMD394 a, VectorSIMD394 b){
		VectorSIMD394 c;
	...
	inline VectorSIMD394 exp(VectorSIMD394 a){
		double a_d[394]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD394 sqrt(VectorSIMD394 a){
		double a_d[394]; a.convert(a_d);
