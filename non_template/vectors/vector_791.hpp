...
public:
		...
		VectorSIMD791(double a){
			...
			_avx197=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD791(double (&a)[791]){
		...
		VectorSIMD791& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD791& operator += (VectorSIMD791 a){
	...
	inline VectorSIMD791 operator*(double a, VectorSIMD791 b){
		VectorSIMD791 c;
	...
	inline VectorSIMD791 operator*(VectorSIMD791 a ,double b){
		VectorSIMD791 c;
	...
	inline VectorSIMD791 operator*(int a, VectorSIMD791 b){
		if(a==1){return b;}
		VectorSIMD791 c;
	...
	inline VectorSIMD791 operator*(VectorSIMD791 a, int b){
		if(b==1){return a;}
		VectorSIMD791 c;
	...
	inline VectorSIMD791 operator*(VectorSIMD791 a, VectorSIMD791 b){
		VectorSIMD791 c;
	...
	inline VectorSIMD791 exp(VectorSIMD791 a){
		double a_d[791]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD791 sqrt(VectorSIMD791 a){
		double a_d[791]; a.convert(a_d);
