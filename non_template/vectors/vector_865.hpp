...
public:
		...
		VectorSIMD865(double a){
			...
			_avx216=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD865(double (&a)[865]){
		...
		VectorSIMD865& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD865& operator += (VectorSIMD865 a){
	...
	inline VectorSIMD865 operator*(double a, VectorSIMD865 b){
		VectorSIMD865 c;
	...
	inline VectorSIMD865 operator*(VectorSIMD865 a ,double b){
		VectorSIMD865 c;
	...
	inline VectorSIMD865 operator*(int a, VectorSIMD865 b){
		if(a==1){return b;}
		VectorSIMD865 c;
	...
	inline VectorSIMD865 operator*(VectorSIMD865 a, int b){
		if(b==1){return a;}
		VectorSIMD865 c;
	...
	inline VectorSIMD865 operator*(VectorSIMD865 a, VectorSIMD865 b){
		VectorSIMD865 c;
	...
	inline VectorSIMD865 exp(VectorSIMD865 a){
		double a_d[865]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD865 sqrt(VectorSIMD865 a){
		double a_d[865]; a.convert(a_d);
