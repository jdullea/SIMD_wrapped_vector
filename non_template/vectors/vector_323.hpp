...
public:
		...
		VectorSIMD323(double a){
			...
			_avx80=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD323(double (&a)[323]){
		...
		VectorSIMD323& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD323& operator += (VectorSIMD323 a){
	...
	inline VectorSIMD323 operator*(double a, VectorSIMD323 b){
		VectorSIMD323 c;
	...
	inline VectorSIMD323 operator*(VectorSIMD323 a ,double b){
		VectorSIMD323 c;
	...
	inline VectorSIMD323 operator*(int a, VectorSIMD323 b){
		if(a==1){return b;}
		VectorSIMD323 c;
	...
	inline VectorSIMD323 operator*(VectorSIMD323 a, int b){
		if(b==1){return a;}
		VectorSIMD323 c;
	...
	inline VectorSIMD323 operator*(VectorSIMD323 a, VectorSIMD323 b){
		VectorSIMD323 c;
	...
	inline VectorSIMD323 exp(VectorSIMD323 a){
		double a_d[323]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD323 sqrt(VectorSIMD323 a){
		double a_d[323]; a.convert(a_d);
