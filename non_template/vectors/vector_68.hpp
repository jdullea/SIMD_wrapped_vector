...
public:
		...
		VectorSIMD68(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13,__m256d _14,__m256d _15,__m256d _16){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD68& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD68& operator += (VectorSIMD68 a){
	...
	inline VectorSIMD68 operator*(double a, VectorSIMD68 b){
		VectorSIMD68 c;
	...
	inline VectorSIMD68 operator*(VectorSIMD68 a ,double b){
		VectorSIMD68 c;
	...
	inline VectorSIMD68 operator*(int a, VectorSIMD68 b){
		if(a==1){return b;}
		VectorSIMD68 c;
	...
	inline VectorSIMD68 operator*(VectorSIMD68 a, int b){
		if(b==1){return a;}
		VectorSIMD68 c;
	...
	inline VectorSIMD68 operator*(VectorSIMD68 a, VectorSIMD68 b){
		VectorSIMD68 c;
	...
	inline VectorSIMD68 exp(VectorSIMD68 a){
		double a_d[68]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD68 sqrt(VectorSIMD68 a){
		double a_d[68]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD68 a){ 
		double ad[68];
		a.convert(ad);
