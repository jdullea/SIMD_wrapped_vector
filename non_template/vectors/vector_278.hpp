...
public:
		...
		VectorSIMD278(double a){
			...
			_avx69=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD278(double (&a)[278]){
		...
		VectorSIMD278& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD278& operator += (VectorSIMD278 a){
	...
	inline VectorSIMD278 operator*(double a, VectorSIMD278 b){
		VectorSIMD278 c;
	...
	inline VectorSIMD278 operator*(VectorSIMD278 a ,double b){
		VectorSIMD278 c;
	...
	inline VectorSIMD278 operator*(int a, VectorSIMD278 b){
		if(a==1){return b;}
		VectorSIMD278 c;
	...
	inline VectorSIMD278 operator*(VectorSIMD278 a, int b){
		if(b==1){return a;}
		VectorSIMD278 c;
	...
	inline VectorSIMD278 operator*(VectorSIMD278 a, VectorSIMD278 b){
		VectorSIMD278 c;
	...
	inline VectorSIMD278 exp(VectorSIMD278 a){
		double a_d[278]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD278 sqrt(VectorSIMD278 a){
		double a_d[278]; a.convert(a_d);
