...
public:
		...
		VectorSIMD617(double a){
			...
			_avx154=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD617(double (&a)[617]){
		...
		VectorSIMD617& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD617& operator += (VectorSIMD617 a){
	...
	inline VectorSIMD617 operator*(double a, VectorSIMD617 b){
		VectorSIMD617 c;
	...
	inline VectorSIMD617 operator*(VectorSIMD617 a ,double b){
		VectorSIMD617 c;
	...
	inline VectorSIMD617 operator*(int a, VectorSIMD617 b){
		if(a==1){return b;}
		VectorSIMD617 c;
	...
	inline VectorSIMD617 operator*(VectorSIMD617 a, int b){
		if(b==1){return a;}
		VectorSIMD617 c;
	...
	inline VectorSIMD617 operator*(VectorSIMD617 a, VectorSIMD617 b){
		VectorSIMD617 c;
	...
	inline VectorSIMD617 exp(VectorSIMD617 a){
		double a_d[617]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD617 sqrt(VectorSIMD617 a){
		double a_d[617]; a.convert(a_d);
