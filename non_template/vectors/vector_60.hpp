...
public:
		...
		VectorSIMD60(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13,__m256d _14){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD60& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD60& operator += (VectorSIMD60 a){
	...
	inline VectorSIMD60 operator*(double a, VectorSIMD60 b){
		VectorSIMD60 c;
	...
	inline VectorSIMD60 operator*(VectorSIMD60 a ,double b){
		VectorSIMD60 c;
	...
	inline VectorSIMD60 operator*(int a, VectorSIMD60 b){
		if(a==1){return b;}
		VectorSIMD60 c;
	...
	inline VectorSIMD60 operator*(VectorSIMD60 a, int b){
		if(b==1){return a;}
		VectorSIMD60 c;
	...
	inline VectorSIMD60 operator*(VectorSIMD60 a, VectorSIMD60 b){
		VectorSIMD60 c;
	...
	inline VectorSIMD60 exp(VectorSIMD60 a){
		double a_d[60]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD60 sqrt(VectorSIMD60 a){
		double a_d[60]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD60 a){ 
		double ad[60];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << ","  << ad[23] << ","  << ad[24] << ","  << ad[25] << ","  << ad[26] << ","  << ad[27] << ","  << ad[28] << ","  << ad[29] << ","  << ad[30] << ","  << ad[31] << ","  << ad[32] << ","  << ad[33] << ","  << ad[34] << ","  << ad[35] << ","  << ad[36] << ","  << ad[37] << ","  << ad[38] << ","  << ad[39] << ","  << ad[40] << ","  << ad[41] << ","  << ad[42] << ","  << ad[43] << ","  << ad[44] << ","  << ad[45] << ","  << ad[46] << ","  << ad[47] << ","  << ad[48] << ","  << ad[49] << ","  << ad[50] << ","  << ad[51] << ","  << ad[52] << ","  << ad[53] << ","  << ad[54] << ","  << ad[55] << ","  << ad[56] << ","  << ad[57] << ","  << ad[58] << ","  << ad[59] << "}";
		return os;
		}