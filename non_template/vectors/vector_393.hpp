...
public:
		...
		VectorSIMD393(double a){
			...
			_avx98=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD393(double (&a)[393]){
		...
		VectorSIMD393& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD393& operator += (VectorSIMD393 a){
	...
	inline VectorSIMD393 operator*(double a, VectorSIMD393 b){
		VectorSIMD393 c;
	...
	inline VectorSIMD393 operator*(VectorSIMD393 a ,double b){
		VectorSIMD393 c;
	...
	inline VectorSIMD393 operator*(int a, VectorSIMD393 b){
		if(a==1){return b;}
		VectorSIMD393 c;
	...
	inline VectorSIMD393 operator*(VectorSIMD393 a, int b){
		if(b==1){return a;}
		VectorSIMD393 c;
	...
	inline VectorSIMD393 operator*(VectorSIMD393 a, VectorSIMD393 b){
		VectorSIMD393 c;
	...
	inline VectorSIMD393 exp(VectorSIMD393 a){
		double a_d[393]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD393 sqrt(VectorSIMD393 a){
		double a_d[393]; a.convert(a_d);
