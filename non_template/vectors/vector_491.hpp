...
public:
		...
		VectorSIMD491(double a){
			...
			_avx122=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD491(double (&a)[491]){
		...
		VectorSIMD491& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD491& operator += (VectorSIMD491 a){
	...
	inline VectorSIMD491 operator*(double a, VectorSIMD491 b){
		VectorSIMD491 c;
	...
	inline VectorSIMD491 operator*(VectorSIMD491 a ,double b){
		VectorSIMD491 c;
	...
	inline VectorSIMD491 operator*(int a, VectorSIMD491 b){
		if(a==1){return b;}
		VectorSIMD491 c;
	...
	inline VectorSIMD491 operator*(VectorSIMD491 a, int b){
		if(b==1){return a;}
		VectorSIMD491 c;
	...
	inline VectorSIMD491 operator*(VectorSIMD491 a, VectorSIMD491 b){
		VectorSIMD491 c;
	...
	inline VectorSIMD491 exp(VectorSIMD491 a){
		double a_d[491]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD491 sqrt(VectorSIMD491 a){
		double a_d[491]; a.convert(a_d);
