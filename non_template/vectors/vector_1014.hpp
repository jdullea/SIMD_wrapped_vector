...
public:
		...
		VectorSIMD1014(double a){
			...
			_avx253=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD1014(double (&a)[1014]){
		...
		VectorSIMD1014& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1014& operator += (VectorSIMD1014 a){
	...
	inline VectorSIMD1014 operator*(double a, VectorSIMD1014 b){
		VectorSIMD1014 c;
	...
	inline VectorSIMD1014 operator*(VectorSIMD1014 a ,double b){
		VectorSIMD1014 c;
	...
	inline VectorSIMD1014 operator*(int a, VectorSIMD1014 b){
		if(a==1){return b;}
		VectorSIMD1014 c;
	...
	inline VectorSIMD1014 operator*(VectorSIMD1014 a, int b){
		if(b==1){return a;}
		VectorSIMD1014 c;
	...
	inline VectorSIMD1014 operator*(VectorSIMD1014 a, VectorSIMD1014 b){
		VectorSIMD1014 c;
	...
	inline VectorSIMD1014 exp(VectorSIMD1014 a){
		double a_d[1014]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1014 r(a_d);
		return r;
	}

	inline VectorSIMD1014 sqrt(VectorSIMD1014 a){
		double a_d[1014]; a.convert(a_d);
