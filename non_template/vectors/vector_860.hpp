...
public:
		...
		VectorSIMD860& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD860& operator += (VectorSIMD860 a){
	...
	inline VectorSIMD860 operator*(double a, VectorSIMD860 b){
		VectorSIMD860 c;
	...
	inline VectorSIMD860 operator*(VectorSIMD860 a ,double b){
		VectorSIMD860 c;
	...
	inline VectorSIMD860 operator*(int a, VectorSIMD860 b){
		if(a==1){return b;}
		VectorSIMD860 c;
	...
	inline VectorSIMD860 operator*(VectorSIMD860 a, int b){
		if(b==1){return a;}
		VectorSIMD860 c;
	...
	inline VectorSIMD860 operator*(VectorSIMD860 a, VectorSIMD860 b){
		VectorSIMD860 c;
	...
	inline VectorSIMD860 exp(VectorSIMD860 a){
		double a_d[860]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD860 sqrt(VectorSIMD860 a){
		double a_d[860]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD860 a){ 
		double ad[860];
		a.convert(ad);
