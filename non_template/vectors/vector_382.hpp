...
public:
		...
		VectorSIMD382(double a){
			...
			_avx95=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD382(double (&a)[382]){
		...
		VectorSIMD382& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD382& operator += (VectorSIMD382 a){
	...
	inline VectorSIMD382 operator*(double a, VectorSIMD382 b){
		VectorSIMD382 c;
	...
	inline VectorSIMD382 operator*(VectorSIMD382 a ,double b){
		VectorSIMD382 c;
	...
	inline VectorSIMD382 operator*(int a, VectorSIMD382 b){
		if(a==1){return b;}
		VectorSIMD382 c;
	...
	inline VectorSIMD382 operator*(VectorSIMD382 a, int b){
		if(b==1){return a;}
		VectorSIMD382 c;
	...
	inline VectorSIMD382 operator*(VectorSIMD382 a, VectorSIMD382 b){
		VectorSIMD382 c;
	...
	inline VectorSIMD382 exp(VectorSIMD382 a){
		double a_d[382]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD382 sqrt(VectorSIMD382 a){
		double a_d[382]; a.convert(a_d);
