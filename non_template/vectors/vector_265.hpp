...
public:
		...
		VectorSIMD265(double a){
			...
			_avx66=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD265(double (&a)[265]){
		...
		VectorSIMD265& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD265& operator += (VectorSIMD265 a){
	...
	inline VectorSIMD265 operator*(double a, VectorSIMD265 b){
		VectorSIMD265 c;
	...
	inline VectorSIMD265 operator*(VectorSIMD265 a ,double b){
		VectorSIMD265 c;
	...
	inline VectorSIMD265 operator*(int a, VectorSIMD265 b){
		if(a==1){return b;}
		VectorSIMD265 c;
	...
	inline VectorSIMD265 operator*(VectorSIMD265 a, int b){
		if(b==1){return a;}
		VectorSIMD265 c;
	...
	inline VectorSIMD265 operator*(VectorSIMD265 a, VectorSIMD265 b){
		VectorSIMD265 c;
	...
	inline VectorSIMD265 exp(VectorSIMD265 a){
		double a_d[265]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD265 sqrt(VectorSIMD265 a){
		double a_d[265]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD265 a){ 
		double ad[265];
		a.convert(ad);
