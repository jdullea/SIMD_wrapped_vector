...
public:
		...
		VectorSIMD407(double a){
			...
			_avx101=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD407(double (&a)[407]){
		...
		VectorSIMD407& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD407& operator += (VectorSIMD407 a){
	...
	inline VectorSIMD407 operator*(double a, VectorSIMD407 b){
		VectorSIMD407 c;
	...
	inline VectorSIMD407 operator*(VectorSIMD407 a ,double b){
		VectorSIMD407 c;
	...
	inline VectorSIMD407 operator*(int a, VectorSIMD407 b){
		if(a==1){return b;}
		VectorSIMD407 c;
	...
	inline VectorSIMD407 operator*(VectorSIMD407 a, int b){
		if(b==1){return a;}
		VectorSIMD407 c;
	...
	inline VectorSIMD407 operator*(VectorSIMD407 a, VectorSIMD407 b){
		VectorSIMD407 c;
	...
	inline VectorSIMD407 exp(VectorSIMD407 a){
		double a_d[407]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD407 sqrt(VectorSIMD407 a){
		double a_d[407]; a.convert(a_d);
