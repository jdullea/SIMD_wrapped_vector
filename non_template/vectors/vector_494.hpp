...
public:
		...
		VectorSIMD494(double a){
			...
			_avx123=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD494(double (&a)[494]){
		...
		VectorSIMD494& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD494& operator += (VectorSIMD494 a){
	...
	inline VectorSIMD494 operator*(double a, VectorSIMD494 b){
		VectorSIMD494 c;
	...
	inline VectorSIMD494 operator*(VectorSIMD494 a ,double b){
		VectorSIMD494 c;
	...
	inline VectorSIMD494 operator*(int a, VectorSIMD494 b){
		if(a==1){return b;}
		VectorSIMD494 c;
	...
	inline VectorSIMD494 operator*(VectorSIMD494 a, int b){
		if(b==1){return a;}
		VectorSIMD494 c;
	...
	inline VectorSIMD494 operator*(VectorSIMD494 a, VectorSIMD494 b){
		VectorSIMD494 c;
	...
	inline VectorSIMD494 exp(VectorSIMD494 a){
		double a_d[494]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD494 sqrt(VectorSIMD494 a){
		double a_d[494]; a.convert(a_d);
