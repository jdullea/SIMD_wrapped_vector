...
public:
		...
		VectorSIMD448& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD448& operator += (VectorSIMD448 a){
	...
	inline VectorSIMD448 operator*(double a, VectorSIMD448 b){
		VectorSIMD448 c;
	...
	inline VectorSIMD448 operator*(VectorSIMD448 a ,double b){
		VectorSIMD448 c;
	...
	inline VectorSIMD448 operator*(int a, VectorSIMD448 b){
		if(a==1){return b;}
		VectorSIMD448 c;
	...
	inline VectorSIMD448 operator*(VectorSIMD448 a, int b){
		if(b==1){return a;}
		VectorSIMD448 c;
	...
	inline VectorSIMD448 operator*(VectorSIMD448 a, VectorSIMD448 b){
		VectorSIMD448 c;
	...
	inline VectorSIMD448 exp(VectorSIMD448 a){
		double a_d[448]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD448 sqrt(VectorSIMD448 a){
		double a_d[448]; a.convert(a_d);
