...
public:
		...
		VectorSIMD652& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD652& operator += (VectorSIMD652 a){
	...
	inline VectorSIMD652 operator*(double a, VectorSIMD652 b){
		VectorSIMD652 c;
	...
	inline VectorSIMD652 operator*(VectorSIMD652 a ,double b){
		VectorSIMD652 c;
	...
	inline VectorSIMD652 operator*(int a, VectorSIMD652 b){
		if(a==1){return b;}
		VectorSIMD652 c;
	...
	inline VectorSIMD652 operator*(VectorSIMD652 a, int b){
		if(b==1){return a;}
		VectorSIMD652 c;
	...
	inline VectorSIMD652 operator*(VectorSIMD652 a, VectorSIMD652 b){
		VectorSIMD652 c;
	...
	inline VectorSIMD652 exp(VectorSIMD652 a){
		double a_d[652]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD652 sqrt(VectorSIMD652 a){
		double a_d[652]; a.convert(a_d);
