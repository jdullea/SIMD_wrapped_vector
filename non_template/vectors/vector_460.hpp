...
public:
		...
		VectorSIMD460& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD460& operator += (VectorSIMD460 a){
	...
	inline VectorSIMD460 operator*(double a, VectorSIMD460 b){
		VectorSIMD460 c;
	...
	inline VectorSIMD460 operator*(VectorSIMD460 a ,double b){
		VectorSIMD460 c;
	...
	inline VectorSIMD460 operator*(int a, VectorSIMD460 b){
		if(a==1){return b;}
		VectorSIMD460 c;
	...
	inline VectorSIMD460 operator*(VectorSIMD460 a, int b){
		if(b==1){return a;}
		VectorSIMD460 c;
	...
	inline VectorSIMD460 operator*(VectorSIMD460 a, VectorSIMD460 b){
		VectorSIMD460 c;
	...
	inline VectorSIMD460 exp(VectorSIMD460 a){
		double a_d[460]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD460 sqrt(VectorSIMD460 a){
		double a_d[460]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD460 a){ 
		double ad[460];
		a.convert(ad);
