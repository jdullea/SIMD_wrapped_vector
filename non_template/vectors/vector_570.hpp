...
public:
		...
		VectorSIMD570(double a){
			...
			_avx142=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD570(double (&a)[570]){
		...
		VectorSIMD570& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD570& operator += (VectorSIMD570 a){
	...
	inline VectorSIMD570 operator*(double a, VectorSIMD570 b){
		VectorSIMD570 c;
	...
	inline VectorSIMD570 operator*(VectorSIMD570 a ,double b){
		VectorSIMD570 c;
	...
	inline VectorSIMD570 operator*(int a, VectorSIMD570 b){
		if(a==1){return b;}
		VectorSIMD570 c;
	...
	inline VectorSIMD570 operator*(VectorSIMD570 a, int b){
		if(b==1){return a;}
		VectorSIMD570 c;
	...
	inline VectorSIMD570 operator*(VectorSIMD570 a, VectorSIMD570 b){
		VectorSIMD570 c;
	...
	inline VectorSIMD570 exp(VectorSIMD570 a){
		double a_d[570]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD570 sqrt(VectorSIMD570 a){
		double a_d[570]; a.convert(a_d);
