...
public:
		...
		VectorSIMD648& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD648& operator += (VectorSIMD648 a){
	...
	inline VectorSIMD648 operator*(double a, VectorSIMD648 b){
		VectorSIMD648 c;
	...
	inline VectorSIMD648 operator*(VectorSIMD648 a ,double b){
		VectorSIMD648 c;
	...
	inline VectorSIMD648 operator*(int a, VectorSIMD648 b){
		if(a==1){return b;}
		VectorSIMD648 c;
	...
	inline VectorSIMD648 operator*(VectorSIMD648 a, int b){
		if(b==1){return a;}
		VectorSIMD648 c;
	...
	inline VectorSIMD648 operator*(VectorSIMD648 a, VectorSIMD648 b){
		VectorSIMD648 c;
	...
	inline VectorSIMD648 exp(VectorSIMD648 a){
		double a_d[648]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD648 sqrt(VectorSIMD648 a){
		double a_d[648]; a.convert(a_d);
