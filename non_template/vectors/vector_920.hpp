...
public:
		...
		VectorSIMD920& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD920& operator += (VectorSIMD920 a){
	...
	inline VectorSIMD920 operator*(double a, VectorSIMD920 b){
		VectorSIMD920 c;
	...
	inline VectorSIMD920 operator*(VectorSIMD920 a ,double b){
		VectorSIMD920 c;
	...
	inline VectorSIMD920 operator*(int a, VectorSIMD920 b){
		if(a==1){return b;}
		VectorSIMD920 c;
	...
	inline VectorSIMD920 operator*(VectorSIMD920 a, int b){
		if(b==1){return a;}
		VectorSIMD920 c;
	...
	inline VectorSIMD920 operator*(VectorSIMD920 a, VectorSIMD920 b){
		VectorSIMD920 c;
	...
	inline VectorSIMD920 exp(VectorSIMD920 a){
		double a_d[920]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD920 sqrt(VectorSIMD920 a){
		double a_d[920]; a.convert(a_d);
