...
public:
		...
		VectorSIMD497(double a){
			...
			_avx124=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD497(double (&a)[497]){
		...
		VectorSIMD497& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD497& operator += (VectorSIMD497 a){
	...
	inline VectorSIMD497 operator*(double a, VectorSIMD497 b){
		VectorSIMD497 c;
	...
	inline VectorSIMD497 operator*(VectorSIMD497 a ,double b){
		VectorSIMD497 c;
	...
	inline VectorSIMD497 operator*(int a, VectorSIMD497 b){
		if(a==1){return b;}
		VectorSIMD497 c;
	...
	inline VectorSIMD497 operator*(VectorSIMD497 a, int b){
		if(b==1){return a;}
		VectorSIMD497 c;
	...
	inline VectorSIMD497 operator*(VectorSIMD497 a, VectorSIMD497 b){
		VectorSIMD497 c;
	...
	inline VectorSIMD497 exp(VectorSIMD497 a){
		double a_d[497]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD497 sqrt(VectorSIMD497 a){
		double a_d[497]; a.convert(a_d);
