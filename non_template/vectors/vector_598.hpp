...
public:
		...
		VectorSIMD598(double a){
			...
			_avx149=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD598(double (&a)[598]){
		...
		VectorSIMD598& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD598& operator += (VectorSIMD598 a){
	...
	inline VectorSIMD598 operator*(double a, VectorSIMD598 b){
		VectorSIMD598 c;
	...
	inline VectorSIMD598 operator*(VectorSIMD598 a ,double b){
		VectorSIMD598 c;
	...
	inline VectorSIMD598 operator*(int a, VectorSIMD598 b){
		if(a==1){return b;}
		VectorSIMD598 c;
	...
	inline VectorSIMD598 operator*(VectorSIMD598 a, int b){
		if(b==1){return a;}
		VectorSIMD598 c;
	...
	inline VectorSIMD598 operator*(VectorSIMD598 a, VectorSIMD598 b){
		VectorSIMD598 c;
	...
	inline VectorSIMD598 exp(VectorSIMD598 a){
		double a_d[598]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD598 sqrt(VectorSIMD598 a){
		double a_d[598]; a.convert(a_d);
