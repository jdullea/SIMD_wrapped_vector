...
public:
		...
		VectorSIMD674(double a){
			...
			_avx168=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD674(double (&a)[674]){
		...
		VectorSIMD674& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD674& operator += (VectorSIMD674 a){
	...
	inline VectorSIMD674 operator*(double a, VectorSIMD674 b){
		VectorSIMD674 c;
	...
	inline VectorSIMD674 operator*(VectorSIMD674 a ,double b){
		VectorSIMD674 c;
	...
	inline VectorSIMD674 operator*(int a, VectorSIMD674 b){
		if(a==1){return b;}
		VectorSIMD674 c;
	...
	inline VectorSIMD674 operator*(VectorSIMD674 a, int b){
		if(b==1){return a;}
		VectorSIMD674 c;
	...
	inline VectorSIMD674 operator*(VectorSIMD674 a, VectorSIMD674 b){
		VectorSIMD674 c;
	...
	inline VectorSIMD674 exp(VectorSIMD674 a){
		double a_d[674]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD674 sqrt(VectorSIMD674 a){
		double a_d[674]; a.convert(a_d);
