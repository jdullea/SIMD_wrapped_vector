...
public:
		...
		VectorSIMD528& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD528& operator += (VectorSIMD528 a){
	...
	inline VectorSIMD528 operator*(double a, VectorSIMD528 b){
		VectorSIMD528 c;
	...
	inline VectorSIMD528 operator*(VectorSIMD528 a ,double b){
		VectorSIMD528 c;
	...
	inline VectorSIMD528 operator*(int a, VectorSIMD528 b){
		if(a==1){return b;}
		VectorSIMD528 c;
	...
	inline VectorSIMD528 operator*(VectorSIMD528 a, int b){
		if(b==1){return a;}
		VectorSIMD528 c;
	...
	inline VectorSIMD528 operator*(VectorSIMD528 a, VectorSIMD528 b){
		VectorSIMD528 c;
	...
	inline VectorSIMD528 exp(VectorSIMD528 a){
		double a_d[528]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD528 sqrt(VectorSIMD528 a){
		double a_d[528]; a.convert(a_d);
