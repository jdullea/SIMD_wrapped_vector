...
public:
		...
		VectorSIMD819(double a){
			...
			_avx204=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD819(double (&a)[819]){
		...
		VectorSIMD819& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD819& operator += (VectorSIMD819 a){
	...
	inline VectorSIMD819 operator*(double a, VectorSIMD819 b){
		VectorSIMD819 c;
	...
	inline VectorSIMD819 operator*(VectorSIMD819 a ,double b){
		VectorSIMD819 c;
	...
	inline VectorSIMD819 operator*(int a, VectorSIMD819 b){
		if(a==1){return b;}
		VectorSIMD819 c;
	...
	inline VectorSIMD819 operator*(VectorSIMD819 a, int b){
		if(b==1){return a;}
		VectorSIMD819 c;
	...
	inline VectorSIMD819 operator*(VectorSIMD819 a, VectorSIMD819 b){
		VectorSIMD819 c;
	...
	inline VectorSIMD819 exp(VectorSIMD819 a){
		double a_d[819]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD819 sqrt(VectorSIMD819 a){
		double a_d[819]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD819 a){ 
		double ad[819];
		a.convert(ad);
