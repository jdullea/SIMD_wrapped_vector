...
public:
		...
		VectorSIMD826(double a){
			...
			_avx206=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD826(double (&a)[826]){
		...
		VectorSIMD826& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD826& operator += (VectorSIMD826 a){
	...
	inline VectorSIMD826 operator*(double a, VectorSIMD826 b){
		VectorSIMD826 c;
	...
	inline VectorSIMD826 operator*(VectorSIMD826 a ,double b){
		VectorSIMD826 c;
	...
	inline VectorSIMD826 operator*(int a, VectorSIMD826 b){
		if(a==1){return b;}
		VectorSIMD826 c;
	...
	inline VectorSIMD826 operator*(VectorSIMD826 a, int b){
		if(b==1){return a;}
		VectorSIMD826 c;
	...
	inline VectorSIMD826 operator*(VectorSIMD826 a, VectorSIMD826 b){
		VectorSIMD826 c;
	...
	inline VectorSIMD826 exp(VectorSIMD826 a){
		double a_d[826]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD826 sqrt(VectorSIMD826 a){
		double a_d[826]; a.convert(a_d);
