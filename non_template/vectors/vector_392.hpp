...
public:
		...
		VectorSIMD392& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD392& operator += (VectorSIMD392 a){
	...
	inline VectorSIMD392 operator*(double a, VectorSIMD392 b){
		VectorSIMD392 c;
	...
	inline VectorSIMD392 operator*(VectorSIMD392 a ,double b){
		VectorSIMD392 c;
	...
	inline VectorSIMD392 operator*(int a, VectorSIMD392 b){
		if(a==1){return b;}
		VectorSIMD392 c;
	...
	inline VectorSIMD392 operator*(VectorSIMD392 a, int b){
		if(b==1){return a;}
		VectorSIMD392 c;
	...
	inline VectorSIMD392 operator*(VectorSIMD392 a, VectorSIMD392 b){
		VectorSIMD392 c;
	...
	inline VectorSIMD392 exp(VectorSIMD392 a){
		double a_d[392]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD392 sqrt(VectorSIMD392 a){
		double a_d[392]; a.convert(a_d);
