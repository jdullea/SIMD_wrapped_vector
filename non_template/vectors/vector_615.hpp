...
public:
		...
		VectorSIMD615(double a){
			...
			_avx153=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD615(double (&a)[615]){
		...
		VectorSIMD615& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD615& operator += (VectorSIMD615 a){
	...
	inline VectorSIMD615 operator*(double a, VectorSIMD615 b){
		VectorSIMD615 c;
	...
	inline VectorSIMD615 operator*(VectorSIMD615 a ,double b){
		VectorSIMD615 c;
	...
	inline VectorSIMD615 operator*(int a, VectorSIMD615 b){
		if(a==1){return b;}
		VectorSIMD615 c;
	...
	inline VectorSIMD615 operator*(VectorSIMD615 a, int b){
		if(b==1){return a;}
		VectorSIMD615 c;
	...
	inline VectorSIMD615 operator*(VectorSIMD615 a, VectorSIMD615 b){
		VectorSIMD615 c;
	...
	inline VectorSIMD615 exp(VectorSIMD615 a){
		double a_d[615]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD615 sqrt(VectorSIMD615 a){
		double a_d[615]; a.convert(a_d);
