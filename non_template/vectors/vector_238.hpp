...
public:
		...
		VectorSIMD238(double a){
			...
			_avx59=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD238(double (&a)[238]){
		...
		VectorSIMD238& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD238& operator += (VectorSIMD238 a){
	...
	inline VectorSIMD238 operator*(double a, VectorSIMD238 b){
		VectorSIMD238 c;
	...
	inline VectorSIMD238 operator*(VectorSIMD238 a ,double b){
		VectorSIMD238 c;
	...
	inline VectorSIMD238 operator*(int a, VectorSIMD238 b){
		if(a==1){return b;}
		VectorSIMD238 c;
	...
	inline VectorSIMD238 operator*(VectorSIMD238 a, int b){
		if(b==1){return a;}
		VectorSIMD238 c;
	...
	inline VectorSIMD238 operator*(VectorSIMD238 a, VectorSIMD238 b){
		VectorSIMD238 c;
	...
	inline VectorSIMD238 exp(VectorSIMD238 a){
		double a_d[238]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD238 sqrt(VectorSIMD238 a){
		double a_d[238]; a.convert(a_d);
