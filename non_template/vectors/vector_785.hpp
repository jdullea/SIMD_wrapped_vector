...
public:
		...
		VectorSIMD785(double a){
			...
			_avx196=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD785(double (&a)[785]){
		...
		VectorSIMD785& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD785& operator += (VectorSIMD785 a){
	...
	inline VectorSIMD785 operator*(double a, VectorSIMD785 b){
		VectorSIMD785 c;
	...
	inline VectorSIMD785 operator*(VectorSIMD785 a ,double b){
		VectorSIMD785 c;
	...
	inline VectorSIMD785 operator*(int a, VectorSIMD785 b){
		if(a==1){return b;}
		VectorSIMD785 c;
	...
	inline VectorSIMD785 operator*(VectorSIMD785 a, int b){
		if(b==1){return a;}
		VectorSIMD785 c;
	...
	inline VectorSIMD785 operator*(VectorSIMD785 a, VectorSIMD785 b){
		VectorSIMD785 c;
	...
	inline VectorSIMD785 exp(VectorSIMD785 a){
		double a_d[785]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD785 sqrt(VectorSIMD785 a){
		double a_d[785]; a.convert(a_d);
