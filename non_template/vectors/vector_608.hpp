...
public:
		...
		VectorSIMD608& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD608& operator += (VectorSIMD608 a){
	...
	inline VectorSIMD608 operator*(double a, VectorSIMD608 b){
		VectorSIMD608 c;
	...
	inline VectorSIMD608 operator*(VectorSIMD608 a ,double b){
		VectorSIMD608 c;
	...
	inline VectorSIMD608 operator*(int a, VectorSIMD608 b){
		if(a==1){return b;}
		VectorSIMD608 c;
	...
	inline VectorSIMD608 operator*(VectorSIMD608 a, int b){
		if(b==1){return a;}
		VectorSIMD608 c;
	...
	inline VectorSIMD608 operator*(VectorSIMD608 a, VectorSIMD608 b){
		VectorSIMD608 c;
	...
	inline VectorSIMD608 exp(VectorSIMD608 a){
		double a_d[608]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD608 sqrt(VectorSIMD608 a){
		double a_d[608]; a.convert(a_d);
