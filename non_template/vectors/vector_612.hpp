...
public:
		...
		VectorSIMD612& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD612& operator += (VectorSIMD612 a){
	...
	inline VectorSIMD612 operator*(double a, VectorSIMD612 b){
		VectorSIMD612 c;
	...
	inline VectorSIMD612 operator*(VectorSIMD612 a ,double b){
		VectorSIMD612 c;
	...
	inline VectorSIMD612 operator*(int a, VectorSIMD612 b){
		if(a==1){return b;}
		VectorSIMD612 c;
	...
	inline VectorSIMD612 operator*(VectorSIMD612 a, int b){
		if(b==1){return a;}
		VectorSIMD612 c;
	...
	inline VectorSIMD612 operator*(VectorSIMD612 a, VectorSIMD612 b){
		VectorSIMD612 c;
	...
	inline VectorSIMD612 exp(VectorSIMD612 a){
		double a_d[612]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD612 sqrt(VectorSIMD612 a){
		double a_d[612]; a.convert(a_d);
