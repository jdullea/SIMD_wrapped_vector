...
public:
		...
		VectorSIMD427(double a){
			...
			_avx106=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD427(double (&a)[427]){
		...
		VectorSIMD427& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD427& operator += (VectorSIMD427 a){
	...
	inline VectorSIMD427 operator*(double a, VectorSIMD427 b){
		VectorSIMD427 c;
	...
	inline VectorSIMD427 operator*(VectorSIMD427 a ,double b){
		VectorSIMD427 c;
	...
	inline VectorSIMD427 operator*(int a, VectorSIMD427 b){
		if(a==1){return b;}
		VectorSIMD427 c;
	...
	inline VectorSIMD427 operator*(VectorSIMD427 a, int b){
		if(b==1){return a;}
		VectorSIMD427 c;
	...
	inline VectorSIMD427 operator*(VectorSIMD427 a, VectorSIMD427 b){
		VectorSIMD427 c;
	...
	inline VectorSIMD427 exp(VectorSIMD427 a){
		double a_d[427]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD427 sqrt(VectorSIMD427 a){
		double a_d[427]; a.convert(a_d);
