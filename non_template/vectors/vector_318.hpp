...
public:
		...
		VectorSIMD318(double a){
			...
			_avx79=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD318(double (&a)[318]){
		...
		VectorSIMD318& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD318& operator += (VectorSIMD318 a){
	...
	inline VectorSIMD318 operator*(double a, VectorSIMD318 b){
		VectorSIMD318 c;
	...
	inline VectorSIMD318 operator*(VectorSIMD318 a ,double b){
		VectorSIMD318 c;
	...
	inline VectorSIMD318 operator*(int a, VectorSIMD318 b){
		if(a==1){return b;}
		VectorSIMD318 c;
	...
	inline VectorSIMD318 operator*(VectorSIMD318 a, int b){
		if(b==1){return a;}
		VectorSIMD318 c;
	...
	inline VectorSIMD318 operator*(VectorSIMD318 a, VectorSIMD318 b){
		VectorSIMD318 c;
	...
	inline VectorSIMD318 exp(VectorSIMD318 a){
		double a_d[318]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD318 sqrt(VectorSIMD318 a){
		double a_d[318]; a.convert(a_d);
