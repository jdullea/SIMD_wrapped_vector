...
public:
		...
		VectorSIMD967(double a){
			...
			_avx241=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD967(double (&a)[967]){
		...
		VectorSIMD967& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD967& operator += (VectorSIMD967 a){
	...
	inline VectorSIMD967 operator*(double a, VectorSIMD967 b){
		VectorSIMD967 c;
	...
	inline VectorSIMD967 operator*(VectorSIMD967 a ,double b){
		VectorSIMD967 c;
	...
	inline VectorSIMD967 operator*(int a, VectorSIMD967 b){
		if(a==1){return b;}
		VectorSIMD967 c;
	...
	inline VectorSIMD967 operator*(VectorSIMD967 a, int b){
		if(b==1){return a;}
		VectorSIMD967 c;
	...
	inline VectorSIMD967 operator*(VectorSIMD967 a, VectorSIMD967 b){
		VectorSIMD967 c;
	...
	inline VectorSIMD967 exp(VectorSIMD967 a){
		double a_d[967]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD967 sqrt(VectorSIMD967 a){
		double a_d[967]; a.convert(a_d);
