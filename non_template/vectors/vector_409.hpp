...
public:
		...
		VectorSIMD409(double a){
			...
			_avx102=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD409(double (&a)[409]){
		...
		VectorSIMD409& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD409& operator += (VectorSIMD409 a){
	...
	inline VectorSIMD409 operator*(double a, VectorSIMD409 b){
		VectorSIMD409 c;
	...
	inline VectorSIMD409 operator*(VectorSIMD409 a ,double b){
		VectorSIMD409 c;
	...
	inline VectorSIMD409 operator*(int a, VectorSIMD409 b){
		if(a==1){return b;}
		VectorSIMD409 c;
	...
	inline VectorSIMD409 operator*(VectorSIMD409 a, int b){
		if(b==1){return a;}
		VectorSIMD409 c;
	...
	inline VectorSIMD409 operator*(VectorSIMD409 a, VectorSIMD409 b){
		VectorSIMD409 c;
	...
	inline VectorSIMD409 exp(VectorSIMD409 a){
		double a_d[409]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD409 sqrt(VectorSIMD409 a){
		double a_d[409]; a.convert(a_d);
