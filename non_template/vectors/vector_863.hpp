...
public:
		...
		VectorSIMD863(double a){
			...
			_avx215=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD863(double (&a)[863]){
		...
		VectorSIMD863& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD863& operator += (VectorSIMD863 a){
	...
	inline VectorSIMD863 operator*(double a, VectorSIMD863 b){
		VectorSIMD863 c;
	...
	inline VectorSIMD863 operator*(VectorSIMD863 a ,double b){
		VectorSIMD863 c;
	...
	inline VectorSIMD863 operator*(int a, VectorSIMD863 b){
		if(a==1){return b;}
		VectorSIMD863 c;
	...
	inline VectorSIMD863 operator*(VectorSIMD863 a, int b){
		if(b==1){return a;}
		VectorSIMD863 c;
	...
	inline VectorSIMD863 operator*(VectorSIMD863 a, VectorSIMD863 b){
		VectorSIMD863 c;
	...
	inline VectorSIMD863 exp(VectorSIMD863 a){
		double a_d[863]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD863 sqrt(VectorSIMD863 a){
		double a_d[863]; a.convert(a_d);
