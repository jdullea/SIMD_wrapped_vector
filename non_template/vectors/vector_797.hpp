...
public:
		...
		VectorSIMD797(double a){
			...
			_avx199=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD797(double (&a)[797]){
		...
		VectorSIMD797& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD797& operator += (VectorSIMD797 a){
	...
	inline VectorSIMD797 operator*(double a, VectorSIMD797 b){
		VectorSIMD797 c;
	...
	inline VectorSIMD797 operator*(VectorSIMD797 a ,double b){
		VectorSIMD797 c;
	...
	inline VectorSIMD797 operator*(int a, VectorSIMD797 b){
		if(a==1){return b;}
		VectorSIMD797 c;
	...
	inline VectorSIMD797 operator*(VectorSIMD797 a, int b){
		if(b==1){return a;}
		VectorSIMD797 c;
	...
	inline VectorSIMD797 operator*(VectorSIMD797 a, VectorSIMD797 b){
		VectorSIMD797 c;
	...
	inline VectorSIMD797 exp(VectorSIMD797 a){
		double a_d[797]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD797 sqrt(VectorSIMD797 a){
		double a_d[797]; a.convert(a_d);
