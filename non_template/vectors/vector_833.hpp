...
public:
		...
		VectorSIMD833(double a){
			...
			_avx208=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD833(double (&a)[833]){
		...
		VectorSIMD833& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD833& operator += (VectorSIMD833 a){
	...
	inline VectorSIMD833 operator*(double a, VectorSIMD833 b){
		VectorSIMD833 c;
	...
	inline VectorSIMD833 operator*(VectorSIMD833 a ,double b){
		VectorSIMD833 c;
	...
	inline VectorSIMD833 operator*(int a, VectorSIMD833 b){
		if(a==1){return b;}
		VectorSIMD833 c;
	...
	inline VectorSIMD833 operator*(VectorSIMD833 a, int b){
		if(b==1){return a;}
		VectorSIMD833 c;
	...
	inline VectorSIMD833 operator*(VectorSIMD833 a, VectorSIMD833 b){
		VectorSIMD833 c;
	...
	inline VectorSIMD833 exp(VectorSIMD833 a){
		double a_d[833]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD833 sqrt(VectorSIMD833 a){
		double a_d[833]; a.convert(a_d);
