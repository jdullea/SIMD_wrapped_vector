...
public:
		...
		VectorSIMD322(double a){
			...
			_avx80=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD322(double (&a)[322]){
		...
		VectorSIMD322& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD322& operator += (VectorSIMD322 a){
	...
	inline VectorSIMD322 operator*(double a, VectorSIMD322 b){
		VectorSIMD322 c;
	...
	inline VectorSIMD322 operator*(VectorSIMD322 a ,double b){
		VectorSIMD322 c;
	...
	inline VectorSIMD322 operator*(int a, VectorSIMD322 b){
		if(a==1){return b;}
		VectorSIMD322 c;
	...
	inline VectorSIMD322 operator*(VectorSIMD322 a, int b){
		if(b==1){return a;}
		VectorSIMD322 c;
	...
	inline VectorSIMD322 operator*(VectorSIMD322 a, VectorSIMD322 b){
		VectorSIMD322 c;
	...
	inline VectorSIMD322 exp(VectorSIMD322 a){
		double a_d[322]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD322 sqrt(VectorSIMD322 a){
		double a_d[322]; a.convert(a_d);
