...
public:
		...
		VectorSIMD518(double a){
			...
			_avx129=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD518(double (&a)[518]){
		...
		VectorSIMD518& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD518& operator += (VectorSIMD518 a){
	...
	inline VectorSIMD518 operator*(double a, VectorSIMD518 b){
		VectorSIMD518 c;
	...
	inline VectorSIMD518 operator*(VectorSIMD518 a ,double b){
		VectorSIMD518 c;
	...
	inline VectorSIMD518 operator*(int a, VectorSIMD518 b){
		if(a==1){return b;}
		VectorSIMD518 c;
	...
	inline VectorSIMD518 operator*(VectorSIMD518 a, int b){
		if(b==1){return a;}
		VectorSIMD518 c;
	...
	inline VectorSIMD518 operator*(VectorSIMD518 a, VectorSIMD518 b){
		VectorSIMD518 c;
	...
	inline VectorSIMD518 exp(VectorSIMD518 a){
		double a_d[518]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD518 sqrt(VectorSIMD518 a){
		double a_d[518]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD518 a){ 
		double ad[518];
		a.convert(ad);
