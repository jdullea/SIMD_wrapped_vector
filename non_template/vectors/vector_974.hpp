...
public:
		...
		VectorSIMD974(double a){
			...
			_avx243=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD974(double (&a)[974]){
		...
		VectorSIMD974& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD974& operator += (VectorSIMD974 a){
	...
	inline VectorSIMD974 operator*(double a, VectorSIMD974 b){
		VectorSIMD974 c;
	...
	inline VectorSIMD974 operator*(VectorSIMD974 a ,double b){
		VectorSIMD974 c;
	...
	inline VectorSIMD974 operator*(int a, VectorSIMD974 b){
		if(a==1){return b;}
		VectorSIMD974 c;
	...
	inline VectorSIMD974 operator*(VectorSIMD974 a, int b){
		if(b==1){return a;}
		VectorSIMD974 c;
	...
	inline VectorSIMD974 operator*(VectorSIMD974 a, VectorSIMD974 b){
		VectorSIMD974 c;
	...
	inline VectorSIMD974 exp(VectorSIMD974 a){
		double a_d[974]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD974 sqrt(VectorSIMD974 a){
		double a_d[974]; a.convert(a_d);
