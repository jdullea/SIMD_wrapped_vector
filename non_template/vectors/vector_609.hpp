...
public:
		...
		VectorSIMD609(double a){
			...
			_avx152=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD609(double (&a)[609]){
		...
		VectorSIMD609& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD609& operator += (VectorSIMD609 a){
	...
	inline VectorSIMD609 operator*(double a, VectorSIMD609 b){
		VectorSIMD609 c;
	...
	inline VectorSIMD609 operator*(VectorSIMD609 a ,double b){
		VectorSIMD609 c;
	...
	inline VectorSIMD609 operator*(int a, VectorSIMD609 b){
		if(a==1){return b;}
		VectorSIMD609 c;
	...
	inline VectorSIMD609 operator*(VectorSIMD609 a, int b){
		if(b==1){return a;}
		VectorSIMD609 c;
	...
	inline VectorSIMD609 operator*(VectorSIMD609 a, VectorSIMD609 b){
		VectorSIMD609 c;
	...
	inline VectorSIMD609 exp(VectorSIMD609 a){
		double a_d[609]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD609 sqrt(VectorSIMD609 a){
		double a_d[609]; a.convert(a_d);
