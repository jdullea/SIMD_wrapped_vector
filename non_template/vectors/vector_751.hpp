...
public:
		...
		VectorSIMD751(double a){
			...
			_avx187=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD751(double (&a)[751]){
		...
		VectorSIMD751& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD751& operator += (VectorSIMD751 a){
	...
	inline VectorSIMD751 operator*(double a, VectorSIMD751 b){
		VectorSIMD751 c;
	...
	inline VectorSIMD751 operator*(VectorSIMD751 a ,double b){
		VectorSIMD751 c;
	...
	inline VectorSIMD751 operator*(int a, VectorSIMD751 b){
		if(a==1){return b;}
		VectorSIMD751 c;
	...
	inline VectorSIMD751 operator*(VectorSIMD751 a, int b){
		if(b==1){return a;}
		VectorSIMD751 c;
	...
	inline VectorSIMD751 operator*(VectorSIMD751 a, VectorSIMD751 b){
		VectorSIMD751 c;
	...
	inline VectorSIMD751 exp(VectorSIMD751 a){
		double a_d[751]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD751 sqrt(VectorSIMD751 a){
		double a_d[751]; a.convert(a_d);
