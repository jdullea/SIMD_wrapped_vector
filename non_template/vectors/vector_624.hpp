...
public:
		...
		VectorSIMD624& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD624& operator += (VectorSIMD624 a){
	...
	inline VectorSIMD624 operator*(double a, VectorSIMD624 b){
		VectorSIMD624 c;
	...
	inline VectorSIMD624 operator*(VectorSIMD624 a ,double b){
		VectorSIMD624 c;
	...
	inline VectorSIMD624 operator*(int a, VectorSIMD624 b){
		if(a==1){return b;}
		VectorSIMD624 c;
	...
	inline VectorSIMD624 operator*(VectorSIMD624 a, int b){
		if(b==1){return a;}
		VectorSIMD624 c;
	...
	inline VectorSIMD624 operator*(VectorSIMD624 a, VectorSIMD624 b){
		VectorSIMD624 c;
	...
	inline VectorSIMD624 exp(VectorSIMD624 a){
		double a_d[624]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD624 sqrt(VectorSIMD624 a){
		double a_d[624]; a.convert(a_d);
