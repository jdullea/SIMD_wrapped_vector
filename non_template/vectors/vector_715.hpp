...
public:
		...
		VectorSIMD715(double a){
			...
			_avx178=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD715(double (&a)[715]){
		...
		VectorSIMD715& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD715& operator += (VectorSIMD715 a){
	...
	inline VectorSIMD715 operator*(double a, VectorSIMD715 b){
		VectorSIMD715 c;
	...
	inline VectorSIMD715 operator*(VectorSIMD715 a ,double b){
		VectorSIMD715 c;
	...
	inline VectorSIMD715 operator*(int a, VectorSIMD715 b){
		if(a==1){return b;}
		VectorSIMD715 c;
	...
	inline VectorSIMD715 operator*(VectorSIMD715 a, int b){
		if(b==1){return a;}
		VectorSIMD715 c;
	...
	inline VectorSIMD715 operator*(VectorSIMD715 a, VectorSIMD715 b){
		VectorSIMD715 c;
	...
	inline VectorSIMD715 exp(VectorSIMD715 a){
		double a_d[715]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD715 sqrt(VectorSIMD715 a){
		double a_d[715]; a.convert(a_d);
