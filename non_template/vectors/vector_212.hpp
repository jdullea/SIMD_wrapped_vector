...
public:
		...
		VectorSIMD212& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD212& operator += (VectorSIMD212 a){
	...
	inline VectorSIMD212 operator*(double a, VectorSIMD212 b){
		VectorSIMD212 c;
	...
	inline VectorSIMD212 operator*(VectorSIMD212 a ,double b){
		VectorSIMD212 c;
	...
	inline VectorSIMD212 operator*(int a, VectorSIMD212 b){
		if(a==1){return b;}
		VectorSIMD212 c;
	...
	inline VectorSIMD212 operator*(VectorSIMD212 a, int b){
		if(b==1){return a;}
		VectorSIMD212 c;
	...
	inline VectorSIMD212 operator*(VectorSIMD212 a, VectorSIMD212 b){
		VectorSIMD212 c;
	...
	inline VectorSIMD212 exp(VectorSIMD212 a){
		double a_d[212]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD212 sqrt(VectorSIMD212 a){
		double a_d[212]; a.convert(a_d);
