...
public:
		...
		VectorSIMD604& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD604& operator += (VectorSIMD604 a){
	...
	inline VectorSIMD604 operator*(double a, VectorSIMD604 b){
		VectorSIMD604 c;
	...
	inline VectorSIMD604 operator*(VectorSIMD604 a ,double b){
		VectorSIMD604 c;
	...
	inline VectorSIMD604 operator*(int a, VectorSIMD604 b){
		if(a==1){return b;}
		VectorSIMD604 c;
	...
	inline VectorSIMD604 operator*(VectorSIMD604 a, int b){
		if(b==1){return a;}
		VectorSIMD604 c;
	...
	inline VectorSIMD604 operator*(VectorSIMD604 a, VectorSIMD604 b){
		VectorSIMD604 c;
	...
	inline VectorSIMD604 exp(VectorSIMD604 a){
		double a_d[604]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD604 sqrt(VectorSIMD604 a){
		double a_d[604]; a.convert(a_d);
