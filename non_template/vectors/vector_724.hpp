...
public:
		...
		VectorSIMD724& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD724& operator += (VectorSIMD724 a){
	...
	inline VectorSIMD724 operator*(double a, VectorSIMD724 b){
		VectorSIMD724 c;
	...
	inline VectorSIMD724 operator*(VectorSIMD724 a ,double b){
		VectorSIMD724 c;
	...
	inline VectorSIMD724 operator*(int a, VectorSIMD724 b){
		if(a==1){return b;}
		VectorSIMD724 c;
	...
	inline VectorSIMD724 operator*(VectorSIMD724 a, int b){
		if(b==1){return a;}
		VectorSIMD724 c;
	...
	inline VectorSIMD724 operator*(VectorSIMD724 a, VectorSIMD724 b){
		VectorSIMD724 c;
	...
	inline VectorSIMD724 exp(VectorSIMD724 a){
		double a_d[724]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD724 sqrt(VectorSIMD724 a){
		double a_d[724]; a.convert(a_d);
