...
public:
		...
		VectorSIMD566(double a){
			...
			_avx141=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD566(double (&a)[566]){
		...
		VectorSIMD566& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD566& operator += (VectorSIMD566 a){
	...
	inline VectorSIMD566 operator*(double a, VectorSIMD566 b){
		VectorSIMD566 c;
	...
	inline VectorSIMD566 operator*(VectorSIMD566 a ,double b){
		VectorSIMD566 c;
	...
	inline VectorSIMD566 operator*(int a, VectorSIMD566 b){
		if(a==1){return b;}
		VectorSIMD566 c;
	...
	inline VectorSIMD566 operator*(VectorSIMD566 a, int b){
		if(b==1){return a;}
		VectorSIMD566 c;
	...
	inline VectorSIMD566 operator*(VectorSIMD566 a, VectorSIMD566 b){
		VectorSIMD566 c;
	...
	inline VectorSIMD566 exp(VectorSIMD566 a){
		double a_d[566]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD566 sqrt(VectorSIMD566 a){
		double a_d[566]; a.convert(a_d);
