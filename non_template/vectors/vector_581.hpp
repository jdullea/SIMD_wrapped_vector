...
public:
		...
		VectorSIMD581(double a){
			...
			_avx145=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD581(double (&a)[581]){
		...
		VectorSIMD581& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD581& operator += (VectorSIMD581 a){
	...
	inline VectorSIMD581 operator*(double a, VectorSIMD581 b){
		VectorSIMD581 c;
	...
	inline VectorSIMD581 operator*(VectorSIMD581 a ,double b){
		VectorSIMD581 c;
	...
	inline VectorSIMD581 operator*(int a, VectorSIMD581 b){
		if(a==1){return b;}
		VectorSIMD581 c;
	...
	inline VectorSIMD581 operator*(VectorSIMD581 a, int b){
		if(b==1){return a;}
		VectorSIMD581 c;
	...
	inline VectorSIMD581 operator*(VectorSIMD581 a, VectorSIMD581 b){
		VectorSIMD581 c;
	...
	inline VectorSIMD581 exp(VectorSIMD581 a){
		double a_d[581]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD581 sqrt(VectorSIMD581 a){
		double a_d[581]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD581 a){ 
		double ad[581];
		a.convert(ad);
