...
public:
		...
		VectorSIMD486(double a){
			...
			_avx121=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD486(double (&a)[486]){
		...
		VectorSIMD486& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD486& operator += (VectorSIMD486 a){
	...
	inline VectorSIMD486 operator*(double a, VectorSIMD486 b){
		VectorSIMD486 c;
	...
	inline VectorSIMD486 operator*(VectorSIMD486 a ,double b){
		VectorSIMD486 c;
	...
	inline VectorSIMD486 operator*(int a, VectorSIMD486 b){
		if(a==1){return b;}
		VectorSIMD486 c;
	...
	inline VectorSIMD486 operator*(VectorSIMD486 a, int b){
		if(b==1){return a;}
		VectorSIMD486 c;
	...
	inline VectorSIMD486 operator*(VectorSIMD486 a, VectorSIMD486 b){
		VectorSIMD486 c;
	...
	inline VectorSIMD486 exp(VectorSIMD486 a){
		double a_d[486]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD486 sqrt(VectorSIMD486 a){
		double a_d[486]; a.convert(a_d);
