...
public:
		...
		VectorSIMD790(double a){
			...
			_avx197=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD790(double (&a)[790]){
		...
		VectorSIMD790& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD790& operator += (VectorSIMD790 a){
	...
	inline VectorSIMD790 operator*(double a, VectorSIMD790 b){
		VectorSIMD790 c;
	...
	inline VectorSIMD790 operator*(VectorSIMD790 a ,double b){
		VectorSIMD790 c;
	...
	inline VectorSIMD790 operator*(int a, VectorSIMD790 b){
		if(a==1){return b;}
		VectorSIMD790 c;
	...
	inline VectorSIMD790 operator*(VectorSIMD790 a, int b){
		if(b==1){return a;}
		VectorSIMD790 c;
	...
	inline VectorSIMD790 operator*(VectorSIMD790 a, VectorSIMD790 b){
		VectorSIMD790 c;
	...
	inline VectorSIMD790 exp(VectorSIMD790 a){
		double a_d[790]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD790 sqrt(VectorSIMD790 a){
		double a_d[790]; a.convert(a_d);
