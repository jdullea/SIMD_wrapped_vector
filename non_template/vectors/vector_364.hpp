...
public:
		...
		VectorSIMD364& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD364& operator += (VectorSIMD364 a){
	...
	inline VectorSIMD364 operator*(double a, VectorSIMD364 b){
		VectorSIMD364 c;
	...
	inline VectorSIMD364 operator*(VectorSIMD364 a ,double b){
		VectorSIMD364 c;
	...
	inline VectorSIMD364 operator*(int a, VectorSIMD364 b){
		if(a==1){return b;}
		VectorSIMD364 c;
	...
	inline VectorSIMD364 operator*(VectorSIMD364 a, int b){
		if(b==1){return a;}
		VectorSIMD364 c;
	...
	inline VectorSIMD364 operator*(VectorSIMD364 a, VectorSIMD364 b){
		VectorSIMD364 c;
	...
	inline VectorSIMD364 exp(VectorSIMD364 a){
		double a_d[364]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD364 sqrt(VectorSIMD364 a){
		double a_d[364]; a.convert(a_d);
