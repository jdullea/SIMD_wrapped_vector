...
public:
		...
		VectorSIMD900& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD900& operator += (VectorSIMD900 a){
	...
	inline VectorSIMD900 operator*(double a, VectorSIMD900 b){
		VectorSIMD900 c;
	...
	inline VectorSIMD900 operator*(VectorSIMD900 a ,double b){
		VectorSIMD900 c;
	...
	inline VectorSIMD900 operator*(int a, VectorSIMD900 b){
		if(a==1){return b;}
		VectorSIMD900 c;
	...
	inline VectorSIMD900 operator*(VectorSIMD900 a, int b){
		if(b==1){return a;}
		VectorSIMD900 c;
	...
	inline VectorSIMD900 operator*(VectorSIMD900 a, VectorSIMD900 b){
		VectorSIMD900 c;
	...
	inline VectorSIMD900 exp(VectorSIMD900 a){
		double a_d[900]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD900 sqrt(VectorSIMD900 a){
		double a_d[900]; a.convert(a_d);
