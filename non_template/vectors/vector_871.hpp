...
public:
		...
		VectorSIMD871(double a){
			...
			_avx217=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD871(double (&a)[871]){
		...
		VectorSIMD871& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD871& operator += (VectorSIMD871 a){
	...
	inline VectorSIMD871 operator*(double a, VectorSIMD871 b){
		VectorSIMD871 c;
	...
	inline VectorSIMD871 operator*(VectorSIMD871 a ,double b){
		VectorSIMD871 c;
	...
	inline VectorSIMD871 operator*(int a, VectorSIMD871 b){
		if(a==1){return b;}
		VectorSIMD871 c;
	...
	inline VectorSIMD871 operator*(VectorSIMD871 a, int b){
		if(b==1){return a;}
		VectorSIMD871 c;
	...
	inline VectorSIMD871 operator*(VectorSIMD871 a, VectorSIMD871 b){
		VectorSIMD871 c;
	...
	inline VectorSIMD871 exp(VectorSIMD871 a){
		double a_d[871]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD871 sqrt(VectorSIMD871 a){
		double a_d[871]; a.convert(a_d);
