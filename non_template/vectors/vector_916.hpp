...
public:
		...
		VectorSIMD916& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD916& operator += (VectorSIMD916 a){
	...
	inline VectorSIMD916 operator*(double a, VectorSIMD916 b){
		VectorSIMD916 c;
	...
	inline VectorSIMD916 operator*(VectorSIMD916 a ,double b){
		VectorSIMD916 c;
	...
	inline VectorSIMD916 operator*(int a, VectorSIMD916 b){
		if(a==1){return b;}
		VectorSIMD916 c;
	...
	inline VectorSIMD916 operator*(VectorSIMD916 a, int b){
		if(b==1){return a;}
		VectorSIMD916 c;
	...
	inline VectorSIMD916 operator*(VectorSIMD916 a, VectorSIMD916 b){
		VectorSIMD916 c;
	...
	inline VectorSIMD916 exp(VectorSIMD916 a){
		double a_d[916]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD916 sqrt(VectorSIMD916 a){
		double a_d[916]; a.convert(a_d);
