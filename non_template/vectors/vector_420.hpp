...
public:
		...
		VectorSIMD420& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD420& operator += (VectorSIMD420 a){
	...
	inline VectorSIMD420 operator*(double a, VectorSIMD420 b){
		VectorSIMD420 c;
	...
	inline VectorSIMD420 operator*(VectorSIMD420 a ,double b){
		VectorSIMD420 c;
	...
	inline VectorSIMD420 operator*(int a, VectorSIMD420 b){
		if(a==1){return b;}
		VectorSIMD420 c;
	...
	inline VectorSIMD420 operator*(VectorSIMD420 a, int b){
		if(b==1){return a;}
		VectorSIMD420 c;
	...
	inline VectorSIMD420 operator*(VectorSIMD420 a, VectorSIMD420 b){
		VectorSIMD420 c;
	...
	inline VectorSIMD420 exp(VectorSIMD420 a){
		double a_d[420]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD420 sqrt(VectorSIMD420 a){
		double a_d[420]; a.convert(a_d);
