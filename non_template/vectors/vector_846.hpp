...
public:
		...
		VectorSIMD846(double a){
			...
			_avx211=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD846(double (&a)[846]){
		...
		VectorSIMD846& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD846& operator += (VectorSIMD846 a){
	...
	inline VectorSIMD846 operator*(double a, VectorSIMD846 b){
		VectorSIMD846 c;
	...
	inline VectorSIMD846 operator*(VectorSIMD846 a ,double b){
		VectorSIMD846 c;
	...
	inline VectorSIMD846 operator*(int a, VectorSIMD846 b){
		if(a==1){return b;}
		VectorSIMD846 c;
	...
	inline VectorSIMD846 operator*(VectorSIMD846 a, int b){
		if(b==1){return a;}
		VectorSIMD846 c;
	...
	inline VectorSIMD846 operator*(VectorSIMD846 a, VectorSIMD846 b){
		VectorSIMD846 c;
	...
	inline VectorSIMD846 exp(VectorSIMD846 a){
		double a_d[846]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD846 sqrt(VectorSIMD846 a){
		double a_d[846]; a.convert(a_d);
