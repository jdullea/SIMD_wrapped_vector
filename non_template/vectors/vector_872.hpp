...
public:
		...
		VectorSIMD872& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD872& operator += (VectorSIMD872 a){
	...
	inline VectorSIMD872 operator*(double a, VectorSIMD872 b){
		VectorSIMD872 c;
	...
	inline VectorSIMD872 operator*(VectorSIMD872 a ,double b){
		VectorSIMD872 c;
	...
	inline VectorSIMD872 operator*(int a, VectorSIMD872 b){
		if(a==1){return b;}
		VectorSIMD872 c;
	...
	inline VectorSIMD872 operator*(VectorSIMD872 a, int b){
		if(b==1){return a;}
		VectorSIMD872 c;
	...
	inline VectorSIMD872 operator*(VectorSIMD872 a, VectorSIMD872 b){
		VectorSIMD872 c;
	...
	inline VectorSIMD872 exp(VectorSIMD872 a){
		double a_d[872]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD872 sqrt(VectorSIMD872 a){
		double a_d[872]; a.convert(a_d);
