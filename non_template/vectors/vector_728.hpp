...
public:
		...
		VectorSIMD728& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD728& operator += (VectorSIMD728 a){
	...
	inline VectorSIMD728 operator*(double a, VectorSIMD728 b){
		VectorSIMD728 c;
	...
	inline VectorSIMD728 operator*(VectorSIMD728 a ,double b){
		VectorSIMD728 c;
	...
	inline VectorSIMD728 operator*(int a, VectorSIMD728 b){
		if(a==1){return b;}
		VectorSIMD728 c;
	...
	inline VectorSIMD728 operator*(VectorSIMD728 a, int b){
		if(b==1){return a;}
		VectorSIMD728 c;
	...
	inline VectorSIMD728 operator*(VectorSIMD728 a, VectorSIMD728 b){
		VectorSIMD728 c;
	...
	inline VectorSIMD728 exp(VectorSIMD728 a){
		double a_d[728]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD728 sqrt(VectorSIMD728 a){
		double a_d[728]; a.convert(a_d);
