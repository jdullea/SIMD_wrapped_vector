...
public:
		...
		VectorSIMD549(double a){
			...
			_avx137=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD549(double (&a)[549]){
		...
		VectorSIMD549& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD549& operator += (VectorSIMD549 a){
	...
	inline VectorSIMD549 operator*(double a, VectorSIMD549 b){
		VectorSIMD549 c;
	...
	inline VectorSIMD549 operator*(VectorSIMD549 a ,double b){
		VectorSIMD549 c;
	...
	inline VectorSIMD549 operator*(int a, VectorSIMD549 b){
		if(a==1){return b;}
		VectorSIMD549 c;
	...
	inline VectorSIMD549 operator*(VectorSIMD549 a, int b){
		if(b==1){return a;}
		VectorSIMD549 c;
	...
	inline VectorSIMD549 operator*(VectorSIMD549 a, VectorSIMD549 b){
		VectorSIMD549 c;
	...
	inline VectorSIMD549 exp(VectorSIMD549 a){
		double a_d[549]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD549 sqrt(VectorSIMD549 a){
		double a_d[549]; a.convert(a_d);
