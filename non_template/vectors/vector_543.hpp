...
public:
		...
		VectorSIMD543(double a){
			...
			_avx135=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD543(double (&a)[543]){
		...
		VectorSIMD543& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD543& operator += (VectorSIMD543 a){
	...
	inline VectorSIMD543 operator*(double a, VectorSIMD543 b){
		VectorSIMD543 c;
	...
	inline VectorSIMD543 operator*(VectorSIMD543 a ,double b){
		VectorSIMD543 c;
	...
	inline VectorSIMD543 operator*(int a, VectorSIMD543 b){
		if(a==1){return b;}
		VectorSIMD543 c;
	...
	inline VectorSIMD543 operator*(VectorSIMD543 a, int b){
		if(b==1){return a;}
		VectorSIMD543 c;
	...
	inline VectorSIMD543 operator*(VectorSIMD543 a, VectorSIMD543 b){
		VectorSIMD543 c;
	...
	inline VectorSIMD543 exp(VectorSIMD543 a){
		double a_d[543]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD543 sqrt(VectorSIMD543 a){
		double a_d[543]; a.convert(a_d);
