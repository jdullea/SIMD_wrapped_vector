...
public:
		...
		VectorSIMD868& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD868& operator += (VectorSIMD868 a){
	...
	inline VectorSIMD868 operator*(double a, VectorSIMD868 b){
		VectorSIMD868 c;
	...
	inline VectorSIMD868 operator*(VectorSIMD868 a ,double b){
		VectorSIMD868 c;
	...
	inline VectorSIMD868 operator*(int a, VectorSIMD868 b){
		if(a==1){return b;}
		VectorSIMD868 c;
	...
	inline VectorSIMD868 operator*(VectorSIMD868 a, int b){
		if(b==1){return a;}
		VectorSIMD868 c;
	...
	inline VectorSIMD868 operator*(VectorSIMD868 a, VectorSIMD868 b){
		VectorSIMD868 c;
	...
	inline VectorSIMD868 exp(VectorSIMD868 a){
		double a_d[868]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD868 sqrt(VectorSIMD868 a){
		double a_d[868]; a.convert(a_d);
