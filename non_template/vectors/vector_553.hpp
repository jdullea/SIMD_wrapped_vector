...
public:
		...
		VectorSIMD553(double a){
			...
			_avx138=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD553(double (&a)[553]){
		...
		VectorSIMD553& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD553& operator += (VectorSIMD553 a){
	...
	inline VectorSIMD553 operator*(double a, VectorSIMD553 b){
		VectorSIMD553 c;
	...
	inline VectorSIMD553 operator*(VectorSIMD553 a ,double b){
		VectorSIMD553 c;
	...
	inline VectorSIMD553 operator*(int a, VectorSIMD553 b){
		if(a==1){return b;}
		VectorSIMD553 c;
	...
	inline VectorSIMD553 operator*(VectorSIMD553 a, int b){
		if(b==1){return a;}
		VectorSIMD553 c;
	...
	inline VectorSIMD553 operator*(VectorSIMD553 a, VectorSIMD553 b){
		VectorSIMD553 c;
	...
	inline VectorSIMD553 exp(VectorSIMD553 a){
		double a_d[553]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD553 sqrt(VectorSIMD553 a){
		double a_d[553]; a.convert(a_d);
