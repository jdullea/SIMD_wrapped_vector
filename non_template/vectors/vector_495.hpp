...
public:
		...
		VectorSIMD495(double a){
			...
			_avx123=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD495(double (&a)[495]){
		...
		VectorSIMD495& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD495& operator += (VectorSIMD495 a){
	...
	inline VectorSIMD495 operator*(double a, VectorSIMD495 b){
		VectorSIMD495 c;
	...
	inline VectorSIMD495 operator*(VectorSIMD495 a ,double b){
		VectorSIMD495 c;
	...
	inline VectorSIMD495 operator*(int a, VectorSIMD495 b){
		if(a==1){return b;}
		VectorSIMD495 c;
	...
	inline VectorSIMD495 operator*(VectorSIMD495 a, int b){
		if(b==1){return a;}
		VectorSIMD495 c;
	...
	inline VectorSIMD495 operator*(VectorSIMD495 a, VectorSIMD495 b){
		VectorSIMD495 c;
	...
	inline VectorSIMD495 exp(VectorSIMD495 a){
		double a_d[495]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD495 sqrt(VectorSIMD495 a){
		double a_d[495]; a.convert(a_d);
