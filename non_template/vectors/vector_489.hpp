...
public:
		...
		VectorSIMD489(double a){
			...
			_avx122=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD489(double (&a)[489]){
		...
		VectorSIMD489& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD489& operator += (VectorSIMD489 a){
	...
	inline VectorSIMD489 operator*(double a, VectorSIMD489 b){
		VectorSIMD489 c;
	...
	inline VectorSIMD489 operator*(VectorSIMD489 a ,double b){
		VectorSIMD489 c;
	...
	inline VectorSIMD489 operator*(int a, VectorSIMD489 b){
		if(a==1){return b;}
		VectorSIMD489 c;
	...
	inline VectorSIMD489 operator*(VectorSIMD489 a, int b){
		if(b==1){return a;}
		VectorSIMD489 c;
	...
	inline VectorSIMD489 operator*(VectorSIMD489 a, VectorSIMD489 b){
		VectorSIMD489 c;
	...
	inline VectorSIMD489 exp(VectorSIMD489 a){
		double a_d[489]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD489 sqrt(VectorSIMD489 a){
		double a_d[489]; a.convert(a_d);
