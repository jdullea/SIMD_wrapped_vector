...
public:
		...
		VectorSIMD426(double a){
			...
			_avx106=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD426(double (&a)[426]){
		...
		VectorSIMD426& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD426& operator += (VectorSIMD426 a){
	...
	inline VectorSIMD426 operator*(double a, VectorSIMD426 b){
		VectorSIMD426 c;
	...
	inline VectorSIMD426 operator*(VectorSIMD426 a ,double b){
		VectorSIMD426 c;
	...
	inline VectorSIMD426 operator*(int a, VectorSIMD426 b){
		if(a==1){return b;}
		VectorSIMD426 c;
	...
	inline VectorSIMD426 operator*(VectorSIMD426 a, int b){
		if(b==1){return a;}
		VectorSIMD426 c;
	...
	inline VectorSIMD426 operator*(VectorSIMD426 a, VectorSIMD426 b){
		VectorSIMD426 c;
	...
	inline VectorSIMD426 exp(VectorSIMD426 a){
		double a_d[426]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD426 sqrt(VectorSIMD426 a){
		double a_d[426]; a.convert(a_d);
