...
public:
		...
		VectorSIMD465(double a){
			...
			_avx116=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD465(double (&a)[465]){
		...
		VectorSIMD465& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD465& operator += (VectorSIMD465 a){
	...
	inline VectorSIMD465 operator*(double a, VectorSIMD465 b){
		VectorSIMD465 c;
	...
	inline VectorSIMD465 operator*(VectorSIMD465 a ,double b){
		VectorSIMD465 c;
	...
	inline VectorSIMD465 operator*(int a, VectorSIMD465 b){
		if(a==1){return b;}
		VectorSIMD465 c;
	...
	inline VectorSIMD465 operator*(VectorSIMD465 a, int b){
		if(b==1){return a;}
		VectorSIMD465 c;
	...
	inline VectorSIMD465 operator*(VectorSIMD465 a, VectorSIMD465 b){
		VectorSIMD465 c;
	...
	inline VectorSIMD465 exp(VectorSIMD465 a){
		double a_d[465]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD465 sqrt(VectorSIMD465 a){
		double a_d[465]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD465 a){ 
		double ad[465];
		a.convert(ad);
