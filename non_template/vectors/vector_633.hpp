...
public:
		...
		VectorSIMD633(double a){
			...
			_avx158=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD633(double (&a)[633]){
		...
		VectorSIMD633& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD633& operator += (VectorSIMD633 a){
	...
	inline VectorSIMD633 operator*(double a, VectorSIMD633 b){
		VectorSIMD633 c;
	...
	inline VectorSIMD633 operator*(VectorSIMD633 a ,double b){
		VectorSIMD633 c;
	...
	inline VectorSIMD633 operator*(int a, VectorSIMD633 b){
		if(a==1){return b;}
		VectorSIMD633 c;
	...
	inline VectorSIMD633 operator*(VectorSIMD633 a, int b){
		if(b==1){return a;}
		VectorSIMD633 c;
	...
	inline VectorSIMD633 operator*(VectorSIMD633 a, VectorSIMD633 b){
		VectorSIMD633 c;
	...
	inline VectorSIMD633 exp(VectorSIMD633 a){
		double a_d[633]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD633 sqrt(VectorSIMD633 a){
		double a_d[633]; a.convert(a_d);
