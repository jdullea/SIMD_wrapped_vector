...
public:
		...
		VectorSIMD984& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD984& operator += (VectorSIMD984 a){
	...
	inline VectorSIMD984 operator*(double a, VectorSIMD984 b){
		VectorSIMD984 c;
	...
	inline VectorSIMD984 operator*(VectorSIMD984 a ,double b){
		VectorSIMD984 c;
	...
	inline VectorSIMD984 operator*(int a, VectorSIMD984 b){
		if(a==1){return b;}
		VectorSIMD984 c;
	...
	inline VectorSIMD984 operator*(VectorSIMD984 a, int b){
		if(b==1){return a;}
		VectorSIMD984 c;
	...
	inline VectorSIMD984 operator*(VectorSIMD984 a, VectorSIMD984 b){
		VectorSIMD984 c;
	...
	inline VectorSIMD984 exp(VectorSIMD984 a){
		double a_d[984]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD984 sqrt(VectorSIMD984 a){
		double a_d[984]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD984 a){ 
		double ad[984];
		a.convert(ad);
