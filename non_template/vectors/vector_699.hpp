...
public:
		...
		VectorSIMD699(double a){
			...
			_avx174=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD699(double (&a)[699]){
		...
		VectorSIMD699& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD699& operator += (VectorSIMD699 a){
	...
	inline VectorSIMD699 operator*(double a, VectorSIMD699 b){
		VectorSIMD699 c;
	...
	inline VectorSIMD699 operator*(VectorSIMD699 a ,double b){
		VectorSIMD699 c;
	...
	inline VectorSIMD699 operator*(int a, VectorSIMD699 b){
		if(a==1){return b;}
		VectorSIMD699 c;
	...
	inline VectorSIMD699 operator*(VectorSIMD699 a, int b){
		if(b==1){return a;}
		VectorSIMD699 c;
	...
	inline VectorSIMD699 operator*(VectorSIMD699 a, VectorSIMD699 b){
		VectorSIMD699 c;
	...
	inline VectorSIMD699 exp(VectorSIMD699 a){
		double a_d[699]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD699 sqrt(VectorSIMD699 a){
		double a_d[699]; a.convert(a_d);
