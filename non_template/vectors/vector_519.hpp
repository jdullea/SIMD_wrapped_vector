...
public:
		...
		VectorSIMD519(double a){
			...
			_avx129=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD519(double (&a)[519]){
		...
		VectorSIMD519& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD519& operator += (VectorSIMD519 a){
	...
	inline VectorSIMD519 operator*(double a, VectorSIMD519 b){
		VectorSIMD519 c;
	...
	inline VectorSIMD519 operator*(VectorSIMD519 a ,double b){
		VectorSIMD519 c;
	...
	inline VectorSIMD519 operator*(int a, VectorSIMD519 b){
		if(a==1){return b;}
		VectorSIMD519 c;
	...
	inline VectorSIMD519 operator*(VectorSIMD519 a, int b){
		if(b==1){return a;}
		VectorSIMD519 c;
	...
	inline VectorSIMD519 operator*(VectorSIMD519 a, VectorSIMD519 b){
		VectorSIMD519 c;
	...
	inline VectorSIMD519 exp(VectorSIMD519 a){
		double a_d[519]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD519 sqrt(VectorSIMD519 a){
		double a_d[519]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD519 a){ 
		double ad[519];
		a.convert(ad);
