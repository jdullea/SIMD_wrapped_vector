...
public:
		...
		VectorSIMD239(double a){
			...
			_avx59=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD239(double (&a)[239]){
		...
		VectorSIMD239& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD239& operator += (VectorSIMD239 a){
	...
	inline VectorSIMD239 operator*(double a, VectorSIMD239 b){
		VectorSIMD239 c;
	...
	inline VectorSIMD239 operator*(VectorSIMD239 a ,double b){
		VectorSIMD239 c;
	...
	inline VectorSIMD239 operator*(int a, VectorSIMD239 b){
		if(a==1){return b;}
		VectorSIMD239 c;
	...
	inline VectorSIMD239 operator*(VectorSIMD239 a, int b){
		if(b==1){return a;}
		VectorSIMD239 c;
	...
	inline VectorSIMD239 operator*(VectorSIMD239 a, VectorSIMD239 b){
		VectorSIMD239 c;
	...
	inline VectorSIMD239 exp(VectorSIMD239 a){
		double a_d[239]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD239 sqrt(VectorSIMD239 a){
		double a_d[239]; a.convert(a_d);
