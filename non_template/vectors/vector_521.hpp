...
public:
		...
		VectorSIMD521(double a){
			...
			_avx130=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD521(double (&a)[521]){
		...
		VectorSIMD521& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD521& operator += (VectorSIMD521 a){
	...
	inline VectorSIMD521 operator*(double a, VectorSIMD521 b){
		VectorSIMD521 c;
	...
	inline VectorSIMD521 operator*(VectorSIMD521 a ,double b){
		VectorSIMD521 c;
	...
	inline VectorSIMD521 operator*(int a, VectorSIMD521 b){
		if(a==1){return b;}
		VectorSIMD521 c;
	...
	inline VectorSIMD521 operator*(VectorSIMD521 a, int b){
		if(b==1){return a;}
		VectorSIMD521 c;
	...
	inline VectorSIMD521 operator*(VectorSIMD521 a, VectorSIMD521 b){
		VectorSIMD521 c;
	...
	inline VectorSIMD521 exp(VectorSIMD521 a){
		double a_d[521]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD521 sqrt(VectorSIMD521 a){
		double a_d[521]; a.convert(a_d);
