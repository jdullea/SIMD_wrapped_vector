...
public:
		...
		VectorSIMD66(double a){
			...
			_avx16=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD66(double (&a)[66]){
		...
		VectorSIMD66(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17,double _18,double _19,double _20,double _21,double _22,double _23,double _24,double _25,double _26,double _27,double _28,double _29,double _30,double _31,double _32,double _33,double _34,double _35,double _36,double _37,double _38,double _39,double _40,double _41,double _42,double _43,double _44,double _45,double _46,double _47,double _48,double _49,double _50,double _51,double _52,double _53,double _54,double _55,double _56,double _57,double _58,double _59,double _60,double _61,double _62,double _63,double _64,double _65){
			...
			_avx16=_mm256_set_pd( 0,0,_65,_64);
		}

		VectorSIMD66(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13,__m256d _14,__m256d _15,__m256d _16){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD66& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD66& operator += (VectorSIMD66 a){
	...
	inline VectorSIMD66 operator*(double a, VectorSIMD66 b){
		VectorSIMD66 c;
	...
	inline VectorSIMD66 operator*(VectorSIMD66 a ,double b){
		VectorSIMD66 c;
	...
	inline VectorSIMD66 operator*(int a, VectorSIMD66 b){
		if(a==1){return b;}
		VectorSIMD66 c;
	...
	inline VectorSIMD66 operator*(VectorSIMD66 a, int b){
		if(b==1){return a;}
		VectorSIMD66 c;
	...
	inline VectorSIMD66 operator*(VectorSIMD66 a, VectorSIMD66 b){
		VectorSIMD66 c;
	...
	inline VectorSIMD66 exp(VectorSIMD66 a){
		double a_d[66]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD66 sqrt(VectorSIMD66 a){
		double a_d[66]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD66 a){ 
		double ad[66];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << ","  << ad[23] << ","  << ad[24] << ","  << ad[25] << ","  << ad[26] << ","  << ad[27] << ","  << ad[28] << ","  << ad[29] << ","  << ad[30] << ","  << ad[31] << ","  << ad[32] << ","  << ad[33] << ","  << ad[34] << ","  << ad[35] << ","  << ad[36] << ","  << ad[37] << ","  << ad[38] << ","  << ad[39] << ","  << ad[40] << ","  << ad[41] << ","  << ad[42] << ","  << ad[43] << ","  << ad[44] << ","  << ad[45] << ","  << ad[46] << ","  << ad[47] << ","  << ad[48] << ","  << ad[49] << ","  << ad[50] << ","  << ad[51] << ","  << ad[52] << ","  << ad[53] << ","  << ad[54] << ","  << ad[55] << ","  << ad[56] << ","  << ad[57] << ","  << ad[58] << ","  << ad[59] << ","  << ad[60] << ","  << ad[61] << ","  << ad[62] << ","  << ad[63] << ","  << ad[64] << ","  << ad[65] << "}";
		return os;
		}
