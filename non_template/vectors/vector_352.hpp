...
public:
		...
		VectorSIMD352& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD352& operator += (VectorSIMD352 a){
	...
	inline VectorSIMD352 operator*(double a, VectorSIMD352 b){
		VectorSIMD352 c;
	...
	inline VectorSIMD352 operator*(VectorSIMD352 a ,double b){
		VectorSIMD352 c;
	...
	inline VectorSIMD352 operator*(int a, VectorSIMD352 b){
		if(a==1){return b;}
		VectorSIMD352 c;
	...
	inline VectorSIMD352 operator*(VectorSIMD352 a, int b){
		if(b==1){return a;}
		VectorSIMD352 c;
	...
	inline VectorSIMD352 operator*(VectorSIMD352 a, VectorSIMD352 b){
		VectorSIMD352 c;
	...
	inline VectorSIMD352 exp(VectorSIMD352 a){
		double a_d[352]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD352 sqrt(VectorSIMD352 a){
		double a_d[352]; a.convert(a_d);
