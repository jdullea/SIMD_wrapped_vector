...
public:
		...
		VectorSIMD569(double a){
			...
			_avx142=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD569(double (&a)[569]){
		...
		VectorSIMD569& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD569& operator += (VectorSIMD569 a){
	...
	inline VectorSIMD569 operator*(double a, VectorSIMD569 b){
		VectorSIMD569 c;
	...
	inline VectorSIMD569 operator*(VectorSIMD569 a ,double b){
		VectorSIMD569 c;
	...
	inline VectorSIMD569 operator*(int a, VectorSIMD569 b){
		if(a==1){return b;}
		VectorSIMD569 c;
	...
	inline VectorSIMD569 operator*(VectorSIMD569 a, int b){
		if(b==1){return a;}
		VectorSIMD569 c;
	...
	inline VectorSIMD569 operator*(VectorSIMD569 a, VectorSIMD569 b){
		VectorSIMD569 c;
	...
	inline VectorSIMD569 exp(VectorSIMD569 a){
		double a_d[569]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD569 sqrt(VectorSIMD569 a){
		double a_d[569]; a.convert(a_d);
