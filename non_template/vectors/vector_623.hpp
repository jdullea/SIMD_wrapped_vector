...
public:
		...
		VectorSIMD623(double a){
			...
			_avx155=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD623(double (&a)[623]){
		...
		VectorSIMD623& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD623& operator += (VectorSIMD623 a){
	...
	inline VectorSIMD623 operator*(double a, VectorSIMD623 b){
		VectorSIMD623 c;
	...
	inline VectorSIMD623 operator*(VectorSIMD623 a ,double b){
		VectorSIMD623 c;
	...
	inline VectorSIMD623 operator*(int a, VectorSIMD623 b){
		if(a==1){return b;}
		VectorSIMD623 c;
	...
	inline VectorSIMD623 operator*(VectorSIMD623 a, int b){
		if(b==1){return a;}
		VectorSIMD623 c;
	...
	inline VectorSIMD623 operator*(VectorSIMD623 a, VectorSIMD623 b){
		VectorSIMD623 c;
	...
	inline VectorSIMD623 exp(VectorSIMD623 a){
		double a_d[623]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD623 sqrt(VectorSIMD623 a){
		double a_d[623]; a.convert(a_d);
