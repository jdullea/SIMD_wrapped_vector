...
public:
		...
		VectorSIMD877(double a){
			...
			_avx219=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD877(double (&a)[877]){
		...
		VectorSIMD877& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD877& operator += (VectorSIMD877 a){
	...
	inline VectorSIMD877 operator*(double a, VectorSIMD877 b){
		VectorSIMD877 c;
	...
	inline VectorSIMD877 operator*(VectorSIMD877 a ,double b){
		VectorSIMD877 c;
	...
	inline VectorSIMD877 operator*(int a, VectorSIMD877 b){
		if(a==1){return b;}
		VectorSIMD877 c;
	...
	inline VectorSIMD877 operator*(VectorSIMD877 a, int b){
		if(b==1){return a;}
		VectorSIMD877 c;
	...
	inline VectorSIMD877 operator*(VectorSIMD877 a, VectorSIMD877 b){
		VectorSIMD877 c;
	...
	inline VectorSIMD877 exp(VectorSIMD877 a){
		double a_d[877]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD877 sqrt(VectorSIMD877 a){
		double a_d[877]; a.convert(a_d);
