...
public:
		...
		VectorSIMD946(double a){
			...
			_avx236=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD946(double (&a)[946]){
		...
		VectorSIMD946& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD946& operator += (VectorSIMD946 a){
	...
	inline VectorSIMD946 operator*(double a, VectorSIMD946 b){
		VectorSIMD946 c;
	...
	inline VectorSIMD946 operator*(VectorSIMD946 a ,double b){
		VectorSIMD946 c;
	...
	inline VectorSIMD946 operator*(int a, VectorSIMD946 b){
		if(a==1){return b;}
		VectorSIMD946 c;
	...
	inline VectorSIMD946 operator*(VectorSIMD946 a, int b){
		if(b==1){return a;}
		VectorSIMD946 c;
	...
	inline VectorSIMD946 operator*(VectorSIMD946 a, VectorSIMD946 b){
		VectorSIMD946 c;
	...
	inline VectorSIMD946 exp(VectorSIMD946 a){
		double a_d[946]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD946 sqrt(VectorSIMD946 a){
		double a_d[946]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD946 a){ 
		double ad[946];
		a.convert(ad);
