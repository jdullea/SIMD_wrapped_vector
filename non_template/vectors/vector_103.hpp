...
public:
		...
		VectorSIMD103(double a){
			...
			_avx25=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD103(double (&a)[103]){
			...
			_avx25=_mm256_set_pd(0,a[102],a[101],a[100]);
		}
		...
		VectorSIMD103& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD103& operator += (VectorSIMD103 a){
	...
	inline VectorSIMD103 operator*(double a, VectorSIMD103 b){
		VectorSIMD103 c;
	...
	inline VectorSIMD103 operator*(VectorSIMD103 a ,double b){
		VectorSIMD103 c;
	...
	inline VectorSIMD103 operator*(int a, VectorSIMD103 b){
		if(a==1){return b;}
		VectorSIMD103 c;
	...
	inline VectorSIMD103 operator*(VectorSIMD103 a, int b){
		if(b==1){return a;}
		VectorSIMD103 c;
	...
	inline VectorSIMD103 operator*(VectorSIMD103 a, VectorSIMD103 b){
		VectorSIMD103 c;
	...
	inline VectorSIMD103 exp(VectorSIMD103 a){
		double a_d[103]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD103 sqrt(VectorSIMD103 a){
		double a_d[103]; a.convert(a_d);
