...
public:
		...
		VectorSIMD1012& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1012& operator += (VectorSIMD1012 a){
	...
	inline VectorSIMD1012 operator*(double a, VectorSIMD1012 b){
		VectorSIMD1012 c;
	...
	inline VectorSIMD1012 operator*(VectorSIMD1012 a ,double b){
		VectorSIMD1012 c;
	...
	inline VectorSIMD1012 operator*(int a, VectorSIMD1012 b){
		if(a==1){return b;}
		VectorSIMD1012 c;
	...
	inline VectorSIMD1012 operator*(VectorSIMD1012 a, int b){
		if(b==1){return a;}
		VectorSIMD1012 c;
	...
	inline VectorSIMD1012 operator*(VectorSIMD1012 a, VectorSIMD1012 b){
		VectorSIMD1012 c;
	...
	inline VectorSIMD1012 exp(VectorSIMD1012 a){
		double a_d[1012]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1012 r(a_d);
		return r;
	}

	inline VectorSIMD1012 sqrt(VectorSIMD1012 a){
		double a_d[1012]; a.convert(a_d);
