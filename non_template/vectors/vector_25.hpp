...
public:
		...
		VectorSIMD25(double a){
			...
			_avx6=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD25(double (&a)[25]){
			...
			_avx6=_mm256_set_pd(0,0,0,a[24]);
		}

		VectorSIMD25(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17,double _18,double _19,double _20,double _21,double _22,double _23,double _24){
			...
			_avx6=_mm256_set_pd( 0,0,0,_24);
		}

		VectorSIMD25(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD25& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD25& operator += (VectorSIMD25 a){
	...
	inline VectorSIMD25 operator*(double a, VectorSIMD25 b){
		VectorSIMD25 c;
	...
	inline VectorSIMD25 operator*(VectorSIMD25 a ,double b){
		VectorSIMD25 c;
	...
	inline VectorSIMD25 operator*(int a, VectorSIMD25 b){
		if(a==1){return b;}
		VectorSIMD25 c;
	...
	inline VectorSIMD25 operator*(VectorSIMD25 a, int b){
		if(b==1){return a;}
		VectorSIMD25 c;
	...
	inline VectorSIMD25 operator*(VectorSIMD25 a, VectorSIMD25 b){
		VectorSIMD25 c;
	...
	inline VectorSIMD25 exp(VectorSIMD25 a){
		double a_d[25]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD25 sqrt(VectorSIMD25 a){
		double a_d[25]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD25 a){ 
		double ad[25];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << ","  << ad[23] << ","  << ad[24] << "}";
		return os;
		}
