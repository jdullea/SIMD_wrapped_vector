...
public:
		...
		VectorSIMD579(double a){
			...
			_avx144=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD579(double (&a)[579]){
		...
		VectorSIMD579& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD579& operator += (VectorSIMD579 a){
	...
	inline VectorSIMD579 operator*(double a, VectorSIMD579 b){
		VectorSIMD579 c;
	...
	inline VectorSIMD579 operator*(VectorSIMD579 a ,double b){
		VectorSIMD579 c;
	...
	inline VectorSIMD579 operator*(int a, VectorSIMD579 b){
		if(a==1){return b;}
		VectorSIMD579 c;
	...
	inline VectorSIMD579 operator*(VectorSIMD579 a, int b){
		if(b==1){return a;}
		VectorSIMD579 c;
	...
	inline VectorSIMD579 operator*(VectorSIMD579 a, VectorSIMD579 b){
		VectorSIMD579 c;
	...
	inline VectorSIMD579 exp(VectorSIMD579 a){
		double a_d[579]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD579 sqrt(VectorSIMD579 a){
		double a_d[579]; a.convert(a_d);
