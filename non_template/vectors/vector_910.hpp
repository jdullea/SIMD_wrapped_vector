...
public:
		...
		VectorSIMD910(double a){
			...
			_avx227=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD910(double (&a)[910]){
		...
		VectorSIMD910& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD910& operator += (VectorSIMD910 a){
	...
	inline VectorSIMD910 operator*(double a, VectorSIMD910 b){
		VectorSIMD910 c;
	...
	inline VectorSIMD910 operator*(VectorSIMD910 a ,double b){
		VectorSIMD910 c;
	...
	inline VectorSIMD910 operator*(int a, VectorSIMD910 b){
		if(a==1){return b;}
		VectorSIMD910 c;
	...
	inline VectorSIMD910 operator*(VectorSIMD910 a, int b){
		if(b==1){return a;}
		VectorSIMD910 c;
	...
	inline VectorSIMD910 operator*(VectorSIMD910 a, VectorSIMD910 b){
		VectorSIMD910 c;
	...
	inline VectorSIMD910 exp(VectorSIMD910 a){
		double a_d[910]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD910 sqrt(VectorSIMD910 a){
		double a_d[910]; a.convert(a_d);
