...
public:
		...
		VectorSIMD507(double a){
			...
			_avx126=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD507(double (&a)[507]){
		...
		VectorSIMD507& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD507& operator += (VectorSIMD507 a){
	...
	inline VectorSIMD507 operator*(double a, VectorSIMD507 b){
		VectorSIMD507 c;
	...
	inline VectorSIMD507 operator*(VectorSIMD507 a ,double b){
		VectorSIMD507 c;
	...
	inline VectorSIMD507 operator*(int a, VectorSIMD507 b){
		if(a==1){return b;}
		VectorSIMD507 c;
	...
	inline VectorSIMD507 operator*(VectorSIMD507 a, int b){
		if(b==1){return a;}
		VectorSIMD507 c;
	...
	inline VectorSIMD507 operator*(VectorSIMD507 a, VectorSIMD507 b){
		VectorSIMD507 c;
	...
	inline VectorSIMD507 exp(VectorSIMD507 a){
		double a_d[507]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD507 sqrt(VectorSIMD507 a){
		double a_d[507]; a.convert(a_d);
