...
public:
		...
		VectorSIMD918(double a){
			...
			_avx229=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD918(double (&a)[918]){
		...
		VectorSIMD918& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD918& operator += (VectorSIMD918 a){
	...
	inline VectorSIMD918 operator*(double a, VectorSIMD918 b){
		VectorSIMD918 c;
	...
	inline VectorSIMD918 operator*(VectorSIMD918 a ,double b){
		VectorSIMD918 c;
	...
	inline VectorSIMD918 operator*(int a, VectorSIMD918 b){
		if(a==1){return b;}
		VectorSIMD918 c;
	...
	inline VectorSIMD918 operator*(VectorSIMD918 a, int b){
		if(b==1){return a;}
		VectorSIMD918 c;
	...
	inline VectorSIMD918 operator*(VectorSIMD918 a, VectorSIMD918 b){
		VectorSIMD918 c;
	...
	inline VectorSIMD918 exp(VectorSIMD918 a){
		double a_d[918]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD918 sqrt(VectorSIMD918 a){
		double a_d[918]; a.convert(a_d);
