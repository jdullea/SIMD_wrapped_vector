...
public:
		...
		VectorSIMD664& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD664& operator += (VectorSIMD664 a){
	...
	inline VectorSIMD664 operator*(double a, VectorSIMD664 b){
		VectorSIMD664 c;
	...
	inline VectorSIMD664 operator*(VectorSIMD664 a ,double b){
		VectorSIMD664 c;
	...
	inline VectorSIMD664 operator*(int a, VectorSIMD664 b){
		if(a==1){return b;}
		VectorSIMD664 c;
	...
	inline VectorSIMD664 operator*(VectorSIMD664 a, int b){
		if(b==1){return a;}
		VectorSIMD664 c;
	...
	inline VectorSIMD664 operator*(VectorSIMD664 a, VectorSIMD664 b){
		VectorSIMD664 c;
	...
	inline VectorSIMD664 exp(VectorSIMD664 a){
		double a_d[664]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD664 sqrt(VectorSIMD664 a){
		double a_d[664]; a.convert(a_d);
