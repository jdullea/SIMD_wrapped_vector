...
public:
		...
		VectorSIMD867(double a){
			...
			_avx216=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD867(double (&a)[867]){
		...
		VectorSIMD867& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD867& operator += (VectorSIMD867 a){
	...
	inline VectorSIMD867 operator*(double a, VectorSIMD867 b){
		VectorSIMD867 c;
	...
	inline VectorSIMD867 operator*(VectorSIMD867 a ,double b){
		VectorSIMD867 c;
	...
	inline VectorSIMD867 operator*(int a, VectorSIMD867 b){
		if(a==1){return b;}
		VectorSIMD867 c;
	...
	inline VectorSIMD867 operator*(VectorSIMD867 a, int b){
		if(b==1){return a;}
		VectorSIMD867 c;
	...
	inline VectorSIMD867 operator*(VectorSIMD867 a, VectorSIMD867 b){
		VectorSIMD867 c;
	...
	inline VectorSIMD867 exp(VectorSIMD867 a){
		double a_d[867]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD867 sqrt(VectorSIMD867 a){
		double a_d[867]; a.convert(a_d);
