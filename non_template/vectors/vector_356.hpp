...
public:
		...
		VectorSIMD356& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD356& operator += (VectorSIMD356 a){
	...
	inline VectorSIMD356 operator*(double a, VectorSIMD356 b){
		VectorSIMD356 c;
	...
	inline VectorSIMD356 operator*(VectorSIMD356 a ,double b){
		VectorSIMD356 c;
	...
	inline VectorSIMD356 operator*(int a, VectorSIMD356 b){
		if(a==1){return b;}
		VectorSIMD356 c;
	...
	inline VectorSIMD356 operator*(VectorSIMD356 a, int b){
		if(b==1){return a;}
		VectorSIMD356 c;
	...
	inline VectorSIMD356 operator*(VectorSIMD356 a, VectorSIMD356 b){
		VectorSIMD356 c;
	...
	inline VectorSIMD356 exp(VectorSIMD356 a){
		double a_d[356]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD356 sqrt(VectorSIMD356 a){
		double a_d[356]; a.convert(a_d);
