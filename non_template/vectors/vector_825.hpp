...
public:
		...
		VectorSIMD825(double a){
			...
			_avx206=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD825(double (&a)[825]){
		...
		VectorSIMD825& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD825& operator += (VectorSIMD825 a){
	...
	inline VectorSIMD825 operator*(double a, VectorSIMD825 b){
		VectorSIMD825 c;
	...
	inline VectorSIMD825 operator*(VectorSIMD825 a ,double b){
		VectorSIMD825 c;
	...
	inline VectorSIMD825 operator*(int a, VectorSIMD825 b){
		if(a==1){return b;}
		VectorSIMD825 c;
	...
	inline VectorSIMD825 operator*(VectorSIMD825 a, int b){
		if(b==1){return a;}
		VectorSIMD825 c;
	...
	inline VectorSIMD825 operator*(VectorSIMD825 a, VectorSIMD825 b){
		VectorSIMD825 c;
	...
	inline VectorSIMD825 exp(VectorSIMD825 a){
		double a_d[825]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD825 sqrt(VectorSIMD825 a){
		double a_d[825]; a.convert(a_d);
