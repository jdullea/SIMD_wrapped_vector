...
public:
		...
		VectorSIMD778(double a){
			...
			_avx194=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD778(double (&a)[778]){
		...
		VectorSIMD778& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD778& operator += (VectorSIMD778 a){
	...
	inline VectorSIMD778 operator*(double a, VectorSIMD778 b){
		VectorSIMD778 c;
	...
	inline VectorSIMD778 operator*(VectorSIMD778 a ,double b){
		VectorSIMD778 c;
	...
	inline VectorSIMD778 operator*(int a, VectorSIMD778 b){
		if(a==1){return b;}
		VectorSIMD778 c;
	...
	inline VectorSIMD778 operator*(VectorSIMD778 a, int b){
		if(b==1){return a;}
		VectorSIMD778 c;
	...
	inline VectorSIMD778 operator*(VectorSIMD778 a, VectorSIMD778 b){
		VectorSIMD778 c;
	...
	inline VectorSIMD778 exp(VectorSIMD778 a){
		double a_d[778]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD778 sqrt(VectorSIMD778 a){
		double a_d[778]; a.convert(a_d);
