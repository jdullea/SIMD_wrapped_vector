...
public:
		...
		VectorSIMD873(double a){
			...
			_avx218=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD873(double (&a)[873]){
		...
		VectorSIMD873& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD873& operator += (VectorSIMD873 a){
	...
	inline VectorSIMD873 operator*(double a, VectorSIMD873 b){
		VectorSIMD873 c;
	...
	inline VectorSIMD873 operator*(VectorSIMD873 a ,double b){
		VectorSIMD873 c;
	...
	inline VectorSIMD873 operator*(int a, VectorSIMD873 b){
		if(a==1){return b;}
		VectorSIMD873 c;
	...
	inline VectorSIMD873 operator*(VectorSIMD873 a, int b){
		if(b==1){return a;}
		VectorSIMD873 c;
	...
	inline VectorSIMD873 operator*(VectorSIMD873 a, VectorSIMD873 b){
		VectorSIMD873 c;
	...
	inline VectorSIMD873 exp(VectorSIMD873 a){
		double a_d[873]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD873 sqrt(VectorSIMD873 a){
		double a_d[873]; a.convert(a_d);
