...
public:
		...
		VectorSIMD1023(double a){
			...
			_avx255=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD1023(double (&a)[1023]){
		...
		VectorSIMD1023& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1023& operator += (VectorSIMD1023 a){
	...
	inline VectorSIMD1023 operator*(double a, VectorSIMD1023 b){
		VectorSIMD1023 c;
	...
	inline VectorSIMD1023 operator*(VectorSIMD1023 a ,double b){
		VectorSIMD1023 c;
	...
	inline VectorSIMD1023 operator*(int a, VectorSIMD1023 b){
		if(a==1){return b;}
		VectorSIMD1023 c;
	...
	inline VectorSIMD1023 operator*(VectorSIMD1023 a, int b){
		if(b==1){return a;}
		VectorSIMD1023 c;
	...
	inline VectorSIMD1023 operator*(VectorSIMD1023 a, VectorSIMD1023 b){
		VectorSIMD1023 c;
	...
	inline VectorSIMD1023 exp(VectorSIMD1023 a){
		double a_d[1023]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1023 r(a_d);
		return r;
	}

	inline VectorSIMD1023 sqrt(VectorSIMD1023 a){
		double a_d[1023]; a.convert(a_d);
