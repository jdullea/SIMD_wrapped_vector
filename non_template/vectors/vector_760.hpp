...
public:
		...
		VectorSIMD760& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD760& operator += (VectorSIMD760 a){
	...
	inline VectorSIMD760 operator*(double a, VectorSIMD760 b){
		VectorSIMD760 c;
	...
	inline VectorSIMD760 operator*(VectorSIMD760 a ,double b){
		VectorSIMD760 c;
	...
	inline VectorSIMD760 operator*(int a, VectorSIMD760 b){
		if(a==1){return b;}
		VectorSIMD760 c;
	...
	inline VectorSIMD760 operator*(VectorSIMD760 a, int b){
		if(b==1){return a;}
		VectorSIMD760 c;
	...
	inline VectorSIMD760 operator*(VectorSIMD760 a, VectorSIMD760 b){
		VectorSIMD760 c;
	...
	inline VectorSIMD760 exp(VectorSIMD760 a){
		double a_d[760]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD760 sqrt(VectorSIMD760 a){
		double a_d[760]; a.convert(a_d);
