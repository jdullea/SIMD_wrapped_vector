...
public:
		...
		VectorSIMD354(double a){
			...
			_avx88=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD354(double (&a)[354]){
		...
		VectorSIMD354& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD354& operator += (VectorSIMD354 a){
	...
	inline VectorSIMD354 operator*(double a, VectorSIMD354 b){
		VectorSIMD354 c;
	...
	inline VectorSIMD354 operator*(VectorSIMD354 a ,double b){
		VectorSIMD354 c;
	...
	inline VectorSIMD354 operator*(int a, VectorSIMD354 b){
		if(a==1){return b;}
		VectorSIMD354 c;
	...
	inline VectorSIMD354 operator*(VectorSIMD354 a, int b){
		if(b==1){return a;}
		VectorSIMD354 c;
	...
	inline VectorSIMD354 operator*(VectorSIMD354 a, VectorSIMD354 b){
		VectorSIMD354 c;
	...
	inline VectorSIMD354 exp(VectorSIMD354 a){
		double a_d[354]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD354 sqrt(VectorSIMD354 a){
		double a_d[354]; a.convert(a_d);
