...
public:
		...
		VectorSIMD333(double a){
			...
			_avx83=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD333(double (&a)[333]){
		...
		VectorSIMD333& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD333& operator += (VectorSIMD333 a){
	...
	inline VectorSIMD333 operator*(double a, VectorSIMD333 b){
		VectorSIMD333 c;
	...
	inline VectorSIMD333 operator*(VectorSIMD333 a ,double b){
		VectorSIMD333 c;
	...
	inline VectorSIMD333 operator*(int a, VectorSIMD333 b){
		if(a==1){return b;}
		VectorSIMD333 c;
	...
	inline VectorSIMD333 operator*(VectorSIMD333 a, int b){
		if(b==1){return a;}
		VectorSIMD333 c;
	...
	inline VectorSIMD333 operator*(VectorSIMD333 a, VectorSIMD333 b){
		VectorSIMD333 c;
	...
	inline VectorSIMD333 exp(VectorSIMD333 a){
		double a_d[333]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD333 sqrt(VectorSIMD333 a){
		double a_d[333]; a.convert(a_d);
