...
public:
		...
		VectorSIMD737(double a){
			...
			_avx184=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD737(double (&a)[737]){
		...
		VectorSIMD737& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD737& operator += (VectorSIMD737 a){
	...
	inline VectorSIMD737 operator*(double a, VectorSIMD737 b){
		VectorSIMD737 c;
	...
	inline VectorSIMD737 operator*(VectorSIMD737 a ,double b){
		VectorSIMD737 c;
	...
	inline VectorSIMD737 operator*(int a, VectorSIMD737 b){
		if(a==1){return b;}
		VectorSIMD737 c;
	...
	inline VectorSIMD737 operator*(VectorSIMD737 a, int b){
		if(b==1){return a;}
		VectorSIMD737 c;
	...
	inline VectorSIMD737 operator*(VectorSIMD737 a, VectorSIMD737 b){
		VectorSIMD737 c;
	...
	inline VectorSIMD737 exp(VectorSIMD737 a){
		double a_d[737]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD737 sqrt(VectorSIMD737 a){
		double a_d[737]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD737 a){ 
		double ad[737];
		a.convert(ad);
