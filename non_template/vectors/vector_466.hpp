...
public:
		...
		VectorSIMD466(double a){
			...
			_avx116=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD466(double (&a)[466]){
		...
		VectorSIMD466& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD466& operator += (VectorSIMD466 a){
	...
	inline VectorSIMD466 operator*(double a, VectorSIMD466 b){
		VectorSIMD466 c;
	...
	inline VectorSIMD466 operator*(VectorSIMD466 a ,double b){
		VectorSIMD466 c;
	...
	inline VectorSIMD466 operator*(int a, VectorSIMD466 b){
		if(a==1){return b;}
		VectorSIMD466 c;
	...
	inline VectorSIMD466 operator*(VectorSIMD466 a, int b){
		if(b==1){return a;}
		VectorSIMD466 c;
	...
	inline VectorSIMD466 operator*(VectorSIMD466 a, VectorSIMD466 b){
		VectorSIMD466 c;
	...
	inline VectorSIMD466 exp(VectorSIMD466 a){
		double a_d[466]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD466 sqrt(VectorSIMD466 a){
		double a_d[466]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD466 a){ 
		double ad[466];
		a.convert(ad);
