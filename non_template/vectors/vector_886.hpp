...
public:
		...
		VectorSIMD886(double a){
			...
			_avx221=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD886(double (&a)[886]){
		...
		VectorSIMD886& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD886& operator += (VectorSIMD886 a){
	...
	inline VectorSIMD886 operator*(double a, VectorSIMD886 b){
		VectorSIMD886 c;
	...
	inline VectorSIMD886 operator*(VectorSIMD886 a ,double b){
		VectorSIMD886 c;
	...
	inline VectorSIMD886 operator*(int a, VectorSIMD886 b){
		if(a==1){return b;}
		VectorSIMD886 c;
	...
	inline VectorSIMD886 operator*(VectorSIMD886 a, int b){
		if(b==1){return a;}
		VectorSIMD886 c;
	...
	inline VectorSIMD886 operator*(VectorSIMD886 a, VectorSIMD886 b){
		VectorSIMD886 c;
	...
	inline VectorSIMD886 exp(VectorSIMD886 a){
		double a_d[886]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD886 sqrt(VectorSIMD886 a){
		double a_d[886]; a.convert(a_d);
