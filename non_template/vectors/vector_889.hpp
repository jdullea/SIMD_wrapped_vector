...
public:
		...
		VectorSIMD889(double a){
			...
			_avx222=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD889(double (&a)[889]){
		...
		VectorSIMD889& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD889& operator += (VectorSIMD889 a){
	...
	inline VectorSIMD889 operator*(double a, VectorSIMD889 b){
		VectorSIMD889 c;
	...
	inline VectorSIMD889 operator*(VectorSIMD889 a ,double b){
		VectorSIMD889 c;
	...
	inline VectorSIMD889 operator*(int a, VectorSIMD889 b){
		if(a==1){return b;}
		VectorSIMD889 c;
	...
	inline VectorSIMD889 operator*(VectorSIMD889 a, int b){
		if(b==1){return a;}
		VectorSIMD889 c;
	...
	inline VectorSIMD889 operator*(VectorSIMD889 a, VectorSIMD889 b){
		VectorSIMD889 c;
	...
	inline VectorSIMD889 exp(VectorSIMD889 a){
		double a_d[889]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD889 sqrt(VectorSIMD889 a){
		double a_d[889]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD889 a){ 
		double ad[889];
		a.convert(ad);
