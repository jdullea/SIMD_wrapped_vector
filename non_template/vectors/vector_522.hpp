...
public:
		...
		VectorSIMD522(double a){
			...
			_avx130=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD522(double (&a)[522]){
		...
		VectorSIMD522& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD522& operator += (VectorSIMD522 a){
	...
	inline VectorSIMD522 operator*(double a, VectorSIMD522 b){
		VectorSIMD522 c;
	...
	inline VectorSIMD522 operator*(VectorSIMD522 a ,double b){
		VectorSIMD522 c;
	...
	inline VectorSIMD522 operator*(int a, VectorSIMD522 b){
		if(a==1){return b;}
		VectorSIMD522 c;
	...
	inline VectorSIMD522 operator*(VectorSIMD522 a, int b){
		if(b==1){return a;}
		VectorSIMD522 c;
	...
	inline VectorSIMD522 operator*(VectorSIMD522 a, VectorSIMD522 b){
		VectorSIMD522 c;
	...
	inline VectorSIMD522 exp(VectorSIMD522 a){
		double a_d[522]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD522 sqrt(VectorSIMD522 a){
		double a_d[522]; a.convert(a_d);
