...
public:
		...
		VectorSIMD349(double a){
			...
			_avx87=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD349(double (&a)[349]){
		...
		VectorSIMD349& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD349& operator += (VectorSIMD349 a){
	...
	inline VectorSIMD349 operator*(double a, VectorSIMD349 b){
		VectorSIMD349 c;
	...
	inline VectorSIMD349 operator*(VectorSIMD349 a ,double b){
		VectorSIMD349 c;
	...
	inline VectorSIMD349 operator*(int a, VectorSIMD349 b){
		if(a==1){return b;}
		VectorSIMD349 c;
	...
	inline VectorSIMD349 operator*(VectorSIMD349 a, int b){
		if(b==1){return a;}
		VectorSIMD349 c;
	...
	inline VectorSIMD349 operator*(VectorSIMD349 a, VectorSIMD349 b){
		VectorSIMD349 c;
	...
	inline VectorSIMD349 exp(VectorSIMD349 a){
		double a_d[349]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD349 sqrt(VectorSIMD349 a){
		double a_d[349]; a.convert(a_d);
