...
public:
		...
		VectorSIMD943(double a){
			...
			_avx235=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD943(double (&a)[943]){
		...
		VectorSIMD943& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD943& operator += (VectorSIMD943 a){
	...
	inline VectorSIMD943 operator*(double a, VectorSIMD943 b){
		VectorSIMD943 c;
	...
	inline VectorSIMD943 operator*(VectorSIMD943 a ,double b){
		VectorSIMD943 c;
	...
	inline VectorSIMD943 operator*(int a, VectorSIMD943 b){
		if(a==1){return b;}
		VectorSIMD943 c;
	...
	inline VectorSIMD943 operator*(VectorSIMD943 a, int b){
		if(b==1){return a;}
		VectorSIMD943 c;
	...
	inline VectorSIMD943 operator*(VectorSIMD943 a, VectorSIMD943 b){
		VectorSIMD943 c;
	...
	inline VectorSIMD943 exp(VectorSIMD943 a){
		double a_d[943]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD943 sqrt(VectorSIMD943 a){
		double a_d[943]; a.convert(a_d);
