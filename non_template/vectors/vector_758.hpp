...
public:
		...
		VectorSIMD758(double a){
			...
			_avx189=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD758(double (&a)[758]){
		...
		VectorSIMD758& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD758& operator += (VectorSIMD758 a){
	...
	inline VectorSIMD758 operator*(double a, VectorSIMD758 b){
		VectorSIMD758 c;
	...
	inline VectorSIMD758 operator*(VectorSIMD758 a ,double b){
		VectorSIMD758 c;
	...
	inline VectorSIMD758 operator*(int a, VectorSIMD758 b){
		if(a==1){return b;}
		VectorSIMD758 c;
	...
	inline VectorSIMD758 operator*(VectorSIMD758 a, int b){
		if(b==1){return a;}
		VectorSIMD758 c;
	...
	inline VectorSIMD758 operator*(VectorSIMD758 a, VectorSIMD758 b){
		VectorSIMD758 c;
	...
	inline VectorSIMD758 exp(VectorSIMD758 a){
		double a_d[758]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD758 sqrt(VectorSIMD758 a){
		double a_d[758]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD758 a){ 
		double ad[758];
		a.convert(ad);
