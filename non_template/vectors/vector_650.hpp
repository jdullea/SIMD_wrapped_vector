...
public:
		...
		VectorSIMD650(double a){
			...
			_avx162=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD650(double (&a)[650]){
		...
		VectorSIMD650& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD650& operator += (VectorSIMD650 a){
	...
	inline VectorSIMD650 operator*(double a, VectorSIMD650 b){
		VectorSIMD650 c;
	...
	inline VectorSIMD650 operator*(VectorSIMD650 a ,double b){
		VectorSIMD650 c;
	...
	inline VectorSIMD650 operator*(int a, VectorSIMD650 b){
		if(a==1){return b;}
		VectorSIMD650 c;
	...
	inline VectorSIMD650 operator*(VectorSIMD650 a, int b){
		if(b==1){return a;}
		VectorSIMD650 c;
	...
	inline VectorSIMD650 operator*(VectorSIMD650 a, VectorSIMD650 b){
		VectorSIMD650 c;
	...
	inline VectorSIMD650 exp(VectorSIMD650 a){
		double a_d[650]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD650 sqrt(VectorSIMD650 a){
		double a_d[650]; a.convert(a_d);
