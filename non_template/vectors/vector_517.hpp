...
public:
		...
		VectorSIMD517(double a){
			...
			_avx129=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD517(double (&a)[517]){
		...
		VectorSIMD517& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD517& operator += (VectorSIMD517 a){
	...
	inline VectorSIMD517 operator*(double a, VectorSIMD517 b){
		VectorSIMD517 c;
	...
	inline VectorSIMD517 operator*(VectorSIMD517 a ,double b){
		VectorSIMD517 c;
	...
	inline VectorSIMD517 operator*(int a, VectorSIMD517 b){
		if(a==1){return b;}
		VectorSIMD517 c;
	...
	inline VectorSIMD517 operator*(VectorSIMD517 a, int b){
		if(b==1){return a;}
		VectorSIMD517 c;
	...
	inline VectorSIMD517 operator*(VectorSIMD517 a, VectorSIMD517 b){
		VectorSIMD517 c;
	...
	inline VectorSIMD517 exp(VectorSIMD517 a){
		double a_d[517]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD517 sqrt(VectorSIMD517 a){
		double a_d[517]; a.convert(a_d);
