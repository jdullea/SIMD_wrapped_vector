...
public:
		...
		VectorSIMD313(double a){
			...
			_avx78=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD313(double (&a)[313]){
		...
		VectorSIMD313& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD313& operator += (VectorSIMD313 a){
	...
	inline VectorSIMD313 operator*(double a, VectorSIMD313 b){
		VectorSIMD313 c;
	...
	inline VectorSIMD313 operator*(VectorSIMD313 a ,double b){
		VectorSIMD313 c;
	...
	inline VectorSIMD313 operator*(int a, VectorSIMD313 b){
		if(a==1){return b;}
		VectorSIMD313 c;
	...
	inline VectorSIMD313 operator*(VectorSIMD313 a, int b){
		if(b==1){return a;}
		VectorSIMD313 c;
	...
	inline VectorSIMD313 operator*(VectorSIMD313 a, VectorSIMD313 b){
		VectorSIMD313 c;
	...
	inline VectorSIMD313 exp(VectorSIMD313 a){
		double a_d[313]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD313 sqrt(VectorSIMD313 a){
		double a_d[313]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD313 a){ 
		double ad[313];
		a.convert(ad);
