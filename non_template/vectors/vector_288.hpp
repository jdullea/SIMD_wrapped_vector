...
public:
		...
		VectorSIMD288& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD288& operator += (VectorSIMD288 a){
	...
	inline VectorSIMD288 operator*(double a, VectorSIMD288 b){
		VectorSIMD288 c;
	...
	inline VectorSIMD288 operator*(VectorSIMD288 a ,double b){
		VectorSIMD288 c;
	...
	inline VectorSIMD288 operator*(int a, VectorSIMD288 b){
		if(a==1){return b;}
		VectorSIMD288 c;
	...
	inline VectorSIMD288 operator*(VectorSIMD288 a, int b){
		if(b==1){return a;}
		VectorSIMD288 c;
	...
	inline VectorSIMD288 operator*(VectorSIMD288 a, VectorSIMD288 b){
		VectorSIMD288 c;
	...
	inline VectorSIMD288 exp(VectorSIMD288 a){
		double a_d[288]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD288 sqrt(VectorSIMD288 a){
		double a_d[288]; a.convert(a_d);
