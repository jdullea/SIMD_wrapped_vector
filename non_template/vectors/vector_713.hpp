...
public:
		...
		VectorSIMD713(double a){
			...
			_avx178=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD713(double (&a)[713]){
		...
		VectorSIMD713& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD713& operator += (VectorSIMD713 a){
	...
	inline VectorSIMD713 operator*(double a, VectorSIMD713 b){
		VectorSIMD713 c;
	...
	inline VectorSIMD713 operator*(VectorSIMD713 a ,double b){
		VectorSIMD713 c;
	...
	inline VectorSIMD713 operator*(int a, VectorSIMD713 b){
		if(a==1){return b;}
		VectorSIMD713 c;
	...
	inline VectorSIMD713 operator*(VectorSIMD713 a, int b){
		if(b==1){return a;}
		VectorSIMD713 c;
	...
	inline VectorSIMD713 operator*(VectorSIMD713 a, VectorSIMD713 b){
		VectorSIMD713 c;
	...
	inline VectorSIMD713 exp(VectorSIMD713 a){
		double a_d[713]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD713 sqrt(VectorSIMD713 a){
		double a_d[713]; a.convert(a_d);
