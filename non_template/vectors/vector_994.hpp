...
public:
		...
		VectorSIMD994(double a){
			...
			_avx248=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD994(double (&a)[994]){
		...
		VectorSIMD994& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD994& operator += (VectorSIMD994 a){
	...
	inline VectorSIMD994 operator*(double a, VectorSIMD994 b){
		VectorSIMD994 c;
	...
	inline VectorSIMD994 operator*(VectorSIMD994 a ,double b){
		VectorSIMD994 c;
	...
	inline VectorSIMD994 operator*(int a, VectorSIMD994 b){
		if(a==1){return b;}
		VectorSIMD994 c;
	...
	inline VectorSIMD994 operator*(VectorSIMD994 a, int b){
		if(b==1){return a;}
		VectorSIMD994 c;
	...
	inline VectorSIMD994 operator*(VectorSIMD994 a, VectorSIMD994 b){
		VectorSIMD994 c;
	...
	inline VectorSIMD994 exp(VectorSIMD994 a){
		double a_d[994]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD994 sqrt(VectorSIMD994 a){
		double a_d[994]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD994 a){ 
		double ad[994];
		a.convert(ad);
