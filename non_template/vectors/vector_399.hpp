...
public:
		...
		VectorSIMD399(double a){
			...
			_avx99=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD399(double (&a)[399]){
		...
		VectorSIMD399& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD399& operator += (VectorSIMD399 a){
	...
	inline VectorSIMD399 operator*(double a, VectorSIMD399 b){
		VectorSIMD399 c;
	...
	inline VectorSIMD399 operator*(VectorSIMD399 a ,double b){
		VectorSIMD399 c;
	...
	inline VectorSIMD399 operator*(int a, VectorSIMD399 b){
		if(a==1){return b;}
		VectorSIMD399 c;
	...
	inline VectorSIMD399 operator*(VectorSIMD399 a, int b){
		if(b==1){return a;}
		VectorSIMD399 c;
	...
	inline VectorSIMD399 operator*(VectorSIMD399 a, VectorSIMD399 b){
		VectorSIMD399 c;
	...
	inline VectorSIMD399 exp(VectorSIMD399 a){
		double a_d[399]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD399 sqrt(VectorSIMD399 a){
		double a_d[399]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD399 a){ 
		double ad[399];
		a.convert(ad);
