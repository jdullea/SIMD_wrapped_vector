...
public:
		...
		VectorSIMD908& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD908& operator += (VectorSIMD908 a){
	...
	inline VectorSIMD908 operator*(double a, VectorSIMD908 b){
		VectorSIMD908 c;
	...
	inline VectorSIMD908 operator*(VectorSIMD908 a ,double b){
		VectorSIMD908 c;
	...
	inline VectorSIMD908 operator*(int a, VectorSIMD908 b){
		if(a==1){return b;}
		VectorSIMD908 c;
	...
	inline VectorSIMD908 operator*(VectorSIMD908 a, int b){
		if(b==1){return a;}
		VectorSIMD908 c;
	...
	inline VectorSIMD908 operator*(VectorSIMD908 a, VectorSIMD908 b){
		VectorSIMD908 c;
	...
	inline VectorSIMD908 exp(VectorSIMD908 a){
		double a_d[908]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD908 sqrt(VectorSIMD908 a){
		double a_d[908]; a.convert(a_d);
