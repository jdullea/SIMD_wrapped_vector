...
public:
		...
		VectorSIMD654(double a){
			...
			_avx163=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD654(double (&a)[654]){
		...
		VectorSIMD654& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD654& operator += (VectorSIMD654 a){
	...
	inline VectorSIMD654 operator*(double a, VectorSIMD654 b){
		VectorSIMD654 c;
	...
	inline VectorSIMD654 operator*(VectorSIMD654 a ,double b){
		VectorSIMD654 c;
	...
	inline VectorSIMD654 operator*(int a, VectorSIMD654 b){
		if(a==1){return b;}
		VectorSIMD654 c;
	...
	inline VectorSIMD654 operator*(VectorSIMD654 a, int b){
		if(b==1){return a;}
		VectorSIMD654 c;
	...
	inline VectorSIMD654 operator*(VectorSIMD654 a, VectorSIMD654 b){
		VectorSIMD654 c;
	...
	inline VectorSIMD654 exp(VectorSIMD654 a){
		double a_d[654]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD654 sqrt(VectorSIMD654 a){
		double a_d[654]; a.convert(a_d);
