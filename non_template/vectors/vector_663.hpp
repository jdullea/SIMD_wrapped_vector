...
public:
		...
		VectorSIMD663(double a){
			...
			_avx165=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD663(double (&a)[663]){
		...
		VectorSIMD663& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD663& operator += (VectorSIMD663 a){
	...
	inline VectorSIMD663 operator*(double a, VectorSIMD663 b){
		VectorSIMD663 c;
	...
	inline VectorSIMD663 operator*(VectorSIMD663 a ,double b){
		VectorSIMD663 c;
	...
	inline VectorSIMD663 operator*(int a, VectorSIMD663 b){
		if(a==1){return b;}
		VectorSIMD663 c;
	...
	inline VectorSIMD663 operator*(VectorSIMD663 a, int b){
		if(b==1){return a;}
		VectorSIMD663 c;
	...
	inline VectorSIMD663 operator*(VectorSIMD663 a, VectorSIMD663 b){
		VectorSIMD663 c;
	...
	inline VectorSIMD663 exp(VectorSIMD663 a){
		double a_d[663]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD663 sqrt(VectorSIMD663 a){
		double a_d[663]; a.convert(a_d);
