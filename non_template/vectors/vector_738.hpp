...
public:
		...
		VectorSIMD738(double a){
			...
			_avx184=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD738(double (&a)[738]){
		...
		VectorSIMD738& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD738& operator += (VectorSIMD738 a){
	...
	inline VectorSIMD738 operator*(double a, VectorSIMD738 b){
		VectorSIMD738 c;
	...
	inline VectorSIMD738 operator*(VectorSIMD738 a ,double b){
		VectorSIMD738 c;
	...
	inline VectorSIMD738 operator*(int a, VectorSIMD738 b){
		if(a==1){return b;}
		VectorSIMD738 c;
	...
	inline VectorSIMD738 operator*(VectorSIMD738 a, int b){
		if(b==1){return a;}
		VectorSIMD738 c;
	...
	inline VectorSIMD738 operator*(VectorSIMD738 a, VectorSIMD738 b){
		VectorSIMD738 c;
	...
	inline VectorSIMD738 exp(VectorSIMD738 a){
		double a_d[738]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD738 sqrt(VectorSIMD738 a){
		double a_d[738]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD738 a){ 
		double ad[738];
		a.convert(ad);
