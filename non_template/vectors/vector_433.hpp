...
public:
		...
		VectorSIMD433(double a){
			...
			_avx108=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD433(double (&a)[433]){
		...
		VectorSIMD433& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD433& operator += (VectorSIMD433 a){
	...
	inline VectorSIMD433 operator*(double a, VectorSIMD433 b){
		VectorSIMD433 c;
	...
	inline VectorSIMD433 operator*(VectorSIMD433 a ,double b){
		VectorSIMD433 c;
	...
	inline VectorSIMD433 operator*(int a, VectorSIMD433 b){
		if(a==1){return b;}
		VectorSIMD433 c;
	...
	inline VectorSIMD433 operator*(VectorSIMD433 a, int b){
		if(b==1){return a;}
		VectorSIMD433 c;
	...
	inline VectorSIMD433 operator*(VectorSIMD433 a, VectorSIMD433 b){
		VectorSIMD433 c;
	...
	inline VectorSIMD433 exp(VectorSIMD433 a){
		double a_d[433]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD433 sqrt(VectorSIMD433 a){
		double a_d[433]; a.convert(a_d);
