...
public:
		...
		VectorSIMD451(double a){
			...
			_avx112=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD451(double (&a)[451]){
		...
		VectorSIMD451& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD451& operator += (VectorSIMD451 a){
	...
	inline VectorSIMD451 operator*(double a, VectorSIMD451 b){
		VectorSIMD451 c;
	...
	inline VectorSIMD451 operator*(VectorSIMD451 a ,double b){
		VectorSIMD451 c;
	...
	inline VectorSIMD451 operator*(int a, VectorSIMD451 b){
		if(a==1){return b;}
		VectorSIMD451 c;
	...
	inline VectorSIMD451 operator*(VectorSIMD451 a, int b){
		if(b==1){return a;}
		VectorSIMD451 c;
	...
	inline VectorSIMD451 operator*(VectorSIMD451 a, VectorSIMD451 b){
		VectorSIMD451 c;
	...
	inline VectorSIMD451 exp(VectorSIMD451 a){
		double a_d[451]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD451 sqrt(VectorSIMD451 a){
		double a_d[451]; a.convert(a_d);
