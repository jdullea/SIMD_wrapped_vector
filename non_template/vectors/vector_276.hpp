...
public:
		...
		VectorSIMD276& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD276& operator += (VectorSIMD276 a){
	...
	inline VectorSIMD276 operator*(double a, VectorSIMD276 b){
		VectorSIMD276 c;
	...
	inline VectorSIMD276 operator*(VectorSIMD276 a ,double b){
		VectorSIMD276 c;
	...
	inline VectorSIMD276 operator*(int a, VectorSIMD276 b){
		if(a==1){return b;}
		VectorSIMD276 c;
	...
	inline VectorSIMD276 operator*(VectorSIMD276 a, int b){
		if(b==1){return a;}
		VectorSIMD276 c;
	...
	inline VectorSIMD276 operator*(VectorSIMD276 a, VectorSIMD276 b){
		VectorSIMD276 c;
	...
	inline VectorSIMD276 exp(VectorSIMD276 a){
		double a_d[276]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD276 sqrt(VectorSIMD276 a){
		double a_d[276]; a.convert(a_d);
