...
public:
		...
		VectorSIMD828& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD828& operator += (VectorSIMD828 a){
	...
	inline VectorSIMD828 operator*(double a, VectorSIMD828 b){
		VectorSIMD828 c;
	...
	inline VectorSIMD828 operator*(VectorSIMD828 a ,double b){
		VectorSIMD828 c;
	...
	inline VectorSIMD828 operator*(int a, VectorSIMD828 b){
		if(a==1){return b;}
		VectorSIMD828 c;
	...
	inline VectorSIMD828 operator*(VectorSIMD828 a, int b){
		if(b==1){return a;}
		VectorSIMD828 c;
	...
	inline VectorSIMD828 operator*(VectorSIMD828 a, VectorSIMD828 b){
		VectorSIMD828 c;
	...
	inline VectorSIMD828 exp(VectorSIMD828 a){
		double a_d[828]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD828 sqrt(VectorSIMD828 a){
		double a_d[828]; a.convert(a_d);
