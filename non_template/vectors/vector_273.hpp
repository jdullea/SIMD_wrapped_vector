...
public:
		...
		VectorSIMD273(double a){
			...
			_avx68=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD273(double (&a)[273]){
		...
		VectorSIMD273& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD273& operator += (VectorSIMD273 a){
	...
	inline VectorSIMD273 operator*(double a, VectorSIMD273 b){
		VectorSIMD273 c;
	...
	inline VectorSIMD273 operator*(VectorSIMD273 a ,double b){
		VectorSIMD273 c;
	...
	inline VectorSIMD273 operator*(int a, VectorSIMD273 b){
		if(a==1){return b;}
		VectorSIMD273 c;
	...
	inline VectorSIMD273 operator*(VectorSIMD273 a, int b){
		if(b==1){return a;}
		VectorSIMD273 c;
	...
	inline VectorSIMD273 operator*(VectorSIMD273 a, VectorSIMD273 b){
		VectorSIMD273 c;
	...
	inline VectorSIMD273 exp(VectorSIMD273 a){
		double a_d[273]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD273 sqrt(VectorSIMD273 a){
		double a_d[273]; a.convert(a_d);
