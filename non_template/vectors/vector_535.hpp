...
public:
		...
		VectorSIMD535(double a){
			...
			_avx133=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD535(double (&a)[535]){
		...
		VectorSIMD535& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD535& operator += (VectorSIMD535 a){
	...
	inline VectorSIMD535 operator*(double a, VectorSIMD535 b){
		VectorSIMD535 c;
	...
	inline VectorSIMD535 operator*(VectorSIMD535 a ,double b){
		VectorSIMD535 c;
	...
	inline VectorSIMD535 operator*(int a, VectorSIMD535 b){
		if(a==1){return b;}
		VectorSIMD535 c;
	...
	inline VectorSIMD535 operator*(VectorSIMD535 a, int b){
		if(b==1){return a;}
		VectorSIMD535 c;
	...
	inline VectorSIMD535 operator*(VectorSIMD535 a, VectorSIMD535 b){
		VectorSIMD535 c;
	...
	inline VectorSIMD535 exp(VectorSIMD535 a){
		double a_d[535]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD535 sqrt(VectorSIMD535 a){
		double a_d[535]; a.convert(a_d);
