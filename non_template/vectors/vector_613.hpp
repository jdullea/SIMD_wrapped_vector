...
public:
		...
		VectorSIMD613(double a){
			...
			_avx153=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD613(double (&a)[613]){
		...
		VectorSIMD613& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD613& operator += (VectorSIMD613 a){
	...
	inline VectorSIMD613 operator*(double a, VectorSIMD613 b){
		VectorSIMD613 c;
	...
	inline VectorSIMD613 operator*(VectorSIMD613 a ,double b){
		VectorSIMD613 c;
	...
	inline VectorSIMD613 operator*(int a, VectorSIMD613 b){
		if(a==1){return b;}
		VectorSIMD613 c;
	...
	inline VectorSIMD613 operator*(VectorSIMD613 a, int b){
		if(b==1){return a;}
		VectorSIMD613 c;
	...
	inline VectorSIMD613 operator*(VectorSIMD613 a, VectorSIMD613 b){
		VectorSIMD613 c;
	...
	inline VectorSIMD613 exp(VectorSIMD613 a){
		double a_d[613]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD613 sqrt(VectorSIMD613 a){
		double a_d[613]; a.convert(a_d);
