...
public:
		...
		VectorSIMD616& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD616& operator += (VectorSIMD616 a){
	...
	inline VectorSIMD616 operator*(double a, VectorSIMD616 b){
		VectorSIMD616 c;
	...
	inline VectorSIMD616 operator*(VectorSIMD616 a ,double b){
		VectorSIMD616 c;
	...
	inline VectorSIMD616 operator*(int a, VectorSIMD616 b){
		if(a==1){return b;}
		VectorSIMD616 c;
	...
	inline VectorSIMD616 operator*(VectorSIMD616 a, int b){
		if(b==1){return a;}
		VectorSIMD616 c;
	...
	inline VectorSIMD616 operator*(VectorSIMD616 a, VectorSIMD616 b){
		VectorSIMD616 c;
	...
	inline VectorSIMD616 exp(VectorSIMD616 a){
		double a_d[616]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD616 sqrt(VectorSIMD616 a){
		double a_d[616]; a.convert(a_d);
