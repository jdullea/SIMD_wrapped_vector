...
public:
		...
		VectorSIMD291(double a){
			...
			_avx72=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD291(double (&a)[291]){
		...
		VectorSIMD291& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD291& operator += (VectorSIMD291 a){
	...
	inline VectorSIMD291 operator*(double a, VectorSIMD291 b){
		VectorSIMD291 c;
	...
	inline VectorSIMD291 operator*(VectorSIMD291 a ,double b){
		VectorSIMD291 c;
	...
	inline VectorSIMD291 operator*(int a, VectorSIMD291 b){
		if(a==1){return b;}
		VectorSIMD291 c;
	...
	inline VectorSIMD291 operator*(VectorSIMD291 a, int b){
		if(b==1){return a;}
		VectorSIMD291 c;
	...
	inline VectorSIMD291 operator*(VectorSIMD291 a, VectorSIMD291 b){
		VectorSIMD291 c;
	...
	inline VectorSIMD291 exp(VectorSIMD291 a){
		double a_d[291]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD291 sqrt(VectorSIMD291 a){
		double a_d[291]; a.convert(a_d);
