...
public:
		...
		VectorSIMD526(double a){
			...
			_avx131=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD526(double (&a)[526]){
		...
		VectorSIMD526& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD526& operator += (VectorSIMD526 a){
	...
	inline VectorSIMD526 operator*(double a, VectorSIMD526 b){
		VectorSIMD526 c;
	...
	inline VectorSIMD526 operator*(VectorSIMD526 a ,double b){
		VectorSIMD526 c;
	...
	inline VectorSIMD526 operator*(int a, VectorSIMD526 b){
		if(a==1){return b;}
		VectorSIMD526 c;
	...
	inline VectorSIMD526 operator*(VectorSIMD526 a, int b){
		if(b==1){return a;}
		VectorSIMD526 c;
	...
	inline VectorSIMD526 operator*(VectorSIMD526 a, VectorSIMD526 b){
		VectorSIMD526 c;
	...
	inline VectorSIMD526 exp(VectorSIMD526 a){
		double a_d[526]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD526 sqrt(VectorSIMD526 a){
		double a_d[526]; a.convert(a_d);
