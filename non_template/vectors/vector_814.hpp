...
public:
		...
		VectorSIMD814(double a){
			...
			_avx203=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD814(double (&a)[814]){
		...
		VectorSIMD814& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD814& operator += (VectorSIMD814 a){
	...
	inline VectorSIMD814 operator*(double a, VectorSIMD814 b){
		VectorSIMD814 c;
	...
	inline VectorSIMD814 operator*(VectorSIMD814 a ,double b){
		VectorSIMD814 c;
	...
	inline VectorSIMD814 operator*(int a, VectorSIMD814 b){
		if(a==1){return b;}
		VectorSIMD814 c;
	...
	inline VectorSIMD814 operator*(VectorSIMD814 a, int b){
		if(b==1){return a;}
		VectorSIMD814 c;
	...
	inline VectorSIMD814 operator*(VectorSIMD814 a, VectorSIMD814 b){
		VectorSIMD814 c;
	...
	inline VectorSIMD814 exp(VectorSIMD814 a){
		double a_d[814]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD814 sqrt(VectorSIMD814 a){
		double a_d[814]; a.convert(a_d);
