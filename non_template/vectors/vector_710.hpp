...
public:
		...
		VectorSIMD710(double a){
			...
			_avx177=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD710(double (&a)[710]){
		...
		VectorSIMD710& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD710& operator += (VectorSIMD710 a){
	...
	inline VectorSIMD710 operator*(double a, VectorSIMD710 b){
		VectorSIMD710 c;
	...
	inline VectorSIMD710 operator*(VectorSIMD710 a ,double b){
		VectorSIMD710 c;
	...
	inline VectorSIMD710 operator*(int a, VectorSIMD710 b){
		if(a==1){return b;}
		VectorSIMD710 c;
	...
	inline VectorSIMD710 operator*(VectorSIMD710 a, int b){
		if(b==1){return a;}
		VectorSIMD710 c;
	...
	inline VectorSIMD710 operator*(VectorSIMD710 a, VectorSIMD710 b){
		VectorSIMD710 c;
	...
	inline VectorSIMD710 exp(VectorSIMD710 a){
		double a_d[710]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD710 sqrt(VectorSIMD710 a){
		double a_d[710]; a.convert(a_d);
