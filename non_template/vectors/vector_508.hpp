...
public:
		...
		VectorSIMD508& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD508& operator += (VectorSIMD508 a){
	...
	inline VectorSIMD508 operator*(double a, VectorSIMD508 b){
		VectorSIMD508 c;
	...
	inline VectorSIMD508 operator*(VectorSIMD508 a ,double b){
		VectorSIMD508 c;
	...
	inline VectorSIMD508 operator*(int a, VectorSIMD508 b){
		if(a==1){return b;}
		VectorSIMD508 c;
	...
	inline VectorSIMD508 operator*(VectorSIMD508 a, int b){
		if(b==1){return a;}
		VectorSIMD508 c;
	...
	inline VectorSIMD508 operator*(VectorSIMD508 a, VectorSIMD508 b){
		VectorSIMD508 c;
	...
	inline VectorSIMD508 exp(VectorSIMD508 a){
		double a_d[508]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD508 sqrt(VectorSIMD508 a){
		double a_d[508]; a.convert(a_d);
