...
public:
		...
		VectorSIMD693(double a){
			...
			_avx173=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD693(double (&a)[693]){
		...
		VectorSIMD693& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD693& operator += (VectorSIMD693 a){
	...
	inline VectorSIMD693 operator*(double a, VectorSIMD693 b){
		VectorSIMD693 c;
	...
	inline VectorSIMD693 operator*(VectorSIMD693 a ,double b){
		VectorSIMD693 c;
	...
	inline VectorSIMD693 operator*(int a, VectorSIMD693 b){
		if(a==1){return b;}
		VectorSIMD693 c;
	...
	inline VectorSIMD693 operator*(VectorSIMD693 a, int b){
		if(b==1){return a;}
		VectorSIMD693 c;
	...
	inline VectorSIMD693 operator*(VectorSIMD693 a, VectorSIMD693 b){
		VectorSIMD693 c;
	...
	inline VectorSIMD693 exp(VectorSIMD693 a){
		double a_d[693]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD693 sqrt(VectorSIMD693 a){
		double a_d[693]; a.convert(a_d);
