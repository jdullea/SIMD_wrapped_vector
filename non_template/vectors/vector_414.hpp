...
public:
		...
		VectorSIMD414(double a){
			...
			_avx103=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD414(double (&a)[414]){
		...
		VectorSIMD414& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD414& operator += (VectorSIMD414 a){
	...
	inline VectorSIMD414 operator*(double a, VectorSIMD414 b){
		VectorSIMD414 c;
	...
	inline VectorSIMD414 operator*(VectorSIMD414 a ,double b){
		VectorSIMD414 c;
	...
	inline VectorSIMD414 operator*(int a, VectorSIMD414 b){
		if(a==1){return b;}
		VectorSIMD414 c;
	...
	inline VectorSIMD414 operator*(VectorSIMD414 a, int b){
		if(b==1){return a;}
		VectorSIMD414 c;
	...
	inline VectorSIMD414 operator*(VectorSIMD414 a, VectorSIMD414 b){
		VectorSIMD414 c;
	...
	inline VectorSIMD414 exp(VectorSIMD414 a){
		double a_d[414]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD414 sqrt(VectorSIMD414 a){
		double a_d[414]; a.convert(a_d);
