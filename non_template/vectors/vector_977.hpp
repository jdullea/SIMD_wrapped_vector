...
public:
		...
		VectorSIMD977(double a){
			...
			_avx244=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD977(double (&a)[977]){
		...
		VectorSIMD977& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD977& operator += (VectorSIMD977 a){
	...
	inline VectorSIMD977 operator*(double a, VectorSIMD977 b){
		VectorSIMD977 c;
	...
	inline VectorSIMD977 operator*(VectorSIMD977 a ,double b){
		VectorSIMD977 c;
	...
	inline VectorSIMD977 operator*(int a, VectorSIMD977 b){
		if(a==1){return b;}
		VectorSIMD977 c;
	...
	inline VectorSIMD977 operator*(VectorSIMD977 a, int b){
		if(b==1){return a;}
		VectorSIMD977 c;
	...
	inline VectorSIMD977 operator*(VectorSIMD977 a, VectorSIMD977 b){
		VectorSIMD977 c;
	...
	inline VectorSIMD977 exp(VectorSIMD977 a){
		double a_d[977]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD977 sqrt(VectorSIMD977 a){
		double a_d[977]; a.convert(a_d);
