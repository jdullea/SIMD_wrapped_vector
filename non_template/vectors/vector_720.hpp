...
public:
		...
		VectorSIMD720& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD720& operator += (VectorSIMD720 a){
	...
	inline VectorSIMD720 operator*(double a, VectorSIMD720 b){
		VectorSIMD720 c;
	...
	inline VectorSIMD720 operator*(VectorSIMD720 a ,double b){
		VectorSIMD720 c;
	...
	inline VectorSIMD720 operator*(int a, VectorSIMD720 b){
		if(a==1){return b;}
		VectorSIMD720 c;
	...
	inline VectorSIMD720 operator*(VectorSIMD720 a, int b){
		if(b==1){return a;}
		VectorSIMD720 c;
	...
	inline VectorSIMD720 operator*(VectorSIMD720 a, VectorSIMD720 b){
		VectorSIMD720 c;
	...
	inline VectorSIMD720 exp(VectorSIMD720 a){
		double a_d[720]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD720 sqrt(VectorSIMD720 a){
		double a_d[720]; a.convert(a_d);
