...
public:
		...
		VectorSIMD530(double a){
			...
			_avx132=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD530(double (&a)[530]){
		...
		VectorSIMD530& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD530& operator += (VectorSIMD530 a){
	...
	inline VectorSIMD530 operator*(double a, VectorSIMD530 b){
		VectorSIMD530 c;
	...
	inline VectorSIMD530 operator*(VectorSIMD530 a ,double b){
		VectorSIMD530 c;
	...
	inline VectorSIMD530 operator*(int a, VectorSIMD530 b){
		if(a==1){return b;}
		VectorSIMD530 c;
	...
	inline VectorSIMD530 operator*(VectorSIMD530 a, int b){
		if(b==1){return a;}
		VectorSIMD530 c;
	...
	inline VectorSIMD530 operator*(VectorSIMD530 a, VectorSIMD530 b){
		VectorSIMD530 c;
	...
	inline VectorSIMD530 exp(VectorSIMD530 a){
		double a_d[530]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD530 sqrt(VectorSIMD530 a){
		double a_d[530]; a.convert(a_d);
