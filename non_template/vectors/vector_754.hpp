...
public:
		...
		VectorSIMD754(double a){
			...
			_avx188=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD754(double (&a)[754]){
		...
		VectorSIMD754& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD754& operator += (VectorSIMD754 a){
	...
	inline VectorSIMD754 operator*(double a, VectorSIMD754 b){
		VectorSIMD754 c;
	...
	inline VectorSIMD754 operator*(VectorSIMD754 a ,double b){
		VectorSIMD754 c;
	...
	inline VectorSIMD754 operator*(int a, VectorSIMD754 b){
		if(a==1){return b;}
		VectorSIMD754 c;
	...
	inline VectorSIMD754 operator*(VectorSIMD754 a, int b){
		if(b==1){return a;}
		VectorSIMD754 c;
	...
	inline VectorSIMD754 operator*(VectorSIMD754 a, VectorSIMD754 b){
		VectorSIMD754 c;
	...
	inline VectorSIMD754 exp(VectorSIMD754 a){
		double a_d[754]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD754 sqrt(VectorSIMD754 a){
		double a_d[754]; a.convert(a_d);
