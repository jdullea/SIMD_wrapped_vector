...
public:
		...
		VectorSIMD765(double a){
			...
			_avx191=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD765(double (&a)[765]){
		...
		VectorSIMD765& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD765& operator += (VectorSIMD765 a){
	...
	inline VectorSIMD765 operator*(double a, VectorSIMD765 b){
		VectorSIMD765 c;
	...
	inline VectorSIMD765 operator*(VectorSIMD765 a ,double b){
		VectorSIMD765 c;
	...
	inline VectorSIMD765 operator*(int a, VectorSIMD765 b){
		if(a==1){return b;}
		VectorSIMD765 c;
	...
	inline VectorSIMD765 operator*(VectorSIMD765 a, int b){
		if(b==1){return a;}
		VectorSIMD765 c;
	...
	inline VectorSIMD765 operator*(VectorSIMD765 a, VectorSIMD765 b){
		VectorSIMD765 c;
	...
	inline VectorSIMD765 exp(VectorSIMD765 a){
		double a_d[765]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD765 sqrt(VectorSIMD765 a){
		double a_d[765]; a.convert(a_d);
