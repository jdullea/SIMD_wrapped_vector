...
public:
		...
		VectorSIMD919(double a){
			...
			_avx229=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD919(double (&a)[919]){
		...
		VectorSIMD919& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD919& operator += (VectorSIMD919 a){
	...
	inline VectorSIMD919 operator*(double a, VectorSIMD919 b){
		VectorSIMD919 c;
	...
	inline VectorSIMD919 operator*(VectorSIMD919 a ,double b){
		VectorSIMD919 c;
	...
	inline VectorSIMD919 operator*(int a, VectorSIMD919 b){
		if(a==1){return b;}
		VectorSIMD919 c;
	...
	inline VectorSIMD919 operator*(VectorSIMD919 a, int b){
		if(b==1){return a;}
		VectorSIMD919 c;
	...
	inline VectorSIMD919 operator*(VectorSIMD919 a, VectorSIMD919 b){
		VectorSIMD919 c;
	...
	inline VectorSIMD919 exp(VectorSIMD919 a){
		double a_d[919]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD919 sqrt(VectorSIMD919 a){
		double a_d[919]; a.convert(a_d);
