...
public:
		...
		VectorSIMD368& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD368& operator += (VectorSIMD368 a){
	...
	inline VectorSIMD368 operator*(double a, VectorSIMD368 b){
		VectorSIMD368 c;
	...
	inline VectorSIMD368 operator*(VectorSIMD368 a ,double b){
		VectorSIMD368 c;
	...
	inline VectorSIMD368 operator*(int a, VectorSIMD368 b){
		if(a==1){return b;}
		VectorSIMD368 c;
	...
	inline VectorSIMD368 operator*(VectorSIMD368 a, int b){
		if(b==1){return a;}
		VectorSIMD368 c;
	...
	inline VectorSIMD368 operator*(VectorSIMD368 a, VectorSIMD368 b){
		VectorSIMD368 c;
	...
	inline VectorSIMD368 exp(VectorSIMD368 a){
		double a_d[368]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD368 sqrt(VectorSIMD368 a){
		double a_d[368]; a.convert(a_d);
