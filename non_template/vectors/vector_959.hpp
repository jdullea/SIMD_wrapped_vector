...
public:
		...
		VectorSIMD959(double a){
			...
			_avx239=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD959(double (&a)[959]){
		...
		VectorSIMD959& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD959& operator += (VectorSIMD959 a){
	...
	inline VectorSIMD959 operator*(double a, VectorSIMD959 b){
		VectorSIMD959 c;
	...
	inline VectorSIMD959 operator*(VectorSIMD959 a ,double b){
		VectorSIMD959 c;
	...
	inline VectorSIMD959 operator*(int a, VectorSIMD959 b){
		if(a==1){return b;}
		VectorSIMD959 c;
	...
	inline VectorSIMD959 operator*(VectorSIMD959 a, int b){
		if(b==1){return a;}
		VectorSIMD959 c;
	...
	inline VectorSIMD959 operator*(VectorSIMD959 a, VectorSIMD959 b){
		VectorSIMD959 c;
	...
	inline VectorSIMD959 exp(VectorSIMD959 a){
		double a_d[959]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD959 sqrt(VectorSIMD959 a){
		double a_d[959]; a.convert(a_d);
