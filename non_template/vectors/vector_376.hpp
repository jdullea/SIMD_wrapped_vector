...
public:
		...
		VectorSIMD376& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD376& operator += (VectorSIMD376 a){
	...
	inline VectorSIMD376 operator*(double a, VectorSIMD376 b){
		VectorSIMD376 c;
	...
	inline VectorSIMD376 operator*(VectorSIMD376 a ,double b){
		VectorSIMD376 c;
	...
	inline VectorSIMD376 operator*(int a, VectorSIMD376 b){
		if(a==1){return b;}
		VectorSIMD376 c;
	...
	inline VectorSIMD376 operator*(VectorSIMD376 a, int b){
		if(b==1){return a;}
		VectorSIMD376 c;
	...
	inline VectorSIMD376 operator*(VectorSIMD376 a, VectorSIMD376 b){
		VectorSIMD376 c;
	...
	inline VectorSIMD376 exp(VectorSIMD376 a){
		double a_d[376]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD376 sqrt(VectorSIMD376 a){
		double a_d[376]; a.convert(a_d);
