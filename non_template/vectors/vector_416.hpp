...
public:
		...
		VectorSIMD416& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD416& operator += (VectorSIMD416 a){
	...
	inline VectorSIMD416 operator*(double a, VectorSIMD416 b){
		VectorSIMD416 c;
	...
	inline VectorSIMD416 operator*(VectorSIMD416 a ,double b){
		VectorSIMD416 c;
	...
	inline VectorSIMD416 operator*(int a, VectorSIMD416 b){
		if(a==1){return b;}
		VectorSIMD416 c;
	...
	inline VectorSIMD416 operator*(VectorSIMD416 a, int b){
		if(b==1){return a;}
		VectorSIMD416 c;
	...
	inline VectorSIMD416 operator*(VectorSIMD416 a, VectorSIMD416 b){
		VectorSIMD416 c;
	...
	inline VectorSIMD416 exp(VectorSIMD416 a){
		double a_d[416]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD416 sqrt(VectorSIMD416 a){
		double a_d[416]; a.convert(a_d);
