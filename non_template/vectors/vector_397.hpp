...
public:
		...
		VectorSIMD397(double a){
			...
			_avx99=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD397(double (&a)[397]){
			...
			_avx99=_mm256_set_pd(0,0,0,a[396]);
		}
		...
		VectorSIMD397& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD397& operator += (VectorSIMD397 a){
	...
	inline VectorSIMD397 operator*(double a, VectorSIMD397 b){
		VectorSIMD397 c;
	...
	inline VectorSIMD397 operator*(VectorSIMD397 a ,double b){
		VectorSIMD397 c;
	...
	inline VectorSIMD397 operator*(int a, VectorSIMD397 b){
		if(a==1){return b;}
		VectorSIMD397 c;
	...
	inline VectorSIMD397 operator*(VectorSIMD397 a, int b){
		if(b==1){return a;}
		VectorSIMD397 c;
	...
	inline VectorSIMD397 operator*(VectorSIMD397 a, VectorSIMD397 b){
		VectorSIMD397 c;
	...
	inline VectorSIMD397 exp(VectorSIMD397 a){
		double a_d[397]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD397 sqrt(VectorSIMD397 a){
		double a_d[397]; a.convert(a_d);
