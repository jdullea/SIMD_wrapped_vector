...
public:
		...
		VectorSIMD771(double a){
			...
			_avx192=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD771(double (&a)[771]){
		...
		VectorSIMD771& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD771& operator += (VectorSIMD771 a){
	...
	inline VectorSIMD771 operator*(double a, VectorSIMD771 b){
		VectorSIMD771 c;
	...
	inline VectorSIMD771 operator*(VectorSIMD771 a ,double b){
		VectorSIMD771 c;
	...
	inline VectorSIMD771 operator*(int a, VectorSIMD771 b){
		if(a==1){return b;}
		VectorSIMD771 c;
	...
	inline VectorSIMD771 operator*(VectorSIMD771 a, int b){
		if(b==1){return a;}
		VectorSIMD771 c;
	...
	inline VectorSIMD771 operator*(VectorSIMD771 a, VectorSIMD771 b){
		VectorSIMD771 c;
	...
	inline VectorSIMD771 exp(VectorSIMD771 a){
		double a_d[771]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD771 sqrt(VectorSIMD771 a){
		double a_d[771]; a.convert(a_d);
