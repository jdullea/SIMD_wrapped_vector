...
public:
		...
		VectorSIMD748& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD748& operator += (VectorSIMD748 a){
	...
	inline VectorSIMD748 operator*(double a, VectorSIMD748 b){
		VectorSIMD748 c;
	...
	inline VectorSIMD748 operator*(VectorSIMD748 a ,double b){
		VectorSIMD748 c;
	...
	inline VectorSIMD748 operator*(int a, VectorSIMD748 b){
		if(a==1){return b;}
		VectorSIMD748 c;
	...
	inline VectorSIMD748 operator*(VectorSIMD748 a, int b){
		if(b==1){return a;}
		VectorSIMD748 c;
	...
	inline VectorSIMD748 operator*(VectorSIMD748 a, VectorSIMD748 b){
		VectorSIMD748 c;
	...
	inline VectorSIMD748 exp(VectorSIMD748 a){
		double a_d[748]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD748 sqrt(VectorSIMD748 a){
		double a_d[748]; a.convert(a_d);
