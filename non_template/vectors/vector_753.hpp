...
public:
		...
		VectorSIMD753(double a){
			...
			_avx188=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD753(double (&a)[753]){
		...
		VectorSIMD753& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD753& operator += (VectorSIMD753 a){
	...
	inline VectorSIMD753 operator*(double a, VectorSIMD753 b){
		VectorSIMD753 c;
	...
	inline VectorSIMD753 operator*(VectorSIMD753 a ,double b){
		VectorSIMD753 c;
	...
	inline VectorSIMD753 operator*(int a, VectorSIMD753 b){
		if(a==1){return b;}
		VectorSIMD753 c;
	...
	inline VectorSIMD753 operator*(VectorSIMD753 a, int b){
		if(b==1){return a;}
		VectorSIMD753 c;
	...
	inline VectorSIMD753 operator*(VectorSIMD753 a, VectorSIMD753 b){
		VectorSIMD753 c;
	...
	inline VectorSIMD753 exp(VectorSIMD753 a){
		double a_d[753]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD753 sqrt(VectorSIMD753 a){
		double a_d[753]; a.convert(a_d);
