...
public:
		...
		VectorSIMD620& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD620& operator += (VectorSIMD620 a){
	...
	inline VectorSIMD620 operator*(double a, VectorSIMD620 b){
		VectorSIMD620 c;
	...
	inline VectorSIMD620 operator*(VectorSIMD620 a ,double b){
		VectorSIMD620 c;
	...
	inline VectorSIMD620 operator*(int a, VectorSIMD620 b){
		if(a==1){return b;}
		VectorSIMD620 c;
	...
	inline VectorSIMD620 operator*(VectorSIMD620 a, int b){
		if(b==1){return a;}
		VectorSIMD620 c;
	...
	inline VectorSIMD620 operator*(VectorSIMD620 a, VectorSIMD620 b){
		VectorSIMD620 c;
	...
	inline VectorSIMD620 exp(VectorSIMD620 a){
		double a_d[620]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD620 sqrt(VectorSIMD620 a){
		double a_d[620]; a.convert(a_d);
