...
public:
		...
		VectorSIMD256& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD256& operator += (VectorSIMD256 a){
	...
	inline VectorSIMD256 operator*(double a, VectorSIMD256 b){
		VectorSIMD256 c;
	...
	inline VectorSIMD256 operator*(VectorSIMD256 a ,double b){
		VectorSIMD256 c;
	...
	inline VectorSIMD256 operator*(int a, VectorSIMD256 b){
		if(a==1){return b;}
		VectorSIMD256 c;
	...
	inline VectorSIMD256 operator*(VectorSIMD256 a, int b){
		if(b==1){return a;}
		VectorSIMD256 c;
	...
	inline VectorSIMD256 operator*(VectorSIMD256 a, VectorSIMD256 b){
		VectorSIMD256 c;
	...
	inline VectorSIMD256 exp(VectorSIMD256 a){
		double a_d[256]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD256 sqrt(VectorSIMD256 a){
		double a_d[256]; a.convert(a_d);
