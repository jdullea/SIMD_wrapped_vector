...
public:
		...
		VectorSIMD983(double a){
			...
			_avx245=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD983(double (&a)[983]){
		...
		VectorSIMD983& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD983& operator += (VectorSIMD983 a){
	...
	inline VectorSIMD983 operator*(double a, VectorSIMD983 b){
		VectorSIMD983 c;
	...
	inline VectorSIMD983 operator*(VectorSIMD983 a ,double b){
		VectorSIMD983 c;
	...
	inline VectorSIMD983 operator*(int a, VectorSIMD983 b){
		if(a==1){return b;}
		VectorSIMD983 c;
	...
	inline VectorSIMD983 operator*(VectorSIMD983 a, int b){
		if(b==1){return a;}
		VectorSIMD983 c;
	...
	inline VectorSIMD983 operator*(VectorSIMD983 a, VectorSIMD983 b){
		VectorSIMD983 c;
	...
	inline VectorSIMD983 exp(VectorSIMD983 a){
		double a_d[983]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD983 sqrt(VectorSIMD983 a){
		double a_d[983]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD983 a){ 
		double ad[983];
		a.convert(ad);
