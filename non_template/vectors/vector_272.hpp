...
public:
		...
		VectorSIMD272& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD272& operator += (VectorSIMD272 a){
	...
	inline VectorSIMD272 operator*(double a, VectorSIMD272 b){
		VectorSIMD272 c;
	...
	inline VectorSIMD272 operator*(VectorSIMD272 a ,double b){
		VectorSIMD272 c;
	...
	inline VectorSIMD272 operator*(int a, VectorSIMD272 b){
		if(a==1){return b;}
		VectorSIMD272 c;
	...
	inline VectorSIMD272 operator*(VectorSIMD272 a, int b){
		if(b==1){return a;}
		VectorSIMD272 c;
	...
	inline VectorSIMD272 operator*(VectorSIMD272 a, VectorSIMD272 b){
		VectorSIMD272 c;
	...
	inline VectorSIMD272 exp(VectorSIMD272 a){
		double a_d[272]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD272 sqrt(VectorSIMD272 a){
		double a_d[272]; a.convert(a_d);
