...
public:
		...
		VectorSIMD461(double a){
			...
			_avx115=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD461(double (&a)[461]){
		...
		VectorSIMD461& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD461& operator += (VectorSIMD461 a){
	...
	inline VectorSIMD461 operator*(double a, VectorSIMD461 b){
		VectorSIMD461 c;
	...
	inline VectorSIMD461 operator*(VectorSIMD461 a ,double b){
		VectorSIMD461 c;
	...
	inline VectorSIMD461 operator*(int a, VectorSIMD461 b){
		if(a==1){return b;}
		VectorSIMD461 c;
	...
	inline VectorSIMD461 operator*(VectorSIMD461 a, int b){
		if(b==1){return a;}
		VectorSIMD461 c;
	...
	inline VectorSIMD461 operator*(VectorSIMD461 a, VectorSIMD461 b){
		VectorSIMD461 c;
	...
	inline VectorSIMD461 exp(VectorSIMD461 a){
		double a_d[461]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD461 sqrt(VectorSIMD461 a){
		double a_d[461]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD461 a){ 
		double ad[461];
		a.convert(ad);
