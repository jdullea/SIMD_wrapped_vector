...
public:
		...
		VectorSIMD324& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD324& operator += (VectorSIMD324 a){
	...
	inline VectorSIMD324 operator*(double a, VectorSIMD324 b){
		VectorSIMD324 c;
	...
	inline VectorSIMD324 operator*(VectorSIMD324 a ,double b){
		VectorSIMD324 c;
	...
	inline VectorSIMD324 operator*(int a, VectorSIMD324 b){
		if(a==1){return b;}
		VectorSIMD324 c;
	...
	inline VectorSIMD324 operator*(VectorSIMD324 a, int b){
		if(b==1){return a;}
		VectorSIMD324 c;
	...
	inline VectorSIMD324 operator*(VectorSIMD324 a, VectorSIMD324 b){
		VectorSIMD324 c;
	...
	inline VectorSIMD324 exp(VectorSIMD324 a){
		double a_d[324]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD324 sqrt(VectorSIMD324 a){
		double a_d[324]; a.convert(a_d);
