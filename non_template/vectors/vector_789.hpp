...
public:
		...
		VectorSIMD789(double a){
			...
			_avx197=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD789(double (&a)[789]){
		...
		VectorSIMD789& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD789& operator += (VectorSIMD789 a){
	...
	inline VectorSIMD789 operator*(double a, VectorSIMD789 b){
		VectorSIMD789 c;
	...
	inline VectorSIMD789 operator*(VectorSIMD789 a ,double b){
		VectorSIMD789 c;
	...
	inline VectorSIMD789 operator*(int a, VectorSIMD789 b){
		if(a==1){return b;}
		VectorSIMD789 c;
	...
	inline VectorSIMD789 operator*(VectorSIMD789 a, int b){
		if(b==1){return a;}
		VectorSIMD789 c;
	...
	inline VectorSIMD789 operator*(VectorSIMD789 a, VectorSIMD789 b){
		VectorSIMD789 c;
	...
	inline VectorSIMD789 exp(VectorSIMD789 a){
		double a_d[789]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD789 sqrt(VectorSIMD789 a){
		double a_d[789]; a.convert(a_d);
