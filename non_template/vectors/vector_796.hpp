...
public:
		...
		VectorSIMD796& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD796& operator += (VectorSIMD796 a){
	...
	inline VectorSIMD796 operator*(double a, VectorSIMD796 b){
		VectorSIMD796 c;
	...
	inline VectorSIMD796 operator*(VectorSIMD796 a ,double b){
		VectorSIMD796 c;
	...
	inline VectorSIMD796 operator*(int a, VectorSIMD796 b){
		if(a==1){return b;}
		VectorSIMD796 c;
	...
	inline VectorSIMD796 operator*(VectorSIMD796 a, int b){
		if(b==1){return a;}
		VectorSIMD796 c;
	...
	inline VectorSIMD796 operator*(VectorSIMD796 a, VectorSIMD796 b){
		VectorSIMD796 c;
	...
	inline VectorSIMD796 exp(VectorSIMD796 a){
		double a_d[796]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD796 sqrt(VectorSIMD796 a){
		double a_d[796]; a.convert(a_d);
