...
public:
		...
		VectorSIMD134(double a){
			...
			_avx33=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD134(double (&a)[134]){
		...
		VectorSIMD134& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD134& operator += (VectorSIMD134 a){
	...
	inline VectorSIMD134 operator*(double a, VectorSIMD134 b){
		VectorSIMD134 c;
	...
	inline VectorSIMD134 operator*(VectorSIMD134 a ,double b){
		VectorSIMD134 c;
	...
	inline VectorSIMD134 operator*(int a, VectorSIMD134 b){
		if(a==1){return b;}
		VectorSIMD134 c;
	...
	inline VectorSIMD134 operator*(VectorSIMD134 a, int b){
		if(b==1){return a;}
		VectorSIMD134 c;
	...
	inline VectorSIMD134 operator*(VectorSIMD134 a, VectorSIMD134 b){
		VectorSIMD134 c;
	...
	inline VectorSIMD134 exp(VectorSIMD134 a){
		double a_d[134]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD134 sqrt(VectorSIMD134 a){
		double a_d[134]; a.convert(a_d);
