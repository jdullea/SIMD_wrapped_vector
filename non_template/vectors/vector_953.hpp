...
public:
		...
		VectorSIMD953(double a){
			...
			_avx238=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD953(double (&a)[953]){
		...
		VectorSIMD953& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD953& operator += (VectorSIMD953 a){
	...
	inline VectorSIMD953 operator*(double a, VectorSIMD953 b){
		VectorSIMD953 c;
	...
	inline VectorSIMD953 operator*(VectorSIMD953 a ,double b){
		VectorSIMD953 c;
	...
	inline VectorSIMD953 operator*(int a, VectorSIMD953 b){
		if(a==1){return b;}
		VectorSIMD953 c;
	...
	inline VectorSIMD953 operator*(VectorSIMD953 a, int b){
		if(b==1){return a;}
		VectorSIMD953 c;
	...
	inline VectorSIMD953 operator*(VectorSIMD953 a, VectorSIMD953 b){
		VectorSIMD953 c;
	...
	inline VectorSIMD953 exp(VectorSIMD953 a){
		double a_d[953]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD953 sqrt(VectorSIMD953 a){
		double a_d[953]; a.convert(a_d);
