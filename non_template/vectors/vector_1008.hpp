...
public:
		...
		VectorSIMD1008& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1008& operator += (VectorSIMD1008 a){
	...
	inline VectorSIMD1008 operator*(double a, VectorSIMD1008 b){
		VectorSIMD1008 c;
	...
	inline VectorSIMD1008 operator*(VectorSIMD1008 a ,double b){
		VectorSIMD1008 c;
	...
	inline VectorSIMD1008 operator*(int a, VectorSIMD1008 b){
		if(a==1){return b;}
		VectorSIMD1008 c;
	...
	inline VectorSIMD1008 operator*(VectorSIMD1008 a, int b){
		if(b==1){return a;}
		VectorSIMD1008 c;
	...
	inline VectorSIMD1008 operator*(VectorSIMD1008 a, VectorSIMD1008 b){
		VectorSIMD1008 c;
	...
	inline VectorSIMD1008 exp(VectorSIMD1008 a){
		double a_d[1008]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1008 r(a_d);
		return r;
	}

	inline VectorSIMD1008 sqrt(VectorSIMD1008 a){
		double a_d[1008]; a.convert(a_d);
