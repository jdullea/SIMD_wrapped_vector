...
public:
		...
		VectorSIMD1015(double a){
			...
			_avx253=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD1015(double (&a)[1015]){
		...
		VectorSIMD1015& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1015& operator += (VectorSIMD1015 a){
	...
	inline VectorSIMD1015 operator*(double a, VectorSIMD1015 b){
		VectorSIMD1015 c;
	...
	inline VectorSIMD1015 operator*(VectorSIMD1015 a ,double b){
		VectorSIMD1015 c;
	...
	inline VectorSIMD1015 operator*(int a, VectorSIMD1015 b){
		if(a==1){return b;}
		VectorSIMD1015 c;
	...
	inline VectorSIMD1015 operator*(VectorSIMD1015 a, int b){
		if(b==1){return a;}
		VectorSIMD1015 c;
	...
	inline VectorSIMD1015 operator*(VectorSIMD1015 a, VectorSIMD1015 b){
		VectorSIMD1015 c;
	...
	inline VectorSIMD1015 exp(VectorSIMD1015 a){
		double a_d[1015]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1015 r(a_d);
		return r;
	}

	inline VectorSIMD1015 sqrt(VectorSIMD1015 a){
		double a_d[1015]; a.convert(a_d);
