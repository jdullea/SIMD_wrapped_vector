...
public:
		...
		VectorSIMD864& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD864& operator += (VectorSIMD864 a){
	...
	inline VectorSIMD864 operator*(double a, VectorSIMD864 b){
		VectorSIMD864 c;
	...
	inline VectorSIMD864 operator*(VectorSIMD864 a ,double b){
		VectorSIMD864 c;
	...
	inline VectorSIMD864 operator*(int a, VectorSIMD864 b){
		if(a==1){return b;}
		VectorSIMD864 c;
	...
	inline VectorSIMD864 operator*(VectorSIMD864 a, int b){
		if(b==1){return a;}
		VectorSIMD864 c;
	...
	inline VectorSIMD864 operator*(VectorSIMD864 a, VectorSIMD864 b){
		VectorSIMD864 c;
	...
	inline VectorSIMD864 exp(VectorSIMD864 a){
		double a_d[864]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD864 sqrt(VectorSIMD864 a){
		double a_d[864]; a.convert(a_d);
