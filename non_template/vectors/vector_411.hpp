...
public:
		...
		VectorSIMD411(double a){
			...
			_avx102=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD411(double (&a)[411]){
		...
		VectorSIMD411& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD411& operator += (VectorSIMD411 a){
	...
	inline VectorSIMD411 operator*(double a, VectorSIMD411 b){
		VectorSIMD411 c;
	...
	inline VectorSIMD411 operator*(VectorSIMD411 a ,double b){
		VectorSIMD411 c;
	...
	inline VectorSIMD411 operator*(int a, VectorSIMD411 b){
		if(a==1){return b;}
		VectorSIMD411 c;
	...
	inline VectorSIMD411 operator*(VectorSIMD411 a, int b){
		if(b==1){return a;}
		VectorSIMD411 c;
	...
	inline VectorSIMD411 operator*(VectorSIMD411 a, VectorSIMD411 b){
		VectorSIMD411 c;
	...
	inline VectorSIMD411 exp(VectorSIMD411 a){
		double a_d[411]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD411 sqrt(VectorSIMD411 a){
		double a_d[411]; a.convert(a_d);
