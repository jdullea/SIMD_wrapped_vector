...
public:
		...
		VectorSIMD954(double a){
			...
			_avx238=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD954(double (&a)[954]){
		...
		VectorSIMD954& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD954& operator += (VectorSIMD954 a){
	...
	inline VectorSIMD954 operator*(double a, VectorSIMD954 b){
		VectorSIMD954 c;
	...
	inline VectorSIMD954 operator*(VectorSIMD954 a ,double b){
		VectorSIMD954 c;
	...
	inline VectorSIMD954 operator*(int a, VectorSIMD954 b){
		if(a==1){return b;}
		VectorSIMD954 c;
	...
	inline VectorSIMD954 operator*(VectorSIMD954 a, int b){
		if(b==1){return a;}
		VectorSIMD954 c;
	...
	inline VectorSIMD954 operator*(VectorSIMD954 a, VectorSIMD954 b){
		VectorSIMD954 c;
	...
	inline VectorSIMD954 exp(VectorSIMD954 a){
		double a_d[954]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD954 sqrt(VectorSIMD954 a){
		double a_d[954]; a.convert(a_d);
