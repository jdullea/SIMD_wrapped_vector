...
public:
		...
		VectorSIMD199(double a){
			...
			_avx49=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD199(double (&a)[199]){
		...
		VectorSIMD199& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD199& operator += (VectorSIMD199 a){
	...
	inline VectorSIMD199 operator*(double a, VectorSIMD199 b){
		VectorSIMD199 c;
	...
	inline VectorSIMD199 operator*(VectorSIMD199 a ,double b){
		VectorSIMD199 c;
	...
	inline VectorSIMD199 operator*(int a, VectorSIMD199 b){
		if(a==1){return b;}
		VectorSIMD199 c;
	...
	inline VectorSIMD199 operator*(VectorSIMD199 a, int b){
		if(b==1){return a;}
		VectorSIMD199 c;
	...
	inline VectorSIMD199 operator*(VectorSIMD199 a, VectorSIMD199 b){
		VectorSIMD199 c;
	...
	inline VectorSIMD199 exp(VectorSIMD199 a){
		double a_d[199]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD199 sqrt(VectorSIMD199 a){
		double a_d[199]; a.convert(a_d);
