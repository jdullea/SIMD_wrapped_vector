...
public:
		...
		VectorSIMD593(double a){
			...
			_avx148=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD593(double (&a)[593]){
		...
		VectorSIMD593& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD593& operator += (VectorSIMD593 a){
	...
	inline VectorSIMD593 operator*(double a, VectorSIMD593 b){
		VectorSIMD593 c;
	...
	inline VectorSIMD593 operator*(VectorSIMD593 a ,double b){
		VectorSIMD593 c;
	...
	inline VectorSIMD593 operator*(int a, VectorSIMD593 b){
		if(a==1){return b;}
		VectorSIMD593 c;
	...
	inline VectorSIMD593 operator*(VectorSIMD593 a, int b){
		if(b==1){return a;}
		VectorSIMD593 c;
	...
	inline VectorSIMD593 operator*(VectorSIMD593 a, VectorSIMD593 b){
		VectorSIMD593 c;
	...
	inline VectorSIMD593 exp(VectorSIMD593 a){
		double a_d[593]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD593 sqrt(VectorSIMD593 a){
		double a_d[593]; a.convert(a_d);
