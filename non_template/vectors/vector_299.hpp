...
public:
		...
		VectorSIMD299(double a){
			...
			_avx74=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD299(double (&a)[299]){
		...
		VectorSIMD299& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD299& operator += (VectorSIMD299 a){
	...
	inline VectorSIMD299 operator*(double a, VectorSIMD299 b){
		VectorSIMD299 c;
	...
	inline VectorSIMD299 operator*(VectorSIMD299 a ,double b){
		VectorSIMD299 c;
	...
	inline VectorSIMD299 operator*(int a, VectorSIMD299 b){
		if(a==1){return b;}
		VectorSIMD299 c;
	...
	inline VectorSIMD299 operator*(VectorSIMD299 a, int b){
		if(b==1){return a;}
		VectorSIMD299 c;
	...
	inline VectorSIMD299 operator*(VectorSIMD299 a, VectorSIMD299 b){
		VectorSIMD299 c;
	...
	inline VectorSIMD299 exp(VectorSIMD299 a){
		double a_d[299]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD299 sqrt(VectorSIMD299 a){
		double a_d[299]; a.convert(a_d);
