...
public:
		...
		VectorSIMD241(double a){
			...
			_avx60=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD241(double (&a)[241]){
		...
		VectorSIMD241& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD241& operator += (VectorSIMD241 a){
	...
	inline VectorSIMD241 operator*(double a, VectorSIMD241 b){
		VectorSIMD241 c;
	...
	inline VectorSIMD241 operator*(VectorSIMD241 a ,double b){
		VectorSIMD241 c;
	...
	inline VectorSIMD241 operator*(int a, VectorSIMD241 b){
		if(a==1){return b;}
		VectorSIMD241 c;
	...
	inline VectorSIMD241 operator*(VectorSIMD241 a, int b){
		if(b==1){return a;}
		VectorSIMD241 c;
	...
	inline VectorSIMD241 operator*(VectorSIMD241 a, VectorSIMD241 b){
		VectorSIMD241 c;
	...
	inline VectorSIMD241 exp(VectorSIMD241 a){
		double a_d[241]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD241 sqrt(VectorSIMD241 a){
		double a_d[241]; a.convert(a_d);
