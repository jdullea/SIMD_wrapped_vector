...
public:
		...
		VectorSIMD556& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD556& operator += (VectorSIMD556 a){
	...
	inline VectorSIMD556 operator*(double a, VectorSIMD556 b){
		VectorSIMD556 c;
	...
	inline VectorSIMD556 operator*(VectorSIMD556 a ,double b){
		VectorSIMD556 c;
	...
	inline VectorSIMD556 operator*(int a, VectorSIMD556 b){
		if(a==1){return b;}
		VectorSIMD556 c;
	...
	inline VectorSIMD556 operator*(VectorSIMD556 a, int b){
		if(b==1){return a;}
		VectorSIMD556 c;
	...
	inline VectorSIMD556 operator*(VectorSIMD556 a, VectorSIMD556 b){
		VectorSIMD556 c;
	...
	inline VectorSIMD556 exp(VectorSIMD556 a){
		double a_d[556]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD556 sqrt(VectorSIMD556 a){
		double a_d[556]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD556 a){ 
		double ad[556];
		a.convert(ad);
