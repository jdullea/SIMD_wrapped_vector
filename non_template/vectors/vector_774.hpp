...
public:
		...
		VectorSIMD774(double a){
			...
			_avx193=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD774(double (&a)[774]){
		...
		VectorSIMD774& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD774& operator += (VectorSIMD774 a){
	...
	inline VectorSIMD774 operator*(double a, VectorSIMD774 b){
		VectorSIMD774 c;
	...
	inline VectorSIMD774 operator*(VectorSIMD774 a ,double b){
		VectorSIMD774 c;
	...
	inline VectorSIMD774 operator*(int a, VectorSIMD774 b){
		if(a==1){return b;}
		VectorSIMD774 c;
	...
	inline VectorSIMD774 operator*(VectorSIMD774 a, int b){
		if(b==1){return a;}
		VectorSIMD774 c;
	...
	inline VectorSIMD774 operator*(VectorSIMD774 a, VectorSIMD774 b){
		VectorSIMD774 c;
	...
	inline VectorSIMD774 exp(VectorSIMD774 a){
		double a_d[774]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD774 sqrt(VectorSIMD774 a){
		double a_d[774]; a.convert(a_d);
