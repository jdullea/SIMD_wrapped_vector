...
public:
		...
		VectorSIMD588& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD588& operator += (VectorSIMD588 a){
	...
	inline VectorSIMD588 operator*(double a, VectorSIMD588 b){
		VectorSIMD588 c;
	...
	inline VectorSIMD588 operator*(VectorSIMD588 a ,double b){
		VectorSIMD588 c;
	...
	inline VectorSIMD588 operator*(int a, VectorSIMD588 b){
		if(a==1){return b;}
		VectorSIMD588 c;
	...
	inline VectorSIMD588 operator*(VectorSIMD588 a, int b){
		if(b==1){return a;}
		VectorSIMD588 c;
	...
	inline VectorSIMD588 operator*(VectorSIMD588 a, VectorSIMD588 b){
		VectorSIMD588 c;
	...
	inline VectorSIMD588 exp(VectorSIMD588 a){
		double a_d[588]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD588 sqrt(VectorSIMD588 a){
		double a_d[588]; a.convert(a_d);
