...
public:
		...
		VectorSIMD580& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD580& operator += (VectorSIMD580 a){
	...
	inline VectorSIMD580 operator*(double a, VectorSIMD580 b){
		VectorSIMD580 c;
	...
	inline VectorSIMD580 operator*(VectorSIMD580 a ,double b){
		VectorSIMD580 c;
	...
	inline VectorSIMD580 operator*(int a, VectorSIMD580 b){
		if(a==1){return b;}
		VectorSIMD580 c;
	...
	inline VectorSIMD580 operator*(VectorSIMD580 a, int b){
		if(b==1){return a;}
		VectorSIMD580 c;
	...
	inline VectorSIMD580 operator*(VectorSIMD580 a, VectorSIMD580 b){
		VectorSIMD580 c;
	...
	inline VectorSIMD580 exp(VectorSIMD580 a){
		double a_d[580]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD580 sqrt(VectorSIMD580 a){
		double a_d[580]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD580 a){ 
		double ad[580];
		a.convert(ad);
