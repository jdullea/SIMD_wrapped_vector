...
public:
		...
		VectorSIMD931(double a){
			...
			_avx232=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD931(double (&a)[931]){
		...
		VectorSIMD931& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD931& operator += (VectorSIMD931 a){
	...
	inline VectorSIMD931 operator*(double a, VectorSIMD931 b){
		VectorSIMD931 c;
	...
	inline VectorSIMD931 operator*(VectorSIMD931 a ,double b){
		VectorSIMD931 c;
	...
	inline VectorSIMD931 operator*(int a, VectorSIMD931 b){
		if(a==1){return b;}
		VectorSIMD931 c;
	...
	inline VectorSIMD931 operator*(VectorSIMD931 a, int b){
		if(b==1){return a;}
		VectorSIMD931 c;
	...
	inline VectorSIMD931 operator*(VectorSIMD931 a, VectorSIMD931 b){
		VectorSIMD931 c;
	...
	inline VectorSIMD931 exp(VectorSIMD931 a){
		double a_d[931]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD931 sqrt(VectorSIMD931 a){
		double a_d[931]; a.convert(a_d);
