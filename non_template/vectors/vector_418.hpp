...
public:
		...
		VectorSIMD418(double a){
			...
			_avx104=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD418(double (&a)[418]){
		...
		VectorSIMD418& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD418& operator += (VectorSIMD418 a){
	...
	inline VectorSIMD418 operator*(double a, VectorSIMD418 b){
		VectorSIMD418 c;
	...
	inline VectorSIMD418 operator*(VectorSIMD418 a ,double b){
		VectorSIMD418 c;
	...
	inline VectorSIMD418 operator*(int a, VectorSIMD418 b){
		if(a==1){return b;}
		VectorSIMD418 c;
	...
	inline VectorSIMD418 operator*(VectorSIMD418 a, int b){
		if(b==1){return a;}
		VectorSIMD418 c;
	...
	inline VectorSIMD418 operator*(VectorSIMD418 a, VectorSIMD418 b){
		VectorSIMD418 c;
	...
	inline VectorSIMD418 exp(VectorSIMD418 a){
		double a_d[418]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD418 sqrt(VectorSIMD418 a){
		double a_d[418]; a.convert(a_d);
