...
public:
		...
		VectorSIMD358(double a){
			...
			_avx89=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD358(double (&a)[358]){
		...
		VectorSIMD358& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD358& operator += (VectorSIMD358 a){
	...
	inline VectorSIMD358 operator*(double a, VectorSIMD358 b){
		VectorSIMD358 c;
	...
	inline VectorSIMD358 operator*(VectorSIMD358 a ,double b){
		VectorSIMD358 c;
	...
	inline VectorSIMD358 operator*(int a, VectorSIMD358 b){
		if(a==1){return b;}
		VectorSIMD358 c;
	...
	inline VectorSIMD358 operator*(VectorSIMD358 a, int b){
		if(b==1){return a;}
		VectorSIMD358 c;
	...
	inline VectorSIMD358 operator*(VectorSIMD358 a, VectorSIMD358 b){
		VectorSIMD358 c;
	...
	inline VectorSIMD358 exp(VectorSIMD358 a){
		double a_d[358]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD358 sqrt(VectorSIMD358 a){
		double a_d[358]; a.convert(a_d);
