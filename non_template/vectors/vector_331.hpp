...
public:
		...
		VectorSIMD331(double a){
			...
			_avx82=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD331(double (&a)[331]){
		...
		VectorSIMD331& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD331& operator += (VectorSIMD331 a){
	...
	inline VectorSIMD331 operator*(double a, VectorSIMD331 b){
		VectorSIMD331 c;
	...
	inline VectorSIMD331 operator*(VectorSIMD331 a ,double b){
		VectorSIMD331 c;
	...
	inline VectorSIMD331 operator*(int a, VectorSIMD331 b){
		if(a==1){return b;}
		VectorSIMD331 c;
	...
	inline VectorSIMD331 operator*(VectorSIMD331 a, int b){
		if(b==1){return a;}
		VectorSIMD331 c;
	...
	inline VectorSIMD331 operator*(VectorSIMD331 a, VectorSIMD331 b){
		VectorSIMD331 c;
	...
	inline VectorSIMD331 exp(VectorSIMD331 a){
		double a_d[331]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD331 sqrt(VectorSIMD331 a){
		double a_d[331]; a.convert(a_d);
