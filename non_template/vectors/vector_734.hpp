...
public:
		...
		VectorSIMD734(double a){
			...
			_avx183=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD734(double (&a)[734]){
		...
		VectorSIMD734& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD734& operator += (VectorSIMD734 a){
	...
	inline VectorSIMD734 operator*(double a, VectorSIMD734 b){
		VectorSIMD734 c;
	...
	inline VectorSIMD734 operator*(VectorSIMD734 a ,double b){
		VectorSIMD734 c;
	...
	inline VectorSIMD734 operator*(int a, VectorSIMD734 b){
		if(a==1){return b;}
		VectorSIMD734 c;
	...
	inline VectorSIMD734 operator*(VectorSIMD734 a, int b){
		if(b==1){return a;}
		VectorSIMD734 c;
	...
	inline VectorSIMD734 operator*(VectorSIMD734 a, VectorSIMD734 b){
		VectorSIMD734 c;
	...
	inline VectorSIMD734 exp(VectorSIMD734 a){
		double a_d[734]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD734 sqrt(VectorSIMD734 a){
		double a_d[734]; a.convert(a_d);
