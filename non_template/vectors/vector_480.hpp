...
public:
		...
		VectorSIMD480& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD480& operator += (VectorSIMD480 a){
	...
	inline VectorSIMD480 operator*(double a, VectorSIMD480 b){
		VectorSIMD480 c;
	...
	inline VectorSIMD480 operator*(VectorSIMD480 a ,double b){
		VectorSIMD480 c;
	...
	inline VectorSIMD480 operator*(int a, VectorSIMD480 b){
		if(a==1){return b;}
		VectorSIMD480 c;
	...
	inline VectorSIMD480 operator*(VectorSIMD480 a, int b){
		if(b==1){return a;}
		VectorSIMD480 c;
	...
	inline VectorSIMD480 operator*(VectorSIMD480 a, VectorSIMD480 b){
		VectorSIMD480 c;
	...
	inline VectorSIMD480 exp(VectorSIMD480 a){
		double a_d[480]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD480 sqrt(VectorSIMD480 a){
		double a_d[480]; a.convert(a_d);
