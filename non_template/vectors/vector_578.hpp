...
public:
		...
		VectorSIMD578(double a){
			...
			_avx144=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD578(double (&a)[578]){
		...
		VectorSIMD578& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD578& operator += (VectorSIMD578 a){
	...
	inline VectorSIMD578 operator*(double a, VectorSIMD578 b){
		VectorSIMD578 c;
	...
	inline VectorSIMD578 operator*(VectorSIMD578 a ,double b){
		VectorSIMD578 c;
	...
	inline VectorSIMD578 operator*(int a, VectorSIMD578 b){
		if(a==1){return b;}
		VectorSIMD578 c;
	...
	inline VectorSIMD578 operator*(VectorSIMD578 a, int b){
		if(b==1){return a;}
		VectorSIMD578 c;
	...
	inline VectorSIMD578 operator*(VectorSIMD578 a, VectorSIMD578 b){
		VectorSIMD578 c;
	...
	inline VectorSIMD578 exp(VectorSIMD578 a){
		double a_d[578]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD578 sqrt(VectorSIMD578 a){
		double a_d[578]; a.convert(a_d);
