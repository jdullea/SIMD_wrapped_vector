...
public:
		...
		VectorSIMD301(double a){
			...
			_avx75=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD301(double (&a)[301]){
		...
		VectorSIMD301& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD301& operator += (VectorSIMD301 a){
	...
	inline VectorSIMD301 operator*(double a, VectorSIMD301 b){
		VectorSIMD301 c;
	...
	inline VectorSIMD301 operator*(VectorSIMD301 a ,double b){
		VectorSIMD301 c;
	...
	inline VectorSIMD301 operator*(int a, VectorSIMD301 b){
		if(a==1){return b;}
		VectorSIMD301 c;
	...
	inline VectorSIMD301 operator*(VectorSIMD301 a, int b){
		if(b==1){return a;}
		VectorSIMD301 c;
	...
	inline VectorSIMD301 operator*(VectorSIMD301 a, VectorSIMD301 b){
		VectorSIMD301 c;
	...
	inline VectorSIMD301 exp(VectorSIMD301 a){
		double a_d[301]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD301 sqrt(VectorSIMD301 a){
		double a_d[301]; a.convert(a_d);
