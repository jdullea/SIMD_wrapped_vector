...
public:
		...
		VectorSIMD739(double a){
			...
			_avx184=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD739(double (&a)[739]){
		...
		VectorSIMD739& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD739& operator += (VectorSIMD739 a){
	...
	inline VectorSIMD739 operator*(double a, VectorSIMD739 b){
		VectorSIMD739 c;
	...
	inline VectorSIMD739 operator*(VectorSIMD739 a ,double b){
		VectorSIMD739 c;
	...
	inline VectorSIMD739 operator*(int a, VectorSIMD739 b){
		if(a==1){return b;}
		VectorSIMD739 c;
	...
	inline VectorSIMD739 operator*(VectorSIMD739 a, int b){
		if(b==1){return a;}
		VectorSIMD739 c;
	...
	inline VectorSIMD739 operator*(VectorSIMD739 a, VectorSIMD739 b){
		VectorSIMD739 c;
	...
	inline VectorSIMD739 exp(VectorSIMD739 a){
		double a_d[739]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD739 sqrt(VectorSIMD739 a){
		double a_d[739]; a.convert(a_d);
