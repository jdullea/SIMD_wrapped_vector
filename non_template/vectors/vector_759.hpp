...
public:
		...
		VectorSIMD759(double a){
			...
			_avx189=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD759(double (&a)[759]){
		...
		VectorSIMD759& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD759& operator += (VectorSIMD759 a){
	...
	inline VectorSIMD759 operator*(double a, VectorSIMD759 b){
		VectorSIMD759 c;
	...
	inline VectorSIMD759 operator*(VectorSIMD759 a ,double b){
		VectorSIMD759 c;
	...
	inline VectorSIMD759 operator*(int a, VectorSIMD759 b){
		if(a==1){return b;}
		VectorSIMD759 c;
	...
	inline VectorSIMD759 operator*(VectorSIMD759 a, int b){
		if(b==1){return a;}
		VectorSIMD759 c;
	...
	inline VectorSIMD759 operator*(VectorSIMD759 a, VectorSIMD759 b){
		VectorSIMD759 c;
	...
	inline VectorSIMD759 exp(VectorSIMD759 a){
		double a_d[759]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD759 sqrt(VectorSIMD759 a){
		double a_d[759]; a.convert(a_d);
