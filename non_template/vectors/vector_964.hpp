...
public:
		...
		VectorSIMD964& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD964& operator += (VectorSIMD964 a){
	...
	inline VectorSIMD964 operator*(double a, VectorSIMD964 b){
		VectorSIMD964 c;
	...
	inline VectorSIMD964 operator*(VectorSIMD964 a ,double b){
		VectorSIMD964 c;
	...
	inline VectorSIMD964 operator*(int a, VectorSIMD964 b){
		if(a==1){return b;}
		VectorSIMD964 c;
	...
	inline VectorSIMD964 operator*(VectorSIMD964 a, int b){
		if(b==1){return a;}
		VectorSIMD964 c;
	...
	inline VectorSIMD964 operator*(VectorSIMD964 a, VectorSIMD964 b){
		VectorSIMD964 c;
	...
	inline VectorSIMD964 exp(VectorSIMD964 a){
		double a_d[964]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD964 sqrt(VectorSIMD964 a){
		double a_d[964]; a.convert(a_d);
