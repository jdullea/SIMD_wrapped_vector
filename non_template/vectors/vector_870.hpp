...
public:
		...
		VectorSIMD870(double a){
			...
			_avx217=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD870(double (&a)[870]){
		...
		VectorSIMD870& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD870& operator += (VectorSIMD870 a){
	...
	inline VectorSIMD870 operator*(double a, VectorSIMD870 b){
		VectorSIMD870 c;
	...
	inline VectorSIMD870 operator*(VectorSIMD870 a ,double b){
		VectorSIMD870 c;
	...
	inline VectorSIMD870 operator*(int a, VectorSIMD870 b){
		if(a==1){return b;}
		VectorSIMD870 c;
	...
	inline VectorSIMD870 operator*(VectorSIMD870 a, int b){
		if(b==1){return a;}
		VectorSIMD870 c;
	...
	inline VectorSIMD870 operator*(VectorSIMD870 a, VectorSIMD870 b){
		VectorSIMD870 c;
	...
	inline VectorSIMD870 exp(VectorSIMD870 a){
		double a_d[870]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD870 sqrt(VectorSIMD870 a){
		double a_d[870]; a.convert(a_d);
