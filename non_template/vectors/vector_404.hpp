...
public:
		...
		VectorSIMD404& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD404& operator += (VectorSIMD404 a){
	...
	inline VectorSIMD404 operator*(double a, VectorSIMD404 b){
		VectorSIMD404 c;
	...
	inline VectorSIMD404 operator*(VectorSIMD404 a ,double b){
		VectorSIMD404 c;
	...
	inline VectorSIMD404 operator*(int a, VectorSIMD404 b){
		if(a==1){return b;}
		VectorSIMD404 c;
	...
	inline VectorSIMD404 operator*(VectorSIMD404 a, int b){
		if(b==1){return a;}
		VectorSIMD404 c;
	...
	inline VectorSIMD404 operator*(VectorSIMD404 a, VectorSIMD404 b){
		VectorSIMD404 c;
	...
	inline VectorSIMD404 exp(VectorSIMD404 a){
		double a_d[404]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD404 sqrt(VectorSIMD404 a){
		double a_d[404]; a.convert(a_d);
