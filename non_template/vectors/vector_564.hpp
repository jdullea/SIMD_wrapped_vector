...
public:
		...
		VectorSIMD564& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD564& operator += (VectorSIMD564 a){
	...
	inline VectorSIMD564 operator*(double a, VectorSIMD564 b){
		VectorSIMD564 c;
	...
	inline VectorSIMD564 operator*(VectorSIMD564 a ,double b){
		VectorSIMD564 c;
	...
	inline VectorSIMD564 operator*(int a, VectorSIMD564 b){
		if(a==1){return b;}
		VectorSIMD564 c;
	...
	inline VectorSIMD564 operator*(VectorSIMD564 a, int b){
		if(b==1){return a;}
		VectorSIMD564 c;
	...
	inline VectorSIMD564 operator*(VectorSIMD564 a, VectorSIMD564 b){
		VectorSIMD564 c;
	...
	inline VectorSIMD564 exp(VectorSIMD564 a){
		double a_d[564]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD564 sqrt(VectorSIMD564 a){
		double a_d[564]; a.convert(a_d);
