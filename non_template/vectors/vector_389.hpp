...
public:
		...
		VectorSIMD389(double a){
			...
			_avx97=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD389(double (&a)[389]){
		...
		VectorSIMD389& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD389& operator += (VectorSIMD389 a){
	...
	inline VectorSIMD389 operator*(double a, VectorSIMD389 b){
		VectorSIMD389 c;
	...
	inline VectorSIMD389 operator*(VectorSIMD389 a ,double b){
		VectorSIMD389 c;
	...
	inline VectorSIMD389 operator*(int a, VectorSIMD389 b){
		if(a==1){return b;}
		VectorSIMD389 c;
	...
	inline VectorSIMD389 operator*(VectorSIMD389 a, int b){
		if(b==1){return a;}
		VectorSIMD389 c;
	...
	inline VectorSIMD389 operator*(VectorSIMD389 a, VectorSIMD389 b){
		VectorSIMD389 c;
	...
	inline VectorSIMD389 exp(VectorSIMD389 a){
		double a_d[389]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD389 sqrt(VectorSIMD389 a){
		double a_d[389]; a.convert(a_d);
