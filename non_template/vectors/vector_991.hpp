...
public:
		...
		VectorSIMD991(double a){
			...
			_avx247=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD991(double (&a)[991]){
		...
		VectorSIMD991& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD991& operator += (VectorSIMD991 a){
	...
	inline VectorSIMD991 operator*(double a, VectorSIMD991 b){
		VectorSIMD991 c;
	...
	inline VectorSIMD991 operator*(VectorSIMD991 a ,double b){
		VectorSIMD991 c;
	...
	inline VectorSIMD991 operator*(int a, VectorSIMD991 b){
		if(a==1){return b;}
		VectorSIMD991 c;
	...
	inline VectorSIMD991 operator*(VectorSIMD991 a, int b){
		if(b==1){return a;}
		VectorSIMD991 c;
	...
	inline VectorSIMD991 operator*(VectorSIMD991 a, VectorSIMD991 b){
		VectorSIMD991 c;
	...
	inline VectorSIMD991 exp(VectorSIMD991 a){
		double a_d[991]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD991 sqrt(VectorSIMD991 a){
		double a_d[991]; a.convert(a_d);
