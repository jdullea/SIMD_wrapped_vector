...
public:
		...
		VectorSIMD545(double a){
			...
			_avx136=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD545(double (&a)[545]){
		...
		VectorSIMD545& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD545& operator += (VectorSIMD545 a){
	...
	inline VectorSIMD545 operator*(double a, VectorSIMD545 b){
		VectorSIMD545 c;
	...
	inline VectorSIMD545 operator*(VectorSIMD545 a ,double b){
		VectorSIMD545 c;
	...
	inline VectorSIMD545 operator*(int a, VectorSIMD545 b){
		if(a==1){return b;}
		VectorSIMD545 c;
	...
	inline VectorSIMD545 operator*(VectorSIMD545 a, int b){
		if(b==1){return a;}
		VectorSIMD545 c;
	...
	inline VectorSIMD545 operator*(VectorSIMD545 a, VectorSIMD545 b){
		VectorSIMD545 c;
	...
	inline VectorSIMD545 exp(VectorSIMD545 a){
		double a_d[545]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD545 sqrt(VectorSIMD545 a){
		double a_d[545]; a.convert(a_d);
