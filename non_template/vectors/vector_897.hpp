...
public:
		...
		VectorSIMD897(double a){
			...
			_avx224=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD897(double (&a)[897]){
		...
		VectorSIMD897& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD897& operator += (VectorSIMD897 a){
	...
	inline VectorSIMD897 operator*(double a, VectorSIMD897 b){
		VectorSIMD897 c;
	...
	inline VectorSIMD897 operator*(VectorSIMD897 a ,double b){
		VectorSIMD897 c;
	...
	inline VectorSIMD897 operator*(int a, VectorSIMD897 b){
		if(a==1){return b;}
		VectorSIMD897 c;
	...
	inline VectorSIMD897 operator*(VectorSIMD897 a, int b){
		if(b==1){return a;}
		VectorSIMD897 c;
	...
	inline VectorSIMD897 operator*(VectorSIMD897 a, VectorSIMD897 b){
		VectorSIMD897 c;
	...
	inline VectorSIMD897 exp(VectorSIMD897 a){
		double a_d[897]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD897 sqrt(VectorSIMD897 a){
		double a_d[897]; a.convert(a_d);
