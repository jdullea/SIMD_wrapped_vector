...
public:
		...
		VectorSIMD492& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD492& operator += (VectorSIMD492 a){
	...
	inline VectorSIMD492 operator*(double a, VectorSIMD492 b){
		VectorSIMD492 c;
	...
	inline VectorSIMD492 operator*(VectorSIMD492 a ,double b){
		VectorSIMD492 c;
	...
	inline VectorSIMD492 operator*(int a, VectorSIMD492 b){
		if(a==1){return b;}
		VectorSIMD492 c;
	...
	inline VectorSIMD492 operator*(VectorSIMD492 a, int b){
		if(b==1){return a;}
		VectorSIMD492 c;
	...
	inline VectorSIMD492 operator*(VectorSIMD492 a, VectorSIMD492 b){
		VectorSIMD492 c;
	...
	inline VectorSIMD492 exp(VectorSIMD492 a){
		double a_d[492]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD492 sqrt(VectorSIMD492 a){
		double a_d[492]; a.convert(a_d);
