...
public:
		...
		VectorSIMD493(double a){
			...
			_avx123=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD493(double (&a)[493]){
		...
		VectorSIMD493& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD493& operator += (VectorSIMD493 a){
	...
	inline VectorSIMD493 operator*(double a, VectorSIMD493 b){
		VectorSIMD493 c;
	...
	inline VectorSIMD493 operator*(VectorSIMD493 a ,double b){
		VectorSIMD493 c;
	...
	inline VectorSIMD493 operator*(int a, VectorSIMD493 b){
		if(a==1){return b;}
		VectorSIMD493 c;
	...
	inline VectorSIMD493 operator*(VectorSIMD493 a, int b){
		if(b==1){return a;}
		VectorSIMD493 c;
	...
	inline VectorSIMD493 operator*(VectorSIMD493 a, VectorSIMD493 b){
		VectorSIMD493 c;
	...
	inline VectorSIMD493 exp(VectorSIMD493 a){
		double a_d[493]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD493 sqrt(VectorSIMD493 a){
		double a_d[493]; a.convert(a_d);
