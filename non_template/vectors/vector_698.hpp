...
public:
		...
		VectorSIMD698(double a){
			...
			_avx174=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD698(double (&a)[698]){
		...
		VectorSIMD698& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD698& operator += (VectorSIMD698 a){
	...
	inline VectorSIMD698 operator*(double a, VectorSIMD698 b){
		VectorSIMD698 c;
	...
	inline VectorSIMD698 operator*(VectorSIMD698 a ,double b){
		VectorSIMD698 c;
	...
	inline VectorSIMD698 operator*(int a, VectorSIMD698 b){
		if(a==1){return b;}
		VectorSIMD698 c;
	...
	inline VectorSIMD698 operator*(VectorSIMD698 a, int b){
		if(b==1){return a;}
		VectorSIMD698 c;
	...
	inline VectorSIMD698 operator*(VectorSIMD698 a, VectorSIMD698 b){
		VectorSIMD698 c;
	...
	inline VectorSIMD698 exp(VectorSIMD698 a){
		double a_d[698]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD698 sqrt(VectorSIMD698 a){
		double a_d[698]; a.convert(a_d);
