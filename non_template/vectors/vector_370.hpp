...
public:
		...
		VectorSIMD370(double a){
			...
			_avx92=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD370(double (&a)[370]){
		...
		VectorSIMD370& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD370& operator += (VectorSIMD370 a){
	...
	inline VectorSIMD370 operator*(double a, VectorSIMD370 b){
		VectorSIMD370 c;
	...
	inline VectorSIMD370 operator*(VectorSIMD370 a ,double b){
		VectorSIMD370 c;
	...
	inline VectorSIMD370 operator*(int a, VectorSIMD370 b){
		if(a==1){return b;}
		VectorSIMD370 c;
	...
	inline VectorSIMD370 operator*(VectorSIMD370 a, int b){
		if(b==1){return a;}
		VectorSIMD370 c;
	...
	inline VectorSIMD370 operator*(VectorSIMD370 a, VectorSIMD370 b){
		VectorSIMD370 c;
	...
	inline VectorSIMD370 exp(VectorSIMD370 a){
		double a_d[370]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD370 sqrt(VectorSIMD370 a){
		double a_d[370]; a.convert(a_d);
