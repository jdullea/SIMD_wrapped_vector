...
public:
		...
		VectorSIMD118(double a){
			...
			_avx29=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD118(double (&a)[118]){
		...
		VectorSIMD118& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD118& operator += (VectorSIMD118 a){
	...
	inline VectorSIMD118 operator*(double a, VectorSIMD118 b){
		VectorSIMD118 c;
	...
	inline VectorSIMD118 operator*(VectorSIMD118 a ,double b){
		VectorSIMD118 c;
	...
	inline VectorSIMD118 operator*(int a, VectorSIMD118 b){
		if(a==1){return b;}
		VectorSIMD118 c;
	...
	inline VectorSIMD118 operator*(VectorSIMD118 a, int b){
		if(b==1){return a;}
		VectorSIMD118 c;
	...
	inline VectorSIMD118 operator*(VectorSIMD118 a, VectorSIMD118 b){
		VectorSIMD118 c;
	...
	inline VectorSIMD118 exp(VectorSIMD118 a){
		double a_d[118]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD118 sqrt(VectorSIMD118 a){
		double a_d[118]; a.convert(a_d);
