...
public:
		...
		VectorSIMD482(double a){
			...
			_avx120=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD482(double (&a)[482]){
		...
		VectorSIMD482& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD482& operator += (VectorSIMD482 a){
	...
	inline VectorSIMD482 operator*(double a, VectorSIMD482 b){
		VectorSIMD482 c;
	...
	inline VectorSIMD482 operator*(VectorSIMD482 a ,double b){
		VectorSIMD482 c;
	...
	inline VectorSIMD482 operator*(int a, VectorSIMD482 b){
		if(a==1){return b;}
		VectorSIMD482 c;
	...
	inline VectorSIMD482 operator*(VectorSIMD482 a, int b){
		if(b==1){return a;}
		VectorSIMD482 c;
	...
	inline VectorSIMD482 operator*(VectorSIMD482 a, VectorSIMD482 b){
		VectorSIMD482 c;
	...
	inline VectorSIMD482 exp(VectorSIMD482 a){
		double a_d[482]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD482 sqrt(VectorSIMD482 a){
		double a_d[482]; a.convert(a_d);
