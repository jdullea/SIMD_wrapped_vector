...
public:
		...
		VectorSIMD244& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD244& operator += (VectorSIMD244 a){
	...
	inline VectorSIMD244 operator*(double a, VectorSIMD244 b){
		VectorSIMD244 c;
	...
	inline VectorSIMD244 operator*(VectorSIMD244 a ,double b){
		VectorSIMD244 c;
	...
	inline VectorSIMD244 operator*(int a, VectorSIMD244 b){
		if(a==1){return b;}
		VectorSIMD244 c;
	...
	inline VectorSIMD244 operator*(VectorSIMD244 a, int b){
		if(b==1){return a;}
		VectorSIMD244 c;
	...
	inline VectorSIMD244 operator*(VectorSIMD244 a, VectorSIMD244 b){
		VectorSIMD244 c;
	...
	inline VectorSIMD244 exp(VectorSIMD244 a){
		double a_d[244]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD244 sqrt(VectorSIMD244 a){
		double a_d[244]; a.convert(a_d);
