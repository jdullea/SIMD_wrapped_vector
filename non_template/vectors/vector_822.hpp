...
public:
		...
		VectorSIMD822(double a){
			...
			_avx205=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD822(double (&a)[822]){
		...
		VectorSIMD822& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD822& operator += (VectorSIMD822 a){
	...
	inline VectorSIMD822 operator*(double a, VectorSIMD822 b){
		VectorSIMD822 c;
	...
	inline VectorSIMD822 operator*(VectorSIMD822 a ,double b){
		VectorSIMD822 c;
	...
	inline VectorSIMD822 operator*(int a, VectorSIMD822 b){
		if(a==1){return b;}
		VectorSIMD822 c;
	...
	inline VectorSIMD822 operator*(VectorSIMD822 a, int b){
		if(b==1){return a;}
		VectorSIMD822 c;
	...
	inline VectorSIMD822 operator*(VectorSIMD822 a, VectorSIMD822 b){
		VectorSIMD822 c;
	...
	inline VectorSIMD822 exp(VectorSIMD822 a){
		double a_d[822]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD822 sqrt(VectorSIMD822 a){
		double a_d[822]; a.convert(a_d);
