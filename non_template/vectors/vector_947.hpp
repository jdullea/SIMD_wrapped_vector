...
public:
		...
		VectorSIMD947(double a){
			...
			_avx236=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD947(double (&a)[947]){
		...
		VectorSIMD947& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD947& operator += (VectorSIMD947 a){
	...
	inline VectorSIMD947 operator*(double a, VectorSIMD947 b){
		VectorSIMD947 c;
	...
	inline VectorSIMD947 operator*(VectorSIMD947 a ,double b){
		VectorSIMD947 c;
	...
	inline VectorSIMD947 operator*(int a, VectorSIMD947 b){
		if(a==1){return b;}
		VectorSIMD947 c;
	...
	inline VectorSIMD947 operator*(VectorSIMD947 a, int b){
		if(b==1){return a;}
		VectorSIMD947 c;
	...
	inline VectorSIMD947 operator*(VectorSIMD947 a, VectorSIMD947 b){
		VectorSIMD947 c;
	...
	inline VectorSIMD947 exp(VectorSIMD947 a){
		double a_d[947]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD947 sqrt(VectorSIMD947 a){
		double a_d[947]; a.convert(a_d);
