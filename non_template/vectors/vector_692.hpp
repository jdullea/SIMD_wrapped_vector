...
public:
		...
		VectorSIMD692& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD692& operator += (VectorSIMD692 a){
	...
	inline VectorSIMD692 operator*(double a, VectorSIMD692 b){
		VectorSIMD692 c;
	...
	inline VectorSIMD692 operator*(VectorSIMD692 a ,double b){
		VectorSIMD692 c;
	...
	inline VectorSIMD692 operator*(int a, VectorSIMD692 b){
		if(a==1){return b;}
		VectorSIMD692 c;
	...
	inline VectorSIMD692 operator*(VectorSIMD692 a, int b){
		if(b==1){return a;}
		VectorSIMD692 c;
	...
	inline VectorSIMD692 operator*(VectorSIMD692 a, VectorSIMD692 b){
		VectorSIMD692 c;
	...
	inline VectorSIMD692 exp(VectorSIMD692 a){
		double a_d[692]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD692 sqrt(VectorSIMD692 a){
		double a_d[692]; a.convert(a_d);
