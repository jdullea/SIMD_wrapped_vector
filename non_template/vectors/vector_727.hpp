...
public:
		...
		VectorSIMD727(double a){
			...
			_avx181=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD727(double (&a)[727]){
		...
		VectorSIMD727& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD727& operator += (VectorSIMD727 a){
	...
	inline VectorSIMD727 operator*(double a, VectorSIMD727 b){
		VectorSIMD727 c;
	...
	inline VectorSIMD727 operator*(VectorSIMD727 a ,double b){
		VectorSIMD727 c;
	...
	inline VectorSIMD727 operator*(int a, VectorSIMD727 b){
		if(a==1){return b;}
		VectorSIMD727 c;
	...
	inline VectorSIMD727 operator*(VectorSIMD727 a, int b){
		if(b==1){return a;}
		VectorSIMD727 c;
	...
	inline VectorSIMD727 operator*(VectorSIMD727 a, VectorSIMD727 b){
		VectorSIMD727 c;
	...
	inline VectorSIMD727 exp(VectorSIMD727 a){
		double a_d[727]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD727 sqrt(VectorSIMD727 a){
		double a_d[727]; a.convert(a_d);
