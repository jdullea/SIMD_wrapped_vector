...
public:
		...
		VectorSIMD605(double a){
			...
			_avx151=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD605(double (&a)[605]){
		...
		VectorSIMD605& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD605& operator += (VectorSIMD605 a){
	...
	inline VectorSIMD605 operator*(double a, VectorSIMD605 b){
		VectorSIMD605 c;
	...
	inline VectorSIMD605 operator*(VectorSIMD605 a ,double b){
		VectorSIMD605 c;
	...
	inline VectorSIMD605 operator*(int a, VectorSIMD605 b){
		if(a==1){return b;}
		VectorSIMD605 c;
	...
	inline VectorSIMD605 operator*(VectorSIMD605 a, int b){
		if(b==1){return a;}
		VectorSIMD605 c;
	...
	inline VectorSIMD605 operator*(VectorSIMD605 a, VectorSIMD605 b){
		VectorSIMD605 c;
	...
	inline VectorSIMD605 exp(VectorSIMD605 a){
		double a_d[605]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD605 sqrt(VectorSIMD605 a){
		double a_d[605]; a.convert(a_d);
