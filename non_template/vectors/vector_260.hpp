...
public:
		...
		VectorSIMD260& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD260& operator += (VectorSIMD260 a){
	...
	inline VectorSIMD260 operator*(double a, VectorSIMD260 b){
		VectorSIMD260 c;
	...
	inline VectorSIMD260 operator*(VectorSIMD260 a ,double b){
		VectorSIMD260 c;
	...
	inline VectorSIMD260 operator*(int a, VectorSIMD260 b){
		if(a==1){return b;}
		VectorSIMD260 c;
	...
	inline VectorSIMD260 operator*(VectorSIMD260 a, int b){
		if(b==1){return a;}
		VectorSIMD260 c;
	...
	inline VectorSIMD260 operator*(VectorSIMD260 a, VectorSIMD260 b){
		VectorSIMD260 c;
	...
	inline VectorSIMD260 exp(VectorSIMD260 a){
		double a_d[260]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD260 sqrt(VectorSIMD260 a){
		double a_d[260]; a.convert(a_d);
