...
public:
		...
		VectorSIMD509(double a){
			...
			_avx127=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD509(double (&a)[509]){
		...
		VectorSIMD509& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD509& operator += (VectorSIMD509 a){
	...
	inline VectorSIMD509 operator*(double a, VectorSIMD509 b){
		VectorSIMD509 c;
	...
	inline VectorSIMD509 operator*(VectorSIMD509 a ,double b){
		VectorSIMD509 c;
	...
	inline VectorSIMD509 operator*(int a, VectorSIMD509 b){
		if(a==1){return b;}
		VectorSIMD509 c;
	...
	inline VectorSIMD509 operator*(VectorSIMD509 a, int b){
		if(b==1){return a;}
		VectorSIMD509 c;
	...
	inline VectorSIMD509 operator*(VectorSIMD509 a, VectorSIMD509 b){
		VectorSIMD509 c;
	...
	inline VectorSIMD509 exp(VectorSIMD509 a){
		double a_d[509]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD509 sqrt(VectorSIMD509 a){
		double a_d[509]; a.convert(a_d);
