...
public:
		...
		VectorSIMD665(double a){
			...
			_avx166=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD665(double (&a)[665]){
		...
		VectorSIMD665& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD665& operator += (VectorSIMD665 a){
	...
	inline VectorSIMD665 operator*(double a, VectorSIMD665 b){
		VectorSIMD665 c;
	...
	inline VectorSIMD665 operator*(VectorSIMD665 a ,double b){
		VectorSIMD665 c;
	...
	inline VectorSIMD665 operator*(int a, VectorSIMD665 b){
		if(a==1){return b;}
		VectorSIMD665 c;
	...
	inline VectorSIMD665 operator*(VectorSIMD665 a, int b){
		if(b==1){return a;}
		VectorSIMD665 c;
	...
	inline VectorSIMD665 operator*(VectorSIMD665 a, VectorSIMD665 b){
		VectorSIMD665 c;
	...
	inline VectorSIMD665 exp(VectorSIMD665 a){
		double a_d[665]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD665 sqrt(VectorSIMD665 a){
		double a_d[665]; a.convert(a_d);
