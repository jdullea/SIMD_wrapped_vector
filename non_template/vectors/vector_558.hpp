...
public:
		...
		VectorSIMD558(double a){
			...
			_avx139=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD558(double (&a)[558]){
		...
		VectorSIMD558& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD558& operator += (VectorSIMD558 a){
	...
	inline VectorSIMD558 operator*(double a, VectorSIMD558 b){
		VectorSIMD558 c;
	...
	inline VectorSIMD558 operator*(VectorSIMD558 a ,double b){
		VectorSIMD558 c;
	...
	inline VectorSIMD558 operator*(int a, VectorSIMD558 b){
		if(a==1){return b;}
		VectorSIMD558 c;
	...
	inline VectorSIMD558 operator*(VectorSIMD558 a, int b){
		if(b==1){return a;}
		VectorSIMD558 c;
	...
	inline VectorSIMD558 operator*(VectorSIMD558 a, VectorSIMD558 b){
		VectorSIMD558 c;
	...
	inline VectorSIMD558 exp(VectorSIMD558 a){
		double a_d[558]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD558 sqrt(VectorSIMD558 a){
		double a_d[558]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD558 a){ 
		double ad[558];
		a.convert(ad);
