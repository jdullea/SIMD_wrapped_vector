...
public:
		...
		VectorSIMD942(double a){
			...
			_avx235=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD942(double (&a)[942]){
		...
		VectorSIMD942& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD942& operator += (VectorSIMD942 a){
	...
	inline VectorSIMD942 operator*(double a, VectorSIMD942 b){
		VectorSIMD942 c;
	...
	inline VectorSIMD942 operator*(VectorSIMD942 a ,double b){
		VectorSIMD942 c;
	...
	inline VectorSIMD942 operator*(int a, VectorSIMD942 b){
		if(a==1){return b;}
		VectorSIMD942 c;
	...
	inline VectorSIMD942 operator*(VectorSIMD942 a, int b){
		if(b==1){return a;}
		VectorSIMD942 c;
	...
	inline VectorSIMD942 operator*(VectorSIMD942 a, VectorSIMD942 b){
		VectorSIMD942 c;
	...
	inline VectorSIMD942 exp(VectorSIMD942 a){
		double a_d[942]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD942 sqrt(VectorSIMD942 a){
		double a_d[942]; a.convert(a_d);
