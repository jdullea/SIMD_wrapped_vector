...
public:
		...
		VectorSIMD361(double a){
			...
			_avx90=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD361(double (&a)[361]){
		...
		VectorSIMD361& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD361& operator += (VectorSIMD361 a){
	...
	inline VectorSIMD361 operator*(double a, VectorSIMD361 b){
		VectorSIMD361 c;
	...
	inline VectorSIMD361 operator*(VectorSIMD361 a ,double b){
		VectorSIMD361 c;
	...
	inline VectorSIMD361 operator*(int a, VectorSIMD361 b){
		if(a==1){return b;}
		VectorSIMD361 c;
	...
	inline VectorSIMD361 operator*(VectorSIMD361 a, int b){
		if(b==1){return a;}
		VectorSIMD361 c;
	...
	inline VectorSIMD361 operator*(VectorSIMD361 a, VectorSIMD361 b){
		VectorSIMD361 c;
	...
	inline VectorSIMD361 exp(VectorSIMD361 a){
		double a_d[361]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD361 sqrt(VectorSIMD361 a){
		double a_d[361]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD361 a){ 
		double ad[361];
		a.convert(ad);
