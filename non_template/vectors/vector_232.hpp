...
public:
		...
		VectorSIMD232& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD232& operator += (VectorSIMD232 a){
	...
	inline VectorSIMD232 operator*(double a, VectorSIMD232 b){
		VectorSIMD232 c;
	...
	inline VectorSIMD232 operator*(VectorSIMD232 a ,double b){
		VectorSIMD232 c;
	...
	inline VectorSIMD232 operator*(int a, VectorSIMD232 b){
		if(a==1){return b;}
		VectorSIMD232 c;
	...
	inline VectorSIMD232 operator*(VectorSIMD232 a, int b){
		if(b==1){return a;}
		VectorSIMD232 c;
	...
	inline VectorSIMD232 operator*(VectorSIMD232 a, VectorSIMD232 b){
		VectorSIMD232 c;
	...
	inline VectorSIMD232 exp(VectorSIMD232 a){
		double a_d[232]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD232 sqrt(VectorSIMD232 a){
		double a_d[232]; a.convert(a_d);
