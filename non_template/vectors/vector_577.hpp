...
public:
		...
		VectorSIMD577(double a){
			...
			_avx144=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD577(double (&a)[577]){
		...
		VectorSIMD577& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD577& operator += (VectorSIMD577 a){
	...
	inline VectorSIMD577 operator*(double a, VectorSIMD577 b){
		VectorSIMD577 c;
	...
	inline VectorSIMD577 operator*(VectorSIMD577 a ,double b){
		VectorSIMD577 c;
	...
	inline VectorSIMD577 operator*(int a, VectorSIMD577 b){
		if(a==1){return b;}
		VectorSIMD577 c;
	...
	inline VectorSIMD577 operator*(VectorSIMD577 a, int b){
		if(b==1){return a;}
		VectorSIMD577 c;
	...
	inline VectorSIMD577 operator*(VectorSIMD577 a, VectorSIMD577 b){
		VectorSIMD577 c;
	...
	inline VectorSIMD577 exp(VectorSIMD577 a){
		double a_d[577]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD577 sqrt(VectorSIMD577 a){
		double a_d[577]; a.convert(a_d);
