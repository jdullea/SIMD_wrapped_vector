...
public:
		...
		VectorSIMD302(double a){
			...
			_avx75=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD302(double (&a)[302]){
		...
		VectorSIMD302& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD302& operator += (VectorSIMD302 a){
	...
	inline VectorSIMD302 operator*(double a, VectorSIMD302 b){
		VectorSIMD302 c;
	...
	inline VectorSIMD302 operator*(VectorSIMD302 a ,double b){
		VectorSIMD302 c;
	...
	inline VectorSIMD302 operator*(int a, VectorSIMD302 b){
		if(a==1){return b;}
		VectorSIMD302 c;
	...
	inline VectorSIMD302 operator*(VectorSIMD302 a, int b){
		if(b==1){return a;}
		VectorSIMD302 c;
	...
	inline VectorSIMD302 operator*(VectorSIMD302 a, VectorSIMD302 b){
		VectorSIMD302 c;
	...
	inline VectorSIMD302 exp(VectorSIMD302 a){
		double a_d[302]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD302 sqrt(VectorSIMD302 a){
		double a_d[302]; a.convert(a_d);
