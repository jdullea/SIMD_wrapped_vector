...
public:
		...
		VectorSIMD992& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD992& operator += (VectorSIMD992 a){
	...
	inline VectorSIMD992 operator*(double a, VectorSIMD992 b){
		VectorSIMD992 c;
	...
	inline VectorSIMD992 operator*(VectorSIMD992 a ,double b){
		VectorSIMD992 c;
	...
	inline VectorSIMD992 operator*(int a, VectorSIMD992 b){
		if(a==1){return b;}
		VectorSIMD992 c;
	...
	inline VectorSIMD992 operator*(VectorSIMD992 a, int b){
		if(b==1){return a;}
		VectorSIMD992 c;
	...
	inline VectorSIMD992 operator*(VectorSIMD992 a, VectorSIMD992 b){
		VectorSIMD992 c;
	...
	inline VectorSIMD992 exp(VectorSIMD992 a){
		double a_d[992]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD992 sqrt(VectorSIMD992 a){
		double a_d[992]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD992 a){ 
		double ad[992];
		a.convert(ad);
