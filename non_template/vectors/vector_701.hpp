...
public:
		...
		VectorSIMD701(double a){
			...
			_avx175=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD701(double (&a)[701]){
		...
		VectorSIMD701& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD701& operator += (VectorSIMD701 a){
	...
	inline VectorSIMD701 operator*(double a, VectorSIMD701 b){
		VectorSIMD701 c;
	...
	inline VectorSIMD701 operator*(VectorSIMD701 a ,double b){
		VectorSIMD701 c;
	...
	inline VectorSIMD701 operator*(int a, VectorSIMD701 b){
		if(a==1){return b;}
		VectorSIMD701 c;
	...
	inline VectorSIMD701 operator*(VectorSIMD701 a, int b){
		if(b==1){return a;}
		VectorSIMD701 c;
	...
	inline VectorSIMD701 operator*(VectorSIMD701 a, VectorSIMD701 b){
		VectorSIMD701 c;
	...
	inline VectorSIMD701 exp(VectorSIMD701 a){
		double a_d[701]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD701 sqrt(VectorSIMD701 a){
		double a_d[701]; a.convert(a_d);
