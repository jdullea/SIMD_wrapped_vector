...
public:
		...
		VectorSIMD656& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD656& operator += (VectorSIMD656 a){
	...
	inline VectorSIMD656 operator*(double a, VectorSIMD656 b){
		VectorSIMD656 c;
	...
	inline VectorSIMD656 operator*(VectorSIMD656 a ,double b){
		VectorSIMD656 c;
	...
	inline VectorSIMD656 operator*(int a, VectorSIMD656 b){
		if(a==1){return b;}
		VectorSIMD656 c;
	...
	inline VectorSIMD656 operator*(VectorSIMD656 a, int b){
		if(b==1){return a;}
		VectorSIMD656 c;
	...
	inline VectorSIMD656 operator*(VectorSIMD656 a, VectorSIMD656 b){
		VectorSIMD656 c;
	...
	inline VectorSIMD656 exp(VectorSIMD656 a){
		double a_d[656]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD656 sqrt(VectorSIMD656 a){
		double a_d[656]; a.convert(a_d);
