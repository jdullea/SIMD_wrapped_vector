...
public:
		...
		VectorSIMD807(double a){
			...
			_avx201=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD807(double (&a)[807]){
		...
		VectorSIMD807& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD807& operator += (VectorSIMD807 a){
	...
	inline VectorSIMD807 operator*(double a, VectorSIMD807 b){
		VectorSIMD807 c;
	...
	inline VectorSIMD807 operator*(VectorSIMD807 a ,double b){
		VectorSIMD807 c;
	...
	inline VectorSIMD807 operator*(int a, VectorSIMD807 b){
		if(a==1){return b;}
		VectorSIMD807 c;
	...
	inline VectorSIMD807 operator*(VectorSIMD807 a, int b){
		if(b==1){return a;}
		VectorSIMD807 c;
	...
	inline VectorSIMD807 operator*(VectorSIMD807 a, VectorSIMD807 b){
		VectorSIMD807 c;
	...
	inline VectorSIMD807 exp(VectorSIMD807 a){
		double a_d[807]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD807 sqrt(VectorSIMD807 a){
		double a_d[807]; a.convert(a_d);
