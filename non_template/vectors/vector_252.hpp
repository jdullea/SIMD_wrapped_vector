...
public:
		...
		VectorSIMD252& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD252& operator += (VectorSIMD252 a){
	...
	inline VectorSIMD252 operator*(double a, VectorSIMD252 b){
		VectorSIMD252 c;
	...
	inline VectorSIMD252 operator*(VectorSIMD252 a ,double b){
		VectorSIMD252 c;
	...
	inline VectorSIMD252 operator*(int a, VectorSIMD252 b){
		if(a==1){return b;}
		VectorSIMD252 c;
	...
	inline VectorSIMD252 operator*(VectorSIMD252 a, int b){
		if(b==1){return a;}
		VectorSIMD252 c;
	...
	inline VectorSIMD252 operator*(VectorSIMD252 a, VectorSIMD252 b){
		VectorSIMD252 c;
	...
	inline VectorSIMD252 exp(VectorSIMD252 a){
		double a_d[252]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD252 sqrt(VectorSIMD252 a){
		double a_d[252]; a.convert(a_d);
