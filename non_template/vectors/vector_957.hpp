...
public:
		...
		VectorSIMD957(double a){
			...
			_avx239=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD957(double (&a)[957]){
		...
		VectorSIMD957& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD957& operator += (VectorSIMD957 a){
	...
	inline VectorSIMD957 operator*(double a, VectorSIMD957 b){
		VectorSIMD957 c;
	...
	inline VectorSIMD957 operator*(VectorSIMD957 a ,double b){
		VectorSIMD957 c;
	...
	inline VectorSIMD957 operator*(int a, VectorSIMD957 b){
		if(a==1){return b;}
		VectorSIMD957 c;
	...
	inline VectorSIMD957 operator*(VectorSIMD957 a, int b){
		if(b==1){return a;}
		VectorSIMD957 c;
	...
	inline VectorSIMD957 operator*(VectorSIMD957 a, VectorSIMD957 b){
		VectorSIMD957 c;
	...
	inline VectorSIMD957 exp(VectorSIMD957 a){
		double a_d[957]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD957 sqrt(VectorSIMD957 a){
		double a_d[957]; a.convert(a_d);
