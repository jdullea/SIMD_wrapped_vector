...
public:
		...
		VectorSIMD898(double a){
			...
			_avx224=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD898(double (&a)[898]){
		...
		VectorSIMD898& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD898& operator += (VectorSIMD898 a){
	...
	inline VectorSIMD898 operator*(double a, VectorSIMD898 b){
		VectorSIMD898 c;
	...
	inline VectorSIMD898 operator*(VectorSIMD898 a ,double b){
		VectorSIMD898 c;
	...
	inline VectorSIMD898 operator*(int a, VectorSIMD898 b){
		if(a==1){return b;}
		VectorSIMD898 c;
	...
	inline VectorSIMD898 operator*(VectorSIMD898 a, int b){
		if(b==1){return a;}
		VectorSIMD898 c;
	...
	inline VectorSIMD898 operator*(VectorSIMD898 a, VectorSIMD898 b){
		VectorSIMD898 c;
	...
	inline VectorSIMD898 exp(VectorSIMD898 a){
		double a_d[898]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD898 sqrt(VectorSIMD898 a){
		double a_d[898]; a.convert(a_d);
