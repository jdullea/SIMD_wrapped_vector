...
public:
		...
		VectorSIMD314(double a){
			...
			_avx78=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD314(double (&a)[314]){
		...
		VectorSIMD314& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD314& operator += (VectorSIMD314 a){
	...
	inline VectorSIMD314 operator*(double a, VectorSIMD314 b){
		VectorSIMD314 c;
	...
	inline VectorSIMD314 operator*(VectorSIMD314 a ,double b){
		VectorSIMD314 c;
	...
	inline VectorSIMD314 operator*(int a, VectorSIMD314 b){
		if(a==1){return b;}
		VectorSIMD314 c;
	...
	inline VectorSIMD314 operator*(VectorSIMD314 a, int b){
		if(b==1){return a;}
		VectorSIMD314 c;
	...
	inline VectorSIMD314 operator*(VectorSIMD314 a, VectorSIMD314 b){
		VectorSIMD314 c;
	...
	inline VectorSIMD314 exp(VectorSIMD314 a){
		double a_d[314]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD314 sqrt(VectorSIMD314 a){
		double a_d[314]; a.convert(a_d);
