...
public:
		...
		VectorSIMD18(double (&a)[18]){
			...
			_avx4=_mm256_set_pd(0,0,a[17],a[16]);
		}

		VectorSIMD18(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17){
			...
			_avx4=_mm256_set_pd( 0,0,_17,_16);
		}

		VectorSIMD18(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD18& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD18& operator += (VectorSIMD18 a){
	...
	inline VectorSIMD18 operator*(double a, VectorSIMD18 b){
		VectorSIMD18 c;
	...
	inline VectorSIMD18 operator*(VectorSIMD18 a ,double b){
		VectorSIMD18 c;
	...
	inline VectorSIMD18 operator*(int a, VectorSIMD18 b){
		if(a==1){return b;}
		VectorSIMD18 c;
	...
	inline VectorSIMD18 operator*(VectorSIMD18 a, int b){
		if(b==1){return a;}
		VectorSIMD18 c;
	...
	inline VectorSIMD18 operator*(VectorSIMD18 a, VectorSIMD18 b){
		VectorSIMD18 c;
	...
	inline VectorSIMD18 exp(VectorSIMD18 a){
	...
	inline VectorSIMD18 sqrt(VectorSIMD18 a){
		double a_d[18]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD18 a){ 
		double ad[18];
		a.convert(ad);
