...
public:
		...
		VectorSIMD643(double a){
			...
			_avx160=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD643(double (&a)[643]){
		...
		VectorSIMD643& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD643& operator += (VectorSIMD643 a){
	...
	inline VectorSIMD643 operator*(double a, VectorSIMD643 b){
		VectorSIMD643 c;
	...
	inline VectorSIMD643 operator*(VectorSIMD643 a ,double b){
		VectorSIMD643 c;
	...
	inline VectorSIMD643 operator*(int a, VectorSIMD643 b){
		if(a==1){return b;}
		VectorSIMD643 c;
	...
	inline VectorSIMD643 operator*(VectorSIMD643 a, int b){
		if(b==1){return a;}
		VectorSIMD643 c;
	...
	inline VectorSIMD643 operator*(VectorSIMD643 a, VectorSIMD643 b){
		VectorSIMD643 c;
	...
	inline VectorSIMD643 exp(VectorSIMD643 a){
		double a_d[643]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD643 sqrt(VectorSIMD643 a){
		double a_d[643]; a.convert(a_d);
