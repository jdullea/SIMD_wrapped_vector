...
public:
		...
		VectorSIMD341(double a){
			...
			_avx85=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD341(double (&a)[341]){
		...
		VectorSIMD341& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD341& operator += (VectorSIMD341 a){
	...
	inline VectorSIMD341 operator*(double a, VectorSIMD341 b){
		VectorSIMD341 c;
	...
	inline VectorSIMD341 operator*(VectorSIMD341 a ,double b){
		VectorSIMD341 c;
	...
	inline VectorSIMD341 operator*(int a, VectorSIMD341 b){
		if(a==1){return b;}
		VectorSIMD341 c;
	...
	inline VectorSIMD341 operator*(VectorSIMD341 a, int b){
		if(b==1){return a;}
		VectorSIMD341 c;
	...
	inline VectorSIMD341 operator*(VectorSIMD341 a, VectorSIMD341 b){
		VectorSIMD341 c;
	...
	inline VectorSIMD341 exp(VectorSIMD341 a){
		double a_d[341]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD341 sqrt(VectorSIMD341 a){
		double a_d[341]; a.convert(a_d);
