...
public:
		...
		VectorSIMD441(double a){
			...
			_avx110=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD441(double (&a)[441]){
		...
		VectorSIMD441& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD441& operator += (VectorSIMD441 a){
	...
	inline VectorSIMD441 operator*(double a, VectorSIMD441 b){
		VectorSIMD441 c;
	...
	inline VectorSIMD441 operator*(VectorSIMD441 a ,double b){
		VectorSIMD441 c;
	...
	inline VectorSIMD441 operator*(int a, VectorSIMD441 b){
		if(a==1){return b;}
		VectorSIMD441 c;
	...
	inline VectorSIMD441 operator*(VectorSIMD441 a, int b){
		if(b==1){return a;}
		VectorSIMD441 c;
	...
	inline VectorSIMD441 operator*(VectorSIMD441 a, VectorSIMD441 b){
		VectorSIMD441 c;
	...
	inline VectorSIMD441 exp(VectorSIMD441 a){
		double a_d[441]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD441 sqrt(VectorSIMD441 a){
		double a_d[441]; a.convert(a_d);
