...
public:
		...
		VectorSIMD769(double a){
			...
			_avx192=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD769(double (&a)[769]){
		...
		VectorSIMD769& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD769& operator += (VectorSIMD769 a){
	...
	inline VectorSIMD769 operator*(double a, VectorSIMD769 b){
		VectorSIMD769 c;
	...
	inline VectorSIMD769 operator*(VectorSIMD769 a ,double b){
		VectorSIMD769 c;
	...
	inline VectorSIMD769 operator*(int a, VectorSIMD769 b){
		if(a==1){return b;}
		VectorSIMD769 c;
	...
	inline VectorSIMD769 operator*(VectorSIMD769 a, int b){
		if(b==1){return a;}
		VectorSIMD769 c;
	...
	inline VectorSIMD769 operator*(VectorSIMD769 a, VectorSIMD769 b){
		VectorSIMD769 c;
	...
	inline VectorSIMD769 exp(VectorSIMD769 a){
		double a_d[769]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD769 sqrt(VectorSIMD769 a){
		double a_d[769]; a.convert(a_d);
