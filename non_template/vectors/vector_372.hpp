...
public:
		...
		VectorSIMD372& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD372& operator += (VectorSIMD372 a){
	...
	inline VectorSIMD372 operator*(double a, VectorSIMD372 b){
		VectorSIMD372 c;
	...
	inline VectorSIMD372 operator*(VectorSIMD372 a ,double b){
		VectorSIMD372 c;
	...
	inline VectorSIMD372 operator*(int a, VectorSIMD372 b){
		if(a==1){return b;}
		VectorSIMD372 c;
	...
	inline VectorSIMD372 operator*(VectorSIMD372 a, int b){
		if(b==1){return a;}
		VectorSIMD372 c;
	...
	inline VectorSIMD372 operator*(VectorSIMD372 a, VectorSIMD372 b){
		VectorSIMD372 c;
	...
	inline VectorSIMD372 exp(VectorSIMD372 a){
		double a_d[372]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD372 sqrt(VectorSIMD372 a){
		double a_d[372]; a.convert(a_d);
