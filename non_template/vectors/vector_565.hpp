...
public:
		...
		VectorSIMD565(double a){
			...
			_avx141=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD565(double (&a)[565]){
		...
		VectorSIMD565& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD565& operator += (VectorSIMD565 a){
	...
	inline VectorSIMD565 operator*(double a, VectorSIMD565 b){
		VectorSIMD565 c;
	...
	inline VectorSIMD565 operator*(VectorSIMD565 a ,double b){
		VectorSIMD565 c;
	...
	inline VectorSIMD565 operator*(int a, VectorSIMD565 b){
		if(a==1){return b;}
		VectorSIMD565 c;
	...
	inline VectorSIMD565 operator*(VectorSIMD565 a, int b){
		if(b==1){return a;}
		VectorSIMD565 c;
	...
	inline VectorSIMD565 operator*(VectorSIMD565 a, VectorSIMD565 b){
		VectorSIMD565 c;
	...
	inline VectorSIMD565 exp(VectorSIMD565 a){
		double a_d[565]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD565 sqrt(VectorSIMD565 a){
		double a_d[565]; a.convert(a_d);
