...
public:
		...
		VectorSIMD204& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD204& operator += (VectorSIMD204 a){
	...
	inline VectorSIMD204 operator*(double a, VectorSIMD204 b){
		VectorSIMD204 c;
	...
	inline VectorSIMD204 operator*(VectorSIMD204 a ,double b){
		VectorSIMD204 c;
	...
	inline VectorSIMD204 operator*(int a, VectorSIMD204 b){
		if(a==1){return b;}
		VectorSIMD204 c;
	...
	inline VectorSIMD204 operator*(VectorSIMD204 a, int b){
		if(b==1){return a;}
		VectorSIMD204 c;
	...
	inline VectorSIMD204 operator*(VectorSIMD204 a, VectorSIMD204 b){
		VectorSIMD204 c;
	...
	inline VectorSIMD204 exp(VectorSIMD204 a){
		double a_d[204]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD204 sqrt(VectorSIMD204 a){
		double a_d[204]; a.convert(a_d);
