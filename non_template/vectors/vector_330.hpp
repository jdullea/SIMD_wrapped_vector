...
public:
		...
		VectorSIMD330(double a){
			...
			_avx82=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD330(double (&a)[330]){
		...
		VectorSIMD330& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD330& operator += (VectorSIMD330 a){
	...
	inline VectorSIMD330 operator*(double a, VectorSIMD330 b){
		VectorSIMD330 c;
	...
	inline VectorSIMD330 operator*(VectorSIMD330 a ,double b){
		VectorSIMD330 c;
	...
	inline VectorSIMD330 operator*(int a, VectorSIMD330 b){
		if(a==1){return b;}
		VectorSIMD330 c;
	...
	inline VectorSIMD330 operator*(VectorSIMD330 a, int b){
		if(b==1){return a;}
		VectorSIMD330 c;
	...
	inline VectorSIMD330 operator*(VectorSIMD330 a, VectorSIMD330 b){
		VectorSIMD330 c;
	...
	inline VectorSIMD330 exp(VectorSIMD330 a){
		double a_d[330]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD330 sqrt(VectorSIMD330 a){
		double a_d[330]; a.convert(a_d);
