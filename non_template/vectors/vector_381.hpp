...
public:
		...
		VectorSIMD381(double a){
			...
			_avx95=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD381(double (&a)[381]){
		...
		VectorSIMD381& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD381& operator += (VectorSIMD381 a){
	...
	inline VectorSIMD381 operator*(double a, VectorSIMD381 b){
		VectorSIMD381 c;
	...
	inline VectorSIMD381 operator*(VectorSIMD381 a ,double b){
		VectorSIMD381 c;
	...
	inline VectorSIMD381 operator*(int a, VectorSIMD381 b){
		if(a==1){return b;}
		VectorSIMD381 c;
	...
	inline VectorSIMD381 operator*(VectorSIMD381 a, int b){
		if(b==1){return a;}
		VectorSIMD381 c;
	...
	inline VectorSIMD381 operator*(VectorSIMD381 a, VectorSIMD381 b){
		VectorSIMD381 c;
	...
	inline VectorSIMD381 exp(VectorSIMD381 a){
		double a_d[381]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD381 sqrt(VectorSIMD381 a){
		double a_d[381]; a.convert(a_d);
