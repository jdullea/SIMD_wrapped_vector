...
public:
		...
		VectorSIMD338(double a){
			...
			_avx84=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD338(double (&a)[338]){
		...
		VectorSIMD338& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD338& operator += (VectorSIMD338 a){
	...
	inline VectorSIMD338 operator*(double a, VectorSIMD338 b){
		VectorSIMD338 c;
	...
	inline VectorSIMD338 operator*(VectorSIMD338 a ,double b){
		VectorSIMD338 c;
	...
	inline VectorSIMD338 operator*(int a, VectorSIMD338 b){
		if(a==1){return b;}
		VectorSIMD338 c;
	...
	inline VectorSIMD338 operator*(VectorSIMD338 a, int b){
		if(b==1){return a;}
		VectorSIMD338 c;
	...
	inline VectorSIMD338 operator*(VectorSIMD338 a, VectorSIMD338 b){
		VectorSIMD338 c;
	...
	inline VectorSIMD338 exp(VectorSIMD338 a){
		double a_d[338]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD338 sqrt(VectorSIMD338 a){
		double a_d[338]; a.convert(a_d);
