...
public:
		...
		VectorSIMD378(double a){
			...
			_avx94=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD378(double (&a)[378]){
		...
		VectorSIMD378& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD378& operator += (VectorSIMD378 a){
	...
	inline VectorSIMD378 operator*(double a, VectorSIMD378 b){
		VectorSIMD378 c;
	...
	inline VectorSIMD378 operator*(VectorSIMD378 a ,double b){
		VectorSIMD378 c;
	...
	inline VectorSIMD378 operator*(int a, VectorSIMD378 b){
		if(a==1){return b;}
		VectorSIMD378 c;
	...
	inline VectorSIMD378 operator*(VectorSIMD378 a, int b){
		if(b==1){return a;}
		VectorSIMD378 c;
	...
	inline VectorSIMD378 operator*(VectorSIMD378 a, VectorSIMD378 b){
		VectorSIMD378 c;
	...
	inline VectorSIMD378 exp(VectorSIMD378 a){
		double a_d[378]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD378 sqrt(VectorSIMD378 a){
		double a_d[378]; a.convert(a_d);
