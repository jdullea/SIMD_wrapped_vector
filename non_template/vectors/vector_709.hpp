...
public:
		...
		VectorSIMD709(double a){
			...
			_avx177=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD709(double (&a)[709]){
		...
		VectorSIMD709& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD709& operator += (VectorSIMD709 a){
	...
	inline VectorSIMD709 operator*(double a, VectorSIMD709 b){
		VectorSIMD709 c;
	...
	inline VectorSIMD709 operator*(VectorSIMD709 a ,double b){
		VectorSIMD709 c;
	...
	inline VectorSIMD709 operator*(int a, VectorSIMD709 b){
		if(a==1){return b;}
		VectorSIMD709 c;
	...
	inline VectorSIMD709 operator*(VectorSIMD709 a, int b){
		if(b==1){return a;}
		VectorSIMD709 c;
	...
	inline VectorSIMD709 operator*(VectorSIMD709 a, VectorSIMD709 b){
		VectorSIMD709 c;
	...
	inline VectorSIMD709 exp(VectorSIMD709 a){
		double a_d[709]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD709 sqrt(VectorSIMD709 a){
		double a_d[709]; a.convert(a_d);
