...
public:
		...
		VectorSIMD217(double a){
			...
			_avx54=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD217(double (&a)[217]){
		...
		VectorSIMD217& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD217& operator += (VectorSIMD217 a){
	...
	inline VectorSIMD217 operator*(double a, VectorSIMD217 b){
		VectorSIMD217 c;
	...
	inline VectorSIMD217 operator*(VectorSIMD217 a ,double b){
		VectorSIMD217 c;
	...
	inline VectorSIMD217 operator*(int a, VectorSIMD217 b){
		if(a==1){return b;}
		VectorSIMD217 c;
	...
	inline VectorSIMD217 operator*(VectorSIMD217 a, int b){
		if(b==1){return a;}
		VectorSIMD217 c;
	...
	inline VectorSIMD217 operator*(VectorSIMD217 a, VectorSIMD217 b){
		VectorSIMD217 c;
	...
	inline VectorSIMD217 exp(VectorSIMD217 a){
		double a_d[217]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD217 sqrt(VectorSIMD217 a){
		double a_d[217]; a.convert(a_d);
