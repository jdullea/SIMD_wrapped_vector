...
public:
		...
		VectorSIMD538(double a){
			...
			_avx134=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD538(double (&a)[538]){
		...
		VectorSIMD538& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD538& operator += (VectorSIMD538 a){
	...
	inline VectorSIMD538 operator*(double a, VectorSIMD538 b){
		VectorSIMD538 c;
	...
	inline VectorSIMD538 operator*(VectorSIMD538 a ,double b){
		VectorSIMD538 c;
	...
	inline VectorSIMD538 operator*(int a, VectorSIMD538 b){
		if(a==1){return b;}
		VectorSIMD538 c;
	...
	inline VectorSIMD538 operator*(VectorSIMD538 a, int b){
		if(b==1){return a;}
		VectorSIMD538 c;
	...
	inline VectorSIMD538 operator*(VectorSIMD538 a, VectorSIMD538 b){
		VectorSIMD538 c;
	...
	inline VectorSIMD538 exp(VectorSIMD538 a){
		double a_d[538]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD538 sqrt(VectorSIMD538 a){
		double a_d[538]; a.convert(a_d);
