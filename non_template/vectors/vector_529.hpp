...
public:
		...
		VectorSIMD529(double a){
			...
			_avx132=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD529(double (&a)[529]){
		...
		VectorSIMD529& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD529& operator += (VectorSIMD529 a){
	...
	inline VectorSIMD529 operator*(double a, VectorSIMD529 b){
		VectorSIMD529 c;
	...
	inline VectorSIMD529 operator*(VectorSIMD529 a ,double b){
		VectorSIMD529 c;
	...
	inline VectorSIMD529 operator*(int a, VectorSIMD529 b){
		if(a==1){return b;}
		VectorSIMD529 c;
	...
	inline VectorSIMD529 operator*(VectorSIMD529 a, int b){
		if(b==1){return a;}
		VectorSIMD529 c;
	...
	inline VectorSIMD529 operator*(VectorSIMD529 a, VectorSIMD529 b){
		VectorSIMD529 c;
	...
	inline VectorSIMD529 exp(VectorSIMD529 a){
		double a_d[529]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD529 sqrt(VectorSIMD529 a){
		double a_d[529]; a.convert(a_d);
