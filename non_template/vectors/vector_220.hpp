...
public:
		...
		VectorSIMD220& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD220& operator += (VectorSIMD220 a){
	...
	inline VectorSIMD220 operator*(double a, VectorSIMD220 b){
		VectorSIMD220 c;
	...
	inline VectorSIMD220 operator*(VectorSIMD220 a ,double b){
		VectorSIMD220 c;
	...
	inline VectorSIMD220 operator*(int a, VectorSIMD220 b){
		if(a==1){return b;}
		VectorSIMD220 c;
	...
	inline VectorSIMD220 operator*(VectorSIMD220 a, int b){
		if(b==1){return a;}
		VectorSIMD220 c;
	...
	inline VectorSIMD220 operator*(VectorSIMD220 a, VectorSIMD220 b){
		VectorSIMD220 c;
	...
	inline VectorSIMD220 exp(VectorSIMD220 a){
		double a_d[220]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD220 sqrt(VectorSIMD220 a){
		double a_d[220]; a.convert(a_d);
