...
public:
		...
		VectorSIMD628& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD628& operator += (VectorSIMD628 a){
	...
	inline VectorSIMD628 operator*(double a, VectorSIMD628 b){
		VectorSIMD628 c;
	...
	inline VectorSIMD628 operator*(VectorSIMD628 a ,double b){
		VectorSIMD628 c;
	...
	inline VectorSIMD628 operator*(int a, VectorSIMD628 b){
		if(a==1){return b;}
		VectorSIMD628 c;
	...
	inline VectorSIMD628 operator*(VectorSIMD628 a, int b){
		if(b==1){return a;}
		VectorSIMD628 c;
	...
	inline VectorSIMD628 operator*(VectorSIMD628 a, VectorSIMD628 b){
		VectorSIMD628 c;
	...
	inline VectorSIMD628 exp(VectorSIMD628 a){
		double a_d[628]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD628 sqrt(VectorSIMD628 a){
		double a_d[628]; a.convert(a_d);
