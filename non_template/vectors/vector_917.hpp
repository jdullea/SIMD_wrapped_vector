...
public:
		...
		VectorSIMD917(double a){
			...
			_avx229=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD917(double (&a)[917]){
		...
		VectorSIMD917& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD917& operator += (VectorSIMD917 a){
	...
	inline VectorSIMD917 operator*(double a, VectorSIMD917 b){
		VectorSIMD917 c;
	...
	inline VectorSIMD917 operator*(VectorSIMD917 a ,double b){
		VectorSIMD917 c;
	...
	inline VectorSIMD917 operator*(int a, VectorSIMD917 b){
		if(a==1){return b;}
		VectorSIMD917 c;
	...
	inline VectorSIMD917 operator*(VectorSIMD917 a, int b){
		if(b==1){return a;}
		VectorSIMD917 c;
	...
	inline VectorSIMD917 operator*(VectorSIMD917 a, VectorSIMD917 b){
		VectorSIMD917 c;
	...
	inline VectorSIMD917 exp(VectorSIMD917 a){
		double a_d[917]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD917 sqrt(VectorSIMD917 a){
		double a_d[917]; a.convert(a_d);
