...
public:
		...
		VectorSIMD205(double a){
			...
			_avx51=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD205(double (&a)[205]){
		...
		VectorSIMD205& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD205& operator += (VectorSIMD205 a){
	...
	inline VectorSIMD205 operator*(double a, VectorSIMD205 b){
		VectorSIMD205 c;
	...
	inline VectorSIMD205 operator*(VectorSIMD205 a ,double b){
		VectorSIMD205 c;
	...
	inline VectorSIMD205 operator*(int a, VectorSIMD205 b){
		if(a==1){return b;}
		VectorSIMD205 c;
	...
	inline VectorSIMD205 operator*(VectorSIMD205 a, int b){
		if(b==1){return a;}
		VectorSIMD205 c;
	...
	inline VectorSIMD205 operator*(VectorSIMD205 a, VectorSIMD205 b){
		VectorSIMD205 c;
	...
	inline VectorSIMD205 exp(VectorSIMD205 a){
		double a_d[205]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD205 sqrt(VectorSIMD205 a){
		double a_d[205]; a.convert(a_d);
