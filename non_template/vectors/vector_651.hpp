...
public:
		...
		VectorSIMD651(double a){
			...
			_avx162=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD651(double (&a)[651]){
		...
		VectorSIMD651& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD651& operator += (VectorSIMD651 a){
	...
	inline VectorSIMD651 operator*(double a, VectorSIMD651 b){
		VectorSIMD651 c;
	...
	inline VectorSIMD651 operator*(VectorSIMD651 a ,double b){
		VectorSIMD651 c;
	...
	inline VectorSIMD651 operator*(int a, VectorSIMD651 b){
		if(a==1){return b;}
		VectorSIMD651 c;
	...
	inline VectorSIMD651 operator*(VectorSIMD651 a, int b){
		if(b==1){return a;}
		VectorSIMD651 c;
	...
	inline VectorSIMD651 operator*(VectorSIMD651 a, VectorSIMD651 b){
		VectorSIMD651 c;
	...
	inline VectorSIMD651 exp(VectorSIMD651 a){
		double a_d[651]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD651 sqrt(VectorSIMD651 a){
		double a_d[651]; a.convert(a_d);
