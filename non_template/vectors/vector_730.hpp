...
public:
		...
		VectorSIMD730(double a){
			...
			_avx182=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD730(double (&a)[730]){
		...
		VectorSIMD730& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD730& operator += (VectorSIMD730 a){
	...
	inline VectorSIMD730 operator*(double a, VectorSIMD730 b){
		VectorSIMD730 c;
	...
	inline VectorSIMD730 operator*(VectorSIMD730 a ,double b){
		VectorSIMD730 c;
	...
	inline VectorSIMD730 operator*(int a, VectorSIMD730 b){
		if(a==1){return b;}
		VectorSIMD730 c;
	...
	inline VectorSIMD730 operator*(VectorSIMD730 a, int b){
		if(b==1){return a;}
		VectorSIMD730 c;
	...
	inline VectorSIMD730 operator*(VectorSIMD730 a, VectorSIMD730 b){
		VectorSIMD730 c;
	...
	inline VectorSIMD730 exp(VectorSIMD730 a){
		double a_d[730]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD730 sqrt(VectorSIMD730 a){
		double a_d[730]; a.convert(a_d);
