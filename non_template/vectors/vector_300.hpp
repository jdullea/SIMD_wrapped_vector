...
public:
		...
		VectorSIMD300& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD300& operator += (VectorSIMD300 a){
	...
	inline VectorSIMD300 operator*(double a, VectorSIMD300 b){
		VectorSIMD300 c;
	...
	inline VectorSIMD300 operator*(VectorSIMD300 a ,double b){
		VectorSIMD300 c;
	...
	inline VectorSIMD300 operator*(int a, VectorSIMD300 b){
		if(a==1){return b;}
		VectorSIMD300 c;
	...
	inline VectorSIMD300 operator*(VectorSIMD300 a, int b){
		if(b==1){return a;}
		VectorSIMD300 c;
	...
	inline VectorSIMD300 operator*(VectorSIMD300 a, VectorSIMD300 b){
		VectorSIMD300 c;
	...
	inline VectorSIMD300 exp(VectorSIMD300 a){
		double a_d[300]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD300 sqrt(VectorSIMD300 a){
		double a_d[300]; a.convert(a_d);
