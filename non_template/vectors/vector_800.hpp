...
public:
		...
		VectorSIMD800& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD800& operator += (VectorSIMD800 a){
	...
	inline VectorSIMD800 operator*(double a, VectorSIMD800 b){
		VectorSIMD800 c;
	...
	inline VectorSIMD800 operator*(VectorSIMD800 a ,double b){
		VectorSIMD800 c;
	...
	inline VectorSIMD800 operator*(int a, VectorSIMD800 b){
		if(a==1){return b;}
		VectorSIMD800 c;
	...
	inline VectorSIMD800 operator*(VectorSIMD800 a, int b){
		if(b==1){return a;}
		VectorSIMD800 c;
	...
	inline VectorSIMD800 operator*(VectorSIMD800 a, VectorSIMD800 b){
		VectorSIMD800 c;
	...
	inline VectorSIMD800 exp(VectorSIMD800 a){
		double a_d[800]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD800 sqrt(VectorSIMD800 a){
		double a_d[800]; a.convert(a_d);
