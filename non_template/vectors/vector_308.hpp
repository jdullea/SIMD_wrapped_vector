...
public:
		...
		VectorSIMD308& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD308& operator += (VectorSIMD308 a){
	...
	inline VectorSIMD308 operator*(double a, VectorSIMD308 b){
		VectorSIMD308 c;
	...
	inline VectorSIMD308 operator*(VectorSIMD308 a ,double b){
		VectorSIMD308 c;
	...
	inline VectorSIMD308 operator*(int a, VectorSIMD308 b){
		if(a==1){return b;}
		VectorSIMD308 c;
	...
	inline VectorSIMD308 operator*(VectorSIMD308 a, int b){
		if(b==1){return a;}
		VectorSIMD308 c;
	...
	inline VectorSIMD308 operator*(VectorSIMD308 a, VectorSIMD308 b){
		VectorSIMD308 c;
	...
	inline VectorSIMD308 exp(VectorSIMD308 a){
		double a_d[308]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD308 sqrt(VectorSIMD308 a){
		double a_d[308]; a.convert(a_d);
