...
public:
		...
		VectorSIMD1000& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1000& operator += (VectorSIMD1000 a){
	...
	inline VectorSIMD1000 operator*(double a, VectorSIMD1000 b){
		VectorSIMD1000 c;
	...
	inline VectorSIMD1000 operator*(VectorSIMD1000 a ,double b){
		VectorSIMD1000 c;
	...
	inline VectorSIMD1000 operator*(int a, VectorSIMD1000 b){
		if(a==1){return b;}
		VectorSIMD1000 c;
	...
	inline VectorSIMD1000 operator*(VectorSIMD1000 a, int b){
		if(b==1){return a;}
		VectorSIMD1000 c;
	...
	inline VectorSIMD1000 operator*(VectorSIMD1000 a, VectorSIMD1000 b){
		VectorSIMD1000 c;
	...
	inline VectorSIMD1000 exp(VectorSIMD1000 a){
		double a_d[1000]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1000 r(a_d);
		return r;
	}

	inline VectorSIMD1000 sqrt(VectorSIMD1000 a){
		double a_d[1000]; a.convert(a_d);
