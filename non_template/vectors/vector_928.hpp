...
public:
		...
		VectorSIMD928& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD928& operator += (VectorSIMD928 a){
	...
	inline VectorSIMD928 operator*(double a, VectorSIMD928 b){
		VectorSIMD928 c;
	...
	inline VectorSIMD928 operator*(VectorSIMD928 a ,double b){
		VectorSIMD928 c;
	...
	inline VectorSIMD928 operator*(int a, VectorSIMD928 b){
		if(a==1){return b;}
		VectorSIMD928 c;
	...
	inline VectorSIMD928 operator*(VectorSIMD928 a, int b){
		if(b==1){return a;}
		VectorSIMD928 c;
	...
	inline VectorSIMD928 operator*(VectorSIMD928 a, VectorSIMD928 b){
		VectorSIMD928 c;
	...
	inline VectorSIMD928 exp(VectorSIMD928 a){
		double a_d[928]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD928 sqrt(VectorSIMD928 a){
		double a_d[928]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD928 a){ 
		double ad[928];
		a.convert(ad);
