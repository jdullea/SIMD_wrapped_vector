...
public:
		...
		VectorSIMD793(double a){
			...
			_avx198=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD793(double (&a)[793]){
		...
		VectorSIMD793& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD793& operator += (VectorSIMD793 a){
	...
	inline VectorSIMD793 operator*(double a, VectorSIMD793 b){
		VectorSIMD793 c;
	...
	inline VectorSIMD793 operator*(VectorSIMD793 a ,double b){
		VectorSIMD793 c;
	...
	inline VectorSIMD793 operator*(int a, VectorSIMD793 b){
		if(a==1){return b;}
		VectorSIMD793 c;
	...
	inline VectorSIMD793 operator*(VectorSIMD793 a, int b){
		if(b==1){return a;}
		VectorSIMD793 c;
	...
	inline VectorSIMD793 operator*(VectorSIMD793 a, VectorSIMD793 b){
		VectorSIMD793 c;
	...
	inline VectorSIMD793 exp(VectorSIMD793 a){
		double a_d[793]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD793 sqrt(VectorSIMD793 a){
		double a_d[793]; a.convert(a_d);
