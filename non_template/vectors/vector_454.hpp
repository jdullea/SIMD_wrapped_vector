...
public:
		...
		VectorSIMD454(double a){
			...
			_avx113=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD454(double (&a)[454]){
		...
		VectorSIMD454& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD454& operator += (VectorSIMD454 a){
	...
	inline VectorSIMD454 operator*(double a, VectorSIMD454 b){
		VectorSIMD454 c;
	...
	inline VectorSIMD454 operator*(VectorSIMD454 a ,double b){
		VectorSIMD454 c;
	...
	inline VectorSIMD454 operator*(int a, VectorSIMD454 b){
		if(a==1){return b;}
		VectorSIMD454 c;
	...
	inline VectorSIMD454 operator*(VectorSIMD454 a, int b){
		if(b==1){return a;}
		VectorSIMD454 c;
	...
	inline VectorSIMD454 operator*(VectorSIMD454 a, VectorSIMD454 b){
		VectorSIMD454 c;
	...
	inline VectorSIMD454 exp(VectorSIMD454 a){
		double a_d[454]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD454 sqrt(VectorSIMD454 a){
		double a_d[454]; a.convert(a_d);
