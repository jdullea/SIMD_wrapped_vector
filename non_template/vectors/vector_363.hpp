...
public:
		...
		VectorSIMD363(double a){
			...
			_avx90=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD363(double (&a)[363]){
		...
		VectorSIMD363& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD363& operator += (VectorSIMD363 a){
	...
	inline VectorSIMD363 operator*(double a, VectorSIMD363 b){
		VectorSIMD363 c;
	...
	inline VectorSIMD363 operator*(VectorSIMD363 a ,double b){
		VectorSIMD363 c;
	...
	inline VectorSIMD363 operator*(int a, VectorSIMD363 b){
		if(a==1){return b;}
		VectorSIMD363 c;
	...
	inline VectorSIMD363 operator*(VectorSIMD363 a, int b){
		if(b==1){return a;}
		VectorSIMD363 c;
	...
	inline VectorSIMD363 operator*(VectorSIMD363 a, VectorSIMD363 b){
		VectorSIMD363 c;
	...
	inline VectorSIMD363 exp(VectorSIMD363 a){
		double a_d[363]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD363 sqrt(VectorSIMD363 a){
		double a_d[363]; a.convert(a_d);
