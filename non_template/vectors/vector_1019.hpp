...
public:
		...
		VectorSIMD1019(double a){
			...
			_avx254=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD1019(double (&a)[1019]){
		...
		VectorSIMD1019& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1019& operator += (VectorSIMD1019 a){
	...
	inline VectorSIMD1019 operator*(double a, VectorSIMD1019 b){
		VectorSIMD1019 c;
	...
	inline VectorSIMD1019 operator*(VectorSIMD1019 a ,double b){
		VectorSIMD1019 c;
	...
	inline VectorSIMD1019 operator*(int a, VectorSIMD1019 b){
		if(a==1){return b;}
		VectorSIMD1019 c;
	...
	inline VectorSIMD1019 operator*(VectorSIMD1019 a, int b){
		if(b==1){return a;}
		VectorSIMD1019 c;
	...
	inline VectorSIMD1019 operator*(VectorSIMD1019 a, VectorSIMD1019 b){
		VectorSIMD1019 c;
	...
	inline VectorSIMD1019 exp(VectorSIMD1019 a){
		double a_d[1019]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1019 r(a_d);
		return r;
	}

	inline VectorSIMD1019 sqrt(VectorSIMD1019 a){
		double a_d[1019]; a.convert(a_d);
