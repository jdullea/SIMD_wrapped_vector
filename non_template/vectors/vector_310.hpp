...
public:
		...
		VectorSIMD310(double a){
			...
			_avx77=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD310(double (&a)[310]){
		...
		VectorSIMD310& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD310& operator += (VectorSIMD310 a){
	...
	inline VectorSIMD310 operator*(double a, VectorSIMD310 b){
		VectorSIMD310 c;
	...
	inline VectorSIMD310 operator*(VectorSIMD310 a ,double b){
		VectorSIMD310 c;
	...
	inline VectorSIMD310 operator*(int a, VectorSIMD310 b){
		if(a==1){return b;}
		VectorSIMD310 c;
	...
	inline VectorSIMD310 operator*(VectorSIMD310 a, int b){
		if(b==1){return a;}
		VectorSIMD310 c;
	...
	inline VectorSIMD310 operator*(VectorSIMD310 a, VectorSIMD310 b){
		VectorSIMD310 c;
	...
	inline VectorSIMD310 exp(VectorSIMD310 a){
		double a_d[310]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD310 sqrt(VectorSIMD310 a){
		double a_d[310]; a.convert(a_d);
