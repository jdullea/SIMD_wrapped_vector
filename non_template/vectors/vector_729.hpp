...
public:
		...
		VectorSIMD729(double a){
			...
			_avx182=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD729(double (&a)[729]){
		...
		VectorSIMD729& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD729& operator += (VectorSIMD729 a){
	...
	inline VectorSIMD729 operator*(double a, VectorSIMD729 b){
		VectorSIMD729 c;
	...
	inline VectorSIMD729 operator*(VectorSIMD729 a ,double b){
		VectorSIMD729 c;
	...
	inline VectorSIMD729 operator*(int a, VectorSIMD729 b){
		if(a==1){return b;}
		VectorSIMD729 c;
	...
	inline VectorSIMD729 operator*(VectorSIMD729 a, int b){
		if(b==1){return a;}
		VectorSIMD729 c;
	...
	inline VectorSIMD729 operator*(VectorSIMD729 a, VectorSIMD729 b){
		VectorSIMD729 c;
	...
	inline VectorSIMD729 exp(VectorSIMD729 a){
		double a_d[729]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD729 sqrt(VectorSIMD729 a){
		double a_d[729]; a.convert(a_d);
