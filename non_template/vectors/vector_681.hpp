...
public:
		...
		VectorSIMD681(double a){
			...
			_avx170=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD681(double (&a)[681]){
		...
		VectorSIMD681& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD681& operator += (VectorSIMD681 a){
	...
	inline VectorSIMD681 operator*(double a, VectorSIMD681 b){
		VectorSIMD681 c;
	...
	inline VectorSIMD681 operator*(VectorSIMD681 a ,double b){
		VectorSIMD681 c;
	...
	inline VectorSIMD681 operator*(int a, VectorSIMD681 b){
		if(a==1){return b;}
		VectorSIMD681 c;
	...
	inline VectorSIMD681 operator*(VectorSIMD681 a, int b){
		if(b==1){return a;}
		VectorSIMD681 c;
	...
	inline VectorSIMD681 operator*(VectorSIMD681 a, VectorSIMD681 b){
		VectorSIMD681 c;
	...
	inline VectorSIMD681 exp(VectorSIMD681 a){
		double a_d[681]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD681 sqrt(VectorSIMD681 a){
		double a_d[681]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD681 a){ 
		double ad[681];
		a.convert(ad);
