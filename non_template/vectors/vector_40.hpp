...
public:
		...
		VectorSIMD40(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD40& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD40& operator += (VectorSIMD40 a){
	...
	inline VectorSIMD40 operator*(double a, VectorSIMD40 b){
		VectorSIMD40 c;
	...
	inline VectorSIMD40 operator*(VectorSIMD40 a ,double b){
		VectorSIMD40 c;
	...
	inline VectorSIMD40 operator*(int a, VectorSIMD40 b){
		if(a==1){return b;}
		VectorSIMD40 c;
	...
	inline VectorSIMD40 operator*(VectorSIMD40 a, int b){
		if(b==1){return a;}
		VectorSIMD40 c;
	...
	inline VectorSIMD40 operator*(VectorSIMD40 a, VectorSIMD40 b){
		VectorSIMD40 c;
	...
	inline VectorSIMD40 exp(VectorSIMD40 a){
		double a_d[40]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD40 sqrt(VectorSIMD40 a){
		double a_d[40]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD40 a){ 
		double ad[40];
		a.convert(ad);
		os << "{" << ad[0] << ","  << ad[1] << ","  << ad[2] << ","  << ad[3] << ","  << ad[4] << ","  << ad[5] << ","  << ad[6] << ","  << ad[7] << ","  << ad[8] << ","  << ad[9] << ","  << ad[10] << ","  << ad[11] << ","  << ad[12] << ","  << ad[13] << ","  << ad[14] << ","  << ad[15] << ","  << ad[16] << ","  << ad[17] << ","  << ad[18] << ","  << ad[19] << ","  << ad[20] << ","  << ad[21] << ","  << ad[22] << ","  << ad[23] << ","  << ad[24] << ","  << ad[25] << ","  << ad[26] << ","  << ad[27] << ","  << ad[28] << ","  << ad[29] << ","  << ad[30] << ","  << ad[31] << ","  << ad[32] << ","  << ad[33] << ","  << ad[34] << ","  << ad[35] << ","  << ad[36] << ","  << ad[37] << ","  << ad[38] << ","  << ad[39] << "}";
		return os;
		}