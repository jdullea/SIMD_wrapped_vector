...
public:
		...
		VectorSIMD292& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD292& operator += (VectorSIMD292 a){
	...
	inline VectorSIMD292 operator*(double a, VectorSIMD292 b){
		VectorSIMD292 c;
	...
	inline VectorSIMD292 operator*(VectorSIMD292 a ,double b){
		VectorSIMD292 c;
	...
	inline VectorSIMD292 operator*(int a, VectorSIMD292 b){
		if(a==1){return b;}
		VectorSIMD292 c;
	...
	inline VectorSIMD292 operator*(VectorSIMD292 a, int b){
		if(b==1){return a;}
		VectorSIMD292 c;
	...
	inline VectorSIMD292 operator*(VectorSIMD292 a, VectorSIMD292 b){
		VectorSIMD292 c;
	...
	inline VectorSIMD292 exp(VectorSIMD292 a){
		double a_d[292]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD292 sqrt(VectorSIMD292 a){
		double a_d[292]; a.convert(a_d);
