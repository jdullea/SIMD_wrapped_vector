...
public:
		...
		VectorSIMD421(double a){
			...
			_avx105=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD421(double (&a)[421]){
		...
		VectorSIMD421& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD421& operator += (VectorSIMD421 a){
	...
	inline VectorSIMD421 operator*(double a, VectorSIMD421 b){
		VectorSIMD421 c;
	...
	inline VectorSIMD421 operator*(VectorSIMD421 a ,double b){
		VectorSIMD421 c;
	...
	inline VectorSIMD421 operator*(int a, VectorSIMD421 b){
		if(a==1){return b;}
		VectorSIMD421 c;
	...
	inline VectorSIMD421 operator*(VectorSIMD421 a, int b){
		if(b==1){return a;}
		VectorSIMD421 c;
	...
	inline VectorSIMD421 operator*(VectorSIMD421 a, VectorSIMD421 b){
		VectorSIMD421 c;
	...
	inline VectorSIMD421 exp(VectorSIMD421 a){
		double a_d[421]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD421 sqrt(VectorSIMD421 a){
		double a_d[421]; a.convert(a_d);
