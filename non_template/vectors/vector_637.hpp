...
public:
		...
		VectorSIMD637(double a){
			...
			_avx159=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD637(double (&a)[637]){
		...
		VectorSIMD637& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD637& operator += (VectorSIMD637 a){
	...
	inline VectorSIMD637 operator*(double a, VectorSIMD637 b){
		VectorSIMD637 c;
	...
	inline VectorSIMD637 operator*(VectorSIMD637 a ,double b){
		VectorSIMD637 c;
	...
	inline VectorSIMD637 operator*(int a, VectorSIMD637 b){
		if(a==1){return b;}
		VectorSIMD637 c;
	...
	inline VectorSIMD637 operator*(VectorSIMD637 a, int b){
		if(b==1){return a;}
		VectorSIMD637 c;
	...
	inline VectorSIMD637 operator*(VectorSIMD637 a, VectorSIMD637 b){
		VectorSIMD637 c;
	...
	inline VectorSIMD637 exp(VectorSIMD637 a){
		double a_d[637]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD637 sqrt(VectorSIMD637 a){
		double a_d[637]; a.convert(a_d);
