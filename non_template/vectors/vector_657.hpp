...
public:
		...
		VectorSIMD657(double a){
			...
			_avx164=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD657(double (&a)[657]){
		...
		VectorSIMD657& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD657& operator += (VectorSIMD657 a){
	...
	inline VectorSIMD657 operator*(double a, VectorSIMD657 b){
		VectorSIMD657 c;
	...
	inline VectorSIMD657 operator*(VectorSIMD657 a ,double b){
		VectorSIMD657 c;
	...
	inline VectorSIMD657 operator*(int a, VectorSIMD657 b){
		if(a==1){return b;}
		VectorSIMD657 c;
	...
	inline VectorSIMD657 operator*(VectorSIMD657 a, int b){
		if(b==1){return a;}
		VectorSIMD657 c;
	...
	inline VectorSIMD657 operator*(VectorSIMD657 a, VectorSIMD657 b){
		VectorSIMD657 c;
	...
	inline VectorSIMD657 exp(VectorSIMD657 a){
		double a_d[657]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD657 sqrt(VectorSIMD657 a){
		double a_d[657]; a.convert(a_d);
