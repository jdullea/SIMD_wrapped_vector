...
public:
		...
		VectorSIMD925(double a){
			...
			_avx231=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD925(double (&a)[925]){
		...
		VectorSIMD925& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD925& operator += (VectorSIMD925 a){
	...
	inline VectorSIMD925 operator*(double a, VectorSIMD925 b){
		VectorSIMD925 c;
	...
	inline VectorSIMD925 operator*(VectorSIMD925 a ,double b){
		VectorSIMD925 c;
	...
	inline VectorSIMD925 operator*(int a, VectorSIMD925 b){
		if(a==1){return b;}
		VectorSIMD925 c;
	...
	inline VectorSIMD925 operator*(VectorSIMD925 a, int b){
		if(b==1){return a;}
		VectorSIMD925 c;
	...
	inline VectorSIMD925 operator*(VectorSIMD925 a, VectorSIMD925 b){
		VectorSIMD925 c;
	...
	inline VectorSIMD925 exp(VectorSIMD925 a){
		double a_d[925]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD925 sqrt(VectorSIMD925 a){
		double a_d[925]; a.convert(a_d);
