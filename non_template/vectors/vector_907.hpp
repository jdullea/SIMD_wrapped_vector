...
public:
		...
		VectorSIMD907(double a){
			...
			_avx226=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD907(double (&a)[907]){
		...
		VectorSIMD907& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD907& operator += (VectorSIMD907 a){
	...
	inline VectorSIMD907 operator*(double a, VectorSIMD907 b){
		VectorSIMD907 c;
	...
	inline VectorSIMD907 operator*(VectorSIMD907 a ,double b){
		VectorSIMD907 c;
	...
	inline VectorSIMD907 operator*(int a, VectorSIMD907 b){
		if(a==1){return b;}
		VectorSIMD907 c;
	...
	inline VectorSIMD907 operator*(VectorSIMD907 a, int b){
		if(b==1){return a;}
		VectorSIMD907 c;
	...
	inline VectorSIMD907 operator*(VectorSIMD907 a, VectorSIMD907 b){
		VectorSIMD907 c;
	...
	inline VectorSIMD907 exp(VectorSIMD907 a){
		double a_d[907]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD907 sqrt(VectorSIMD907 a){
		double a_d[907]; a.convert(a_d);
