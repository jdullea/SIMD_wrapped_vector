...
public:
		...
		VectorSIMD108& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD108& operator += (VectorSIMD108 a){
	...
	inline VectorSIMD108 operator*(double a, VectorSIMD108 b){
		VectorSIMD108 c;
	...
	inline VectorSIMD108 operator*(VectorSIMD108 a ,double b){
		VectorSIMD108 c;
	...
	inline VectorSIMD108 operator*(int a, VectorSIMD108 b){
		if(a==1){return b;}
		VectorSIMD108 c;
	...
	inline VectorSIMD108 operator*(VectorSIMD108 a, int b){
		if(b==1){return a;}
		VectorSIMD108 c;
	...
	inline VectorSIMD108 operator*(VectorSIMD108 a, VectorSIMD108 b){
		VectorSIMD108 c;
	...
	inline VectorSIMD108 exp(VectorSIMD108 a){
		double a_d[108]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD108 sqrt(VectorSIMD108 a){
		double a_d[108]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD108 a){ 
		double ad[108];
		a.convert(ad);
