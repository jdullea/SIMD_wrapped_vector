...
public:
		...
		VectorSIMD913(double a){
			...
			_avx228=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD913(double (&a)[913]){
		...
		VectorSIMD913& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD913& operator += (VectorSIMD913 a){
	...
	inline VectorSIMD913 operator*(double a, VectorSIMD913 b){
		VectorSIMD913 c;
	...
	inline VectorSIMD913 operator*(VectorSIMD913 a ,double b){
		VectorSIMD913 c;
	...
	inline VectorSIMD913 operator*(int a, VectorSIMD913 b){
		if(a==1){return b;}
		VectorSIMD913 c;
	...
	inline VectorSIMD913 operator*(VectorSIMD913 a, int b){
		if(b==1){return a;}
		VectorSIMD913 c;
	...
	inline VectorSIMD913 operator*(VectorSIMD913 a, VectorSIMD913 b){
		VectorSIMD913 c;
	...
	inline VectorSIMD913 exp(VectorSIMD913 a){
		double a_d[913]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD913 sqrt(VectorSIMD913 a){
		double a_d[913]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD913 a){ 
		double ad[913];
		a.convert(ad);
