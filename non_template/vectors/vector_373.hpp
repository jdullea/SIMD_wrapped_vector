...
public:
		...
		VectorSIMD373(double a){
			...
			_avx93=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD373(double (&a)[373]){
		...
		VectorSIMD373& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD373& operator += (VectorSIMD373 a){
	...
	inline VectorSIMD373 operator*(double a, VectorSIMD373 b){
		VectorSIMD373 c;
	...
	inline VectorSIMD373 operator*(VectorSIMD373 a ,double b){
		VectorSIMD373 c;
	...
	inline VectorSIMD373 operator*(int a, VectorSIMD373 b){
		if(a==1){return b;}
		VectorSIMD373 c;
	...
	inline VectorSIMD373 operator*(VectorSIMD373 a, int b){
		if(b==1){return a;}
		VectorSIMD373 c;
	...
	inline VectorSIMD373 operator*(VectorSIMD373 a, VectorSIMD373 b){
		VectorSIMD373 c;
	...
	inline VectorSIMD373 exp(VectorSIMD373 a){
		double a_d[373]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD373 sqrt(VectorSIMD373 a){
		double a_d[373]; a.convert(a_d);
