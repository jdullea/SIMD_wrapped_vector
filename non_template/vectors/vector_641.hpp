...
public:
		...
		VectorSIMD641(double a){
			...
			_avx160=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD641(double (&a)[641]){
		...
		VectorSIMD641& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD641& operator += (VectorSIMD641 a){
	...
	inline VectorSIMD641 operator*(double a, VectorSIMD641 b){
		VectorSIMD641 c;
	...
	inline VectorSIMD641 operator*(VectorSIMD641 a ,double b){
		VectorSIMD641 c;
	...
	inline VectorSIMD641 operator*(int a, VectorSIMD641 b){
		if(a==1){return b;}
		VectorSIMD641 c;
	...
	inline VectorSIMD641 operator*(VectorSIMD641 a, int b){
		if(b==1){return a;}
		VectorSIMD641 c;
	...
	inline VectorSIMD641 operator*(VectorSIMD641 a, VectorSIMD641 b){
		VectorSIMD641 c;
	...
	inline VectorSIMD641 exp(VectorSIMD641 a){
		double a_d[641]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD641 sqrt(VectorSIMD641 a){
		double a_d[641]; a.convert(a_d);
