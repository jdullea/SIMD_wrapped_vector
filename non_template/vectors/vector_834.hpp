...
public:
		...
		VectorSIMD834(double a){
			...
			_avx208=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD834(double (&a)[834]){
		...
		VectorSIMD834& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD834& operator += (VectorSIMD834 a){
	...
	inline VectorSIMD834 operator*(double a, VectorSIMD834 b){
		VectorSIMD834 c;
	...
	inline VectorSIMD834 operator*(VectorSIMD834 a ,double b){
		VectorSIMD834 c;
	...
	inline VectorSIMD834 operator*(int a, VectorSIMD834 b){
		if(a==1){return b;}
		VectorSIMD834 c;
	...
	inline VectorSIMD834 operator*(VectorSIMD834 a, int b){
		if(b==1){return a;}
		VectorSIMD834 c;
	...
	inline VectorSIMD834 operator*(VectorSIMD834 a, VectorSIMD834 b){
		VectorSIMD834 c;
	...
	inline VectorSIMD834 exp(VectorSIMD834 a){
		double a_d[834]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD834 sqrt(VectorSIMD834 a){
		double a_d[834]; a.convert(a_d);
