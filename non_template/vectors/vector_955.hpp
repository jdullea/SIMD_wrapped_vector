...
public:
		...
		VectorSIMD955(double a){
			...
			_avx238=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD955(double (&a)[955]){
		...
		VectorSIMD955& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD955& operator += (VectorSIMD955 a){
	...
	inline VectorSIMD955 operator*(double a, VectorSIMD955 b){
		VectorSIMD955 c;
	...
	inline VectorSIMD955 operator*(VectorSIMD955 a ,double b){
		VectorSIMD955 c;
	...
	inline VectorSIMD955 operator*(int a, VectorSIMD955 b){
		if(a==1){return b;}
		VectorSIMD955 c;
	...
	inline VectorSIMD955 operator*(VectorSIMD955 a, int b){
		if(b==1){return a;}
		VectorSIMD955 c;
	...
	inline VectorSIMD955 operator*(VectorSIMD955 a, VectorSIMD955 b){
		VectorSIMD955 c;
	...
	inline VectorSIMD955 exp(VectorSIMD955 a){
		double a_d[955]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD955 sqrt(VectorSIMD955 a){
		double a_d[955]; a.convert(a_d);
