...
public:
		...
		VectorSIMD622(double a){
			...
			_avx155=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD622(double (&a)[622]){
		...
		VectorSIMD622& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD622& operator += (VectorSIMD622 a){
	...
	inline VectorSIMD622 operator*(double a, VectorSIMD622 b){
		VectorSIMD622 c;
	...
	inline VectorSIMD622 operator*(VectorSIMD622 a ,double b){
		VectorSIMD622 c;
	...
	inline VectorSIMD622 operator*(int a, VectorSIMD622 b){
		if(a==1){return b;}
		VectorSIMD622 c;
	...
	inline VectorSIMD622 operator*(VectorSIMD622 a, int b){
		if(b==1){return a;}
		VectorSIMD622 c;
	...
	inline VectorSIMD622 operator*(VectorSIMD622 a, VectorSIMD622 b){
		VectorSIMD622 c;
	...
	inline VectorSIMD622 exp(VectorSIMD622 a){
		double a_d[622]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD622 sqrt(VectorSIMD622 a){
		double a_d[622]; a.convert(a_d);
