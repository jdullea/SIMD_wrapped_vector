...
public:
		...
		VectorSIMD312& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD312& operator += (VectorSIMD312 a){
	...
	inline VectorSIMD312 operator*(double a, VectorSIMD312 b){
		VectorSIMD312 c;
	...
	inline VectorSIMD312 operator*(VectorSIMD312 a ,double b){
		VectorSIMD312 c;
	...
	inline VectorSIMD312 operator*(int a, VectorSIMD312 b){
		if(a==1){return b;}
		VectorSIMD312 c;
	...
	inline VectorSIMD312 operator*(VectorSIMD312 a, int b){
		if(b==1){return a;}
		VectorSIMD312 c;
	...
	inline VectorSIMD312 operator*(VectorSIMD312 a, VectorSIMD312 b){
		VectorSIMD312 c;
	...
	inline VectorSIMD312 exp(VectorSIMD312 a){
		double a_d[312]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD312 sqrt(VectorSIMD312 a){
		double a_d[312]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD312 a){ 
		double ad[312];
		a.convert(ad);
