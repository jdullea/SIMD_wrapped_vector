...
public:
		...
		VectorSIMD388& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD388& operator += (VectorSIMD388 a){
	...
	inline VectorSIMD388 operator*(double a, VectorSIMD388 b){
		VectorSIMD388 c;
	...
	inline VectorSIMD388 operator*(VectorSIMD388 a ,double b){
		VectorSIMD388 c;
	...
	inline VectorSIMD388 operator*(int a, VectorSIMD388 b){
		if(a==1){return b;}
		VectorSIMD388 c;
	...
	inline VectorSIMD388 operator*(VectorSIMD388 a, int b){
		if(b==1){return a;}
		VectorSIMD388 c;
	...
	inline VectorSIMD388 operator*(VectorSIMD388 a, VectorSIMD388 b){
		VectorSIMD388 c;
	...
	inline VectorSIMD388 exp(VectorSIMD388 a){
		double a_d[388]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD388 sqrt(VectorSIMD388 a){
		double a_d[388]; a.convert(a_d);
