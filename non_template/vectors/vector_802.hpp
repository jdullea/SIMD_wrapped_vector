...
public:
		...
		VectorSIMD802(double a){
			...
			_avx200=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD802(double (&a)[802]){
		...
		VectorSIMD802& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD802& operator += (VectorSIMD802 a){
	...
	inline VectorSIMD802 operator*(double a, VectorSIMD802 b){
		VectorSIMD802 c;
	...
	inline VectorSIMD802 operator*(VectorSIMD802 a ,double b){
		VectorSIMD802 c;
	...
	inline VectorSIMD802 operator*(int a, VectorSIMD802 b){
		if(a==1){return b;}
		VectorSIMD802 c;
	...
	inline VectorSIMD802 operator*(VectorSIMD802 a, int b){
		if(b==1){return a;}
		VectorSIMD802 c;
	...
	inline VectorSIMD802 operator*(VectorSIMD802 a, VectorSIMD802 b){
		VectorSIMD802 c;
	...
	inline VectorSIMD802 exp(VectorSIMD802 a){
		double a_d[802]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD802 sqrt(VectorSIMD802 a){
		double a_d[802]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD802 a){ 
		double ad[802];
		a.convert(ad);
