...
public:
		...
		VectorSIMD452& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD452& operator += (VectorSIMD452 a){
	...
	inline VectorSIMD452 operator*(double a, VectorSIMD452 b){
		VectorSIMD452 c;
	...
	inline VectorSIMD452 operator*(VectorSIMD452 a ,double b){
		VectorSIMD452 c;
	...
	inline VectorSIMD452 operator*(int a, VectorSIMD452 b){
		if(a==1){return b;}
		VectorSIMD452 c;
	...
	inline VectorSIMD452 operator*(VectorSIMD452 a, int b){
		if(b==1){return a;}
		VectorSIMD452 c;
	...
	inline VectorSIMD452 operator*(VectorSIMD452 a, VectorSIMD452 b){
		VectorSIMD452 c;
	...
	inline VectorSIMD452 exp(VectorSIMD452 a){
		double a_d[452]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD452 sqrt(VectorSIMD452 a){
		double a_d[452]; a.convert(a_d);
