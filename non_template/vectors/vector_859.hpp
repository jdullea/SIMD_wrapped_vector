...
public:
		...
		VectorSIMD859(double a){
			...
			_avx214=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD859(double (&a)[859]){
		...
		VectorSIMD859& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD859& operator += (VectorSIMD859 a){
	...
	inline VectorSIMD859 operator*(double a, VectorSIMD859 b){
		VectorSIMD859 c;
	...
	inline VectorSIMD859 operator*(VectorSIMD859 a ,double b){
		VectorSIMD859 c;
	...
	inline VectorSIMD859 operator*(int a, VectorSIMD859 b){
		if(a==1){return b;}
		VectorSIMD859 c;
	...
	inline VectorSIMD859 operator*(VectorSIMD859 a, int b){
		if(b==1){return a;}
		VectorSIMD859 c;
	...
	inline VectorSIMD859 operator*(VectorSIMD859 a, VectorSIMD859 b){
		VectorSIMD859 c;
	...
	inline VectorSIMD859 exp(VectorSIMD859 a){
		double a_d[859]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD859 sqrt(VectorSIMD859 a){
		double a_d[859]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD859 a){ 
		double ad[859];
		a.convert(ad);
