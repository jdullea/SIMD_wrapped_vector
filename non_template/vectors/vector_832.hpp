...
public:
		...
		VectorSIMD832& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD832& operator += (VectorSIMD832 a){
	...
	inline VectorSIMD832 operator*(double a, VectorSIMD832 b){
		VectorSIMD832 c;
	...
	inline VectorSIMD832 operator*(VectorSIMD832 a ,double b){
		VectorSIMD832 c;
	...
	inline VectorSIMD832 operator*(int a, VectorSIMD832 b){
		if(a==1){return b;}
		VectorSIMD832 c;
	...
	inline VectorSIMD832 operator*(VectorSIMD832 a, int b){
		if(b==1){return a;}
		VectorSIMD832 c;
	...
	inline VectorSIMD832 operator*(VectorSIMD832 a, VectorSIMD832 b){
		VectorSIMD832 c;
	...
	inline VectorSIMD832 exp(VectorSIMD832 a){
		double a_d[832]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD832 sqrt(VectorSIMD832 a){
		double a_d[832]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD832 a){ 
		double ad[832];
		a.convert(ad);
