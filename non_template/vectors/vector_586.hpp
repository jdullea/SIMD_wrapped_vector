...
public:
		...
		VectorSIMD586(double a){
			...
			_avx146=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD586(double (&a)[586]){
		...
		VectorSIMD586& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD586& operator += (VectorSIMD586 a){
	...
	inline VectorSIMD586 operator*(double a, VectorSIMD586 b){
		VectorSIMD586 c;
	...
	inline VectorSIMD586 operator*(VectorSIMD586 a ,double b){
		VectorSIMD586 c;
	...
	inline VectorSIMD586 operator*(int a, VectorSIMD586 b){
		if(a==1){return b;}
		VectorSIMD586 c;
	...
	inline VectorSIMD586 operator*(VectorSIMD586 a, int b){
		if(b==1){return a;}
		VectorSIMD586 c;
	...
	inline VectorSIMD586 operator*(VectorSIMD586 a, VectorSIMD586 b){
		VectorSIMD586 c;
	...
	inline VectorSIMD586 exp(VectorSIMD586 a){
		double a_d[586]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD586 sqrt(VectorSIMD586 a){
		double a_d[586]; a.convert(a_d);
