...
public:
		...
		VectorSIMD1021(double a){
			...
			_avx255=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD1021(double (&a)[1021]){
		...
		VectorSIMD1021& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1021& operator += (VectorSIMD1021 a){
	...
	inline VectorSIMD1021 operator*(double a, VectorSIMD1021 b){
		VectorSIMD1021 c;
	...
	inline VectorSIMD1021 operator*(VectorSIMD1021 a ,double b){
		VectorSIMD1021 c;
	...
	inline VectorSIMD1021 operator*(int a, VectorSIMD1021 b){
		if(a==1){return b;}
		VectorSIMD1021 c;
	...
	inline VectorSIMD1021 operator*(VectorSIMD1021 a, int b){
		if(b==1){return a;}
		VectorSIMD1021 c;
	...
	inline VectorSIMD1021 operator*(VectorSIMD1021 a, VectorSIMD1021 b){
		VectorSIMD1021 c;
	...
	inline VectorSIMD1021 exp(VectorSIMD1021 a){
		double a_d[1021]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1021 r(a_d);
		return r;
	}

	inline VectorSIMD1021 sqrt(VectorSIMD1021 a){
		double a_d[1021]; a.convert(a_d);
