...
public:
		...
		VectorSIMD890(double a){
			...
			_avx222=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD890(double (&a)[890]){
		...
		VectorSIMD890& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD890& operator += (VectorSIMD890 a){
	...
	inline VectorSIMD890 operator*(double a, VectorSIMD890 b){
		VectorSIMD890 c;
	...
	inline VectorSIMD890 operator*(VectorSIMD890 a ,double b){
		VectorSIMD890 c;
	...
	inline VectorSIMD890 operator*(int a, VectorSIMD890 b){
		if(a==1){return b;}
		VectorSIMD890 c;
	...
	inline VectorSIMD890 operator*(VectorSIMD890 a, int b){
		if(b==1){return a;}
		VectorSIMD890 c;
	...
	inline VectorSIMD890 operator*(VectorSIMD890 a, VectorSIMD890 b){
		VectorSIMD890 c;
	...
	inline VectorSIMD890 exp(VectorSIMD890 a){
		double a_d[890]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD890 sqrt(VectorSIMD890 a){
		double a_d[890]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD890 a){ 
		double ad[890];
		a.convert(ad);
