...
public:
		...
		VectorSIMD438(double a){
			...
			_avx109=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD438(double (&a)[438]){
		...
		VectorSIMD438& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD438& operator += (VectorSIMD438 a){
	...
	inline VectorSIMD438 operator*(double a, VectorSIMD438 b){
		VectorSIMD438 c;
	...
	inline VectorSIMD438 operator*(VectorSIMD438 a ,double b){
		VectorSIMD438 c;
	...
	inline VectorSIMD438 operator*(int a, VectorSIMD438 b){
		if(a==1){return b;}
		VectorSIMD438 c;
	...
	inline VectorSIMD438 operator*(VectorSIMD438 a, int b){
		if(b==1){return a;}
		VectorSIMD438 c;
	...
	inline VectorSIMD438 operator*(VectorSIMD438 a, VectorSIMD438 b){
		VectorSIMD438 c;
	...
	inline VectorSIMD438 exp(VectorSIMD438 a){
		double a_d[438]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD438 sqrt(VectorSIMD438 a){
		double a_d[438]; a.convert(a_d);
