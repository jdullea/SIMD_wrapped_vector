...
public:
		...
		VectorSIMD966(double a){
			...
			_avx241=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD966(double (&a)[966]){
		...
		VectorSIMD966& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD966& operator += (VectorSIMD966 a){
	...
	inline VectorSIMD966 operator*(double a, VectorSIMD966 b){
		VectorSIMD966 c;
	...
	inline VectorSIMD966 operator*(VectorSIMD966 a ,double b){
		VectorSIMD966 c;
	...
	inline VectorSIMD966 operator*(int a, VectorSIMD966 b){
		if(a==1){return b;}
		VectorSIMD966 c;
	...
	inline VectorSIMD966 operator*(VectorSIMD966 a, int b){
		if(b==1){return a;}
		VectorSIMD966 c;
	...
	inline VectorSIMD966 operator*(VectorSIMD966 a, VectorSIMD966 b){
		VectorSIMD966 c;
	...
	inline VectorSIMD966 exp(VectorSIMD966 a){
		double a_d[966]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD966 sqrt(VectorSIMD966 a){
		double a_d[966]; a.convert(a_d);
