...
public:
		...
		VectorSIMD831(double a){
			...
			_avx207=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD831(double (&a)[831]){
		...
		VectorSIMD831& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD831& operator += (VectorSIMD831 a){
	...
	inline VectorSIMD831 operator*(double a, VectorSIMD831 b){
		VectorSIMD831 c;
	...
	inline VectorSIMD831 operator*(VectorSIMD831 a ,double b){
		VectorSIMD831 c;
	...
	inline VectorSIMD831 operator*(int a, VectorSIMD831 b){
		if(a==1){return b;}
		VectorSIMD831 c;
	...
	inline VectorSIMD831 operator*(VectorSIMD831 a, int b){
		if(b==1){return a;}
		VectorSIMD831 c;
	...
	inline VectorSIMD831 operator*(VectorSIMD831 a, VectorSIMD831 b){
		VectorSIMD831 c;
	...
	inline VectorSIMD831 exp(VectorSIMD831 a){
		double a_d[831]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD831 sqrt(VectorSIMD831 a){
		double a_d[831]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD831 a){ 
		double ad[831];
		a.convert(ad);
