...
public:
		...
		VectorSIMD952& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD952& operator += (VectorSIMD952 a){
	...
	inline VectorSIMD952 operator*(double a, VectorSIMD952 b){
		VectorSIMD952 c;
	...
	inline VectorSIMD952 operator*(VectorSIMD952 a ,double b){
		VectorSIMD952 c;
	...
	inline VectorSIMD952 operator*(int a, VectorSIMD952 b){
		if(a==1){return b;}
		VectorSIMD952 c;
	...
	inline VectorSIMD952 operator*(VectorSIMD952 a, int b){
		if(b==1){return a;}
		VectorSIMD952 c;
	...
	inline VectorSIMD952 operator*(VectorSIMD952 a, VectorSIMD952 b){
		VectorSIMD952 c;
	...
	inline VectorSIMD952 exp(VectorSIMD952 a){
		double a_d[952]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD952 sqrt(VectorSIMD952 a){
		double a_d[952]; a.convert(a_d);
