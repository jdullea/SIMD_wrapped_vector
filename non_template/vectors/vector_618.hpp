...
public:
		...
		VectorSIMD618(double a){
			...
			_avx154=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD618(double (&a)[618]){
		...
		VectorSIMD618& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD618& operator += (VectorSIMD618 a){
	...
	inline VectorSIMD618 operator*(double a, VectorSIMD618 b){
		VectorSIMD618 c;
	...
	inline VectorSIMD618 operator*(VectorSIMD618 a ,double b){
		VectorSIMD618 c;
	...
	inline VectorSIMD618 operator*(int a, VectorSIMD618 b){
		if(a==1){return b;}
		VectorSIMD618 c;
	...
	inline VectorSIMD618 operator*(VectorSIMD618 a, int b){
		if(b==1){return a;}
		VectorSIMD618 c;
	...
	inline VectorSIMD618 operator*(VectorSIMD618 a, VectorSIMD618 b){
		VectorSIMD618 c;
	...
	inline VectorSIMD618 exp(VectorSIMD618 a){
		double a_d[618]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD618 sqrt(VectorSIMD618 a){
		double a_d[618]; a.convert(a_d);
