...
public:
		...
		VectorSIMD371(double a){
			...
			_avx92=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD371(double (&a)[371]){
		...
		VectorSIMD371& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD371& operator += (VectorSIMD371 a){
	...
	inline VectorSIMD371 operator*(double a, VectorSIMD371 b){
		VectorSIMD371 c;
	...
	inline VectorSIMD371 operator*(VectorSIMD371 a ,double b){
		VectorSIMD371 c;
	...
	inline VectorSIMD371 operator*(int a, VectorSIMD371 b){
		if(a==1){return b;}
		VectorSIMD371 c;
	...
	inline VectorSIMD371 operator*(VectorSIMD371 a, int b){
		if(b==1){return a;}
		VectorSIMD371 c;
	...
	inline VectorSIMD371 operator*(VectorSIMD371 a, VectorSIMD371 b){
		VectorSIMD371 c;
	...
	inline VectorSIMD371 exp(VectorSIMD371 a){
		double a_d[371]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD371 sqrt(VectorSIMD371 a){
		double a_d[371]; a.convert(a_d);
