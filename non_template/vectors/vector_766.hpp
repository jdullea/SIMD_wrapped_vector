...
public:
		...
		VectorSIMD766(double a){
			...
			_avx191=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD766(double (&a)[766]){
		...
		VectorSIMD766& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD766& operator += (VectorSIMD766 a){
	...
	inline VectorSIMD766 operator*(double a, VectorSIMD766 b){
		VectorSIMD766 c;
	...
	inline VectorSIMD766 operator*(VectorSIMD766 a ,double b){
		VectorSIMD766 c;
	...
	inline VectorSIMD766 operator*(int a, VectorSIMD766 b){
		if(a==1){return b;}
		VectorSIMD766 c;
	...
	inline VectorSIMD766 operator*(VectorSIMD766 a, int b){
		if(b==1){return a;}
		VectorSIMD766 c;
	...
	inline VectorSIMD766 operator*(VectorSIMD766 a, VectorSIMD766 b){
		VectorSIMD766 c;
	...
	inline VectorSIMD766 exp(VectorSIMD766 a){
		double a_d[766]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD766 sqrt(VectorSIMD766 a){
		double a_d[766]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD766 a){ 
		double ad[766];
		a.convert(ad);
