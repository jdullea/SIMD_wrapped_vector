...
public:
		...
		VectorSIMD675(double a){
			...
			_avx168=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD675(double (&a)[675]){
		...
		VectorSIMD675& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD675& operator += (VectorSIMD675 a){
	...
	inline VectorSIMD675 operator*(double a, VectorSIMD675 b){
		VectorSIMD675 c;
	...
	inline VectorSIMD675 operator*(VectorSIMD675 a ,double b){
		VectorSIMD675 c;
	...
	inline VectorSIMD675 operator*(int a, VectorSIMD675 b){
		if(a==1){return b;}
		VectorSIMD675 c;
	...
	inline VectorSIMD675 operator*(VectorSIMD675 a, int b){
		if(b==1){return a;}
		VectorSIMD675 c;
	...
	inline VectorSIMD675 operator*(VectorSIMD675 a, VectorSIMD675 b){
		VectorSIMD675 c;
	...
	inline VectorSIMD675 exp(VectorSIMD675 a){
		double a_d[675]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD675 sqrt(VectorSIMD675 a){
		double a_d[675]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD675 a){ 
		double ad[675];
		a.convert(ad);
