...
public:
		...
		VectorSIMD601(double a){
			...
			_avx150=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD601(double (&a)[601]){
		...
		VectorSIMD601& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD601& operator += (VectorSIMD601 a){
	...
	inline VectorSIMD601 operator*(double a, VectorSIMD601 b){
		VectorSIMD601 c;
	...
	inline VectorSIMD601 operator*(VectorSIMD601 a ,double b){
		VectorSIMD601 c;
	...
	inline VectorSIMD601 operator*(int a, VectorSIMD601 b){
		if(a==1){return b;}
		VectorSIMD601 c;
	...
	inline VectorSIMD601 operator*(VectorSIMD601 a, int b){
		if(b==1){return a;}
		VectorSIMD601 c;
	...
	inline VectorSIMD601 operator*(VectorSIMD601 a, VectorSIMD601 b){
		VectorSIMD601 c;
	...
	inline VectorSIMD601 exp(VectorSIMD601 a){
		double a_d[601]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD601 sqrt(VectorSIMD601 a){
		double a_d[601]; a.convert(a_d);
