...
public:
		...
		VectorSIMD1006(double a){
			...
			_avx251=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD1006(double (&a)[1006]){
		...
		VectorSIMD1006& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1006& operator += (VectorSIMD1006 a){
	...
	inline VectorSIMD1006 operator*(double a, VectorSIMD1006 b){
		VectorSIMD1006 c;
	...
	inline VectorSIMD1006 operator*(VectorSIMD1006 a ,double b){
		VectorSIMD1006 c;
	...
	inline VectorSIMD1006 operator*(int a, VectorSIMD1006 b){
		if(a==1){return b;}
		VectorSIMD1006 c;
	...
	inline VectorSIMD1006 operator*(VectorSIMD1006 a, int b){
		if(b==1){return a;}
		VectorSIMD1006 c;
	...
	inline VectorSIMD1006 operator*(VectorSIMD1006 a, VectorSIMD1006 b){
		VectorSIMD1006 c;
	...
	inline VectorSIMD1006 exp(VectorSIMD1006 a){
		double a_d[1006]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1006 r(a_d);
		return r;
	}

	inline VectorSIMD1006 sqrt(VectorSIMD1006 a){
		double a_d[1006]; a.convert(a_d);
