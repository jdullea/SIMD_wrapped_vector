...
public:
		...
		VectorSIMD367(double a){
			...
			_avx91=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD367(double (&a)[367]){
		...
		VectorSIMD367& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD367& operator += (VectorSIMD367 a){
	...
	inline VectorSIMD367 operator*(double a, VectorSIMD367 b){
		VectorSIMD367 c;
	...
	inline VectorSIMD367 operator*(VectorSIMD367 a ,double b){
		VectorSIMD367 c;
	...
	inline VectorSIMD367 operator*(int a, VectorSIMD367 b){
		if(a==1){return b;}
		VectorSIMD367 c;
	...
	inline VectorSIMD367 operator*(VectorSIMD367 a, int b){
		if(b==1){return a;}
		VectorSIMD367 c;
	...
	inline VectorSIMD367 operator*(VectorSIMD367 a, VectorSIMD367 b){
		VectorSIMD367 c;
	...
	inline VectorSIMD367 exp(VectorSIMD367 a){
		double a_d[367]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD367 sqrt(VectorSIMD367 a){
		double a_d[367]; a.convert(a_d);
