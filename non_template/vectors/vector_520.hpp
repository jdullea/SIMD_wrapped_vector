...
public:
		...
		VectorSIMD520& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD520& operator += (VectorSIMD520 a){
	...
	inline VectorSIMD520 operator*(double a, VectorSIMD520 b){
		VectorSIMD520 c;
	...
	inline VectorSIMD520 operator*(VectorSIMD520 a ,double b){
		VectorSIMD520 c;
	...
	inline VectorSIMD520 operator*(int a, VectorSIMD520 b){
		if(a==1){return b;}
		VectorSIMD520 c;
	...
	inline VectorSIMD520 operator*(VectorSIMD520 a, int b){
		if(b==1){return a;}
		VectorSIMD520 c;
	...
	inline VectorSIMD520 operator*(VectorSIMD520 a, VectorSIMD520 b){
		VectorSIMD520 c;
	...
	inline VectorSIMD520 exp(VectorSIMD520 a){
		double a_d[520]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD520 sqrt(VectorSIMD520 a){
		double a_d[520]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD520 a){ 
		double ad[520];
		a.convert(ad);
