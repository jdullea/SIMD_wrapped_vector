...
public:
		...
		VectorSIMD120& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD120& operator += (VectorSIMD120 a){
	...
	inline VectorSIMD120 operator*(double a, VectorSIMD120 b){
		VectorSIMD120 c;
	...
	inline VectorSIMD120 operator*(VectorSIMD120 a ,double b){
		VectorSIMD120 c;
	...
	inline VectorSIMD120 operator*(int a, VectorSIMD120 b){
		if(a==1){return b;}
		VectorSIMD120 c;
	...
	inline VectorSIMD120 operator*(VectorSIMD120 a, int b){
		if(b==1){return a;}
		VectorSIMD120 c;
	...
	inline VectorSIMD120 operator*(VectorSIMD120 a, VectorSIMD120 b){
		VectorSIMD120 c;
	...
	inline VectorSIMD120 exp(VectorSIMD120 a){
		double a_d[120]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD120 sqrt(VectorSIMD120 a){
		double a_d[120]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD120 a){ 
		double ad[120];
		a.convert(ad);
