...
public:
		...
		VectorSIMD630(double a){
			...
			_avx157=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD630(double (&a)[630]){
		...
		VectorSIMD630& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD630& operator += (VectorSIMD630 a){
	...
	inline VectorSIMD630 operator*(double a, VectorSIMD630 b){
		VectorSIMD630 c;
	...
	inline VectorSIMD630 operator*(VectorSIMD630 a ,double b){
		VectorSIMD630 c;
	...
	inline VectorSIMD630 operator*(int a, VectorSIMD630 b){
		if(a==1){return b;}
		VectorSIMD630 c;
	...
	inline VectorSIMD630 operator*(VectorSIMD630 a, int b){
		if(b==1){return a;}
		VectorSIMD630 c;
	...
	inline VectorSIMD630 operator*(VectorSIMD630 a, VectorSIMD630 b){
		VectorSIMD630 c;
	...
	inline VectorSIMD630 exp(VectorSIMD630 a){
		double a_d[630]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD630 sqrt(VectorSIMD630 a){
		double a_d[630]; a.convert(a_d);
