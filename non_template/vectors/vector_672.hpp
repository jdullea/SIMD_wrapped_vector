...
public:
		...
		VectorSIMD672& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD672& operator += (VectorSIMD672 a){
	...
	inline VectorSIMD672 operator*(double a, VectorSIMD672 b){
		VectorSIMD672 c;
	...
	inline VectorSIMD672 operator*(VectorSIMD672 a ,double b){
		VectorSIMD672 c;
	...
	inline VectorSIMD672 operator*(int a, VectorSIMD672 b){
		if(a==1){return b;}
		VectorSIMD672 c;
	...
	inline VectorSIMD672 operator*(VectorSIMD672 a, int b){
		if(b==1){return a;}
		VectorSIMD672 c;
	...
	inline VectorSIMD672 operator*(VectorSIMD672 a, VectorSIMD672 b){
		VectorSIMD672 c;
	...
	inline VectorSIMD672 exp(VectorSIMD672 a){
		double a_d[672]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD672 sqrt(VectorSIMD672 a){
		double a_d[672]; a.convert(a_d);
