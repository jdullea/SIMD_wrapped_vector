...
public:
		...
		VectorSIMD214(double a){
			...
			_avx53=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD214(double (&a)[214]){
		...
		VectorSIMD214& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD214& operator += (VectorSIMD214 a){
	...
	inline VectorSIMD214 operator*(double a, VectorSIMD214 b){
		VectorSIMD214 c;
	...
	inline VectorSIMD214 operator*(VectorSIMD214 a ,double b){
		VectorSIMD214 c;
	...
	inline VectorSIMD214 operator*(int a, VectorSIMD214 b){
		if(a==1){return b;}
		VectorSIMD214 c;
	...
	inline VectorSIMD214 operator*(VectorSIMD214 a, int b){
		if(b==1){return a;}
		VectorSIMD214 c;
	...
	inline VectorSIMD214 operator*(VectorSIMD214 a, VectorSIMD214 b){
		VectorSIMD214 c;
	...
	inline VectorSIMD214 exp(VectorSIMD214 a){
		double a_d[214]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD214 sqrt(VectorSIMD214 a){
		double a_d[214]; a.convert(a_d);
