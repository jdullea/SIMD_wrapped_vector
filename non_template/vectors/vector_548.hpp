...
public:
		...
		VectorSIMD548& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD548& operator += (VectorSIMD548 a){
	...
	inline VectorSIMD548 operator*(double a, VectorSIMD548 b){
		VectorSIMD548 c;
	...
	inline VectorSIMD548 operator*(VectorSIMD548 a ,double b){
		VectorSIMD548 c;
	...
	inline VectorSIMD548 operator*(int a, VectorSIMD548 b){
		if(a==1){return b;}
		VectorSIMD548 c;
	...
	inline VectorSIMD548 operator*(VectorSIMD548 a, int b){
		if(b==1){return a;}
		VectorSIMD548 c;
	...
	inline VectorSIMD548 operator*(VectorSIMD548 a, VectorSIMD548 b){
		VectorSIMD548 c;
	...
	inline VectorSIMD548 exp(VectorSIMD548 a){
		double a_d[548]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD548 sqrt(VectorSIMD548 a){
		double a_d[548]; a.convert(a_d);
