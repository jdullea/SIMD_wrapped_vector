...
public:
		...
		VectorSIMD1017(double a){
			...
			_avx254=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD1017(double (&a)[1017]){
		...
		VectorSIMD1017& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1017& operator += (VectorSIMD1017 a){
	...
	inline VectorSIMD1017 operator*(double a, VectorSIMD1017 b){
		VectorSIMD1017 c;
	...
	inline VectorSIMD1017 operator*(VectorSIMD1017 a ,double b){
		VectorSIMD1017 c;
	...
	inline VectorSIMD1017 operator*(int a, VectorSIMD1017 b){
		if(a==1){return b;}
		VectorSIMD1017 c;
	...
	inline VectorSIMD1017 operator*(VectorSIMD1017 a, int b){
		if(b==1){return a;}
		VectorSIMD1017 c;
	...
	inline VectorSIMD1017 operator*(VectorSIMD1017 a, VectorSIMD1017 b){
		VectorSIMD1017 c;
	...
	inline VectorSIMD1017 exp(VectorSIMD1017 a){
		double a_d[1017]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1017 r(a_d);
		return r;
	}

	inline VectorSIMD1017 sqrt(VectorSIMD1017 a){
		double a_d[1017]; a.convert(a_d);
