...
public:
		...
		VectorSIMD379(double a){
			...
			_avx94=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD379(double (&a)[379]){
		...
		VectorSIMD379& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD379& operator += (VectorSIMD379 a){
	...
	inline VectorSIMD379 operator*(double a, VectorSIMD379 b){
		VectorSIMD379 c;
	...
	inline VectorSIMD379 operator*(VectorSIMD379 a ,double b){
		VectorSIMD379 c;
	...
	inline VectorSIMD379 operator*(int a, VectorSIMD379 b){
		if(a==1){return b;}
		VectorSIMD379 c;
	...
	inline VectorSIMD379 operator*(VectorSIMD379 a, int b){
		if(b==1){return a;}
		VectorSIMD379 c;
	...
	inline VectorSIMD379 operator*(VectorSIMD379 a, VectorSIMD379 b){
		VectorSIMD379 c;
	...
	inline VectorSIMD379 exp(VectorSIMD379 a){
		double a_d[379]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD379 sqrt(VectorSIMD379 a){
		double a_d[379]; a.convert(a_d);
