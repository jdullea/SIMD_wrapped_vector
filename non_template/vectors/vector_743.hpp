...
public:
		...
		VectorSIMD743(double a){
			...
			_avx185=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD743(double (&a)[743]){
		...
		VectorSIMD743& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD743& operator += (VectorSIMD743 a){
	...
	inline VectorSIMD743 operator*(double a, VectorSIMD743 b){
		VectorSIMD743 c;
	...
	inline VectorSIMD743 operator*(VectorSIMD743 a ,double b){
		VectorSIMD743 c;
	...
	inline VectorSIMD743 operator*(int a, VectorSIMD743 b){
		if(a==1){return b;}
		VectorSIMD743 c;
	...
	inline VectorSIMD743 operator*(VectorSIMD743 a, int b){
		if(b==1){return a;}
		VectorSIMD743 c;
	...
	inline VectorSIMD743 operator*(VectorSIMD743 a, VectorSIMD743 b){
		VectorSIMD743 c;
	...
	inline VectorSIMD743 exp(VectorSIMD743 a){
		double a_d[743]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD743 sqrt(VectorSIMD743 a){
		double a_d[743]; a.convert(a_d);
