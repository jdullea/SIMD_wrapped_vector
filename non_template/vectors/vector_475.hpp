...
public:
		...
		VectorSIMD475(double a){
			...
			_avx118=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD475(double (&a)[475]){
		...
		VectorSIMD475& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD475& operator += (VectorSIMD475 a){
	...
	inline VectorSIMD475 operator*(double a, VectorSIMD475 b){
		VectorSIMD475 c;
	...
	inline VectorSIMD475 operator*(VectorSIMD475 a ,double b){
		VectorSIMD475 c;
	...
	inline VectorSIMD475 operator*(int a, VectorSIMD475 b){
		if(a==1){return b;}
		VectorSIMD475 c;
	...
	inline VectorSIMD475 operator*(VectorSIMD475 a, int b){
		if(b==1){return a;}
		VectorSIMD475 c;
	...
	inline VectorSIMD475 operator*(VectorSIMD475 a, VectorSIMD475 b){
		VectorSIMD475 c;
	...
	inline VectorSIMD475 exp(VectorSIMD475 a){
		double a_d[475]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD475 sqrt(VectorSIMD475 a){
		double a_d[475]; a.convert(a_d);
