...
public:
		...
		VectorSIMD336& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD336& operator += (VectorSIMD336 a){
	...
	inline VectorSIMD336 operator*(double a, VectorSIMD336 b){
		VectorSIMD336 c;
	...
	inline VectorSIMD336 operator*(VectorSIMD336 a ,double b){
		VectorSIMD336 c;
	...
	inline VectorSIMD336 operator*(int a, VectorSIMD336 b){
		if(a==1){return b;}
		VectorSIMD336 c;
	...
	inline VectorSIMD336 operator*(VectorSIMD336 a, int b){
		if(b==1){return a;}
		VectorSIMD336 c;
	...
	inline VectorSIMD336 operator*(VectorSIMD336 a, VectorSIMD336 b){
		VectorSIMD336 c;
	...
	inline VectorSIMD336 exp(VectorSIMD336 a){
		double a_d[336]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD336 sqrt(VectorSIMD336 a){
		double a_d[336]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD336 a){ 
		double ad[336];
		a.convert(ad);
