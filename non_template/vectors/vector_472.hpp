...
public:
		...
		VectorSIMD472& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD472& operator += (VectorSIMD472 a){
	...
	inline VectorSIMD472 operator*(double a, VectorSIMD472 b){
		VectorSIMD472 c;
	...
	inline VectorSIMD472 operator*(VectorSIMD472 a ,double b){
		VectorSIMD472 c;
	...
	inline VectorSIMD472 operator*(int a, VectorSIMD472 b){
		if(a==1){return b;}
		VectorSIMD472 c;
	...
	inline VectorSIMD472 operator*(VectorSIMD472 a, int b){
		if(b==1){return a;}
		VectorSIMD472 c;
	...
	inline VectorSIMD472 operator*(VectorSIMD472 a, VectorSIMD472 b){
		VectorSIMD472 c;
	...
	inline VectorSIMD472 exp(VectorSIMD472 a){
		double a_d[472]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD472 sqrt(VectorSIMD472 a){
		double a_d[472]; a.convert(a_d);
