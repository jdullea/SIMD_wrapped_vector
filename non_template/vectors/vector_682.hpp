...
public:
		...
		VectorSIMD682(double a){
			...
			_avx170=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD682(double (&a)[682]){
		...
		VectorSIMD682& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD682& operator += (VectorSIMD682 a){
	...
	inline VectorSIMD682 operator*(double a, VectorSIMD682 b){
		VectorSIMD682 c;
	...
	inline VectorSIMD682 operator*(VectorSIMD682 a ,double b){
		VectorSIMD682 c;
	...
	inline VectorSIMD682 operator*(int a, VectorSIMD682 b){
		if(a==1){return b;}
		VectorSIMD682 c;
	...
	inline VectorSIMD682 operator*(VectorSIMD682 a, int b){
		if(b==1){return a;}
		VectorSIMD682 c;
	...
	inline VectorSIMD682 operator*(VectorSIMD682 a, VectorSIMD682 b){
		VectorSIMD682 c;
	...
	inline VectorSIMD682 exp(VectorSIMD682 a){
		double a_d[682]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD682 sqrt(VectorSIMD682 a){
		double a_d[682]; a.convert(a_d);
