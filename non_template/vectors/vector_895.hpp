...
public:
		...
		VectorSIMD895(double a){
			...
			_avx223=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD895(double (&a)[895]){
		...
		VectorSIMD895& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD895& operator += (VectorSIMD895 a){
	...
	inline VectorSIMD895 operator*(double a, VectorSIMD895 b){
		VectorSIMD895 c;
	...
	inline VectorSIMD895 operator*(VectorSIMD895 a ,double b){
		VectorSIMD895 c;
	...
	inline VectorSIMD895 operator*(int a, VectorSIMD895 b){
		if(a==1){return b;}
		VectorSIMD895 c;
	...
	inline VectorSIMD895 operator*(VectorSIMD895 a, int b){
		if(b==1){return a;}
		VectorSIMD895 c;
	...
	inline VectorSIMD895 operator*(VectorSIMD895 a, VectorSIMD895 b){
		VectorSIMD895 c;
	...
	inline VectorSIMD895 exp(VectorSIMD895 a){
		double a_d[895]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD895 sqrt(VectorSIMD895 a){
		double a_d[895]; a.convert(a_d);
