...
public:
		...
		VectorSIMD686(double a){
			...
			_avx171=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD686(double (&a)[686]){
		...
		VectorSIMD686& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD686& operator += (VectorSIMD686 a){
	...
	inline VectorSIMD686 operator*(double a, VectorSIMD686 b){
		VectorSIMD686 c;
	...
	inline VectorSIMD686 operator*(VectorSIMD686 a ,double b){
		VectorSIMD686 c;
	...
	inline VectorSIMD686 operator*(int a, VectorSIMD686 b){
		if(a==1){return b;}
		VectorSIMD686 c;
	...
	inline VectorSIMD686 operator*(VectorSIMD686 a, int b){
		if(b==1){return a;}
		VectorSIMD686 c;
	...
	inline VectorSIMD686 operator*(VectorSIMD686 a, VectorSIMD686 b){
		VectorSIMD686 c;
	...
	inline VectorSIMD686 exp(VectorSIMD686 a){
		double a_d[686]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD686 sqrt(VectorSIMD686 a){
		double a_d[686]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD686 a){ 
		double ad[686];
		a.convert(ad);
