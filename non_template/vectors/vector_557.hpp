...
public:
		...
		VectorSIMD557(double a){
			...
			_avx139=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD557(double (&a)[557]){
		...
		VectorSIMD557& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD557& operator += (VectorSIMD557 a){
	...
	inline VectorSIMD557 operator*(double a, VectorSIMD557 b){
		VectorSIMD557 c;
	...
	inline VectorSIMD557 operator*(VectorSIMD557 a ,double b){
		VectorSIMD557 c;
	...
	inline VectorSIMD557 operator*(int a, VectorSIMD557 b){
		if(a==1){return b;}
		VectorSIMD557 c;
	...
	inline VectorSIMD557 operator*(VectorSIMD557 a, int b){
		if(b==1){return a;}
		VectorSIMD557 c;
	...
	inline VectorSIMD557 operator*(VectorSIMD557 a, VectorSIMD557 b){
		VectorSIMD557 c;
	...
	inline VectorSIMD557 exp(VectorSIMD557 a){
		double a_d[557]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD557 sqrt(VectorSIMD557 a){
		double a_d[557]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD557 a){ 
		double ad[557];
		a.convert(ad);
