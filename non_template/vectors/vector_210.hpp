...
public:
		...
		VectorSIMD210(double a){
			...
			_avx52=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD210(double (&a)[210]){
		...
		VectorSIMD210& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD210& operator += (VectorSIMD210 a){
	...
	inline VectorSIMD210 operator*(double a, VectorSIMD210 b){
		VectorSIMD210 c;
	...
	inline VectorSIMD210 operator*(VectorSIMD210 a ,double b){
		VectorSIMD210 c;
	...
	inline VectorSIMD210 operator*(int a, VectorSIMD210 b){
		if(a==1){return b;}
		VectorSIMD210 c;
	...
	inline VectorSIMD210 operator*(VectorSIMD210 a, int b){
		if(b==1){return a;}
		VectorSIMD210 c;
	...
	inline VectorSIMD210 operator*(VectorSIMD210 a, VectorSIMD210 b){
		VectorSIMD210 c;
	...
	inline VectorSIMD210 exp(VectorSIMD210 a){
		double a_d[210]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD210 sqrt(VectorSIMD210 a){
		double a_d[210]; a.convert(a_d);
