...
public:
		...
		VectorSIMD575(double a){
			...
			_avx143=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD575(double (&a)[575]){
		...
		VectorSIMD575& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD575& operator += (VectorSIMD575 a){
	...
	inline VectorSIMD575 operator*(double a, VectorSIMD575 b){
		VectorSIMD575 c;
	...
	inline VectorSIMD575 operator*(VectorSIMD575 a ,double b){
		VectorSIMD575 c;
	...
	inline VectorSIMD575 operator*(int a, VectorSIMD575 b){
		if(a==1){return b;}
		VectorSIMD575 c;
	...
	inline VectorSIMD575 operator*(VectorSIMD575 a, int b){
		if(b==1){return a;}
		VectorSIMD575 c;
	...
	inline VectorSIMD575 operator*(VectorSIMD575 a, VectorSIMD575 b){
		VectorSIMD575 c;
	...
	inline VectorSIMD575 exp(VectorSIMD575 a){
		double a_d[575]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD575 sqrt(VectorSIMD575 a){
		double a_d[575]; a.convert(a_d);
