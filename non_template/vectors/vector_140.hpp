...
public:
		...
		VectorSIMD140& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD140& operator += (VectorSIMD140 a){
	...
	inline VectorSIMD140 operator*(double a, VectorSIMD140 b){
		VectorSIMD140 c;
	...
	inline VectorSIMD140 operator*(VectorSIMD140 a ,double b){
		VectorSIMD140 c;
	...
	inline VectorSIMD140 operator*(int a, VectorSIMD140 b){
		if(a==1){return b;}
		VectorSIMD140 c;
	...
	inline VectorSIMD140 operator*(VectorSIMD140 a, int b){
		if(b==1){return a;}
		VectorSIMD140 c;
	...
	inline VectorSIMD140 operator*(VectorSIMD140 a, VectorSIMD140 b){
		VectorSIMD140 c;
	...
	inline VectorSIMD140 exp(VectorSIMD140 a){
		double a_d[140]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD140 sqrt(VectorSIMD140 a){
		double a_d[140]; a.convert(a_d);
