...
public:
		...
		VectorSIMD396& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD396& operator += (VectorSIMD396 a){
	...
	inline VectorSIMD396 operator*(double a, VectorSIMD396 b){
		VectorSIMD396 c;
	...
	inline VectorSIMD396 operator*(VectorSIMD396 a ,double b){
		VectorSIMD396 c;
	...
	inline VectorSIMD396 operator*(int a, VectorSIMD396 b){
		if(a==1){return b;}
		VectorSIMD396 c;
	...
	inline VectorSIMD396 operator*(VectorSIMD396 a, int b){
		if(b==1){return a;}
		VectorSIMD396 c;
	...
	inline VectorSIMD396 operator*(VectorSIMD396 a, VectorSIMD396 b){
		VectorSIMD396 c;
	...
	inline VectorSIMD396 exp(VectorSIMD396 a){
		double a_d[396]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD396 sqrt(VectorSIMD396 a){
		double a_d[396]; a.convert(a_d);
