...
public:
		...
		VectorSIMD741(double a){
			...
			_avx185=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD741(double (&a)[741]){
		...
		VectorSIMD741& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD741& operator += (VectorSIMD741 a){
	...
	inline VectorSIMD741 operator*(double a, VectorSIMD741 b){
		VectorSIMD741 c;
	...
	inline VectorSIMD741 operator*(VectorSIMD741 a ,double b){
		VectorSIMD741 c;
	...
	inline VectorSIMD741 operator*(int a, VectorSIMD741 b){
		if(a==1){return b;}
		VectorSIMD741 c;
	...
	inline VectorSIMD741 operator*(VectorSIMD741 a, int b){
		if(b==1){return a;}
		VectorSIMD741 c;
	...
	inline VectorSIMD741 operator*(VectorSIMD741 a, VectorSIMD741 b){
		VectorSIMD741 c;
	...
	inline VectorSIMD741 exp(VectorSIMD741 a){
		double a_d[741]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD741 sqrt(VectorSIMD741 a){
		double a_d[741]; a.convert(a_d);
