...
public:
		...
		VectorSIMD971(double a){
			...
			_avx242=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD971(double (&a)[971]){
		...
		VectorSIMD971& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD971& operator += (VectorSIMD971 a){
	...
	inline VectorSIMD971 operator*(double a, VectorSIMD971 b){
		VectorSIMD971 c;
	...
	inline VectorSIMD971 operator*(VectorSIMD971 a ,double b){
		VectorSIMD971 c;
	...
	inline VectorSIMD971 operator*(int a, VectorSIMD971 b){
		if(a==1){return b;}
		VectorSIMD971 c;
	...
	inline VectorSIMD971 operator*(VectorSIMD971 a, int b){
		if(b==1){return a;}
		VectorSIMD971 c;
	...
	inline VectorSIMD971 operator*(VectorSIMD971 a, VectorSIMD971 b){
		VectorSIMD971 c;
	...
	inline VectorSIMD971 exp(VectorSIMD971 a){
		double a_d[971]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD971 sqrt(VectorSIMD971 a){
		double a_d[971]; a.convert(a_d);
