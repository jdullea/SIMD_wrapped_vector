...
public:
		...
		VectorSIMD921(double a){
			...
			_avx230=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD921(double (&a)[921]){
		...
		VectorSIMD921& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD921& operator += (VectorSIMD921 a){
	...
	inline VectorSIMD921 operator*(double a, VectorSIMD921 b){
		VectorSIMD921 c;
	...
	inline VectorSIMD921 operator*(VectorSIMD921 a ,double b){
		VectorSIMD921 c;
	...
	inline VectorSIMD921 operator*(int a, VectorSIMD921 b){
		if(a==1){return b;}
		VectorSIMD921 c;
	...
	inline VectorSIMD921 operator*(VectorSIMD921 a, int b){
		if(b==1){return a;}
		VectorSIMD921 c;
	...
	inline VectorSIMD921 operator*(VectorSIMD921 a, VectorSIMD921 b){
		VectorSIMD921 c;
	...
	inline VectorSIMD921 exp(VectorSIMD921 a){
		double a_d[921]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD921 sqrt(VectorSIMD921 a){
		double a_d[921]; a.convert(a_d);
