...
public:
		...
		VectorSIMD228& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD228& operator += (VectorSIMD228 a){
	...
	inline VectorSIMD228 operator*(double a, VectorSIMD228 b){
		VectorSIMD228 c;
	...
	inline VectorSIMD228 operator*(VectorSIMD228 a ,double b){
		VectorSIMD228 c;
	...
	inline VectorSIMD228 operator*(int a, VectorSIMD228 b){
		if(a==1){return b;}
		VectorSIMD228 c;
	...
	inline VectorSIMD228 operator*(VectorSIMD228 a, int b){
		if(b==1){return a;}
		VectorSIMD228 c;
	...
	inline VectorSIMD228 operator*(VectorSIMD228 a, VectorSIMD228 b){
		VectorSIMD228 c;
	...
	inline VectorSIMD228 exp(VectorSIMD228 a){
		double a_d[228]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD228 sqrt(VectorSIMD228 a){
		double a_d[228]; a.convert(a_d);
