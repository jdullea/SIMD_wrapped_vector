...
public:
		...
		VectorSIMD192& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD192& operator += (VectorSIMD192 a){
	...
	inline VectorSIMD192 operator*(double a, VectorSIMD192 b){
		VectorSIMD192 c;
	...
	inline VectorSIMD192 operator*(VectorSIMD192 a ,double b){
		VectorSIMD192 c;
	...
	inline VectorSIMD192 operator*(int a, VectorSIMD192 b){
		if(a==1){return b;}
		VectorSIMD192 c;
	...
	inline VectorSIMD192 operator*(VectorSIMD192 a, int b){
		if(b==1){return a;}
		VectorSIMD192 c;
	...
	inline VectorSIMD192 operator*(VectorSIMD192 a, VectorSIMD192 b){
		VectorSIMD192 c;
	...
	inline VectorSIMD192 exp(VectorSIMD192 a){
		double a_d[192]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD192 sqrt(VectorSIMD192 a){
		double a_d[192]; a.convert(a_d);
