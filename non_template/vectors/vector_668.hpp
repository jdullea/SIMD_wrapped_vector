...
public:
		...
		VectorSIMD668& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD668& operator += (VectorSIMD668 a){
	...
	inline VectorSIMD668 operator*(double a, VectorSIMD668 b){
		VectorSIMD668 c;
	...
	inline VectorSIMD668 operator*(VectorSIMD668 a ,double b){
		VectorSIMD668 c;
	...
	inline VectorSIMD668 operator*(int a, VectorSIMD668 b){
		if(a==1){return b;}
		VectorSIMD668 c;
	...
	inline VectorSIMD668 operator*(VectorSIMD668 a, int b){
		if(b==1){return a;}
		VectorSIMD668 c;
	...
	inline VectorSIMD668 operator*(VectorSIMD668 a, VectorSIMD668 b){
		VectorSIMD668 c;
	...
	inline VectorSIMD668 exp(VectorSIMD668 a){
		double a_d[668]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD668 sqrt(VectorSIMD668 a){
		double a_d[668]; a.convert(a_d);
