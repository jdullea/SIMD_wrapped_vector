...
public:
		...
		VectorSIMD201(double a){
			...
			_avx50=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD201(double (&a)[201]){
		...
		VectorSIMD201& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD201& operator += (VectorSIMD201 a){
	...
	inline VectorSIMD201 operator*(double a, VectorSIMD201 b){
		VectorSIMD201 c;
	...
	inline VectorSIMD201 operator*(VectorSIMD201 a ,double b){
		VectorSIMD201 c;
	...
	inline VectorSIMD201 operator*(int a, VectorSIMD201 b){
		if(a==1){return b;}
		VectorSIMD201 c;
	...
	inline VectorSIMD201 operator*(VectorSIMD201 a, int b){
		if(b==1){return a;}
		VectorSIMD201 c;
	...
	inline VectorSIMD201 operator*(VectorSIMD201 a, VectorSIMD201 b){
		VectorSIMD201 c;
	...
	inline VectorSIMD201 exp(VectorSIMD201 a){
		double a_d[201]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD201 sqrt(VectorSIMD201 a){
		double a_d[201]; a.convert(a_d);
