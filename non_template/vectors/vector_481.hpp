...
public:
		...
		VectorSIMD481(double a){
			...
			_avx120=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD481(double (&a)[481]){
		...
		VectorSIMD481& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD481& operator += (VectorSIMD481 a){
	...
	inline VectorSIMD481 operator*(double a, VectorSIMD481 b){
		VectorSIMD481 c;
	...
	inline VectorSIMD481 operator*(VectorSIMD481 a ,double b){
		VectorSIMD481 c;
	...
	inline VectorSIMD481 operator*(int a, VectorSIMD481 b){
		if(a==1){return b;}
		VectorSIMD481 c;
	...
	inline VectorSIMD481 operator*(VectorSIMD481 a, int b){
		if(b==1){return a;}
		VectorSIMD481 c;
	...
	inline VectorSIMD481 operator*(VectorSIMD481 a, VectorSIMD481 b){
		VectorSIMD481 c;
	...
	inline VectorSIMD481 exp(VectorSIMD481 a){
		double a_d[481]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD481 sqrt(VectorSIMD481 a){
		double a_d[481]; a.convert(a_d);
