...
public:
		...
		VectorSIMD976& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD976& operator += (VectorSIMD976 a){
	...
	inline VectorSIMD976 operator*(double a, VectorSIMD976 b){
		VectorSIMD976 c;
	...
	inline VectorSIMD976 operator*(VectorSIMD976 a ,double b){
		VectorSIMD976 c;
	...
	inline VectorSIMD976 operator*(int a, VectorSIMD976 b){
		if(a==1){return b;}
		VectorSIMD976 c;
	...
	inline VectorSIMD976 operator*(VectorSIMD976 a, int b){
		if(b==1){return a;}
		VectorSIMD976 c;
	...
	inline VectorSIMD976 operator*(VectorSIMD976 a, VectorSIMD976 b){
		VectorSIMD976 c;
	...
	inline VectorSIMD976 exp(VectorSIMD976 a){
		double a_d[976]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD976 sqrt(VectorSIMD976 a){
		double a_d[976]; a.convert(a_d);
