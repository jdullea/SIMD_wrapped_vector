...
public:
		...
		VectorSIMD901(double a){
			...
			_avx225=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD901(double (&a)[901]){
		...
		VectorSIMD901& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD901& operator += (VectorSIMD901 a){
	...
	inline VectorSIMD901 operator*(double a, VectorSIMD901 b){
		VectorSIMD901 c;
	...
	inline VectorSIMD901 operator*(VectorSIMD901 a ,double b){
		VectorSIMD901 c;
	...
	inline VectorSIMD901 operator*(int a, VectorSIMD901 b){
		if(a==1){return b;}
		VectorSIMD901 c;
	...
	inline VectorSIMD901 operator*(VectorSIMD901 a, int b){
		if(b==1){return a;}
		VectorSIMD901 c;
	...
	inline VectorSIMD901 operator*(VectorSIMD901 a, VectorSIMD901 b){
		VectorSIMD901 c;
	...
	inline VectorSIMD901 exp(VectorSIMD901 a){
		double a_d[901]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD901 sqrt(VectorSIMD901 a){
		double a_d[901]; a.convert(a_d);
