...
public:
		...
		VectorSIMD746(double a){
			...
			_avx186=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD746(double (&a)[746]){
		...
		VectorSIMD746& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD746& operator += (VectorSIMD746 a){
	...
	inline VectorSIMD746 operator*(double a, VectorSIMD746 b){
		VectorSIMD746 c;
	...
	inline VectorSIMD746 operator*(VectorSIMD746 a ,double b){
		VectorSIMD746 c;
	...
	inline VectorSIMD746 operator*(int a, VectorSIMD746 b){
		if(a==1){return b;}
		VectorSIMD746 c;
	...
	inline VectorSIMD746 operator*(VectorSIMD746 a, int b){
		if(b==1){return a;}
		VectorSIMD746 c;
	...
	inline VectorSIMD746 operator*(VectorSIMD746 a, VectorSIMD746 b){
		VectorSIMD746 c;
	...
	inline VectorSIMD746 exp(VectorSIMD746 a){
		double a_d[746]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD746 sqrt(VectorSIMD746 a){
		double a_d[746]; a.convert(a_d);
