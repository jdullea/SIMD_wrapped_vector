...
public:
		...
		VectorSIMD15(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14){
		...
		VectorSIMD15(__m256d _0,__m256d _1,__m256d _2,__m256d _3){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD15& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD15& operator += (VectorSIMD15 a){
	...
	inline VectorSIMD15 operator*(double a, VectorSIMD15 b){
		VectorSIMD15 c;
	...
	inline VectorSIMD15 operator*(VectorSIMD15 a ,double b){
		VectorSIMD15 c;
	...
	inline VectorSIMD15 operator*(int a, VectorSIMD15 b){
		if(a==1){return b;}
		VectorSIMD15 c;
	...
	inline VectorSIMD15 operator*(VectorSIMD15 a, int b){
		if(b==1){return a;}
		VectorSIMD15 c;
	...
	inline VectorSIMD15 operator*(VectorSIMD15 a, VectorSIMD15 b){
		VectorSIMD15 c;
	...
	inline VectorSIMD15 exp(VectorSIMD15 a){
	...
	inline VectorSIMD15 sqrt(VectorSIMD15 a){
		double a_d[15]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD15 a){ 
		double ad[15];
		a.convert(ad);
