...
public:
		...
		VectorSIMD283(double a){
			...
			_avx70=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD283(double (&a)[283]){
		...
		VectorSIMD283& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD283& operator += (VectorSIMD283 a){
	...
	inline VectorSIMD283 operator*(double a, VectorSIMD283 b){
		VectorSIMD283 c;
	...
	inline VectorSIMD283 operator*(VectorSIMD283 a ,double b){
		VectorSIMD283 c;
	...
	inline VectorSIMD283 operator*(int a, VectorSIMD283 b){
		if(a==1){return b;}
		VectorSIMD283 c;
	...
	inline VectorSIMD283 operator*(VectorSIMD283 a, int b){
		if(b==1){return a;}
		VectorSIMD283 c;
	...
	inline VectorSIMD283 operator*(VectorSIMD283 a, VectorSIMD283 b){
		VectorSIMD283 c;
	...
	inline VectorSIMD283 exp(VectorSIMD283 a){
		double a_d[283]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD283 sqrt(VectorSIMD283 a){
		double a_d[283]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD283 a){ 
		double ad[283];
		a.convert(ad);
