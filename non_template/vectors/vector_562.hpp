...
public:
		...
		VectorSIMD562(double a){
			...
			_avx140=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD562(double (&a)[562]){
		...
		VectorSIMD562& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD562& operator += (VectorSIMD562 a){
	...
	inline VectorSIMD562 operator*(double a, VectorSIMD562 b){
		VectorSIMD562 c;
	...
	inline VectorSIMD562 operator*(VectorSIMD562 a ,double b){
		VectorSIMD562 c;
	...
	inline VectorSIMD562 operator*(int a, VectorSIMD562 b){
		if(a==1){return b;}
		VectorSIMD562 c;
	...
	inline VectorSIMD562 operator*(VectorSIMD562 a, int b){
		if(b==1){return a;}
		VectorSIMD562 c;
	...
	inline VectorSIMD562 operator*(VectorSIMD562 a, VectorSIMD562 b){
		VectorSIMD562 c;
	...
	inline VectorSIMD562 exp(VectorSIMD562 a){
		double a_d[562]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD562 sqrt(VectorSIMD562 a){
		double a_d[562]; a.convert(a_d);
