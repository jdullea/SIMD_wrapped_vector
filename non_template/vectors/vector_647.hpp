...
public:
		...
		VectorSIMD647(double a){
			...
			_avx161=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD647(double (&a)[647]){
		...
		VectorSIMD647& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD647& operator += (VectorSIMD647 a){
	...
	inline VectorSIMD647 operator*(double a, VectorSIMD647 b){
		VectorSIMD647 c;
	...
	inline VectorSIMD647 operator*(VectorSIMD647 a ,double b){
		VectorSIMD647 c;
	...
	inline VectorSIMD647 operator*(int a, VectorSIMD647 b){
		if(a==1){return b;}
		VectorSIMD647 c;
	...
	inline VectorSIMD647 operator*(VectorSIMD647 a, int b){
		if(b==1){return a;}
		VectorSIMD647 c;
	...
	inline VectorSIMD647 operator*(VectorSIMD647 a, VectorSIMD647 b){
		VectorSIMD647 c;
	...
	inline VectorSIMD647 exp(VectorSIMD647 a){
		double a_d[647]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD647 sqrt(VectorSIMD647 a){
		double a_d[647]; a.convert(a_d);
