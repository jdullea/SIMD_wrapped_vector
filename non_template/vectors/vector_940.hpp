...
public:
		...
		VectorSIMD940& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD940& operator += (VectorSIMD940 a){
	...
	inline VectorSIMD940 operator*(double a, VectorSIMD940 b){
		VectorSIMD940 c;
	...
	inline VectorSIMD940 operator*(VectorSIMD940 a ,double b){
		VectorSIMD940 c;
	...
	inline VectorSIMD940 operator*(int a, VectorSIMD940 b){
		if(a==1){return b;}
		VectorSIMD940 c;
	...
	inline VectorSIMD940 operator*(VectorSIMD940 a, int b){
		if(b==1){return a;}
		VectorSIMD940 c;
	...
	inline VectorSIMD940 operator*(VectorSIMD940 a, VectorSIMD940 b){
		VectorSIMD940 c;
	...
	inline VectorSIMD940 exp(VectorSIMD940 a){
		double a_d[940]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD940 sqrt(VectorSIMD940 a){
		double a_d[940]; a.convert(a_d);
