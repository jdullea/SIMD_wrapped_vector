...
public:
		...
		VectorSIMD444& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD444& operator += (VectorSIMD444 a){
	...
	inline VectorSIMD444 operator*(double a, VectorSIMD444 b){
		VectorSIMD444 c;
	...
	inline VectorSIMD444 operator*(VectorSIMD444 a ,double b){
		VectorSIMD444 c;
	...
	inline VectorSIMD444 operator*(int a, VectorSIMD444 b){
		if(a==1){return b;}
		VectorSIMD444 c;
	...
	inline VectorSIMD444 operator*(VectorSIMD444 a, int b){
		if(b==1){return a;}
		VectorSIMD444 c;
	...
	inline VectorSIMD444 operator*(VectorSIMD444 a, VectorSIMD444 b){
		VectorSIMD444 c;
	...
	inline VectorSIMD444 exp(VectorSIMD444 a){
		double a_d[444]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD444 sqrt(VectorSIMD444 a){
		double a_d[444]; a.convert(a_d);
