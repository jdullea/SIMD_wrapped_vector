...
public:
		...
		VectorSIMD446(double a){
			...
			_avx111=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD446(double (&a)[446]){
		...
		VectorSIMD446& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD446& operator += (VectorSIMD446 a){
	...
	inline VectorSIMD446 operator*(double a, VectorSIMD446 b){
		VectorSIMD446 c;
	...
	inline VectorSIMD446 operator*(VectorSIMD446 a ,double b){
		VectorSIMD446 c;
	...
	inline VectorSIMD446 operator*(int a, VectorSIMD446 b){
		if(a==1){return b;}
		VectorSIMD446 c;
	...
	inline VectorSIMD446 operator*(VectorSIMD446 a, int b){
		if(b==1){return a;}
		VectorSIMD446 c;
	...
	inline VectorSIMD446 operator*(VectorSIMD446 a, VectorSIMD446 b){
		VectorSIMD446 c;
	...
	inline VectorSIMD446 exp(VectorSIMD446 a){
		double a_d[446]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD446 sqrt(VectorSIMD446 a){
		double a_d[446]; a.convert(a_d);
