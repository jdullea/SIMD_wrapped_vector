...
public:
		...
		VectorSIMD909(double a){
			...
			_avx227=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD909(double (&a)[909]){
		...
		VectorSIMD909& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD909& operator += (VectorSIMD909 a){
	...
	inline VectorSIMD909 operator*(double a, VectorSIMD909 b){
		VectorSIMD909 c;
	...
	inline VectorSIMD909 operator*(VectorSIMD909 a ,double b){
		VectorSIMD909 c;
	...
	inline VectorSIMD909 operator*(int a, VectorSIMD909 b){
		if(a==1){return b;}
		VectorSIMD909 c;
	...
	inline VectorSIMD909 operator*(VectorSIMD909 a, int b){
		if(b==1){return a;}
		VectorSIMD909 c;
	...
	inline VectorSIMD909 operator*(VectorSIMD909 a, VectorSIMD909 b){
		VectorSIMD909 c;
	...
	inline VectorSIMD909 exp(VectorSIMD909 a){
		double a_d[909]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD909 sqrt(VectorSIMD909 a){
		double a_d[909]; a.convert(a_d);
