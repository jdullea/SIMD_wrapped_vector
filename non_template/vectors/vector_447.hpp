...
public:
		...
		VectorSIMD447(double a){
			...
			_avx111=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD447(double (&a)[447]){
		...
		VectorSIMD447& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD447& operator += (VectorSIMD447 a){
	...
	inline VectorSIMD447 operator*(double a, VectorSIMD447 b){
		VectorSIMD447 c;
	...
	inline VectorSIMD447 operator*(VectorSIMD447 a ,double b){
		VectorSIMD447 c;
	...
	inline VectorSIMD447 operator*(int a, VectorSIMD447 b){
		if(a==1){return b;}
		VectorSIMD447 c;
	...
	inline VectorSIMD447 operator*(VectorSIMD447 a, int b){
		if(b==1){return a;}
		VectorSIMD447 c;
	...
	inline VectorSIMD447 operator*(VectorSIMD447 a, VectorSIMD447 b){
		VectorSIMD447 c;
	...
	inline VectorSIMD447 exp(VectorSIMD447 a){
		double a_d[447]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD447 sqrt(VectorSIMD447 a){
		double a_d[447]; a.convert(a_d);
