...
public:
		...
		VectorSIMD902(double a){
			...
			_avx225=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD902(double (&a)[902]){
		...
		VectorSIMD902& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD902& operator += (VectorSIMD902 a){
	...
	inline VectorSIMD902 operator*(double a, VectorSIMD902 b){
		VectorSIMD902 c;
	...
	inline VectorSIMD902 operator*(VectorSIMD902 a ,double b){
		VectorSIMD902 c;
	...
	inline VectorSIMD902 operator*(int a, VectorSIMD902 b){
		if(a==1){return b;}
		VectorSIMD902 c;
	...
	inline VectorSIMD902 operator*(VectorSIMD902 a, int b){
		if(b==1){return a;}
		VectorSIMD902 c;
	...
	inline VectorSIMD902 operator*(VectorSIMD902 a, VectorSIMD902 b){
		VectorSIMD902 c;
	...
	inline VectorSIMD902 exp(VectorSIMD902 a){
		double a_d[902]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD902 sqrt(VectorSIMD902 a){
		double a_d[902]; a.convert(a_d);
