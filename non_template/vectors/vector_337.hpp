...
public:
		...
		VectorSIMD337(double a){
			...
			_avx84=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD337(double (&a)[337]){
		...
		VectorSIMD337& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD337& operator += (VectorSIMD337 a){
	...
	inline VectorSIMD337 operator*(double a, VectorSIMD337 b){
		VectorSIMD337 c;
	...
	inline VectorSIMD337 operator*(VectorSIMD337 a ,double b){
		VectorSIMD337 c;
	...
	inline VectorSIMD337 operator*(int a, VectorSIMD337 b){
		if(a==1){return b;}
		VectorSIMD337 c;
	...
	inline VectorSIMD337 operator*(VectorSIMD337 a, int b){
		if(b==1){return a;}
		VectorSIMD337 c;
	...
	inline VectorSIMD337 operator*(VectorSIMD337 a, VectorSIMD337 b){
		VectorSIMD337 c;
	...
	inline VectorSIMD337 exp(VectorSIMD337 a){
		double a_d[337]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD337 sqrt(VectorSIMD337 a){
		double a_d[337]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD337 a){ 
		double ad[337];
		a.convert(ad);
