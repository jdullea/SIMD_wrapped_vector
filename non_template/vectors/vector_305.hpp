...
public:
		...
		VectorSIMD305(double a){
			...
			_avx76=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD305(double (&a)[305]){
		...
		VectorSIMD305& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD305& operator += (VectorSIMD305 a){
	...
	inline VectorSIMD305 operator*(double a, VectorSIMD305 b){
		VectorSIMD305 c;
	...
	inline VectorSIMD305 operator*(VectorSIMD305 a ,double b){
		VectorSIMD305 c;
	...
	inline VectorSIMD305 operator*(int a, VectorSIMD305 b){
		if(a==1){return b;}
		VectorSIMD305 c;
	...
	inline VectorSIMD305 operator*(VectorSIMD305 a, int b){
		if(b==1){return a;}
		VectorSIMD305 c;
	...
	inline VectorSIMD305 operator*(VectorSIMD305 a, VectorSIMD305 b){
		VectorSIMD305 c;
	...
	inline VectorSIMD305 exp(VectorSIMD305 a){
		double a_d[305]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD305 sqrt(VectorSIMD305 a){
		double a_d[305]; a.convert(a_d);
