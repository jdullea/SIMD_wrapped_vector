...
public:
		...
		VectorSIMD644& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD644& operator += (VectorSIMD644 a){
	...
	inline VectorSIMD644 operator*(double a, VectorSIMD644 b){
		VectorSIMD644 c;
	...
	inline VectorSIMD644 operator*(VectorSIMD644 a ,double b){
		VectorSIMD644 c;
	...
	inline VectorSIMD644 operator*(int a, VectorSIMD644 b){
		if(a==1){return b;}
		VectorSIMD644 c;
	...
	inline VectorSIMD644 operator*(VectorSIMD644 a, int b){
		if(b==1){return a;}
		VectorSIMD644 c;
	...
	inline VectorSIMD644 operator*(VectorSIMD644 a, VectorSIMD644 b){
		VectorSIMD644 c;
	...
	inline VectorSIMD644 exp(VectorSIMD644 a){
		double a_d[644]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD644 sqrt(VectorSIMD644 a){
		double a_d[644]; a.convert(a_d);
