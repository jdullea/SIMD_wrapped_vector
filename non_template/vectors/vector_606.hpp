...
public:
		...
		VectorSIMD606(double a){
			...
			_avx151=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD606(double (&a)[606]){
		...
		VectorSIMD606& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD606& operator += (VectorSIMD606 a){
	...
	inline VectorSIMD606 operator*(double a, VectorSIMD606 b){
		VectorSIMD606 c;
	...
	inline VectorSIMD606 operator*(VectorSIMD606 a ,double b){
		VectorSIMD606 c;
	...
	inline VectorSIMD606 operator*(int a, VectorSIMD606 b){
		if(a==1){return b;}
		VectorSIMD606 c;
	...
	inline VectorSIMD606 operator*(VectorSIMD606 a, int b){
		if(b==1){return a;}
		VectorSIMD606 c;
	...
	inline VectorSIMD606 operator*(VectorSIMD606 a, VectorSIMD606 b){
		VectorSIMD606 c;
	...
	inline VectorSIMD606 exp(VectorSIMD606 a){
		double a_d[606]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD606 sqrt(VectorSIMD606 a){
		double a_d[606]; a.convert(a_d);
