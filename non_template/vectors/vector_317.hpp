...
public:
		...
		VectorSIMD317(double a){
			...
			_avx79=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD317(double (&a)[317]){
		...
		VectorSIMD317& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD317& operator += (VectorSIMD317 a){
	...
	inline VectorSIMD317 operator*(double a, VectorSIMD317 b){
		VectorSIMD317 c;
	...
	inline VectorSIMD317 operator*(VectorSIMD317 a ,double b){
		VectorSIMD317 c;
	...
	inline VectorSIMD317 operator*(int a, VectorSIMD317 b){
		if(a==1){return b;}
		VectorSIMD317 c;
	...
	inline VectorSIMD317 operator*(VectorSIMD317 a, int b){
		if(b==1){return a;}
		VectorSIMD317 c;
	...
	inline VectorSIMD317 operator*(VectorSIMD317 a, VectorSIMD317 b){
		VectorSIMD317 c;
	...
	inline VectorSIMD317 exp(VectorSIMD317 a){
		double a_d[317]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD317 sqrt(VectorSIMD317 a){
		double a_d[317]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD317 a){ 
		double ad[317];
		a.convert(ad);
