...
public:
		...
		VectorSIMD329(double a){
			...
			_avx82=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD329(double (&a)[329]){
		...
		VectorSIMD329& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD329& operator += (VectorSIMD329 a){
	...
	inline VectorSIMD329 operator*(double a, VectorSIMD329 b){
		VectorSIMD329 c;
	...
	inline VectorSIMD329 operator*(VectorSIMD329 a ,double b){
		VectorSIMD329 c;
	...
	inline VectorSIMD329 operator*(int a, VectorSIMD329 b){
		if(a==1){return b;}
		VectorSIMD329 c;
	...
	inline VectorSIMD329 operator*(VectorSIMD329 a, int b){
		if(b==1){return a;}
		VectorSIMD329 c;
	...
	inline VectorSIMD329 operator*(VectorSIMD329 a, VectorSIMD329 b){
		VectorSIMD329 c;
	...
	inline VectorSIMD329 exp(VectorSIMD329 a){
		double a_d[329]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD329 sqrt(VectorSIMD329 a){
		double a_d[329]; a.convert(a_d);
