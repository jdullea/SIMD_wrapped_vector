...
public:
		...
		VectorSIMD927(double a){
			...
			_avx231=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD927(double (&a)[927]){
		...
		VectorSIMD927& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD927& operator += (VectorSIMD927 a){
	...
	inline VectorSIMD927 operator*(double a, VectorSIMD927 b){
		VectorSIMD927 c;
	...
	inline VectorSIMD927 operator*(VectorSIMD927 a ,double b){
		VectorSIMD927 c;
	...
	inline VectorSIMD927 operator*(int a, VectorSIMD927 b){
		if(a==1){return b;}
		VectorSIMD927 c;
	...
	inline VectorSIMD927 operator*(VectorSIMD927 a, int b){
		if(b==1){return a;}
		VectorSIMD927 c;
	...
	inline VectorSIMD927 operator*(VectorSIMD927 a, VectorSIMD927 b){
		VectorSIMD927 c;
	...
	inline VectorSIMD927 exp(VectorSIMD927 a){
		double a_d[927]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD927 sqrt(VectorSIMD927 a){
		double a_d[927]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD927 a){ 
		double ad[927];
		a.convert(ad);
