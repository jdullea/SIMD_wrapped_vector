...
public:
		...
		VectorSIMD525(double a){
			...
			_avx131=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD525(double (&a)[525]){
		...
		VectorSIMD525& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD525& operator += (VectorSIMD525 a){
	...
	inline VectorSIMD525 operator*(double a, VectorSIMD525 b){
		VectorSIMD525 c;
	...
	inline VectorSIMD525 operator*(VectorSIMD525 a ,double b){
		VectorSIMD525 c;
	...
	inline VectorSIMD525 operator*(int a, VectorSIMD525 b){
		if(a==1){return b;}
		VectorSIMD525 c;
	...
	inline VectorSIMD525 operator*(VectorSIMD525 a, int b){
		if(b==1){return a;}
		VectorSIMD525 c;
	...
	inline VectorSIMD525 operator*(VectorSIMD525 a, VectorSIMD525 b){
		VectorSIMD525 c;
	...
	inline VectorSIMD525 exp(VectorSIMD525 a){
		double a_d[525]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD525 sqrt(VectorSIMD525 a){
		double a_d[525]; a.convert(a_d);
