...
public:
		...
		VectorSIMD858(double a){
			...
			_avx214=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD858(double (&a)[858]){
		...
		VectorSIMD858& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD858& operator += (VectorSIMD858 a){
	...
	inline VectorSIMD858 operator*(double a, VectorSIMD858 b){
		VectorSIMD858 c;
	...
	inline VectorSIMD858 operator*(VectorSIMD858 a ,double b){
		VectorSIMD858 c;
	...
	inline VectorSIMD858 operator*(int a, VectorSIMD858 b){
		if(a==1){return b;}
		VectorSIMD858 c;
	...
	inline VectorSIMD858 operator*(VectorSIMD858 a, int b){
		if(b==1){return a;}
		VectorSIMD858 c;
	...
	inline VectorSIMD858 operator*(VectorSIMD858 a, VectorSIMD858 b){
		VectorSIMD858 c;
	...
	inline VectorSIMD858 exp(VectorSIMD858 a){
		double a_d[858]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD858 sqrt(VectorSIMD858 a){
		double a_d[858]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD858 a){ 
		double ad[858];
		a.convert(ad);
