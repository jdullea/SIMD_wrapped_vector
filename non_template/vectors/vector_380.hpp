...
public:
		...
		VectorSIMD380& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD380& operator += (VectorSIMD380 a){
	...
	inline VectorSIMD380 operator*(double a, VectorSIMD380 b){
		VectorSIMD380 c;
	...
	inline VectorSIMD380 operator*(VectorSIMD380 a ,double b){
		VectorSIMD380 c;
	...
	inline VectorSIMD380 operator*(int a, VectorSIMD380 b){
		if(a==1){return b;}
		VectorSIMD380 c;
	...
	inline VectorSIMD380 operator*(VectorSIMD380 a, int b){
		if(b==1){return a;}
		VectorSIMD380 c;
	...
	inline VectorSIMD380 operator*(VectorSIMD380 a, VectorSIMD380 b){
		VectorSIMD380 c;
	...
	inline VectorSIMD380 exp(VectorSIMD380 a){
		double a_d[380]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD380 sqrt(VectorSIMD380 a){
		double a_d[380]; a.convert(a_d);
