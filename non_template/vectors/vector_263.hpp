...
public:
		...
		VectorSIMD263(double a){
			...
			_avx65=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD263(double (&a)[263]){
		...
		VectorSIMD263& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD263& operator += (VectorSIMD263 a){
	...
	inline VectorSIMD263 operator*(double a, VectorSIMD263 b){
		VectorSIMD263 c;
	...
	inline VectorSIMD263 operator*(VectorSIMD263 a ,double b){
		VectorSIMD263 c;
	...
	inline VectorSIMD263 operator*(int a, VectorSIMD263 b){
		if(a==1){return b;}
		VectorSIMD263 c;
	...
	inline VectorSIMD263 operator*(VectorSIMD263 a, int b){
		if(b==1){return a;}
		VectorSIMD263 c;
	...
	inline VectorSIMD263 operator*(VectorSIMD263 a, VectorSIMD263 b){
		VectorSIMD263 c;
	...
	inline VectorSIMD263 exp(VectorSIMD263 a){
		double a_d[263]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD263 sqrt(VectorSIMD263 a){
		double a_d[263]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD263 a){ 
		double ad[263];
		a.convert(ad);
