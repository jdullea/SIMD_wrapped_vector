...
public:
		...
		VectorSIMD934(double a){
			...
			_avx233=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD934(double (&a)[934]){
		...
		VectorSIMD934& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD934& operator += (VectorSIMD934 a){
	...
	inline VectorSIMD934 operator*(double a, VectorSIMD934 b){
		VectorSIMD934 c;
	...
	inline VectorSIMD934 operator*(VectorSIMD934 a ,double b){
		VectorSIMD934 c;
	...
	inline VectorSIMD934 operator*(int a, VectorSIMD934 b){
		if(a==1){return b;}
		VectorSIMD934 c;
	...
	inline VectorSIMD934 operator*(VectorSIMD934 a, int b){
		if(b==1){return a;}
		VectorSIMD934 c;
	...
	inline VectorSIMD934 operator*(VectorSIMD934 a, VectorSIMD934 b){
		VectorSIMD934 c;
	...
	inline VectorSIMD934 exp(VectorSIMD934 a){
		double a_d[934]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD934 sqrt(VectorSIMD934 a){
		double a_d[934]; a.convert(a_d);
