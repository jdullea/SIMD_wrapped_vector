...
public:
		...
		VectorSIMD810(double a){
			...
			_avx202=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD810(double (&a)[810]){
		...
		VectorSIMD810& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD810& operator += (VectorSIMD810 a){
	...
	inline VectorSIMD810 operator*(double a, VectorSIMD810 b){
		VectorSIMD810 c;
	...
	inline VectorSIMD810 operator*(VectorSIMD810 a ,double b){
		VectorSIMD810 c;
	...
	inline VectorSIMD810 operator*(int a, VectorSIMD810 b){
		if(a==1){return b;}
		VectorSIMD810 c;
	...
	inline VectorSIMD810 operator*(VectorSIMD810 a, int b){
		if(b==1){return a;}
		VectorSIMD810 c;
	...
	inline VectorSIMD810 operator*(VectorSIMD810 a, VectorSIMD810 b){
		VectorSIMD810 c;
	...
	inline VectorSIMD810 exp(VectorSIMD810 a){
		double a_d[810]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD810 sqrt(VectorSIMD810 a){
		double a_d[810]; a.convert(a_d);
