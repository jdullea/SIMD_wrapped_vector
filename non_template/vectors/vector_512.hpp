...
public:
		...
		VectorSIMD512& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD512& operator += (VectorSIMD512 a){
	...
	inline VectorSIMD512 operator*(double a, VectorSIMD512 b){
		VectorSIMD512 c;
	...
	inline VectorSIMD512 operator*(VectorSIMD512 a ,double b){
		VectorSIMD512 c;
	...
	inline VectorSIMD512 operator*(int a, VectorSIMD512 b){
		if(a==1){return b;}
		VectorSIMD512 c;
	...
	inline VectorSIMD512 operator*(VectorSIMD512 a, int b){
		if(b==1){return a;}
		VectorSIMD512 c;
	...
	inline VectorSIMD512 operator*(VectorSIMD512 a, VectorSIMD512 b){
		VectorSIMD512 c;
	...
	inline VectorSIMD512 exp(VectorSIMD512 a){
		double a_d[512]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD512 sqrt(VectorSIMD512 a){
		double a_d[512]; a.convert(a_d);
