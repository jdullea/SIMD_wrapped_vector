...
public:
		...
		VectorSIMD621(double a){
			...
			_avx155=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD621(double (&a)[621]){
		...
		VectorSIMD621& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD621& operator += (VectorSIMD621 a){
	...
	inline VectorSIMD621 operator*(double a, VectorSIMD621 b){
		VectorSIMD621 c;
	...
	inline VectorSIMD621 operator*(VectorSIMD621 a ,double b){
		VectorSIMD621 c;
	...
	inline VectorSIMD621 operator*(int a, VectorSIMD621 b){
		if(a==1){return b;}
		VectorSIMD621 c;
	...
	inline VectorSIMD621 operator*(VectorSIMD621 a, int b){
		if(b==1){return a;}
		VectorSIMD621 c;
	...
	inline VectorSIMD621 operator*(VectorSIMD621 a, VectorSIMD621 b){
		VectorSIMD621 c;
	...
	inline VectorSIMD621 exp(VectorSIMD621 a){
		double a_d[621]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD621 sqrt(VectorSIMD621 a){
		double a_d[621]; a.convert(a_d);
