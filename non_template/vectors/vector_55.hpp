...
public:
		...
		VectorSIMD55(double a){
			...
			_avx13=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD55(double (&a)[55]){
		...
		VectorSIMD55(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17,double _18,double _19,double _20,double _21,double _22,double _23,double _24,double _25,double _26,double _27,double _28,double _29,double _30,double _31,double _32,double _33,double _34,double _35,double _36,double _37,double _38,double _39,double _40,double _41,double _42,double _43,double _44,double _45,double _46,double _47,double _48,double _49,double _50,double _51,double _52,double _53,double _54){
			...
			_avx13=_mm256_set_pd( 0,_54,_53,_52);
		}

		VectorSIMD55(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD55& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD55& operator += (VectorSIMD55 a){
	...
	inline VectorSIMD55 operator*(double a, VectorSIMD55 b){
		VectorSIMD55 c;
	...
	inline VectorSIMD55 operator*(VectorSIMD55 a ,double b){
		VectorSIMD55 c;
	...
	inline VectorSIMD55 operator*(int a, VectorSIMD55 b){
		if(a==1){return b;}
		VectorSIMD55 c;
	...
	inline VectorSIMD55 operator*(VectorSIMD55 a, int b){
		if(b==1){return a;}
		VectorSIMD55 c;
	...
	inline VectorSIMD55 operator*(VectorSIMD55 a, VectorSIMD55 b){
		VectorSIMD55 c;
	...
	inline VectorSIMD55 exp(VectorSIMD55 a){
		double a_d[55]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD55 sqrt(VectorSIMD55 a){
		double a_d[55]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD55 a){ 
		double ad[55];
		a.convert(ad);
