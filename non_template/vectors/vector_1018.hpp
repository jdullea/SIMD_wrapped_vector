...
public:
		...
		VectorSIMD1018(double a){
			...
			_avx254=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD1018(double (&a)[1018]){
		...
		VectorSIMD1018& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1018& operator += (VectorSIMD1018 a){
	...
	inline VectorSIMD1018 operator*(double a, VectorSIMD1018 b){
		VectorSIMD1018 c;
	...
	inline VectorSIMD1018 operator*(VectorSIMD1018 a ,double b){
		VectorSIMD1018 c;
	...
	inline VectorSIMD1018 operator*(int a, VectorSIMD1018 b){
		if(a==1){return b;}
		VectorSIMD1018 c;
	...
	inline VectorSIMD1018 operator*(VectorSIMD1018 a, int b){
		if(b==1){return a;}
		VectorSIMD1018 c;
	...
	inline VectorSIMD1018 operator*(VectorSIMD1018 a, VectorSIMD1018 b){
		VectorSIMD1018 c;
	...
	inline VectorSIMD1018 exp(VectorSIMD1018 a){
		double a_d[1018]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1018 r(a_d);
		return r;
	}

	inline VectorSIMD1018 sqrt(VectorSIMD1018 a){
		double a_d[1018]; a.convert(a_d);
