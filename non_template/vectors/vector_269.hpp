...
public:
		...
		VectorSIMD269(double a){
			...
			_avx67=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD269(double (&a)[269]){
		...
		VectorSIMD269& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD269& operator += (VectorSIMD269 a){
	...
	inline VectorSIMD269 operator*(double a, VectorSIMD269 b){
		VectorSIMD269 c;
	...
	inline VectorSIMD269 operator*(VectorSIMD269 a ,double b){
		VectorSIMD269 c;
	...
	inline VectorSIMD269 operator*(int a, VectorSIMD269 b){
		if(a==1){return b;}
		VectorSIMD269 c;
	...
	inline VectorSIMD269 operator*(VectorSIMD269 a, int b){
		if(b==1){return a;}
		VectorSIMD269 c;
	...
	inline VectorSIMD269 operator*(VectorSIMD269 a, VectorSIMD269 b){
		VectorSIMD269 c;
	...
	inline VectorSIMD269 exp(VectorSIMD269 a){
		double a_d[269]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD269 sqrt(VectorSIMD269 a){
		double a_d[269]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD269 a){ 
		double ad[269];
		a.convert(ad);
