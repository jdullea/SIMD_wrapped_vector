...
public:
		...
		VectorSIMD387(double a){
			...
			_avx96=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD387(double (&a)[387]){
		...
		VectorSIMD387& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD387& operator += (VectorSIMD387 a){
	...
	inline VectorSIMD387 operator*(double a, VectorSIMD387 b){
		VectorSIMD387 c;
	...
	inline VectorSIMD387 operator*(VectorSIMD387 a ,double b){
		VectorSIMD387 c;
	...
	inline VectorSIMD387 operator*(int a, VectorSIMD387 b){
		if(a==1){return b;}
		VectorSIMD387 c;
	...
	inline VectorSIMD387 operator*(VectorSIMD387 a, int b){
		if(b==1){return a;}
		VectorSIMD387 c;
	...
	inline VectorSIMD387 operator*(VectorSIMD387 a, VectorSIMD387 b){
		VectorSIMD387 c;
	...
	inline VectorSIMD387 exp(VectorSIMD387 a){
		double a_d[387]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD387 sqrt(VectorSIMD387 a){
		double a_d[387]; a.convert(a_d);
