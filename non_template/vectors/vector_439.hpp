...
public:
		...
		VectorSIMD439(double a){
			...
			_avx109=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD439(double (&a)[439]){
		...
		VectorSIMD439& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD439& operator += (VectorSIMD439 a){
	...
	inline VectorSIMD439 operator*(double a, VectorSIMD439 b){
		VectorSIMD439 c;
	...
	inline VectorSIMD439 operator*(VectorSIMD439 a ,double b){
		VectorSIMD439 c;
	...
	inline VectorSIMD439 operator*(int a, VectorSIMD439 b){
		if(a==1){return b;}
		VectorSIMD439 c;
	...
	inline VectorSIMD439 operator*(VectorSIMD439 a, int b){
		if(b==1){return a;}
		VectorSIMD439 c;
	...
	inline VectorSIMD439 operator*(VectorSIMD439 a, VectorSIMD439 b){
		VectorSIMD439 c;
	...
	inline VectorSIMD439 exp(VectorSIMD439 a){
		double a_d[439]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD439 sqrt(VectorSIMD439 a){
		double a_d[439]; a.convert(a_d);
