...
public:
		...
		VectorSIMD768& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD768& operator += (VectorSIMD768 a){
	...
	inline VectorSIMD768 operator*(double a, VectorSIMD768 b){
		VectorSIMD768 c;
	...
	inline VectorSIMD768 operator*(VectorSIMD768 a ,double b){
		VectorSIMD768 c;
	...
	inline VectorSIMD768 operator*(int a, VectorSIMD768 b){
		if(a==1){return b;}
		VectorSIMD768 c;
	...
	inline VectorSIMD768 operator*(VectorSIMD768 a, int b){
		if(b==1){return a;}
		VectorSIMD768 c;
	...
	inline VectorSIMD768 operator*(VectorSIMD768 a, VectorSIMD768 b){
		VectorSIMD768 c;
	...
	inline VectorSIMD768 exp(VectorSIMD768 a){
		double a_d[768]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD768 sqrt(VectorSIMD768 a){
		double a_d[768]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD768 a){ 
		double ad[768];
		a.convert(ad);
