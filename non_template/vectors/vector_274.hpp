...
public:
		...
		VectorSIMD274(double a){
			...
			_avx68=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD274(double (&a)[274]){
		...
		VectorSIMD274& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD274& operator += (VectorSIMD274 a){
	...
	inline VectorSIMD274 operator*(double a, VectorSIMD274 b){
		VectorSIMD274 c;
	...
	inline VectorSIMD274 operator*(VectorSIMD274 a ,double b){
		VectorSIMD274 c;
	...
	inline VectorSIMD274 operator*(int a, VectorSIMD274 b){
		if(a==1){return b;}
		VectorSIMD274 c;
	...
	inline VectorSIMD274 operator*(VectorSIMD274 a, int b){
		if(b==1){return a;}
		VectorSIMD274 c;
	...
	inline VectorSIMD274 operator*(VectorSIMD274 a, VectorSIMD274 b){
		VectorSIMD274 c;
	...
	inline VectorSIMD274 exp(VectorSIMD274 a){
		double a_d[274]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD274 sqrt(VectorSIMD274 a){
		double a_d[274]; a.convert(a_d);
