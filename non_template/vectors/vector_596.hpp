...
public:
		...
		VectorSIMD596& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD596& operator += (VectorSIMD596 a){
	...
	inline VectorSIMD596 operator*(double a, VectorSIMD596 b){
		VectorSIMD596 c;
	...
	inline VectorSIMD596 operator*(VectorSIMD596 a ,double b){
		VectorSIMD596 c;
	...
	inline VectorSIMD596 operator*(int a, VectorSIMD596 b){
		if(a==1){return b;}
		VectorSIMD596 c;
	...
	inline VectorSIMD596 operator*(VectorSIMD596 a, int b){
		if(b==1){return a;}
		VectorSIMD596 c;
	...
	inline VectorSIMD596 operator*(VectorSIMD596 a, VectorSIMD596 b){
		VectorSIMD596 c;
	...
	inline VectorSIMD596 exp(VectorSIMD596 a){
		double a_d[596]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD596 sqrt(VectorSIMD596 a){
		double a_d[596]; a.convert(a_d);
