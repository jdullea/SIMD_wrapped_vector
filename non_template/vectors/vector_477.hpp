...
public:
		...
		VectorSIMD477(double a){
			...
			_avx119=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD477(double (&a)[477]){
		...
		VectorSIMD477& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD477& operator += (VectorSIMD477 a){
	...
	inline VectorSIMD477 operator*(double a, VectorSIMD477 b){
		VectorSIMD477 c;
	...
	inline VectorSIMD477 operator*(VectorSIMD477 a ,double b){
		VectorSIMD477 c;
	...
	inline VectorSIMD477 operator*(int a, VectorSIMD477 b){
		if(a==1){return b;}
		VectorSIMD477 c;
	...
	inline VectorSIMD477 operator*(VectorSIMD477 a, int b){
		if(b==1){return a;}
		VectorSIMD477 c;
	...
	inline VectorSIMD477 operator*(VectorSIMD477 a, VectorSIMD477 b){
		VectorSIMD477 c;
	...
	inline VectorSIMD477 exp(VectorSIMD477 a){
		double a_d[477]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD477 sqrt(VectorSIMD477 a){
		double a_d[477]; a.convert(a_d);
