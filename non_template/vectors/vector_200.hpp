...
public:
		...
		VectorSIMD200& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD200& operator += (VectorSIMD200 a){
	...
	inline VectorSIMD200 operator*(double a, VectorSIMD200 b){
		VectorSIMD200 c;
	...
	inline VectorSIMD200 operator*(VectorSIMD200 a ,double b){
		VectorSIMD200 c;
	...
	inline VectorSIMD200 operator*(int a, VectorSIMD200 b){
		if(a==1){return b;}
		VectorSIMD200 c;
	...
	inline VectorSIMD200 operator*(VectorSIMD200 a, int b){
		if(b==1){return a;}
		VectorSIMD200 c;
	...
	inline VectorSIMD200 operator*(VectorSIMD200 a, VectorSIMD200 b){
		VectorSIMD200 c;
	...
	inline VectorSIMD200 exp(VectorSIMD200 a){
		double a_d[200]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD200 sqrt(VectorSIMD200 a){
		double a_d[200]; a.convert(a_d);
