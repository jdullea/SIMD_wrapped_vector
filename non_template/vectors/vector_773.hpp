...
public:
		...
		VectorSIMD773(double a){
			...
			_avx193=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD773(double (&a)[773]){
		...
		VectorSIMD773& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD773& operator += (VectorSIMD773 a){
	...
	inline VectorSIMD773 operator*(double a, VectorSIMD773 b){
		VectorSIMD773 c;
	...
	inline VectorSIMD773 operator*(VectorSIMD773 a ,double b){
		VectorSIMD773 c;
	...
	inline VectorSIMD773 operator*(int a, VectorSIMD773 b){
		if(a==1){return b;}
		VectorSIMD773 c;
	...
	inline VectorSIMD773 operator*(VectorSIMD773 a, int b){
		if(b==1){return a;}
		VectorSIMD773 c;
	...
	inline VectorSIMD773 operator*(VectorSIMD773 a, VectorSIMD773 b){
		VectorSIMD773 c;
	...
	inline VectorSIMD773 exp(VectorSIMD773 a){
		double a_d[773]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD773 sqrt(VectorSIMD773 a){
		double a_d[773]; a.convert(a_d);
