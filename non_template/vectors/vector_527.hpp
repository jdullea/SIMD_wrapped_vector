...
public:
		...
		VectorSIMD527(double a){
			...
			_avx131=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD527(double (&a)[527]){
		...
		VectorSIMD527& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD527& operator += (VectorSIMD527 a){
	...
	inline VectorSIMD527 operator*(double a, VectorSIMD527 b){
		VectorSIMD527 c;
	...
	inline VectorSIMD527 operator*(VectorSIMD527 a ,double b){
		VectorSIMD527 c;
	...
	inline VectorSIMD527 operator*(int a, VectorSIMD527 b){
		if(a==1){return b;}
		VectorSIMD527 c;
	...
	inline VectorSIMD527 operator*(VectorSIMD527 a, int b){
		if(b==1){return a;}
		VectorSIMD527 c;
	...
	inline VectorSIMD527 operator*(VectorSIMD527 a, VectorSIMD527 b){
		VectorSIMD527 c;
	...
	inline VectorSIMD527 exp(VectorSIMD527 a){
		double a_d[527]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD527 sqrt(VectorSIMD527 a){
		double a_d[527]; a.convert(a_d);
