...
public:
		...
		VectorSIMD607(double a){
			...
			_avx151=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD607(double (&a)[607]){
		...
		VectorSIMD607& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD607& operator += (VectorSIMD607 a){
	...
	inline VectorSIMD607 operator*(double a, VectorSIMD607 b){
		VectorSIMD607 c;
	...
	inline VectorSIMD607 operator*(VectorSIMD607 a ,double b){
		VectorSIMD607 c;
	...
	inline VectorSIMD607 operator*(int a, VectorSIMD607 b){
		if(a==1){return b;}
		VectorSIMD607 c;
	...
	inline VectorSIMD607 operator*(VectorSIMD607 a, int b){
		if(b==1){return a;}
		VectorSIMD607 c;
	...
	inline VectorSIMD607 operator*(VectorSIMD607 a, VectorSIMD607 b){
		VectorSIMD607 c;
	...
	inline VectorSIMD607 exp(VectorSIMD607 a){
		double a_d[607]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD607 sqrt(VectorSIMD607 a){
		double a_d[607]; a.convert(a_d);
