...
public:
		...
		VectorSIMD100& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD100& operator += (VectorSIMD100 a){
	...
	inline VectorSIMD100 operator*(double a, VectorSIMD100 b){
		VectorSIMD100 c;
	...
	inline VectorSIMD100 operator*(VectorSIMD100 a ,double b){
		VectorSIMD100 c;
	...
	inline VectorSIMD100 operator*(int a, VectorSIMD100 b){
		if(a==1){return b;}
		VectorSIMD100 c;
	...
	inline VectorSIMD100 operator*(VectorSIMD100 a, int b){
		if(b==1){return a;}
		VectorSIMD100 c;
	...
	inline VectorSIMD100 operator*(VectorSIMD100 a, VectorSIMD100 b){
		VectorSIMD100 c;
	...
	inline VectorSIMD100 exp(VectorSIMD100 a){
		double a_d[100]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD100 sqrt(VectorSIMD100 a){
		double a_d[100]; a.convert(a_d);
