...
public:
		...
		VectorSIMD932& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD932& operator += (VectorSIMD932 a){
	...
	inline VectorSIMD932 operator*(double a, VectorSIMD932 b){
		VectorSIMD932 c;
	...
	inline VectorSIMD932 operator*(VectorSIMD932 a ,double b){
		VectorSIMD932 c;
	...
	inline VectorSIMD932 operator*(int a, VectorSIMD932 b){
		if(a==1){return b;}
		VectorSIMD932 c;
	...
	inline VectorSIMD932 operator*(VectorSIMD932 a, int b){
		if(b==1){return a;}
		VectorSIMD932 c;
	...
	inline VectorSIMD932 operator*(VectorSIMD932 a, VectorSIMD932 b){
		VectorSIMD932 c;
	...
	inline VectorSIMD932 exp(VectorSIMD932 a){
		double a_d[932]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD932 sqrt(VectorSIMD932 a){
		double a_d[932]; a.convert(a_d);
