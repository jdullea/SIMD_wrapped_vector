...
public:
		...
		VectorSIMD423(double a){
			...
			_avx105=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD423(double (&a)[423]){
		...
		VectorSIMD423& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD423& operator += (VectorSIMD423 a){
	...
	inline VectorSIMD423 operator*(double a, VectorSIMD423 b){
		VectorSIMD423 c;
	...
	inline VectorSIMD423 operator*(VectorSIMD423 a ,double b){
		VectorSIMD423 c;
	...
	inline VectorSIMD423 operator*(int a, VectorSIMD423 b){
		if(a==1){return b;}
		VectorSIMD423 c;
	...
	inline VectorSIMD423 operator*(VectorSIMD423 a, int b){
		if(b==1){return a;}
		VectorSIMD423 c;
	...
	inline VectorSIMD423 operator*(VectorSIMD423 a, VectorSIMD423 b){
		VectorSIMD423 c;
	...
	inline VectorSIMD423 exp(VectorSIMD423 a){
		double a_d[423]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD423 sqrt(VectorSIMD423 a){
		double a_d[423]; a.convert(a_d);
