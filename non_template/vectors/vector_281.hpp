...
public:
		...
		VectorSIMD281(double a){
			...
			_avx70=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD281(double (&a)[281]){
		...
		VectorSIMD281& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD281& operator += (VectorSIMD281 a){
	...
	inline VectorSIMD281 operator*(double a, VectorSIMD281 b){
		VectorSIMD281 c;
	...
	inline VectorSIMD281 operator*(VectorSIMD281 a ,double b){
		VectorSIMD281 c;
	...
	inline VectorSIMD281 operator*(int a, VectorSIMD281 b){
		if(a==1){return b;}
		VectorSIMD281 c;
	...
	inline VectorSIMD281 operator*(VectorSIMD281 a, int b){
		if(b==1){return a;}
		VectorSIMD281 c;
	...
	inline VectorSIMD281 operator*(VectorSIMD281 a, VectorSIMD281 b){
		VectorSIMD281 c;
	...
	inline VectorSIMD281 exp(VectorSIMD281 a){
		double a_d[281]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD281 sqrt(VectorSIMD281 a){
		double a_d[281]; a.convert(a_d);
