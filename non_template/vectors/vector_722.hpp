...
public:
		...
		VectorSIMD722(double a){
			...
			_avx180=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD722(double (&a)[722]){
		...
		VectorSIMD722& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD722& operator += (VectorSIMD722 a){
	...
	inline VectorSIMD722 operator*(double a, VectorSIMD722 b){
		VectorSIMD722 c;
	...
	inline VectorSIMD722 operator*(VectorSIMD722 a ,double b){
		VectorSIMD722 c;
	...
	inline VectorSIMD722 operator*(int a, VectorSIMD722 b){
		if(a==1){return b;}
		VectorSIMD722 c;
	...
	inline VectorSIMD722 operator*(VectorSIMD722 a, int b){
		if(b==1){return a;}
		VectorSIMD722 c;
	...
	inline VectorSIMD722 operator*(VectorSIMD722 a, VectorSIMD722 b){
		VectorSIMD722 c;
	...
	inline VectorSIMD722 exp(VectorSIMD722 a){
		double a_d[722]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD722 sqrt(VectorSIMD722 a){
		double a_d[722]; a.convert(a_d);
