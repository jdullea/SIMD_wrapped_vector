...
public:
		...
		VectorSIMD798(double a){
			...
			_avx199=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD798(double (&a)[798]){
		...
		VectorSIMD798& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD798& operator += (VectorSIMD798 a){
	...
	inline VectorSIMD798 operator*(double a, VectorSIMD798 b){
		VectorSIMD798 c;
	...
	inline VectorSIMD798 operator*(VectorSIMD798 a ,double b){
		VectorSIMD798 c;
	...
	inline VectorSIMD798 operator*(int a, VectorSIMD798 b){
		if(a==1){return b;}
		VectorSIMD798 c;
	...
	inline VectorSIMD798 operator*(VectorSIMD798 a, int b){
		if(b==1){return a;}
		VectorSIMD798 c;
	...
	inline VectorSIMD798 operator*(VectorSIMD798 a, VectorSIMD798 b){
		VectorSIMD798 c;
	...
	inline VectorSIMD798 exp(VectorSIMD798 a){
		double a_d[798]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD798 sqrt(VectorSIMD798 a){
		double a_d[798]; a.convert(a_d);
