...
public:
		...
		VectorSIMD595(double a){
			...
			_avx148=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD595(double (&a)[595]){
		...
		VectorSIMD595& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD595& operator += (VectorSIMD595 a){
	...
	inline VectorSIMD595 operator*(double a, VectorSIMD595 b){
		VectorSIMD595 c;
	...
	inline VectorSIMD595 operator*(VectorSIMD595 a ,double b){
		VectorSIMD595 c;
	...
	inline VectorSIMD595 operator*(int a, VectorSIMD595 b){
		if(a==1){return b;}
		VectorSIMD595 c;
	...
	inline VectorSIMD595 operator*(VectorSIMD595 a, int b){
		if(b==1){return a;}
		VectorSIMD595 c;
	...
	inline VectorSIMD595 operator*(VectorSIMD595 a, VectorSIMD595 b){
		VectorSIMD595 c;
	...
	inline VectorSIMD595 exp(VectorSIMD595 a){
		double a_d[595]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD595 sqrt(VectorSIMD595 a){
		double a_d[595]; a.convert(a_d);
