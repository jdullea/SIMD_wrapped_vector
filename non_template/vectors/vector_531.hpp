...
public:
		...
		VectorSIMD531(double a){
			...
			_avx132=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD531(double (&a)[531]){
		...
		VectorSIMD531& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD531& operator += (VectorSIMD531 a){
	...
	inline VectorSIMD531 operator*(double a, VectorSIMD531 b){
		VectorSIMD531 c;
	...
	inline VectorSIMD531 operator*(VectorSIMD531 a ,double b){
		VectorSIMD531 c;
	...
	inline VectorSIMD531 operator*(int a, VectorSIMD531 b){
		if(a==1){return b;}
		VectorSIMD531 c;
	...
	inline VectorSIMD531 operator*(VectorSIMD531 a, int b){
		if(b==1){return a;}
		VectorSIMD531 c;
	...
	inline VectorSIMD531 operator*(VectorSIMD531 a, VectorSIMD531 b){
		VectorSIMD531 c;
	...
	inline VectorSIMD531 exp(VectorSIMD531 a){
		double a_d[531]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD531 sqrt(VectorSIMD531 a){
		double a_d[531]; a.convert(a_d);
