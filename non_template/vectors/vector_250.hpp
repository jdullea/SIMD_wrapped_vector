...
public:
		...
		VectorSIMD250(double a){
			...
			_avx62=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD250(double (&a)[250]){
		...
		VectorSIMD250& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD250& operator += (VectorSIMD250 a){
	...
	inline VectorSIMD250 operator*(double a, VectorSIMD250 b){
		VectorSIMD250 c;
	...
	inline VectorSIMD250 operator*(VectorSIMD250 a ,double b){
		VectorSIMD250 c;
	...
	inline VectorSIMD250 operator*(int a, VectorSIMD250 b){
		if(a==1){return b;}
		VectorSIMD250 c;
	...
	inline VectorSIMD250 operator*(VectorSIMD250 a, int b){
		if(b==1){return a;}
		VectorSIMD250 c;
	...
	inline VectorSIMD250 operator*(VectorSIMD250 a, VectorSIMD250 b){
		VectorSIMD250 c;
	...
	inline VectorSIMD250 exp(VectorSIMD250 a){
		double a_d[250]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD250 sqrt(VectorSIMD250 a){
		double a_d[250]; a.convert(a_d);
