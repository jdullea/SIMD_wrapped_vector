...
public:
		...
		VectorSIMD374(double a){
			...
			_avx93=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD374(double (&a)[374]){
		...
		VectorSIMD374& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD374& operator += (VectorSIMD374 a){
	...
	inline VectorSIMD374 operator*(double a, VectorSIMD374 b){
		VectorSIMD374 c;
	...
	inline VectorSIMD374 operator*(VectorSIMD374 a ,double b){
		VectorSIMD374 c;
	...
	inline VectorSIMD374 operator*(int a, VectorSIMD374 b){
		if(a==1){return b;}
		VectorSIMD374 c;
	...
	inline VectorSIMD374 operator*(VectorSIMD374 a, int b){
		if(b==1){return a;}
		VectorSIMD374 c;
	...
	inline VectorSIMD374 operator*(VectorSIMD374 a, VectorSIMD374 b){
		VectorSIMD374 c;
	...
	inline VectorSIMD374 exp(VectorSIMD374 a){
		double a_d[374]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD374 sqrt(VectorSIMD374 a){
		double a_d[374]; a.convert(a_d);
