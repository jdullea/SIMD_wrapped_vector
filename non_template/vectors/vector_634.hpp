...
public:
		...
		VectorSIMD634(double a){
			...
			_avx158=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD634(double (&a)[634]){
		...
		VectorSIMD634& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD634& operator += (VectorSIMD634 a){
	...
	inline VectorSIMD634 operator*(double a, VectorSIMD634 b){
		VectorSIMD634 c;
	...
	inline VectorSIMD634 operator*(VectorSIMD634 a ,double b){
		VectorSIMD634 c;
	...
	inline VectorSIMD634 operator*(int a, VectorSIMD634 b){
		if(a==1){return b;}
		VectorSIMD634 c;
	...
	inline VectorSIMD634 operator*(VectorSIMD634 a, int b){
		if(b==1){return a;}
		VectorSIMD634 c;
	...
	inline VectorSIMD634 operator*(VectorSIMD634 a, VectorSIMD634 b){
		VectorSIMD634 c;
	...
	inline VectorSIMD634 exp(VectorSIMD634 a){
		double a_d[634]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD634 sqrt(VectorSIMD634 a){
		double a_d[634]; a.convert(a_d);
