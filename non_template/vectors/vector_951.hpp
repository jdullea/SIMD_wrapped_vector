...
public:
		...
		VectorSIMD951(double a){
			...
			_avx237=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD951(double (&a)[951]){
		...
		VectorSIMD951& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD951& operator += (VectorSIMD951 a){
	...
	inline VectorSIMD951 operator*(double a, VectorSIMD951 b){
		VectorSIMD951 c;
	...
	inline VectorSIMD951 operator*(VectorSIMD951 a ,double b){
		VectorSIMD951 c;
	...
	inline VectorSIMD951 operator*(int a, VectorSIMD951 b){
		if(a==1){return b;}
		VectorSIMD951 c;
	...
	inline VectorSIMD951 operator*(VectorSIMD951 a, int b){
		if(b==1){return a;}
		VectorSIMD951 c;
	...
	inline VectorSIMD951 operator*(VectorSIMD951 a, VectorSIMD951 b){
		VectorSIMD951 c;
	...
	inline VectorSIMD951 exp(VectorSIMD951 a){
		double a_d[951]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD951 sqrt(VectorSIMD951 a){
		double a_d[951]; a.convert(a_d);
