...
public:
		...
		VectorSIMD573(double a){
			...
			_avx143=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD573(double (&a)[573]){
		...
		VectorSIMD573& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD573& operator += (VectorSIMD573 a){
	...
	inline VectorSIMD573 operator*(double a, VectorSIMD573 b){
		VectorSIMD573 c;
	...
	inline VectorSIMD573 operator*(VectorSIMD573 a ,double b){
		VectorSIMD573 c;
	...
	inline VectorSIMD573 operator*(int a, VectorSIMD573 b){
		if(a==1){return b;}
		VectorSIMD573 c;
	...
	inline VectorSIMD573 operator*(VectorSIMD573 a, int b){
		if(b==1){return a;}
		VectorSIMD573 c;
	...
	inline VectorSIMD573 operator*(VectorSIMD573 a, VectorSIMD573 b){
		VectorSIMD573 c;
	...
	inline VectorSIMD573 exp(VectorSIMD573 a){
		double a_d[573]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD573 sqrt(VectorSIMD573 a){
		double a_d[573]; a.convert(a_d);
