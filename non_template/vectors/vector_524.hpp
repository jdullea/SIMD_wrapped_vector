...
public:
		...
		VectorSIMD524& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD524& operator += (VectorSIMD524 a){
	...
	inline VectorSIMD524 operator*(double a, VectorSIMD524 b){
		VectorSIMD524 c;
	...
	inline VectorSIMD524 operator*(VectorSIMD524 a ,double b){
		VectorSIMD524 c;
	...
	inline VectorSIMD524 operator*(int a, VectorSIMD524 b){
		if(a==1){return b;}
		VectorSIMD524 c;
	...
	inline VectorSIMD524 operator*(VectorSIMD524 a, int b){
		if(b==1){return a;}
		VectorSIMD524 c;
	...
	inline VectorSIMD524 operator*(VectorSIMD524 a, VectorSIMD524 b){
		VectorSIMD524 c;
	...
	inline VectorSIMD524 exp(VectorSIMD524 a){
		double a_d[524]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD524 sqrt(VectorSIMD524 a){
		double a_d[524]; a.convert(a_d);
