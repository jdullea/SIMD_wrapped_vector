...
public:
		...
		VectorSIMD455(double a){
			...
			_avx113=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD455(double (&a)[455]){
		...
		VectorSIMD455& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD455& operator += (VectorSIMD455 a){
	...
	inline VectorSIMD455 operator*(double a, VectorSIMD455 b){
		VectorSIMD455 c;
	...
	inline VectorSIMD455 operator*(VectorSIMD455 a ,double b){
		VectorSIMD455 c;
	...
	inline VectorSIMD455 operator*(int a, VectorSIMD455 b){
		if(a==1){return b;}
		VectorSIMD455 c;
	...
	inline VectorSIMD455 operator*(VectorSIMD455 a, int b){
		if(b==1){return a;}
		VectorSIMD455 c;
	...
	inline VectorSIMD455 operator*(VectorSIMD455 a, VectorSIMD455 b){
		VectorSIMD455 c;
	...
	inline VectorSIMD455 exp(VectorSIMD455 a){
		double a_d[455]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD455 sqrt(VectorSIMD455 a){
		double a_d[455]; a.convert(a_d);
