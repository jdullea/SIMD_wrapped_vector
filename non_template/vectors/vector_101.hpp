...
public:
		...
		VectorSIMD101(double a){
			...
			_avx25=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD101(double (&a)[101]){
		...
		VectorSIMD101& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD101& operator += (VectorSIMD101 a){
	...
	inline VectorSIMD101 operator*(double a, VectorSIMD101 b){
		VectorSIMD101 c;
	...
	inline VectorSIMD101 operator*(VectorSIMD101 a ,double b){
		VectorSIMD101 c;
	...
	inline VectorSIMD101 operator*(int a, VectorSIMD101 b){
		if(a==1){return b;}
		VectorSIMD101 c;
	...
	inline VectorSIMD101 operator*(VectorSIMD101 a, int b){
		if(b==1){return a;}
		VectorSIMD101 c;
	...
	inline VectorSIMD101 operator*(VectorSIMD101 a, VectorSIMD101 b){
		VectorSIMD101 c;
	...
	inline VectorSIMD101 exp(VectorSIMD101 a){
		double a_d[101]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD101 sqrt(VectorSIMD101 a){
		double a_d[101]; a.convert(a_d);
