...
public:
		...
		VectorSIMD377(double a){
			...
			_avx94=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD377(double (&a)[377]){
		...
		VectorSIMD377& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD377& operator += (VectorSIMD377 a){
	...
	inline VectorSIMD377 operator*(double a, VectorSIMD377 b){
		VectorSIMD377 c;
	...
	inline VectorSIMD377 operator*(VectorSIMD377 a ,double b){
		VectorSIMD377 c;
	...
	inline VectorSIMD377 operator*(int a, VectorSIMD377 b){
		if(a==1){return b;}
		VectorSIMD377 c;
	...
	inline VectorSIMD377 operator*(VectorSIMD377 a, int b){
		if(b==1){return a;}
		VectorSIMD377 c;
	...
	inline VectorSIMD377 operator*(VectorSIMD377 a, VectorSIMD377 b){
		VectorSIMD377 c;
	...
	inline VectorSIMD377 exp(VectorSIMD377 a){
		double a_d[377]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD377 sqrt(VectorSIMD377 a){
		double a_d[377]; a.convert(a_d);
