...
public:
		...
		VectorSIMD742(double a){
			...
			_avx185=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD742(double (&a)[742]){
		...
		VectorSIMD742& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD742& operator += (VectorSIMD742 a){
	...
	inline VectorSIMD742 operator*(double a, VectorSIMD742 b){
		VectorSIMD742 c;
	...
	inline VectorSIMD742 operator*(VectorSIMD742 a ,double b){
		VectorSIMD742 c;
	...
	inline VectorSIMD742 operator*(int a, VectorSIMD742 b){
		if(a==1){return b;}
		VectorSIMD742 c;
	...
	inline VectorSIMD742 operator*(VectorSIMD742 a, int b){
		if(b==1){return a;}
		VectorSIMD742 c;
	...
	inline VectorSIMD742 operator*(VectorSIMD742 a, VectorSIMD742 b){
		VectorSIMD742 c;
	...
	inline VectorSIMD742 exp(VectorSIMD742 a){
		double a_d[742]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD742 sqrt(VectorSIMD742 a){
		double a_d[742]; a.convert(a_d);
