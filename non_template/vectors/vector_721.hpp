...
public:
		...
		VectorSIMD721(double a){
			...
			_avx180=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD721(double (&a)[721]){
		...
		VectorSIMD721& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD721& operator += (VectorSIMD721 a){
	...
	inline VectorSIMD721 operator*(double a, VectorSIMD721 b){
		VectorSIMD721 c;
	...
	inline VectorSIMD721 operator*(VectorSIMD721 a ,double b){
		VectorSIMD721 c;
	...
	inline VectorSIMD721 operator*(int a, VectorSIMD721 b){
		if(a==1){return b;}
		VectorSIMD721 c;
	...
	inline VectorSIMD721 operator*(VectorSIMD721 a, int b){
		if(b==1){return a;}
		VectorSIMD721 c;
	...
	inline VectorSIMD721 operator*(VectorSIMD721 a, VectorSIMD721 b){
		VectorSIMD721 c;
	...
	inline VectorSIMD721 exp(VectorSIMD721 a){
		double a_d[721]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD721 sqrt(VectorSIMD721 a){
		double a_d[721]; a.convert(a_d);
