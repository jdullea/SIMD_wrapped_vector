...
public:
		...
		VectorSIMD571(double a){
			...
			_avx142=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD571(double (&a)[571]){
		...
		VectorSIMD571& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD571& operator += (VectorSIMD571 a){
	...
	inline VectorSIMD571 operator*(double a, VectorSIMD571 b){
		VectorSIMD571 c;
	...
	inline VectorSIMD571 operator*(VectorSIMD571 a ,double b){
		VectorSIMD571 c;
	...
	inline VectorSIMD571 operator*(int a, VectorSIMD571 b){
		if(a==1){return b;}
		VectorSIMD571 c;
	...
	inline VectorSIMD571 operator*(VectorSIMD571 a, int b){
		if(b==1){return a;}
		VectorSIMD571 c;
	...
	inline VectorSIMD571 operator*(VectorSIMD571 a, VectorSIMD571 b){
		VectorSIMD571 c;
	...
	inline VectorSIMD571 exp(VectorSIMD571 a){
		double a_d[571]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD571 sqrt(VectorSIMD571 a){
		double a_d[571]; a.convert(a_d);
