...
public:
		...
		VectorSIMD658(double a){
			...
			_avx164=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD658(double (&a)[658]){
		...
		VectorSIMD658& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD658& operator += (VectorSIMD658 a){
	...
	inline VectorSIMD658 operator*(double a, VectorSIMD658 b){
		VectorSIMD658 c;
	...
	inline VectorSIMD658 operator*(VectorSIMD658 a ,double b){
		VectorSIMD658 c;
	...
	inline VectorSIMD658 operator*(int a, VectorSIMD658 b){
		if(a==1){return b;}
		VectorSIMD658 c;
	...
	inline VectorSIMD658 operator*(VectorSIMD658 a, int b){
		if(b==1){return a;}
		VectorSIMD658 c;
	...
	inline VectorSIMD658 operator*(VectorSIMD658 a, VectorSIMD658 b){
		VectorSIMD658 c;
	...
	inline VectorSIMD658 exp(VectorSIMD658 a){
		double a_d[658]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD658 sqrt(VectorSIMD658 a){
		double a_d[658]; a.convert(a_d);
