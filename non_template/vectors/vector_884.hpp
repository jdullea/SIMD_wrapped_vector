...
public:
		...
		VectorSIMD884& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD884& operator += (VectorSIMD884 a){
	...
	inline VectorSIMD884 operator*(double a, VectorSIMD884 b){
		VectorSIMD884 c;
	...
	inline VectorSIMD884 operator*(VectorSIMD884 a ,double b){
		VectorSIMD884 c;
	...
	inline VectorSIMD884 operator*(int a, VectorSIMD884 b){
		if(a==1){return b;}
		VectorSIMD884 c;
	...
	inline VectorSIMD884 operator*(VectorSIMD884 a, int b){
		if(b==1){return a;}
		VectorSIMD884 c;
	...
	inline VectorSIMD884 operator*(VectorSIMD884 a, VectorSIMD884 b){
		VectorSIMD884 c;
	...
	inline VectorSIMD884 exp(VectorSIMD884 a){
		double a_d[884]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD884 sqrt(VectorSIMD884 a){
		double a_d[884]; a.convert(a_d);
