...
public:
		...
		VectorSIMD950(double a){
			...
			_avx237=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD950(double (&a)[950]){
		...
		VectorSIMD950& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD950& operator += (VectorSIMD950 a){
	...
	inline VectorSIMD950 operator*(double a, VectorSIMD950 b){
		VectorSIMD950 c;
	...
	inline VectorSIMD950 operator*(VectorSIMD950 a ,double b){
		VectorSIMD950 c;
	...
	inline VectorSIMD950 operator*(int a, VectorSIMD950 b){
		if(a==1){return b;}
		VectorSIMD950 c;
	...
	inline VectorSIMD950 operator*(VectorSIMD950 a, int b){
		if(b==1){return a;}
		VectorSIMD950 c;
	...
	inline VectorSIMD950 operator*(VectorSIMD950 a, VectorSIMD950 b){
		VectorSIMD950 c;
	...
	inline VectorSIMD950 exp(VectorSIMD950 a){
		double a_d[950]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD950 sqrt(VectorSIMD950 a){
		double a_d[950]; a.convert(a_d);
