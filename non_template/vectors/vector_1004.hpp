...
public:
		...
		VectorSIMD1004& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1004& operator += (VectorSIMD1004 a){
	...
	inline VectorSIMD1004 operator*(double a, VectorSIMD1004 b){
		VectorSIMD1004 c;
	...
	inline VectorSIMD1004 operator*(VectorSIMD1004 a ,double b){
		VectorSIMD1004 c;
	...
	inline VectorSIMD1004 operator*(int a, VectorSIMD1004 b){
		if(a==1){return b;}
		VectorSIMD1004 c;
	...
	inline VectorSIMD1004 operator*(VectorSIMD1004 a, int b){
		if(b==1){return a;}
		VectorSIMD1004 c;
	...
	inline VectorSIMD1004 operator*(VectorSIMD1004 a, VectorSIMD1004 b){
		VectorSIMD1004 c;
	...
	inline VectorSIMD1004 exp(VectorSIMD1004 a){
		double a_d[1004]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1004 r(a_d);
		return r;
	}

	inline VectorSIMD1004 sqrt(VectorSIMD1004 a){
		double a_d[1004]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD1004 a){ 
		double ad[1004];
		a.convert(ad);
