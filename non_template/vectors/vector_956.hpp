...
public:
		...
		VectorSIMD956& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD956& operator += (VectorSIMD956 a){
	...
	inline VectorSIMD956 operator*(double a, VectorSIMD956 b){
		VectorSIMD956 c;
	...
	inline VectorSIMD956 operator*(VectorSIMD956 a ,double b){
		VectorSIMD956 c;
	...
	inline VectorSIMD956 operator*(int a, VectorSIMD956 b){
		if(a==1){return b;}
		VectorSIMD956 c;
	...
	inline VectorSIMD956 operator*(VectorSIMD956 a, int b){
		if(b==1){return a;}
		VectorSIMD956 c;
	...
	inline VectorSIMD956 operator*(VectorSIMD956 a, VectorSIMD956 b){
		VectorSIMD956 c;
	...
	inline VectorSIMD956 exp(VectorSIMD956 a){
		double a_d[956]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD956 sqrt(VectorSIMD956 a){
		double a_d[956]; a.convert(a_d);
