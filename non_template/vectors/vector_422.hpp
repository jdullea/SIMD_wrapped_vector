...
public:
		...
		VectorSIMD422(double a){
			...
			_avx105=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD422(double (&a)[422]){
		...
		VectorSIMD422& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD422& operator += (VectorSIMD422 a){
	...
	inline VectorSIMD422 operator*(double a, VectorSIMD422 b){
		VectorSIMD422 c;
	...
	inline VectorSIMD422 operator*(VectorSIMD422 a ,double b){
		VectorSIMD422 c;
	...
	inline VectorSIMD422 operator*(int a, VectorSIMD422 b){
		if(a==1){return b;}
		VectorSIMD422 c;
	...
	inline VectorSIMD422 operator*(VectorSIMD422 a, int b){
		if(b==1){return a;}
		VectorSIMD422 c;
	...
	inline VectorSIMD422 operator*(VectorSIMD422 a, VectorSIMD422 b){
		VectorSIMD422 c;
	...
	inline VectorSIMD422 exp(VectorSIMD422 a){
		double a_d[422]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD422 sqrt(VectorSIMD422 a){
		double a_d[422]; a.convert(a_d);
