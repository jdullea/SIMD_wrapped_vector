...
public:
		...
		VectorSIMD290(double a){
			...
			_avx72=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD290(double (&a)[290]){
		...
		VectorSIMD290& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD290& operator += (VectorSIMD290 a){
	...
	inline VectorSIMD290 operator*(double a, VectorSIMD290 b){
		VectorSIMD290 c;
	...
	inline VectorSIMD290 operator*(VectorSIMD290 a ,double b){
		VectorSIMD290 c;
	...
	inline VectorSIMD290 operator*(int a, VectorSIMD290 b){
		if(a==1){return b;}
		VectorSIMD290 c;
	...
	inline VectorSIMD290 operator*(VectorSIMD290 a, int b){
		if(b==1){return a;}
		VectorSIMD290 c;
	...
	inline VectorSIMD290 operator*(VectorSIMD290 a, VectorSIMD290 b){
		VectorSIMD290 c;
	...
	inline VectorSIMD290 exp(VectorSIMD290 a){
		double a_d[290]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD290 sqrt(VectorSIMD290 a){
		double a_d[290]; a.convert(a_d);
