...
public:
		...
		VectorSIMD911(double a){
			...
			_avx227=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD911(double (&a)[911]){
		...
		VectorSIMD911& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD911& operator += (VectorSIMD911 a){
	...
	inline VectorSIMD911 operator*(double a, VectorSIMD911 b){
		VectorSIMD911 c;
	...
	inline VectorSIMD911 operator*(VectorSIMD911 a ,double b){
		VectorSIMD911 c;
	...
	inline VectorSIMD911 operator*(int a, VectorSIMD911 b){
		if(a==1){return b;}
		VectorSIMD911 c;
	...
	inline VectorSIMD911 operator*(VectorSIMD911 a, int b){
		if(b==1){return a;}
		VectorSIMD911 c;
	...
	inline VectorSIMD911 operator*(VectorSIMD911 a, VectorSIMD911 b){
		VectorSIMD911 c;
	...
	inline VectorSIMD911 exp(VectorSIMD911 a){
		double a_d[911]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD911 sqrt(VectorSIMD911 a){
		double a_d[911]; a.convert(a_d);
