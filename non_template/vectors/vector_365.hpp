...
public:
		...
		VectorSIMD365(double a){
			...
			_avx91=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD365(double (&a)[365]){
		...
		VectorSIMD365& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD365& operator += (VectorSIMD365 a){
	...
	inline VectorSIMD365 operator*(double a, VectorSIMD365 b){
		VectorSIMD365 c;
	...
	inline VectorSIMD365 operator*(VectorSIMD365 a ,double b){
		VectorSIMD365 c;
	...
	inline VectorSIMD365 operator*(int a, VectorSIMD365 b){
		if(a==1){return b;}
		VectorSIMD365 c;
	...
	inline VectorSIMD365 operator*(VectorSIMD365 a, int b){
		if(b==1){return a;}
		VectorSIMD365 c;
	...
	inline VectorSIMD365 operator*(VectorSIMD365 a, VectorSIMD365 b){
		VectorSIMD365 c;
	...
	inline VectorSIMD365 exp(VectorSIMD365 a){
		double a_d[365]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD365 sqrt(VectorSIMD365 a){
		double a_d[365]; a.convert(a_d);
