...
public:
		...
		VectorSIMD542(double a){
			...
			_avx135=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD542(double (&a)[542]){
		...
		VectorSIMD542& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD542& operator += (VectorSIMD542 a){
	...
	inline VectorSIMD542 operator*(double a, VectorSIMD542 b){
		VectorSIMD542 c;
	...
	inline VectorSIMD542 operator*(VectorSIMD542 a ,double b){
		VectorSIMD542 c;
	...
	inline VectorSIMD542 operator*(int a, VectorSIMD542 b){
		if(a==1){return b;}
		VectorSIMD542 c;
	...
	inline VectorSIMD542 operator*(VectorSIMD542 a, int b){
		if(b==1){return a;}
		VectorSIMD542 c;
	...
	inline VectorSIMD542 operator*(VectorSIMD542 a, VectorSIMD542 b){
		VectorSIMD542 c;
	...
	inline VectorSIMD542 exp(VectorSIMD542 a){
		double a_d[542]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD542 sqrt(VectorSIMD542 a){
		double a_d[542]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD542 a){ 
		double ad[542];
		a.convert(ad);
