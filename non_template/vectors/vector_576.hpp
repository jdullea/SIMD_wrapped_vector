...
public:
		...
		VectorSIMD576& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD576& operator += (VectorSIMD576 a){
	...
	inline VectorSIMD576 operator*(double a, VectorSIMD576 b){
		VectorSIMD576 c;
	...
	inline VectorSIMD576 operator*(VectorSIMD576 a ,double b){
		VectorSIMD576 c;
	...
	inline VectorSIMD576 operator*(int a, VectorSIMD576 b){
		if(a==1){return b;}
		VectorSIMD576 c;
	...
	inline VectorSIMD576 operator*(VectorSIMD576 a, int b){
		if(b==1){return a;}
		VectorSIMD576 c;
	...
	inline VectorSIMD576 operator*(VectorSIMD576 a, VectorSIMD576 b){
		VectorSIMD576 c;
	...
	inline VectorSIMD576 exp(VectorSIMD576 a){
		double a_d[576]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD576 sqrt(VectorSIMD576 a){
		double a_d[576]; a.convert(a_d);
