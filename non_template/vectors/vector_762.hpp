...
public:
		...
		VectorSIMD762(double a){
			...
			_avx190=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD762(double (&a)[762]){
		...
		VectorSIMD762& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD762& operator += (VectorSIMD762 a){
	...
	inline VectorSIMD762 operator*(double a, VectorSIMD762 b){
		VectorSIMD762 c;
	...
	inline VectorSIMD762 operator*(VectorSIMD762 a ,double b){
		VectorSIMD762 c;
	...
	inline VectorSIMD762 operator*(int a, VectorSIMD762 b){
		if(a==1){return b;}
		VectorSIMD762 c;
	...
	inline VectorSIMD762 operator*(VectorSIMD762 a, int b){
		if(b==1){return a;}
		VectorSIMD762 c;
	...
	inline VectorSIMD762 operator*(VectorSIMD762 a, VectorSIMD762 b){
		VectorSIMD762 c;
	...
	inline VectorSIMD762 exp(VectorSIMD762 a){
		double a_d[762]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD762 sqrt(VectorSIMD762 a){
		double a_d[762]; a.convert(a_d);
