...
public:
		...
		VectorSIMD777(double a){
			...
			_avx194=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD777(double (&a)[777]){
		...
		VectorSIMD777& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD777& operator += (VectorSIMD777 a){
	...
	inline VectorSIMD777 operator*(double a, VectorSIMD777 b){
		VectorSIMD777 c;
	...
	inline VectorSIMD777 operator*(VectorSIMD777 a ,double b){
		VectorSIMD777 c;
	...
	inline VectorSIMD777 operator*(int a, VectorSIMD777 b){
		if(a==1){return b;}
		VectorSIMD777 c;
	...
	inline VectorSIMD777 operator*(VectorSIMD777 a, int b){
		if(b==1){return a;}
		VectorSIMD777 c;
	...
	inline VectorSIMD777 operator*(VectorSIMD777 a, VectorSIMD777 b){
		VectorSIMD777 c;
	...
	inline VectorSIMD777 exp(VectorSIMD777 a){
		double a_d[777]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD777 sqrt(VectorSIMD777 a){
		double a_d[777]; a.convert(a_d);
