...
public:
		...
		VectorSIMD986(double a){
			...
			_avx246=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD986(double (&a)[986]){
		...
		VectorSIMD986& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD986& operator += (VectorSIMD986 a){
	...
	inline VectorSIMD986 operator*(double a, VectorSIMD986 b){
		VectorSIMD986 c;
	...
	inline VectorSIMD986 operator*(VectorSIMD986 a ,double b){
		VectorSIMD986 c;
	...
	inline VectorSIMD986 operator*(int a, VectorSIMD986 b){
		if(a==1){return b;}
		VectorSIMD986 c;
	...
	inline VectorSIMD986 operator*(VectorSIMD986 a, int b){
		if(b==1){return a;}
		VectorSIMD986 c;
	...
	inline VectorSIMD986 operator*(VectorSIMD986 a, VectorSIMD986 b){
		VectorSIMD986 c;
	...
	inline VectorSIMD986 exp(VectorSIMD986 a){
		double a_d[986]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD986 sqrt(VectorSIMD986 a){
		double a_d[986]; a.convert(a_d);
