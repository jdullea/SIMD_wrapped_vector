...
public:
		...
		VectorSIMD332& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD332& operator += (VectorSIMD332 a){
	...
	inline VectorSIMD332 operator*(double a, VectorSIMD332 b){
		VectorSIMD332 c;
	...
	inline VectorSIMD332 operator*(VectorSIMD332 a ,double b){
		VectorSIMD332 c;
	...
	inline VectorSIMD332 operator*(int a, VectorSIMD332 b){
		if(a==1){return b;}
		VectorSIMD332 c;
	...
	inline VectorSIMD332 operator*(VectorSIMD332 a, int b){
		if(b==1){return a;}
		VectorSIMD332 c;
	...
	inline VectorSIMD332 operator*(VectorSIMD332 a, VectorSIMD332 b){
		VectorSIMD332 c;
	...
	inline VectorSIMD332 exp(VectorSIMD332 a){
		double a_d[332]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD332 sqrt(VectorSIMD332 a){
		double a_d[332]; a.convert(a_d);
