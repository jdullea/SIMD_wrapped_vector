...
public:
		...
		VectorSIMD385(double a){
			...
			_avx96=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD385(double (&a)[385]){
		...
		VectorSIMD385& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD385& operator += (VectorSIMD385 a){
	...
	inline VectorSIMD385 operator*(double a, VectorSIMD385 b){
		VectorSIMD385 c;
	...
	inline VectorSIMD385 operator*(VectorSIMD385 a ,double b){
		VectorSIMD385 c;
	...
	inline VectorSIMD385 operator*(int a, VectorSIMD385 b){
		if(a==1){return b;}
		VectorSIMD385 c;
	...
	inline VectorSIMD385 operator*(VectorSIMD385 a, int b){
		if(b==1){return a;}
		VectorSIMD385 c;
	...
	inline VectorSIMD385 operator*(VectorSIMD385 a, VectorSIMD385 b){
		VectorSIMD385 c;
	...
	inline VectorSIMD385 exp(VectorSIMD385 a){
		double a_d[385]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD385 sqrt(VectorSIMD385 a){
		double a_d[385]; a.convert(a_d);
