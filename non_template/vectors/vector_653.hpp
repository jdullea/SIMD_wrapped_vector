...
public:
		...
		VectorSIMD653(double a){
			...
			_avx163=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD653(double (&a)[653]){
		...
		VectorSIMD653& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD653& operator += (VectorSIMD653 a){
	...
	inline VectorSIMD653 operator*(double a, VectorSIMD653 b){
		VectorSIMD653 c;
	...
	inline VectorSIMD653 operator*(VectorSIMD653 a ,double b){
		VectorSIMD653 c;
	...
	inline VectorSIMD653 operator*(int a, VectorSIMD653 b){
		if(a==1){return b;}
		VectorSIMD653 c;
	...
	inline VectorSIMD653 operator*(VectorSIMD653 a, int b){
		if(b==1){return a;}
		VectorSIMD653 c;
	...
	inline VectorSIMD653 operator*(VectorSIMD653 a, VectorSIMD653 b){
		VectorSIMD653 c;
	...
	inline VectorSIMD653 exp(VectorSIMD653 a){
		double a_d[653]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD653 sqrt(VectorSIMD653 a){
		double a_d[653]; a.convert(a_d);
