...
public:
		...
		VectorSIMD690(double a){
			...
			_avx172=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD690(double (&a)[690]){
		...
		VectorSIMD690& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD690& operator += (VectorSIMD690 a){
	...
	inline VectorSIMD690 operator*(double a, VectorSIMD690 b){
		VectorSIMD690 c;
	...
	inline VectorSIMD690 operator*(VectorSIMD690 a ,double b){
		VectorSIMD690 c;
	...
	inline VectorSIMD690 operator*(int a, VectorSIMD690 b){
		if(a==1){return b;}
		VectorSIMD690 c;
	...
	inline VectorSIMD690 operator*(VectorSIMD690 a, int b){
		if(b==1){return a;}
		VectorSIMD690 c;
	...
	inline VectorSIMD690 operator*(VectorSIMD690 a, VectorSIMD690 b){
		VectorSIMD690 c;
	...
	inline VectorSIMD690 exp(VectorSIMD690 a){
		double a_d[690]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD690 sqrt(VectorSIMD690 a){
		double a_d[690]; a.convert(a_d);
