...
public:
		...
		VectorSIMD348& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD348& operator += (VectorSIMD348 a){
	...
	inline VectorSIMD348 operator*(double a, VectorSIMD348 b){
		VectorSIMD348 c;
	...
	inline VectorSIMD348 operator*(VectorSIMD348 a ,double b){
		VectorSIMD348 c;
	...
	inline VectorSIMD348 operator*(int a, VectorSIMD348 b){
		if(a==1){return b;}
		VectorSIMD348 c;
	...
	inline VectorSIMD348 operator*(VectorSIMD348 a, int b){
		if(b==1){return a;}
		VectorSIMD348 c;
	...
	inline VectorSIMD348 operator*(VectorSIMD348 a, VectorSIMD348 b){
		VectorSIMD348 c;
	...
	inline VectorSIMD348 exp(VectorSIMD348 a){
		double a_d[348]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD348 sqrt(VectorSIMD348 a){
		double a_d[348]; a.convert(a_d);
