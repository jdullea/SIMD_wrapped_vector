...
public:
		...
		VectorSIMD443(double a){
			...
			_avx110=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD443(double (&a)[443]){
		...
		VectorSIMD443& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD443& operator += (VectorSIMD443 a){
	...
	inline VectorSIMD443 operator*(double a, VectorSIMD443 b){
		VectorSIMD443 c;
	...
	inline VectorSIMD443 operator*(VectorSIMD443 a ,double b){
		VectorSIMD443 c;
	...
	inline VectorSIMD443 operator*(int a, VectorSIMD443 b){
		if(a==1){return b;}
		VectorSIMD443 c;
	...
	inline VectorSIMD443 operator*(VectorSIMD443 a, int b){
		if(b==1){return a;}
		VectorSIMD443 c;
	...
	inline VectorSIMD443 operator*(VectorSIMD443 a, VectorSIMD443 b){
		VectorSIMD443 c;
	...
	inline VectorSIMD443 exp(VectorSIMD443 a){
		double a_d[443]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD443 sqrt(VectorSIMD443 a){
		double a_d[443]; a.convert(a_d);
