...
public:
		...
		VectorSIMD1016& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1016& operator += (VectorSIMD1016 a){
	...
	inline VectorSIMD1016 operator*(double a, VectorSIMD1016 b){
		VectorSIMD1016 c;
	...
	inline VectorSIMD1016 operator*(VectorSIMD1016 a ,double b){
		VectorSIMD1016 c;
	...
	inline VectorSIMD1016 operator*(int a, VectorSIMD1016 b){
		if(a==1){return b;}
		VectorSIMD1016 c;
	...
	inline VectorSIMD1016 operator*(VectorSIMD1016 a, int b){
		if(b==1){return a;}
		VectorSIMD1016 c;
	...
	inline VectorSIMD1016 operator*(VectorSIMD1016 a, VectorSIMD1016 b){
		VectorSIMD1016 c;
	...
	inline VectorSIMD1016 exp(VectorSIMD1016 a){
		double a_d[1016]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1016 r(a_d);
		return r;
	}

	inline VectorSIMD1016 sqrt(VectorSIMD1016 a){
		double a_d[1016]; a.convert(a_d);
