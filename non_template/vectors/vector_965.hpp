...
public:
		...
		VectorSIMD965(double a){
			...
			_avx241=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD965(double (&a)[965]){
		...
		VectorSIMD965& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD965& operator += (VectorSIMD965 a){
	...
	inline VectorSIMD965 operator*(double a, VectorSIMD965 b){
		VectorSIMD965 c;
	...
	inline VectorSIMD965 operator*(VectorSIMD965 a ,double b){
		VectorSIMD965 c;
	...
	inline VectorSIMD965 operator*(int a, VectorSIMD965 b){
		if(a==1){return b;}
		VectorSIMD965 c;
	...
	inline VectorSIMD965 operator*(VectorSIMD965 a, int b){
		if(b==1){return a;}
		VectorSIMD965 c;
	...
	inline VectorSIMD965 operator*(VectorSIMD965 a, VectorSIMD965 b){
		VectorSIMD965 c;
	...
	inline VectorSIMD965 exp(VectorSIMD965 a){
		double a_d[965]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD965 sqrt(VectorSIMD965 a){
		double a_d[965]; a.convert(a_d);
