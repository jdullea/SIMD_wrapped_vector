...
public:
		...
		VectorSIMD704& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD704& operator += (VectorSIMD704 a){
	...
	inline VectorSIMD704 operator*(double a, VectorSIMD704 b){
		VectorSIMD704 c;
	...
	inline VectorSIMD704 operator*(VectorSIMD704 a ,double b){
		VectorSIMD704 c;
	...
	inline VectorSIMD704 operator*(int a, VectorSIMD704 b){
		if(a==1){return b;}
		VectorSIMD704 c;
	...
	inline VectorSIMD704 operator*(VectorSIMD704 a, int b){
		if(b==1){return a;}
		VectorSIMD704 c;
	...
	inline VectorSIMD704 operator*(VectorSIMD704 a, VectorSIMD704 b){
		VectorSIMD704 c;
	...
	inline VectorSIMD704 exp(VectorSIMD704 a){
		double a_d[704]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD704 sqrt(VectorSIMD704 a){
		double a_d[704]; a.convert(a_d);
