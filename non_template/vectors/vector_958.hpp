...
public:
		...
		VectorSIMD958(double a){
			...
			_avx239=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD958(double (&a)[958]){
		...
		VectorSIMD958& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD958& operator += (VectorSIMD958 a){
	...
	inline VectorSIMD958 operator*(double a, VectorSIMD958 b){
		VectorSIMD958 c;
	...
	inline VectorSIMD958 operator*(VectorSIMD958 a ,double b){
		VectorSIMD958 c;
	...
	inline VectorSIMD958 operator*(int a, VectorSIMD958 b){
		if(a==1){return b;}
		VectorSIMD958 c;
	...
	inline VectorSIMD958 operator*(VectorSIMD958 a, int b){
		if(b==1){return a;}
		VectorSIMD958 c;
	...
	inline VectorSIMD958 operator*(VectorSIMD958 a, VectorSIMD958 b){
		VectorSIMD958 c;
	...
	inline VectorSIMD958 exp(VectorSIMD958 a){
		double a_d[958]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD958 sqrt(VectorSIMD958 a){
		double a_d[958]; a.convert(a_d);
