...
public:
		...
		VectorSIMD659(double a){
			...
			_avx164=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD659(double (&a)[659]){
		...
		VectorSIMD659& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD659& operator += (VectorSIMD659 a){
	...
	inline VectorSIMD659 operator*(double a, VectorSIMD659 b){
		VectorSIMD659 c;
	...
	inline VectorSIMD659 operator*(VectorSIMD659 a ,double b){
		VectorSIMD659 c;
	...
	inline VectorSIMD659 operator*(int a, VectorSIMD659 b){
		if(a==1){return b;}
		VectorSIMD659 c;
	...
	inline VectorSIMD659 operator*(VectorSIMD659 a, int b){
		if(b==1){return a;}
		VectorSIMD659 c;
	...
	inline VectorSIMD659 operator*(VectorSIMD659 a, VectorSIMD659 b){
		VectorSIMD659 c;
	...
	inline VectorSIMD659 exp(VectorSIMD659 a){
		double a_d[659]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD659 sqrt(VectorSIMD659 a){
		double a_d[659]; a.convert(a_d);
