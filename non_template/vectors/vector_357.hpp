...
public:
		...
		VectorSIMD357(double a){
			...
			_avx89=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD357(double (&a)[357]){
		...
		VectorSIMD357& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD357& operator += (VectorSIMD357 a){
	...
	inline VectorSIMD357 operator*(double a, VectorSIMD357 b){
		VectorSIMD357 c;
	...
	inline VectorSIMD357 operator*(VectorSIMD357 a ,double b){
		VectorSIMD357 c;
	...
	inline VectorSIMD357 operator*(int a, VectorSIMD357 b){
		if(a==1){return b;}
		VectorSIMD357 c;
	...
	inline VectorSIMD357 operator*(VectorSIMD357 a, int b){
		if(b==1){return a;}
		VectorSIMD357 c;
	...
	inline VectorSIMD357 operator*(VectorSIMD357 a, VectorSIMD357 b){
		VectorSIMD357 c;
	...
	inline VectorSIMD357 exp(VectorSIMD357 a){
		double a_d[357]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD357 sqrt(VectorSIMD357 a){
		double a_d[357]; a.convert(a_d);
