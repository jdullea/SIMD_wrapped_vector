...
public:
		...
		VectorSIMD750(double a){
			...
			_avx187=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD750(double (&a)[750]){
		...
		VectorSIMD750& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD750& operator += (VectorSIMD750 a){
	...
	inline VectorSIMD750 operator*(double a, VectorSIMD750 b){
		VectorSIMD750 c;
	...
	inline VectorSIMD750 operator*(VectorSIMD750 a ,double b){
		VectorSIMD750 c;
	...
	inline VectorSIMD750 operator*(int a, VectorSIMD750 b){
		if(a==1){return b;}
		VectorSIMD750 c;
	...
	inline VectorSIMD750 operator*(VectorSIMD750 a, int b){
		if(b==1){return a;}
		VectorSIMD750 c;
	...
	inline VectorSIMD750 operator*(VectorSIMD750 a, VectorSIMD750 b){
		VectorSIMD750 c;
	...
	inline VectorSIMD750 exp(VectorSIMD750 a){
		double a_d[750]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD750 sqrt(VectorSIMD750 a){
		double a_d[750]; a.convert(a_d);
