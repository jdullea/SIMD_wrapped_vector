...
public:
		...
		VectorSIMD987(double a){
			...
			_avx246=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD987(double (&a)[987]){
		...
		VectorSIMD987& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD987& operator += (VectorSIMD987 a){
	...
	inline VectorSIMD987 operator*(double a, VectorSIMD987 b){
		VectorSIMD987 c;
	...
	inline VectorSIMD987 operator*(VectorSIMD987 a ,double b){
		VectorSIMD987 c;
	...
	inline VectorSIMD987 operator*(int a, VectorSIMD987 b){
		if(a==1){return b;}
		VectorSIMD987 c;
	...
	inline VectorSIMD987 operator*(VectorSIMD987 a, int b){
		if(b==1){return a;}
		VectorSIMD987 c;
	...
	inline VectorSIMD987 operator*(VectorSIMD987 a, VectorSIMD987 b){
		VectorSIMD987 c;
	...
	inline VectorSIMD987 exp(VectorSIMD987 a){
		double a_d[987]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD987 sqrt(VectorSIMD987 a){
		double a_d[987]; a.convert(a_d);
