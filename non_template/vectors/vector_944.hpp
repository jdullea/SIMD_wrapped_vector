...
public:
		...
		VectorSIMD944& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD944& operator += (VectorSIMD944 a){
	...
	inline VectorSIMD944 operator*(double a, VectorSIMD944 b){
		VectorSIMD944 c;
	...
	inline VectorSIMD944 operator*(VectorSIMD944 a ,double b){
		VectorSIMD944 c;
	...
	inline VectorSIMD944 operator*(int a, VectorSIMD944 b){
		if(a==1){return b;}
		VectorSIMD944 c;
	...
	inline VectorSIMD944 operator*(VectorSIMD944 a, int b){
		if(b==1){return a;}
		VectorSIMD944 c;
	...
	inline VectorSIMD944 operator*(VectorSIMD944 a, VectorSIMD944 b){
		VectorSIMD944 c;
	...
	inline VectorSIMD944 exp(VectorSIMD944 a){
		double a_d[944]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD944 sqrt(VectorSIMD944 a){
		double a_d[944]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD944 a){ 
		double ad[944];
		a.convert(ad);
