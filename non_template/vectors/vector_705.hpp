...
public:
		...
		VectorSIMD705(double a){
			...
			_avx176=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD705(double (&a)[705]){
		...
		VectorSIMD705& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD705& operator += (VectorSIMD705 a){
	...
	inline VectorSIMD705 operator*(double a, VectorSIMD705 b){
		VectorSIMD705 c;
	...
	inline VectorSIMD705 operator*(VectorSIMD705 a ,double b){
		VectorSIMD705 c;
	...
	inline VectorSIMD705 operator*(int a, VectorSIMD705 b){
		if(a==1){return b;}
		VectorSIMD705 c;
	...
	inline VectorSIMD705 operator*(VectorSIMD705 a, int b){
		if(b==1){return a;}
		VectorSIMD705 c;
	...
	inline VectorSIMD705 operator*(VectorSIMD705 a, VectorSIMD705 b){
		VectorSIMD705 c;
	...
	inline VectorSIMD705 exp(VectorSIMD705 a){
		double a_d[705]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD705 sqrt(VectorSIMD705 a){
		double a_d[705]; a.convert(a_d);
