...
public:
		...
		VectorSIMD359(double a){
			...
			_avx89=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD359(double (&a)[359]){
		...
		VectorSIMD359& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD359& operator += (VectorSIMD359 a){
	...
	inline VectorSIMD359 operator*(double a, VectorSIMD359 b){
		VectorSIMD359 c;
	...
	inline VectorSIMD359 operator*(VectorSIMD359 a ,double b){
		VectorSIMD359 c;
	...
	inline VectorSIMD359 operator*(int a, VectorSIMD359 b){
		if(a==1){return b;}
		VectorSIMD359 c;
	...
	inline VectorSIMD359 operator*(VectorSIMD359 a, int b){
		if(b==1){return a;}
		VectorSIMD359 c;
	...
	inline VectorSIMD359 operator*(VectorSIMD359 a, VectorSIMD359 b){
		VectorSIMD359 c;
	...
	inline VectorSIMD359 exp(VectorSIMD359 a){
		double a_d[359]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD359 sqrt(VectorSIMD359 a){
		double a_d[359]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD359 a){ 
		double ad[359];
		a.convert(ad);
