...
public:
		...
		VectorSIMD673(double a){
			...
			_avx168=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD673(double (&a)[673]){
		...
		VectorSIMD673& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD673& operator += (VectorSIMD673 a){
	...
	inline VectorSIMD673 operator*(double a, VectorSIMD673 b){
		VectorSIMD673 c;
	...
	inline VectorSIMD673 operator*(VectorSIMD673 a ,double b){
		VectorSIMD673 c;
	...
	inline VectorSIMD673 operator*(int a, VectorSIMD673 b){
		if(a==1){return b;}
		VectorSIMD673 c;
	...
	inline VectorSIMD673 operator*(VectorSIMD673 a, int b){
		if(b==1){return a;}
		VectorSIMD673 c;
	...
	inline VectorSIMD673 operator*(VectorSIMD673 a, VectorSIMD673 b){
		VectorSIMD673 c;
	...
	inline VectorSIMD673 exp(VectorSIMD673 a){
		double a_d[673]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD673 sqrt(VectorSIMD673 a){
		double a_d[673]; a.convert(a_d);
