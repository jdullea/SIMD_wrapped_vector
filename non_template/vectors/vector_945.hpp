...
public:
		...
		VectorSIMD945(double a){
			...
			_avx236=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD945(double (&a)[945]){
		...
		VectorSIMD945& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD945& operator += (VectorSIMD945 a){
	...
	inline VectorSIMD945 operator*(double a, VectorSIMD945 b){
		VectorSIMD945 c;
	...
	inline VectorSIMD945 operator*(VectorSIMD945 a ,double b){
		VectorSIMD945 c;
	...
	inline VectorSIMD945 operator*(int a, VectorSIMD945 b){
		if(a==1){return b;}
		VectorSIMD945 c;
	...
	inline VectorSIMD945 operator*(VectorSIMD945 a, int b){
		if(b==1){return a;}
		VectorSIMD945 c;
	...
	inline VectorSIMD945 operator*(VectorSIMD945 a, VectorSIMD945 b){
		VectorSIMD945 c;
	...
	inline VectorSIMD945 exp(VectorSIMD945 a){
		double a_d[945]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD945 sqrt(VectorSIMD945 a){
		double a_d[945]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD945 a){ 
		double ad[945];
		a.convert(ad);
