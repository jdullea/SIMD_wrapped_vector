...
public:
		...
		VectorSIMD1011(double a){
			...
			_avx252=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD1011(double (&a)[1011]){
		...
		VectorSIMD1011& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1011& operator += (VectorSIMD1011 a){
	...
	inline VectorSIMD1011 operator*(double a, VectorSIMD1011 b){
		VectorSIMD1011 c;
	...
	inline VectorSIMD1011 operator*(VectorSIMD1011 a ,double b){
		VectorSIMD1011 c;
	...
	inline VectorSIMD1011 operator*(int a, VectorSIMD1011 b){
		if(a==1){return b;}
		VectorSIMD1011 c;
	...
	inline VectorSIMD1011 operator*(VectorSIMD1011 a, int b){
		if(b==1){return a;}
		VectorSIMD1011 c;
	...
	inline VectorSIMD1011 operator*(VectorSIMD1011 a, VectorSIMD1011 b){
		VectorSIMD1011 c;
	...
	inline VectorSIMD1011 exp(VectorSIMD1011 a){
		double a_d[1011]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1011 r(a_d);
		return r;
	}

	inline VectorSIMD1011 sqrt(VectorSIMD1011 a){
		double a_d[1011]; a.convert(a_d);
