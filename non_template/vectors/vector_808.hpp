...
public:
		...
		VectorSIMD808& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD808& operator += (VectorSIMD808 a){
	...
	inline VectorSIMD808 operator*(double a, VectorSIMD808 b){
		VectorSIMD808 c;
	...
	inline VectorSIMD808 operator*(VectorSIMD808 a ,double b){
		VectorSIMD808 c;
	...
	inline VectorSIMD808 operator*(int a, VectorSIMD808 b){
		if(a==1){return b;}
		VectorSIMD808 c;
	...
	inline VectorSIMD808 operator*(VectorSIMD808 a, int b){
		if(b==1){return a;}
		VectorSIMD808 c;
	...
	inline VectorSIMD808 operator*(VectorSIMD808 a, VectorSIMD808 b){
		VectorSIMD808 c;
	...
	inline VectorSIMD808 exp(VectorSIMD808 a){
		double a_d[808]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD808 sqrt(VectorSIMD808 a){
		double a_d[808]; a.convert(a_d);
