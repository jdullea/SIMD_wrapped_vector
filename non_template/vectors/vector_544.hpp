...
public:
		...
		VectorSIMD544& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD544& operator += (VectorSIMD544 a){
	...
	inline VectorSIMD544 operator*(double a, VectorSIMD544 b){
		VectorSIMD544 c;
	...
	inline VectorSIMD544 operator*(VectorSIMD544 a ,double b){
		VectorSIMD544 c;
	...
	inline VectorSIMD544 operator*(int a, VectorSIMD544 b){
		if(a==1){return b;}
		VectorSIMD544 c;
	...
	inline VectorSIMD544 operator*(VectorSIMD544 a, int b){
		if(b==1){return a;}
		VectorSIMD544 c;
	...
	inline VectorSIMD544 operator*(VectorSIMD544 a, VectorSIMD544 b){
		VectorSIMD544 c;
	...
	inline VectorSIMD544 exp(VectorSIMD544 a){
		double a_d[544]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD544 sqrt(VectorSIMD544 a){
		double a_d[544]; a.convert(a_d);
