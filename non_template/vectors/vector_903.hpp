...
public:
		...
		VectorSIMD903(double a){
			...
			_avx225=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD903(double (&a)[903]){
		...
		VectorSIMD903& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD903& operator += (VectorSIMD903 a){
	...
	inline VectorSIMD903 operator*(double a, VectorSIMD903 b){
		VectorSIMD903 c;
	...
	inline VectorSIMD903 operator*(VectorSIMD903 a ,double b){
		VectorSIMD903 c;
	...
	inline VectorSIMD903 operator*(int a, VectorSIMD903 b){
		if(a==1){return b;}
		VectorSIMD903 c;
	...
	inline VectorSIMD903 operator*(VectorSIMD903 a, int b){
		if(b==1){return a;}
		VectorSIMD903 c;
	...
	inline VectorSIMD903 operator*(VectorSIMD903 a, VectorSIMD903 b){
		VectorSIMD903 c;
	...
	inline VectorSIMD903 exp(VectorSIMD903 a){
		double a_d[903]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD903 sqrt(VectorSIMD903 a){
		double a_d[903]; a.convert(a_d);
