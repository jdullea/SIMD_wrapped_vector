...
public:
		...
		VectorSIMD809(double a){
			...
			_avx202=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD809(double (&a)[809]){
		...
		VectorSIMD809& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD809& operator += (VectorSIMD809 a){
	...
	inline VectorSIMD809 operator*(double a, VectorSIMD809 b){
		VectorSIMD809 c;
	...
	inline VectorSIMD809 operator*(VectorSIMD809 a ,double b){
		VectorSIMD809 c;
	...
	inline VectorSIMD809 operator*(int a, VectorSIMD809 b){
		if(a==1){return b;}
		VectorSIMD809 c;
	...
	inline VectorSIMD809 operator*(VectorSIMD809 a, int b){
		if(b==1){return a;}
		VectorSIMD809 c;
	...
	inline VectorSIMD809 operator*(VectorSIMD809 a, VectorSIMD809 b){
		VectorSIMD809 c;
	...
	inline VectorSIMD809 exp(VectorSIMD809 a){
		double a_d[809]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD809 sqrt(VectorSIMD809 a){
		double a_d[809]; a.convert(a_d);
