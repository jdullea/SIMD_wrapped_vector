...
public:
		...
		VectorSIMD767(double a){
			...
			_avx191=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD767(double (&a)[767]){
		...
		VectorSIMD767& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD767& operator += (VectorSIMD767 a){
	...
	inline VectorSIMD767 operator*(double a, VectorSIMD767 b){
		VectorSIMD767 c;
	...
	inline VectorSIMD767 operator*(VectorSIMD767 a ,double b){
		VectorSIMD767 c;
	...
	inline VectorSIMD767 operator*(int a, VectorSIMD767 b){
		if(a==1){return b;}
		VectorSIMD767 c;
	...
	inline VectorSIMD767 operator*(VectorSIMD767 a, int b){
		if(b==1){return a;}
		VectorSIMD767 c;
	...
	inline VectorSIMD767 operator*(VectorSIMD767 a, VectorSIMD767 b){
		VectorSIMD767 c;
	...
	inline VectorSIMD767 exp(VectorSIMD767 a){
		double a_d[767]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD767 sqrt(VectorSIMD767 a){
		double a_d[767]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD767 a){ 
		double ad[767];
		a.convert(ad);
