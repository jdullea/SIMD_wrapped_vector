...
public:
		...
		VectorSIMD795(double a){
			...
			_avx198=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD795(double (&a)[795]){
		...
		VectorSIMD795& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD795& operator += (VectorSIMD795 a){
	...
	inline VectorSIMD795 operator*(double a, VectorSIMD795 b){
		VectorSIMD795 c;
	...
	inline VectorSIMD795 operator*(VectorSIMD795 a ,double b){
		VectorSIMD795 c;
	...
	inline VectorSIMD795 operator*(int a, VectorSIMD795 b){
		if(a==1){return b;}
		VectorSIMD795 c;
	...
	inline VectorSIMD795 operator*(VectorSIMD795 a, int b){
		if(b==1){return a;}
		VectorSIMD795 c;
	...
	inline VectorSIMD795 operator*(VectorSIMD795 a, VectorSIMD795 b){
		VectorSIMD795 c;
	...
	inline VectorSIMD795 exp(VectorSIMD795 a){
		double a_d[795]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD795 sqrt(VectorSIMD795 a){
		double a_d[795]; a.convert(a_d);
