...
public:
		...
		VectorSIMD572& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD572& operator += (VectorSIMD572 a){
	...
	inline VectorSIMD572 operator*(double a, VectorSIMD572 b){
		VectorSIMD572 c;
	...
	inline VectorSIMD572 operator*(VectorSIMD572 a ,double b){
		VectorSIMD572 c;
	...
	inline VectorSIMD572 operator*(int a, VectorSIMD572 b){
		if(a==1){return b;}
		VectorSIMD572 c;
	...
	inline VectorSIMD572 operator*(VectorSIMD572 a, int b){
		if(b==1){return a;}
		VectorSIMD572 c;
	...
	inline VectorSIMD572 operator*(VectorSIMD572 a, VectorSIMD572 b){
		VectorSIMD572 c;
	...
	inline VectorSIMD572 exp(VectorSIMD572 a){
		double a_d[572]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD572 sqrt(VectorSIMD572 a){
		double a_d[572]; a.convert(a_d);
