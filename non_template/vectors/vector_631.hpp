...
public:
		...
		VectorSIMD631(double a){
			...
			_avx157=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD631(double (&a)[631]){
		...
		VectorSIMD631& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD631& operator += (VectorSIMD631 a){
	...
	inline VectorSIMD631 operator*(double a, VectorSIMD631 b){
		VectorSIMD631 c;
	...
	inline VectorSIMD631 operator*(VectorSIMD631 a ,double b){
		VectorSIMD631 c;
	...
	inline VectorSIMD631 operator*(int a, VectorSIMD631 b){
		if(a==1){return b;}
		VectorSIMD631 c;
	...
	inline VectorSIMD631 operator*(VectorSIMD631 a, int b){
		if(b==1){return a;}
		VectorSIMD631 c;
	...
	inline VectorSIMD631 operator*(VectorSIMD631 a, VectorSIMD631 b){
		VectorSIMD631 c;
	...
	inline VectorSIMD631 exp(VectorSIMD631 a){
		double a_d[631]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD631 sqrt(VectorSIMD631 a){
		double a_d[631]; a.convert(a_d);
