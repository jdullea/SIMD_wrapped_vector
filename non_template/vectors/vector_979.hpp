...
public:
		...
		VectorSIMD979(double a){
			...
			_avx244=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD979(double (&a)[979]){
		...
		VectorSIMD979& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD979& operator += (VectorSIMD979 a){
	...
	inline VectorSIMD979 operator*(double a, VectorSIMD979 b){
		VectorSIMD979 c;
	...
	inline VectorSIMD979 operator*(VectorSIMD979 a ,double b){
		VectorSIMD979 c;
	...
	inline VectorSIMD979 operator*(int a, VectorSIMD979 b){
		if(a==1){return b;}
		VectorSIMD979 c;
	...
	inline VectorSIMD979 operator*(VectorSIMD979 a, int b){
		if(b==1){return a;}
		VectorSIMD979 c;
	...
	inline VectorSIMD979 operator*(VectorSIMD979 a, VectorSIMD979 b){
		VectorSIMD979 c;
	...
	inline VectorSIMD979 exp(VectorSIMD979 a){
		double a_d[979]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD979 sqrt(VectorSIMD979 a){
		double a_d[979]; a.convert(a_d);
