...
public:
		...
		VectorSIMD970(double a){
			...
			_avx242=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD970(double (&a)[970]){
		...
		VectorSIMD970& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD970& operator += (VectorSIMD970 a){
	...
	inline VectorSIMD970 operator*(double a, VectorSIMD970 b){
		VectorSIMD970 c;
	...
	inline VectorSIMD970 operator*(VectorSIMD970 a ,double b){
		VectorSIMD970 c;
	...
	inline VectorSIMD970 operator*(int a, VectorSIMD970 b){
		if(a==1){return b;}
		VectorSIMD970 c;
	...
	inline VectorSIMD970 operator*(VectorSIMD970 a, int b){
		if(b==1){return a;}
		VectorSIMD970 c;
	...
	inline VectorSIMD970 operator*(VectorSIMD970 a, VectorSIMD970 b){
		VectorSIMD970 c;
	...
	inline VectorSIMD970 exp(VectorSIMD970 a){
		double a_d[970]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD970 sqrt(VectorSIMD970 a){
		double a_d[970]; a.convert(a_d);
