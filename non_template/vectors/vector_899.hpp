...
public:
		...
		VectorSIMD899(double a){
			...
			_avx224=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD899(double (&a)[899]){
		...
		VectorSIMD899& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD899& operator += (VectorSIMD899 a){
	...
	inline VectorSIMD899 operator*(double a, VectorSIMD899 b){
		VectorSIMD899 c;
	...
	inline VectorSIMD899 operator*(VectorSIMD899 a ,double b){
		VectorSIMD899 c;
	...
	inline VectorSIMD899 operator*(int a, VectorSIMD899 b){
		if(a==1){return b;}
		VectorSIMD899 c;
	...
	inline VectorSIMD899 operator*(VectorSIMD899 a, int b){
		if(b==1){return a;}
		VectorSIMD899 c;
	...
	inline VectorSIMD899 operator*(VectorSIMD899 a, VectorSIMD899 b){
		VectorSIMD899 c;
	...
	inline VectorSIMD899 exp(VectorSIMD899 a){
		double a_d[899]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD899 sqrt(VectorSIMD899 a){
		double a_d[899]; a.convert(a_d);
