...
public:
		...
		VectorSIMD398(double a){
			...
			_avx99=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD398(double (&a)[398]){
		...
		VectorSIMD398& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD398& operator += (VectorSIMD398 a){
	...
	inline VectorSIMD398 operator*(double a, VectorSIMD398 b){
		VectorSIMD398 c;
	...
	inline VectorSIMD398 operator*(VectorSIMD398 a ,double b){
		VectorSIMD398 c;
	...
	inline VectorSIMD398 operator*(int a, VectorSIMD398 b){
		if(a==1){return b;}
		VectorSIMD398 c;
	...
	inline VectorSIMD398 operator*(VectorSIMD398 a, int b){
		if(b==1){return a;}
		VectorSIMD398 c;
	...
	inline VectorSIMD398 operator*(VectorSIMD398 a, VectorSIMD398 b){
		VectorSIMD398 c;
	...
	inline VectorSIMD398 exp(VectorSIMD398 a){
		double a_d[398]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD398 sqrt(VectorSIMD398 a){
		double a_d[398]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD398 a){ 
		double ad[398];
		a.convert(ad);
