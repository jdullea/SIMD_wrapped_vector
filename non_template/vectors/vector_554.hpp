...
public:
		...
		VectorSIMD554(double a){
			...
			_avx138=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD554(double (&a)[554]){
		...
		VectorSIMD554& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD554& operator += (VectorSIMD554 a){
	...
	inline VectorSIMD554 operator*(double a, VectorSIMD554 b){
		VectorSIMD554 c;
	...
	inline VectorSIMD554 operator*(VectorSIMD554 a ,double b){
		VectorSIMD554 c;
	...
	inline VectorSIMD554 operator*(int a, VectorSIMD554 b){
		if(a==1){return b;}
		VectorSIMD554 c;
	...
	inline VectorSIMD554 operator*(VectorSIMD554 a, int b){
		if(b==1){return a;}
		VectorSIMD554 c;
	...
	inline VectorSIMD554 operator*(VectorSIMD554 a, VectorSIMD554 b){
		VectorSIMD554 c;
	...
	inline VectorSIMD554 exp(VectorSIMD554 a){
		double a_d[554]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD554 sqrt(VectorSIMD554 a){
		double a_d[554]; a.convert(a_d);
