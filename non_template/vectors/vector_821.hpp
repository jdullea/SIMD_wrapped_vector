...
public:
		...
		VectorSIMD821(double a){
			...
			_avx205=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD821(double (&a)[821]){
		...
		VectorSIMD821& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD821& operator += (VectorSIMD821 a){
	...
	inline VectorSIMD821 operator*(double a, VectorSIMD821 b){
		VectorSIMD821 c;
	...
	inline VectorSIMD821 operator*(VectorSIMD821 a ,double b){
		VectorSIMD821 c;
	...
	inline VectorSIMD821 operator*(int a, VectorSIMD821 b){
		if(a==1){return b;}
		VectorSIMD821 c;
	...
	inline VectorSIMD821 operator*(VectorSIMD821 a, int b){
		if(b==1){return a;}
		VectorSIMD821 c;
	...
	inline VectorSIMD821 operator*(VectorSIMD821 a, VectorSIMD821 b){
		VectorSIMD821 c;
	...
	inline VectorSIMD821 exp(VectorSIMD821 a){
		double a_d[821]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD821 sqrt(VectorSIMD821 a){
		double a_d[821]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD821 a){ 
		double ad[821];
		a.convert(ad);
