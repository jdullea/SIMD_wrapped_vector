...
public:
		...
		VectorSIMD763(double a){
			...
			_avx190=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD763(double (&a)[763]){
		...
		VectorSIMD763& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD763& operator += (VectorSIMD763 a){
	...
	inline VectorSIMD763 operator*(double a, VectorSIMD763 b){
		VectorSIMD763 c;
	...
	inline VectorSIMD763 operator*(VectorSIMD763 a ,double b){
		VectorSIMD763 c;
	...
	inline VectorSIMD763 operator*(int a, VectorSIMD763 b){
		if(a==1){return b;}
		VectorSIMD763 c;
	...
	inline VectorSIMD763 operator*(VectorSIMD763 a, int b){
		if(b==1){return a;}
		VectorSIMD763 c;
	...
	inline VectorSIMD763 operator*(VectorSIMD763 a, VectorSIMD763 b){
		VectorSIMD763 c;
	...
	inline VectorSIMD763 exp(VectorSIMD763 a){
		double a_d[763]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD763 sqrt(VectorSIMD763 a){
		double a_d[763]; a.convert(a_d);
