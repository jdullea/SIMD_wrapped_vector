...
public:
		...
		VectorSIMD483(double a){
			...
			_avx120=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD483(double (&a)[483]){
		...
		VectorSIMD483& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD483& operator += (VectorSIMD483 a){
	...
	inline VectorSIMD483 operator*(double a, VectorSIMD483 b){
		VectorSIMD483 c;
	...
	inline VectorSIMD483 operator*(VectorSIMD483 a ,double b){
		VectorSIMD483 c;
	...
	inline VectorSIMD483 operator*(int a, VectorSIMD483 b){
		if(a==1){return b;}
		VectorSIMD483 c;
	...
	inline VectorSIMD483 operator*(VectorSIMD483 a, int b){
		if(b==1){return a;}
		VectorSIMD483 c;
	...
	inline VectorSIMD483 operator*(VectorSIMD483 a, VectorSIMD483 b){
		VectorSIMD483 c;
	...
	inline VectorSIMD483 exp(VectorSIMD483 a){
		double a_d[483]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD483 sqrt(VectorSIMD483 a){
		double a_d[483]; a.convert(a_d);
