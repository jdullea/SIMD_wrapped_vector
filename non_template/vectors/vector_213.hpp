...
public:
		...
		VectorSIMD213(double a){
			...
			_avx53=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD213(double (&a)[213]){
		...
		VectorSIMD213& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD213& operator += (VectorSIMD213 a){
	...
	inline VectorSIMD213 operator*(double a, VectorSIMD213 b){
		VectorSIMD213 c;
	...
	inline VectorSIMD213 operator*(VectorSIMD213 a ,double b){
		VectorSIMD213 c;
	...
	inline VectorSIMD213 operator*(int a, VectorSIMD213 b){
		if(a==1){return b;}
		VectorSIMD213 c;
	...
	inline VectorSIMD213 operator*(VectorSIMD213 a, int b){
		if(b==1){return a;}
		VectorSIMD213 c;
	...
	inline VectorSIMD213 operator*(VectorSIMD213 a, VectorSIMD213 b){
		VectorSIMD213 c;
	...
	inline VectorSIMD213 exp(VectorSIMD213 a){
		double a_d[213]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD213 sqrt(VectorSIMD213 a){
		double a_d[213]; a.convert(a_d);
