...
public:
		...
		VectorSIMD697(double a){
			...
			_avx174=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD697(double (&a)[697]){
		...
		VectorSIMD697& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD697& operator += (VectorSIMD697 a){
	...
	inline VectorSIMD697 operator*(double a, VectorSIMD697 b){
		VectorSIMD697 c;
	...
	inline VectorSIMD697 operator*(VectorSIMD697 a ,double b){
		VectorSIMD697 c;
	...
	inline VectorSIMD697 operator*(int a, VectorSIMD697 b){
		if(a==1){return b;}
		VectorSIMD697 c;
	...
	inline VectorSIMD697 operator*(VectorSIMD697 a, int b){
		if(b==1){return a;}
		VectorSIMD697 c;
	...
	inline VectorSIMD697 operator*(VectorSIMD697 a, VectorSIMD697 b){
		VectorSIMD697 c;
	...
	inline VectorSIMD697 exp(VectorSIMD697 a){
		double a_d[697]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD697 sqrt(VectorSIMD697 a){
		double a_d[697]; a.convert(a_d);
