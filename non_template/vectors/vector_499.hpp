...
public:
		...
		VectorSIMD499(double a){
			...
			_avx124=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD499(double (&a)[499]){
		...
		VectorSIMD499& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD499& operator += (VectorSIMD499 a){
	...
	inline VectorSIMD499 operator*(double a, VectorSIMD499 b){
		VectorSIMD499 c;
	...
	inline VectorSIMD499 operator*(VectorSIMD499 a ,double b){
		VectorSIMD499 c;
	...
	inline VectorSIMD499 operator*(int a, VectorSIMD499 b){
		if(a==1){return b;}
		VectorSIMD499 c;
	...
	inline VectorSIMD499 operator*(VectorSIMD499 a, int b){
		if(b==1){return a;}
		VectorSIMD499 c;
	...
	inline VectorSIMD499 operator*(VectorSIMD499 a, VectorSIMD499 b){
		VectorSIMD499 c;
	...
	inline VectorSIMD499 exp(VectorSIMD499 a){
		double a_d[499]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD499 sqrt(VectorSIMD499 a){
		double a_d[499]; a.convert(a_d);
