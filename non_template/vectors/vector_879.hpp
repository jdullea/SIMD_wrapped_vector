...
public:
		...
		VectorSIMD879(double a){
			...
			_avx219=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD879(double (&a)[879]){
		...
		VectorSIMD879& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD879& operator += (VectorSIMD879 a){
	...
	inline VectorSIMD879 operator*(double a, VectorSIMD879 b){
		VectorSIMD879 c;
	...
	inline VectorSIMD879 operator*(VectorSIMD879 a ,double b){
		VectorSIMD879 c;
	...
	inline VectorSIMD879 operator*(int a, VectorSIMD879 b){
		if(a==1){return b;}
		VectorSIMD879 c;
	...
	inline VectorSIMD879 operator*(VectorSIMD879 a, int b){
		if(b==1){return a;}
		VectorSIMD879 c;
	...
	inline VectorSIMD879 operator*(VectorSIMD879 a, VectorSIMD879 b){
		VectorSIMD879 c;
	...
	inline VectorSIMD879 exp(VectorSIMD879 a){
		double a_d[879]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD879 sqrt(VectorSIMD879 a){
		double a_d[879]; a.convert(a_d);
