...
public:
		...
		VectorSIMD432& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD432& operator += (VectorSIMD432 a){
	...
	inline VectorSIMD432 operator*(double a, VectorSIMD432 b){
		VectorSIMD432 c;
	...
	inline VectorSIMD432 operator*(VectorSIMD432 a ,double b){
		VectorSIMD432 c;
	...
	inline VectorSIMD432 operator*(int a, VectorSIMD432 b){
		if(a==1){return b;}
		VectorSIMD432 c;
	...
	inline VectorSIMD432 operator*(VectorSIMD432 a, int b){
		if(b==1){return a;}
		VectorSIMD432 c;
	...
	inline VectorSIMD432 operator*(VectorSIMD432 a, VectorSIMD432 b){
		VectorSIMD432 c;
	...
	inline VectorSIMD432 exp(VectorSIMD432 a){
		double a_d[432]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD432 sqrt(VectorSIMD432 a){
		double a_d[432]; a.convert(a_d);
