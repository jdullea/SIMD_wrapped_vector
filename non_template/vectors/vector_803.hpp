...
public:
		...
		VectorSIMD803(double a){
			...
			_avx200=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD803(double (&a)[803]){
		...
		VectorSIMD803& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD803& operator += (VectorSIMD803 a){
	...
	inline VectorSIMD803 operator*(double a, VectorSIMD803 b){
		VectorSIMD803 c;
	...
	inline VectorSIMD803 operator*(VectorSIMD803 a ,double b){
		VectorSIMD803 c;
	...
	inline VectorSIMD803 operator*(int a, VectorSIMD803 b){
		if(a==1){return b;}
		VectorSIMD803 c;
	...
	inline VectorSIMD803 operator*(VectorSIMD803 a, int b){
		if(b==1){return a;}
		VectorSIMD803 c;
	...
	inline VectorSIMD803 operator*(VectorSIMD803 a, VectorSIMD803 b){
		VectorSIMD803 c;
	...
	inline VectorSIMD803 exp(VectorSIMD803 a){
		double a_d[803]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD803 sqrt(VectorSIMD803 a){
		double a_d[803]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD803 a){ 
		double ad[803];
		a.convert(ad);
