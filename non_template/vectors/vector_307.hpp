...
public:
		...
		VectorSIMD307(double a){
			...
			_avx76=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD307(double (&a)[307]){
		...
		VectorSIMD307& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD307& operator += (VectorSIMD307 a){
	...
	inline VectorSIMD307 operator*(double a, VectorSIMD307 b){
		VectorSIMD307 c;
	...
	inline VectorSIMD307 operator*(VectorSIMD307 a ,double b){
		VectorSIMD307 c;
	...
	inline VectorSIMD307 operator*(int a, VectorSIMD307 b){
		if(a==1){return b;}
		VectorSIMD307 c;
	...
	inline VectorSIMD307 operator*(VectorSIMD307 a, int b){
		if(b==1){return a;}
		VectorSIMD307 c;
	...
	inline VectorSIMD307 operator*(VectorSIMD307 a, VectorSIMD307 b){
		VectorSIMD307 c;
	...
	inline VectorSIMD307 exp(VectorSIMD307 a){
		double a_d[307]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD307 sqrt(VectorSIMD307 a){
		double a_d[307]; a.convert(a_d);
