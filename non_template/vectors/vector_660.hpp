...
public:
		...
		VectorSIMD660& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD660& operator += (VectorSIMD660 a){
	...
	inline VectorSIMD660 operator*(double a, VectorSIMD660 b){
		VectorSIMD660 c;
	...
	inline VectorSIMD660 operator*(VectorSIMD660 a ,double b){
		VectorSIMD660 c;
	...
	inline VectorSIMD660 operator*(int a, VectorSIMD660 b){
		if(a==1){return b;}
		VectorSIMD660 c;
	...
	inline VectorSIMD660 operator*(VectorSIMD660 a, int b){
		if(b==1){return a;}
		VectorSIMD660 c;
	...
	inline VectorSIMD660 operator*(VectorSIMD660 a, VectorSIMD660 b){
		VectorSIMD660 c;
	...
	inline VectorSIMD660 exp(VectorSIMD660 a){
		double a_d[660]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD660 sqrt(VectorSIMD660 a){
		double a_d[660]; a.convert(a_d);
