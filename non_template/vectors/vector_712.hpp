...
public:
		...
		VectorSIMD712& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD712& operator += (VectorSIMD712 a){
	...
	inline VectorSIMD712 operator*(double a, VectorSIMD712 b){
		VectorSIMD712 c;
	...
	inline VectorSIMD712 operator*(VectorSIMD712 a ,double b){
		VectorSIMD712 c;
	...
	inline VectorSIMD712 operator*(int a, VectorSIMD712 b){
		if(a==1){return b;}
		VectorSIMD712 c;
	...
	inline VectorSIMD712 operator*(VectorSIMD712 a, int b){
		if(b==1){return a;}
		VectorSIMD712 c;
	...
	inline VectorSIMD712 operator*(VectorSIMD712 a, VectorSIMD712 b){
		VectorSIMD712 c;
	...
	inline VectorSIMD712 exp(VectorSIMD712 a){
		double a_d[712]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD712 sqrt(VectorSIMD712 a){
		double a_d[712]; a.convert(a_d);
