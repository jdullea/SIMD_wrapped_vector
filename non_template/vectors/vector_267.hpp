...
public:
		...
		VectorSIMD267(double a){
			...
			_avx66=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD267(double (&a)[267]){
		...
		VectorSIMD267& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD267& operator += (VectorSIMD267 a){
	...
	inline VectorSIMD267 operator*(double a, VectorSIMD267 b){
		VectorSIMD267 c;
	...
	inline VectorSIMD267 operator*(VectorSIMD267 a ,double b){
		VectorSIMD267 c;
	...
	inline VectorSIMD267 operator*(int a, VectorSIMD267 b){
		if(a==1){return b;}
		VectorSIMD267 c;
	...
	inline VectorSIMD267 operator*(VectorSIMD267 a, int b){
		if(b==1){return a;}
		VectorSIMD267 c;
	...
	inline VectorSIMD267 operator*(VectorSIMD267 a, VectorSIMD267 b){
		VectorSIMD267 c;
	...
	inline VectorSIMD267 exp(VectorSIMD267 a){
		double a_d[267]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD267 sqrt(VectorSIMD267 a){
		double a_d[267]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD267 a){ 
		double ad[267];
		a.convert(ad);
