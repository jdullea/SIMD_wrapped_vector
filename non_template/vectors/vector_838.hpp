...
public:
		...
		VectorSIMD838(double a){
			...
			_avx209=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD838(double (&a)[838]){
		...
		VectorSIMD838& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD838& operator += (VectorSIMD838 a){
	...
	inline VectorSIMD838 operator*(double a, VectorSIMD838 b){
		VectorSIMD838 c;
	...
	inline VectorSIMD838 operator*(VectorSIMD838 a ,double b){
		VectorSIMD838 c;
	...
	inline VectorSIMD838 operator*(int a, VectorSIMD838 b){
		if(a==1){return b;}
		VectorSIMD838 c;
	...
	inline VectorSIMD838 operator*(VectorSIMD838 a, int b){
		if(b==1){return a;}
		VectorSIMD838 c;
	...
	inline VectorSIMD838 operator*(VectorSIMD838 a, VectorSIMD838 b){
		VectorSIMD838 c;
	...
	inline VectorSIMD838 exp(VectorSIMD838 a){
		double a_d[838]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD838 sqrt(VectorSIMD838 a){
		double a_d[838]; a.convert(a_d);
