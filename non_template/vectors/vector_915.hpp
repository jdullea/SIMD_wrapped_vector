...
public:
		...
		VectorSIMD915(double a){
			...
			_avx228=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD915(double (&a)[915]){
		...
		VectorSIMD915& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD915& operator += (VectorSIMD915 a){
	...
	inline VectorSIMD915 operator*(double a, VectorSIMD915 b){
		VectorSIMD915 c;
	...
	inline VectorSIMD915 operator*(VectorSIMD915 a ,double b){
		VectorSIMD915 c;
	...
	inline VectorSIMD915 operator*(int a, VectorSIMD915 b){
		if(a==1){return b;}
		VectorSIMD915 c;
	...
	inline VectorSIMD915 operator*(VectorSIMD915 a, int b){
		if(b==1){return a;}
		VectorSIMD915 c;
	...
	inline VectorSIMD915 operator*(VectorSIMD915 a, VectorSIMD915 b){
		VectorSIMD915 c;
	...
	inline VectorSIMD915 exp(VectorSIMD915 a){
		double a_d[915]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD915 sqrt(VectorSIMD915 a){
		double a_d[915]; a.convert(a_d);
