...
public:
		...
		VectorSIMD599(double a){
			...
			_avx149=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD599(double (&a)[599]){
		...
		VectorSIMD599& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD599& operator += (VectorSIMD599 a){
	...
	inline VectorSIMD599 operator*(double a, VectorSIMD599 b){
		VectorSIMD599 c;
	...
	inline VectorSIMD599 operator*(VectorSIMD599 a ,double b){
		VectorSIMD599 c;
	...
	inline VectorSIMD599 operator*(int a, VectorSIMD599 b){
		if(a==1){return b;}
		VectorSIMD599 c;
	...
	inline VectorSIMD599 operator*(VectorSIMD599 a, int b){
		if(b==1){return a;}
		VectorSIMD599 c;
	...
	inline VectorSIMD599 operator*(VectorSIMD599 a, VectorSIMD599 b){
		VectorSIMD599 c;
	...
	inline VectorSIMD599 exp(VectorSIMD599 a){
		double a_d[599]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD599 sqrt(VectorSIMD599 a){
		double a_d[599]; a.convert(a_d);
