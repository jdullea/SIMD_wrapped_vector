...
public:
		...
		VectorSIMD782(double a){
			...
			_avx195=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD782(double (&a)[782]){
		...
		VectorSIMD782& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD782& operator += (VectorSIMD782 a){
	...
	inline VectorSIMD782 operator*(double a, VectorSIMD782 b){
		VectorSIMD782 c;
	...
	inline VectorSIMD782 operator*(VectorSIMD782 a ,double b){
		VectorSIMD782 c;
	...
	inline VectorSIMD782 operator*(int a, VectorSIMD782 b){
		if(a==1){return b;}
		VectorSIMD782 c;
	...
	inline VectorSIMD782 operator*(VectorSIMD782 a, int b){
		if(b==1){return a;}
		VectorSIMD782 c;
	...
	inline VectorSIMD782 operator*(VectorSIMD782 a, VectorSIMD782 b){
		VectorSIMD782 c;
	...
	inline VectorSIMD782 exp(VectorSIMD782 a){
		double a_d[782]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD782 sqrt(VectorSIMD782 a){
		double a_d[782]; a.convert(a_d);
