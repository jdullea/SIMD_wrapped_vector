...
public:
		...
		VectorSIMD230(double a){
			...
			_avx57=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD230(double (&a)[230]){
		...
		VectorSIMD230& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD230& operator += (VectorSIMD230 a){
	...
	inline VectorSIMD230 operator*(double a, VectorSIMD230 b){
		VectorSIMD230 c;
	...
	inline VectorSIMD230 operator*(VectorSIMD230 a ,double b){
		VectorSIMD230 c;
	...
	inline VectorSIMD230 operator*(int a, VectorSIMD230 b){
		if(a==1){return b;}
		VectorSIMD230 c;
	...
	inline VectorSIMD230 operator*(VectorSIMD230 a, int b){
		if(b==1){return a;}
		VectorSIMD230 c;
	...
	inline VectorSIMD230 operator*(VectorSIMD230 a, VectorSIMD230 b){
		VectorSIMD230 c;
	...
	inline VectorSIMD230 exp(VectorSIMD230 a){
		double a_d[230]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD230 sqrt(VectorSIMD230 a){
		double a_d[230]; a.convert(a_d);
