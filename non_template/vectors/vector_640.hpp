...
public:
		...
		VectorSIMD640& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD640& operator += (VectorSIMD640 a){
	...
	inline VectorSIMD640 operator*(double a, VectorSIMD640 b){
		VectorSIMD640 c;
	...
	inline VectorSIMD640 operator*(VectorSIMD640 a ,double b){
		VectorSIMD640 c;
	...
	inline VectorSIMD640 operator*(int a, VectorSIMD640 b){
		if(a==1){return b;}
		VectorSIMD640 c;
	...
	inline VectorSIMD640 operator*(VectorSIMD640 a, int b){
		if(b==1){return a;}
		VectorSIMD640 c;
	...
	inline VectorSIMD640 operator*(VectorSIMD640 a, VectorSIMD640 b){
		VectorSIMD640 c;
	...
	inline VectorSIMD640 exp(VectorSIMD640 a){
		double a_d[640]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD640 sqrt(VectorSIMD640 a){
		double a_d[640]; a.convert(a_d);
