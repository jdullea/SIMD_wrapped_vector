...
public:
		...
		VectorSIMD678(double a){
			...
			_avx169=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD678(double (&a)[678]){
		...
		VectorSIMD678& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD678& operator += (VectorSIMD678 a){
	...
	inline VectorSIMD678 operator*(double a, VectorSIMD678 b){
		VectorSIMD678 c;
	...
	inline VectorSIMD678 operator*(VectorSIMD678 a ,double b){
		VectorSIMD678 c;
	...
	inline VectorSIMD678 operator*(int a, VectorSIMD678 b){
		if(a==1){return b;}
		VectorSIMD678 c;
	...
	inline VectorSIMD678 operator*(VectorSIMD678 a, int b){
		if(b==1){return a;}
		VectorSIMD678 c;
	...
	inline VectorSIMD678 operator*(VectorSIMD678 a, VectorSIMD678 b){
		VectorSIMD678 c;
	...
	inline VectorSIMD678 exp(VectorSIMD678 a){
		double a_d[678]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD678 sqrt(VectorSIMD678 a){
		double a_d[678]; a.convert(a_d);
