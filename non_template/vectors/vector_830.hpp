...
public:
		...
		VectorSIMD830(double a){
			...
			_avx207=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD830(double (&a)[830]){
		...
		VectorSIMD830& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD830& operator += (VectorSIMD830 a){
	...
	inline VectorSIMD830 operator*(double a, VectorSIMD830 b){
		VectorSIMD830 c;
	...
	inline VectorSIMD830 operator*(VectorSIMD830 a ,double b){
		VectorSIMD830 c;
	...
	inline VectorSIMD830 operator*(int a, VectorSIMD830 b){
		if(a==1){return b;}
		VectorSIMD830 c;
	...
	inline VectorSIMD830 operator*(VectorSIMD830 a, int b){
		if(b==1){return a;}
		VectorSIMD830 c;
	...
	inline VectorSIMD830 operator*(VectorSIMD830 a, VectorSIMD830 b){
		VectorSIMD830 c;
	...
	inline VectorSIMD830 exp(VectorSIMD830 a){
		double a_d[830]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD830 sqrt(VectorSIMD830 a){
		double a_d[830]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD830 a){ 
		double ad[830];
		a.convert(ad);
