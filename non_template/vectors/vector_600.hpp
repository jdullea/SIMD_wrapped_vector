...
public:
		...
		VectorSIMD600& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD600& operator += (VectorSIMD600 a){
	...
	inline VectorSIMD600 operator*(double a, VectorSIMD600 b){
		VectorSIMD600 c;
	...
	inline VectorSIMD600 operator*(VectorSIMD600 a ,double b){
		VectorSIMD600 c;
	...
	inline VectorSIMD600 operator*(int a, VectorSIMD600 b){
		if(a==1){return b;}
		VectorSIMD600 c;
	...
	inline VectorSIMD600 operator*(VectorSIMD600 a, int b){
		if(b==1){return a;}
		VectorSIMD600 c;
	...
	inline VectorSIMD600 operator*(VectorSIMD600 a, VectorSIMD600 b){
		VectorSIMD600 c;
	...
	inline VectorSIMD600 exp(VectorSIMD600 a){
		double a_d[600]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD600 sqrt(VectorSIMD600 a){
		double a_d[600]; a.convert(a_d);
