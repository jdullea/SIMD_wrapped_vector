...
public:
		...
		VectorSIMD431(double a){
			...
			_avx107=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD431(double (&a)[431]){
		...
		VectorSIMD431& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD431& operator += (VectorSIMD431 a){
	...
	inline VectorSIMD431 operator*(double a, VectorSIMD431 b){
		VectorSIMD431 c;
	...
	inline VectorSIMD431 operator*(VectorSIMD431 a ,double b){
		VectorSIMD431 c;
	...
	inline VectorSIMD431 operator*(int a, VectorSIMD431 b){
		if(a==1){return b;}
		VectorSIMD431 c;
	...
	inline VectorSIMD431 operator*(VectorSIMD431 a, int b){
		if(b==1){return a;}
		VectorSIMD431 c;
	...
	inline VectorSIMD431 operator*(VectorSIMD431 a, VectorSIMD431 b){
		VectorSIMD431 c;
	...
	inline VectorSIMD431 exp(VectorSIMD431 a){
		double a_d[431]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD431 sqrt(VectorSIMD431 a){
		double a_d[431]; a.convert(a_d);
