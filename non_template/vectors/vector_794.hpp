...
public:
		...
		VectorSIMD794(double a){
			...
			_avx198=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD794(double (&a)[794]){
		...
		VectorSIMD794& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD794& operator += (VectorSIMD794 a){
	...
	inline VectorSIMD794 operator*(double a, VectorSIMD794 b){
		VectorSIMD794 c;
	...
	inline VectorSIMD794 operator*(VectorSIMD794 a ,double b){
		VectorSIMD794 c;
	...
	inline VectorSIMD794 operator*(int a, VectorSIMD794 b){
		if(a==1){return b;}
		VectorSIMD794 c;
	...
	inline VectorSIMD794 operator*(VectorSIMD794 a, int b){
		if(b==1){return a;}
		VectorSIMD794 c;
	...
	inline VectorSIMD794 operator*(VectorSIMD794 a, VectorSIMD794 b){
		VectorSIMD794 c;
	...
	inline VectorSIMD794 exp(VectorSIMD794 a){
		double a_d[794]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD794 sqrt(VectorSIMD794 a){
		double a_d[794]; a.convert(a_d);
