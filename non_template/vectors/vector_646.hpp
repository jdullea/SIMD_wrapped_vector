...
public:
		...
		VectorSIMD646(double a){
			...
			_avx161=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD646(double (&a)[646]){
		...
		VectorSIMD646& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD646& operator += (VectorSIMD646 a){
	...
	inline VectorSIMD646 operator*(double a, VectorSIMD646 b){
		VectorSIMD646 c;
	...
	inline VectorSIMD646 operator*(VectorSIMD646 a ,double b){
		VectorSIMD646 c;
	...
	inline VectorSIMD646 operator*(int a, VectorSIMD646 b){
		if(a==1){return b;}
		VectorSIMD646 c;
	...
	inline VectorSIMD646 operator*(VectorSIMD646 a, int b){
		if(b==1){return a;}
		VectorSIMD646 c;
	...
	inline VectorSIMD646 operator*(VectorSIMD646 a, VectorSIMD646 b){
		VectorSIMD646 c;
	...
	inline VectorSIMD646 exp(VectorSIMD646 a){
		double a_d[646]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD646 sqrt(VectorSIMD646 a){
		double a_d[646]; a.convert(a_d);
