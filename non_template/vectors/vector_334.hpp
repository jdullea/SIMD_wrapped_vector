...
public:
		...
		VectorSIMD334(double a){
			...
			_avx83=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD334(double (&a)[334]){
		...
		VectorSIMD334& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD334& operator += (VectorSIMD334 a){
	...
	inline VectorSIMD334 operator*(double a, VectorSIMD334 b){
		VectorSIMD334 c;
	...
	inline VectorSIMD334 operator*(VectorSIMD334 a ,double b){
		VectorSIMD334 c;
	...
	inline VectorSIMD334 operator*(int a, VectorSIMD334 b){
		if(a==1){return b;}
		VectorSIMD334 c;
	...
	inline VectorSIMD334 operator*(VectorSIMD334 a, int b){
		if(b==1){return a;}
		VectorSIMD334 c;
	...
	inline VectorSIMD334 operator*(VectorSIMD334 a, VectorSIMD334 b){
		VectorSIMD334 c;
	...
	inline VectorSIMD334 exp(VectorSIMD334 a){
		double a_d[334]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD334 sqrt(VectorSIMD334 a){
		double a_d[334]; a.convert(a_d);
