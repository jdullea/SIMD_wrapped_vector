...
public:
		...
		VectorSIMD691(double a){
			...
			_avx172=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD691(double (&a)[691]){
		...
		VectorSIMD691& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD691& operator += (VectorSIMD691 a){
	...
	inline VectorSIMD691 operator*(double a, VectorSIMD691 b){
		VectorSIMD691 c;
	...
	inline VectorSIMD691 operator*(VectorSIMD691 a ,double b){
		VectorSIMD691 c;
	...
	inline VectorSIMD691 operator*(int a, VectorSIMD691 b){
		if(a==1){return b;}
		VectorSIMD691 c;
	...
	inline VectorSIMD691 operator*(VectorSIMD691 a, int b){
		if(b==1){return a;}
		VectorSIMD691 c;
	...
	inline VectorSIMD691 operator*(VectorSIMD691 a, VectorSIMD691 b){
		VectorSIMD691 c;
	...
	inline VectorSIMD691 exp(VectorSIMD691 a){
		double a_d[691]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD691 sqrt(VectorSIMD691 a){
		double a_d[691]; a.convert(a_d);
