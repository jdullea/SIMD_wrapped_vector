...
public:
		...
		VectorSIMD534(double a){
			...
			_avx133=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD534(double (&a)[534]){
		...
		VectorSIMD534& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD534& operator += (VectorSIMD534 a){
	...
	inline VectorSIMD534 operator*(double a, VectorSIMD534 b){
		VectorSIMD534 c;
	...
	inline VectorSIMD534 operator*(VectorSIMD534 a ,double b){
		VectorSIMD534 c;
	...
	inline VectorSIMD534 operator*(int a, VectorSIMD534 b){
		if(a==1){return b;}
		VectorSIMD534 c;
	...
	inline VectorSIMD534 operator*(VectorSIMD534 a, int b){
		if(b==1){return a;}
		VectorSIMD534 c;
	...
	inline VectorSIMD534 operator*(VectorSIMD534 a, VectorSIMD534 b){
		VectorSIMD534 c;
	...
	inline VectorSIMD534 exp(VectorSIMD534 a){
		double a_d[534]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD534 sqrt(VectorSIMD534 a){
		double a_d[534]; a.convert(a_d);
