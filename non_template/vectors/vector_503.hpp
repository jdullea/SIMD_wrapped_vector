...
public:
		...
		VectorSIMD503(double a){
			...
			_avx125=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD503(double (&a)[503]){
		...
		VectorSIMD503& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD503& operator += (VectorSIMD503 a){
	...
	inline VectorSIMD503 operator*(double a, VectorSIMD503 b){
		VectorSIMD503 c;
	...
	inline VectorSIMD503 operator*(VectorSIMD503 a ,double b){
		VectorSIMD503 c;
	...
	inline VectorSIMD503 operator*(int a, VectorSIMD503 b){
		if(a==1){return b;}
		VectorSIMD503 c;
	...
	inline VectorSIMD503 operator*(VectorSIMD503 a, int b){
		if(b==1){return a;}
		VectorSIMD503 c;
	...
	inline VectorSIMD503 operator*(VectorSIMD503 a, VectorSIMD503 b){
		VectorSIMD503 c;
	...
	inline VectorSIMD503 exp(VectorSIMD503 a){
		double a_d[503]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD503 sqrt(VectorSIMD503 a){
		double a_d[503]; a.convert(a_d);
