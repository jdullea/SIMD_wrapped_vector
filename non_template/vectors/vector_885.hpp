...
public:
		...
		VectorSIMD885(double a){
			...
			_avx221=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD885(double (&a)[885]){
		...
		VectorSIMD885& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD885& operator += (VectorSIMD885 a){
	...
	inline VectorSIMD885 operator*(double a, VectorSIMD885 b){
		VectorSIMD885 c;
	...
	inline VectorSIMD885 operator*(VectorSIMD885 a ,double b){
		VectorSIMD885 c;
	...
	inline VectorSIMD885 operator*(int a, VectorSIMD885 b){
		if(a==1){return b;}
		VectorSIMD885 c;
	...
	inline VectorSIMD885 operator*(VectorSIMD885 a, int b){
		if(b==1){return a;}
		VectorSIMD885 c;
	...
	inline VectorSIMD885 operator*(VectorSIMD885 a, VectorSIMD885 b){
		VectorSIMD885 c;
	...
	inline VectorSIMD885 exp(VectorSIMD885 a){
		double a_d[885]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD885 sqrt(VectorSIMD885 a){
		double a_d[885]; a.convert(a_d);
