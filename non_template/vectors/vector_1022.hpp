...
public:
		...
		VectorSIMD1022(double a){
			...
			_avx255=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD1022(double (&a)[1022]){
		...
		VectorSIMD1022& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1022& operator += (VectorSIMD1022 a){
	...
	inline VectorSIMD1022 operator*(double a, VectorSIMD1022 b){
		VectorSIMD1022 c;
	...
	inline VectorSIMD1022 operator*(VectorSIMD1022 a ,double b){
		VectorSIMD1022 c;
	...
	inline VectorSIMD1022 operator*(int a, VectorSIMD1022 b){
		if(a==1){return b;}
		VectorSIMD1022 c;
	...
	inline VectorSIMD1022 operator*(VectorSIMD1022 a, int b){
		if(b==1){return a;}
		VectorSIMD1022 c;
	...
	inline VectorSIMD1022 operator*(VectorSIMD1022 a, VectorSIMD1022 b){
		VectorSIMD1022 c;
	...
	inline VectorSIMD1022 exp(VectorSIMD1022 a){
		double a_d[1022]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1022 r(a_d);
		return r;
	}

	inline VectorSIMD1022 sqrt(VectorSIMD1022 a){
		double a_d[1022]; a.convert(a_d);
