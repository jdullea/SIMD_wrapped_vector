...
public:
		...
		VectorSIMD603(double a){
			...
			_avx150=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD603(double (&a)[603]){
		...
		VectorSIMD603& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD603& operator += (VectorSIMD603 a){
	...
	inline VectorSIMD603 operator*(double a, VectorSIMD603 b){
		VectorSIMD603 c;
	...
	inline VectorSIMD603 operator*(VectorSIMD603 a ,double b){
		VectorSIMD603 c;
	...
	inline VectorSIMD603 operator*(int a, VectorSIMD603 b){
		if(a==1){return b;}
		VectorSIMD603 c;
	...
	inline VectorSIMD603 operator*(VectorSIMD603 a, int b){
		if(b==1){return a;}
		VectorSIMD603 c;
	...
	inline VectorSIMD603 operator*(VectorSIMD603 a, VectorSIMD603 b){
		VectorSIMD603 c;
	...
	inline VectorSIMD603 exp(VectorSIMD603 a){
		double a_d[603]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD603 sqrt(VectorSIMD603 a){
		double a_d[603]; a.convert(a_d);
