...
public:
		...
		VectorSIMD972& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD972& operator += (VectorSIMD972 a){
	...
	inline VectorSIMD972 operator*(double a, VectorSIMD972 b){
		VectorSIMD972 c;
	...
	inline VectorSIMD972 operator*(VectorSIMD972 a ,double b){
		VectorSIMD972 c;
	...
	inline VectorSIMD972 operator*(int a, VectorSIMD972 b){
		if(a==1){return b;}
		VectorSIMD972 c;
	...
	inline VectorSIMD972 operator*(VectorSIMD972 a, int b){
		if(b==1){return a;}
		VectorSIMD972 c;
	...
	inline VectorSIMD972 operator*(VectorSIMD972 a, VectorSIMD972 b){
		VectorSIMD972 c;
	...
	inline VectorSIMD972 exp(VectorSIMD972 a){
		double a_d[972]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD972 sqrt(VectorSIMD972 a){
		double a_d[972]; a.convert(a_d);
