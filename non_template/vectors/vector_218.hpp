...
public:
		...
		VectorSIMD218(double a){
			...
			_avx54=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD218(double (&a)[218]){
		...
		VectorSIMD218& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD218& operator += (VectorSIMD218 a){
	...
	inline VectorSIMD218 operator*(double a, VectorSIMD218 b){
		VectorSIMD218 c;
	...
	inline VectorSIMD218 operator*(VectorSIMD218 a ,double b){
		VectorSIMD218 c;
	...
	inline VectorSIMD218 operator*(int a, VectorSIMD218 b){
		if(a==1){return b;}
		VectorSIMD218 c;
	...
	inline VectorSIMD218 operator*(VectorSIMD218 a, int b){
		if(b==1){return a;}
		VectorSIMD218 c;
	...
	inline VectorSIMD218 operator*(VectorSIMD218 a, VectorSIMD218 b){
		VectorSIMD218 c;
	...
	inline VectorSIMD218 exp(VectorSIMD218 a){
		double a_d[218]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD218 sqrt(VectorSIMD218 a){
		double a_d[218]; a.convert(a_d);
