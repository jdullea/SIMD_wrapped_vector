...
public:
		...
		VectorSIMD804& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD804& operator += (VectorSIMD804 a){
	...
	inline VectorSIMD804 operator*(double a, VectorSIMD804 b){
		VectorSIMD804 c;
	...
	inline VectorSIMD804 operator*(VectorSIMD804 a ,double b){
		VectorSIMD804 c;
	...
	inline VectorSIMD804 operator*(int a, VectorSIMD804 b){
		if(a==1){return b;}
		VectorSIMD804 c;
	...
	inline VectorSIMD804 operator*(VectorSIMD804 a, int b){
		if(b==1){return a;}
		VectorSIMD804 c;
	...
	inline VectorSIMD804 operator*(VectorSIMD804 a, VectorSIMD804 b){
		VectorSIMD804 c;
	...
	inline VectorSIMD804 exp(VectorSIMD804 a){
		double a_d[804]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD804 sqrt(VectorSIMD804 a){
		double a_d[804]; a.convert(a_d);
