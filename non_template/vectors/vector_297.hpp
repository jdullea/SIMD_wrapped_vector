...
public:
		...
		VectorSIMD297(double a){
			...
			_avx74=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD297(double (&a)[297]){
		...
		VectorSIMD297& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD297& operator += (VectorSIMD297 a){
	...
	inline VectorSIMD297 operator*(double a, VectorSIMD297 b){
		VectorSIMD297 c;
	...
	inline VectorSIMD297 operator*(VectorSIMD297 a ,double b){
		VectorSIMD297 c;
	...
	inline VectorSIMD297 operator*(int a, VectorSIMD297 b){
		if(a==1){return b;}
		VectorSIMD297 c;
	...
	inline VectorSIMD297 operator*(VectorSIMD297 a, int b){
		if(b==1){return a;}
		VectorSIMD297 c;
	...
	inline VectorSIMD297 operator*(VectorSIMD297 a, VectorSIMD297 b){
		VectorSIMD297 c;
	...
	inline VectorSIMD297 exp(VectorSIMD297 a){
		double a_d[297]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD297 sqrt(VectorSIMD297 a){
		double a_d[297]; a.convert(a_d);
