...
public:
		...
		VectorSIMD321(double a){
			...
			_avx80=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD321(double (&a)[321]){
		...
		VectorSIMD321& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD321& operator += (VectorSIMD321 a){
	...
	inline VectorSIMD321 operator*(double a, VectorSIMD321 b){
		VectorSIMD321 c;
	...
	inline VectorSIMD321 operator*(VectorSIMD321 a ,double b){
		VectorSIMD321 c;
	...
	inline VectorSIMD321 operator*(int a, VectorSIMD321 b){
		if(a==1){return b;}
		VectorSIMD321 c;
	...
	inline VectorSIMD321 operator*(VectorSIMD321 a, int b){
		if(b==1){return a;}
		VectorSIMD321 c;
	...
	inline VectorSIMD321 operator*(VectorSIMD321 a, VectorSIMD321 b){
		VectorSIMD321 c;
	...
	inline VectorSIMD321 exp(VectorSIMD321 a){
		double a_d[321]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD321 sqrt(VectorSIMD321 a){
		double a_d[321]; a.convert(a_d);
