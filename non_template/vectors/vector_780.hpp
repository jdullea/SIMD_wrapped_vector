...
public:
		...
		VectorSIMD780& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD780& operator += (VectorSIMD780 a){
	...
	inline VectorSIMD780 operator*(double a, VectorSIMD780 b){
		VectorSIMD780 c;
	...
	inline VectorSIMD780 operator*(VectorSIMD780 a ,double b){
		VectorSIMD780 c;
	...
	inline VectorSIMD780 operator*(int a, VectorSIMD780 b){
		if(a==1){return b;}
		VectorSIMD780 c;
	...
	inline VectorSIMD780 operator*(VectorSIMD780 a, int b){
		if(b==1){return a;}
		VectorSIMD780 c;
	...
	inline VectorSIMD780 operator*(VectorSIMD780 a, VectorSIMD780 b){
		VectorSIMD780 c;
	...
	inline VectorSIMD780 exp(VectorSIMD780 a){
		double a_d[780]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD780 sqrt(VectorSIMD780 a){
		double a_d[780]; a.convert(a_d);
