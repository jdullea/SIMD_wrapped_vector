...
public:
		...
		VectorSIMD327(double a){
			...
			_avx81=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD327(double (&a)[327]){
		...
		VectorSIMD327& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD327& operator += (VectorSIMD327 a){
	...
	inline VectorSIMD327 operator*(double a, VectorSIMD327 b){
		VectorSIMD327 c;
	...
	inline VectorSIMD327 operator*(VectorSIMD327 a ,double b){
		VectorSIMD327 c;
	...
	inline VectorSIMD327 operator*(int a, VectorSIMD327 b){
		if(a==1){return b;}
		VectorSIMD327 c;
	...
	inline VectorSIMD327 operator*(VectorSIMD327 a, int b){
		if(b==1){return a;}
		VectorSIMD327 c;
	...
	inline VectorSIMD327 operator*(VectorSIMD327 a, VectorSIMD327 b){
		VectorSIMD327 c;
	...
	inline VectorSIMD327 exp(VectorSIMD327 a){
		double a_d[327]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD327 sqrt(VectorSIMD327 a){
		double a_d[327]; a.convert(a_d);
