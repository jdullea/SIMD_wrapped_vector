...
public:
		...
		VectorSIMD824& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD824& operator += (VectorSIMD824 a){
	...
	inline VectorSIMD824 operator*(double a, VectorSIMD824 b){
		VectorSIMD824 c;
	...
	inline VectorSIMD824 operator*(VectorSIMD824 a ,double b){
		VectorSIMD824 c;
	...
	inline VectorSIMD824 operator*(int a, VectorSIMD824 b){
		if(a==1){return b;}
		VectorSIMD824 c;
	...
	inline VectorSIMD824 operator*(VectorSIMD824 a, int b){
		if(b==1){return a;}
		VectorSIMD824 c;
	...
	inline VectorSIMD824 operator*(VectorSIMD824 a, VectorSIMD824 b){
		VectorSIMD824 c;
	...
	inline VectorSIMD824 exp(VectorSIMD824 a){
		double a_d[824]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD824 sqrt(VectorSIMD824 a){
		double a_d[824]; a.convert(a_d);
