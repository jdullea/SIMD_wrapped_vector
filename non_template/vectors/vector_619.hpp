...
public:
		...
		VectorSIMD619(double a){
			...
			_avx154=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD619(double (&a)[619]){
		...
		VectorSIMD619& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD619& operator += (VectorSIMD619 a){
	...
	inline VectorSIMD619 operator*(double a, VectorSIMD619 b){
		VectorSIMD619 c;
	...
	inline VectorSIMD619 operator*(VectorSIMD619 a ,double b){
		VectorSIMD619 c;
	...
	inline VectorSIMD619 operator*(int a, VectorSIMD619 b){
		if(a==1){return b;}
		VectorSIMD619 c;
	...
	inline VectorSIMD619 operator*(VectorSIMD619 a, int b){
		if(b==1){return a;}
		VectorSIMD619 c;
	...
	inline VectorSIMD619 operator*(VectorSIMD619 a, VectorSIMD619 b){
		VectorSIMD619 c;
	...
	inline VectorSIMD619 exp(VectorSIMD619 a){
		double a_d[619]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD619 sqrt(VectorSIMD619 a){
		double a_d[619]; a.convert(a_d);
