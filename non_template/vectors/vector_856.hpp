...
public:
		...
		VectorSIMD856& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD856& operator += (VectorSIMD856 a){
	...
	inline VectorSIMD856 operator*(double a, VectorSIMD856 b){
		VectorSIMD856 c;
	...
	inline VectorSIMD856 operator*(VectorSIMD856 a ,double b){
		VectorSIMD856 c;
	...
	inline VectorSIMD856 operator*(int a, VectorSIMD856 b){
		if(a==1){return b;}
		VectorSIMD856 c;
	...
	inline VectorSIMD856 operator*(VectorSIMD856 a, int b){
		if(b==1){return a;}
		VectorSIMD856 c;
	...
	inline VectorSIMD856 operator*(VectorSIMD856 a, VectorSIMD856 b){
		VectorSIMD856 c;
	...
	inline VectorSIMD856 exp(VectorSIMD856 a){
		double a_d[856]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD856 sqrt(VectorSIMD856 a){
		double a_d[856]; a.convert(a_d);
