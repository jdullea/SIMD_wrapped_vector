...
public:
		...
		VectorSIMD316& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD316& operator += (VectorSIMD316 a){
	...
	inline VectorSIMD316 operator*(double a, VectorSIMD316 b){
		VectorSIMD316 c;
	...
	inline VectorSIMD316 operator*(VectorSIMD316 a ,double b){
		VectorSIMD316 c;
	...
	inline VectorSIMD316 operator*(int a, VectorSIMD316 b){
		if(a==1){return b;}
		VectorSIMD316 c;
	...
	inline VectorSIMD316 operator*(VectorSIMD316 a, int b){
		if(b==1){return a;}
		VectorSIMD316 c;
	...
	inline VectorSIMD316 operator*(VectorSIMD316 a, VectorSIMD316 b){
		VectorSIMD316 c;
	...
	inline VectorSIMD316 exp(VectorSIMD316 a){
		double a_d[316]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD316 sqrt(VectorSIMD316 a){
		double a_d[316]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD316 a){ 
		double ad[316];
		a.convert(ad);
