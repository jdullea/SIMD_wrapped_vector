...
public:
		...
		VectorSIMD997(double a){
			...
			_avx249=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD997(double (&a)[997]){
		...
		VectorSIMD997& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD997& operator += (VectorSIMD997 a){
	...
	inline VectorSIMD997 operator*(double a, VectorSIMD997 b){
		VectorSIMD997 c;
	...
	inline VectorSIMD997 operator*(VectorSIMD997 a ,double b){
		VectorSIMD997 c;
	...
	inline VectorSIMD997 operator*(int a, VectorSIMD997 b){
		if(a==1){return b;}
		VectorSIMD997 c;
	...
	inline VectorSIMD997 operator*(VectorSIMD997 a, int b){
		if(b==1){return a;}
		VectorSIMD997 c;
	...
	inline VectorSIMD997 operator*(VectorSIMD997 a, VectorSIMD997 b){
		VectorSIMD997 c;
	...
	inline VectorSIMD997 exp(VectorSIMD997 a){
		double a_d[997]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD997 sqrt(VectorSIMD997 a){
		double a_d[997]; a.convert(a_d);
