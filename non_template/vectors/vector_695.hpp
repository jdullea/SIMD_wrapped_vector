...
public:
		...
		VectorSIMD695(double a){
			...
			_avx173=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD695(double (&a)[695]){
		...
		VectorSIMD695& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD695& operator += (VectorSIMD695 a){
	...
	inline VectorSIMD695 operator*(double a, VectorSIMD695 b){
		VectorSIMD695 c;
	...
	inline VectorSIMD695 operator*(VectorSIMD695 a ,double b){
		VectorSIMD695 c;
	...
	inline VectorSIMD695 operator*(int a, VectorSIMD695 b){
		if(a==1){return b;}
		VectorSIMD695 c;
	...
	inline VectorSIMD695 operator*(VectorSIMD695 a, int b){
		if(b==1){return a;}
		VectorSIMD695 c;
	...
	inline VectorSIMD695 operator*(VectorSIMD695 a, VectorSIMD695 b){
		VectorSIMD695 c;
	...
	inline VectorSIMD695 exp(VectorSIMD695 a){
		double a_d[695]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD695 sqrt(VectorSIMD695 a){
		double a_d[695]; a.convert(a_d);
