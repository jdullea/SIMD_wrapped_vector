...
public:
		...
		VectorSIMD236& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD236& operator += (VectorSIMD236 a){
	...
	inline VectorSIMD236 operator*(double a, VectorSIMD236 b){
		VectorSIMD236 c;
	...
	inline VectorSIMD236 operator*(VectorSIMD236 a ,double b){
		VectorSIMD236 c;
	...
	inline VectorSIMD236 operator*(int a, VectorSIMD236 b){
		if(a==1){return b;}
		VectorSIMD236 c;
	...
	inline VectorSIMD236 operator*(VectorSIMD236 a, int b){
		if(b==1){return a;}
		VectorSIMD236 c;
	...
	inline VectorSIMD236 operator*(VectorSIMD236 a, VectorSIMD236 b){
		VectorSIMD236 c;
	...
	inline VectorSIMD236 exp(VectorSIMD236 a){
		double a_d[236]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD236 sqrt(VectorSIMD236 a){
		double a_d[236]; a.convert(a_d);
