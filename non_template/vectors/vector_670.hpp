...
public:
		...
		VectorSIMD670(double a){
			...
			_avx167=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD670(double (&a)[670]){
		...
		VectorSIMD670& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD670& operator += (VectorSIMD670 a){
	...
	inline VectorSIMD670 operator*(double a, VectorSIMD670 b){
		VectorSIMD670 c;
	...
	inline VectorSIMD670 operator*(VectorSIMD670 a ,double b){
		VectorSIMD670 c;
	...
	inline VectorSIMD670 operator*(int a, VectorSIMD670 b){
		if(a==1){return b;}
		VectorSIMD670 c;
	...
	inline VectorSIMD670 operator*(VectorSIMD670 a, int b){
		if(b==1){return a;}
		VectorSIMD670 c;
	...
	inline VectorSIMD670 operator*(VectorSIMD670 a, VectorSIMD670 b){
		VectorSIMD670 c;
	...
	inline VectorSIMD670 exp(VectorSIMD670 a){
		double a_d[670]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD670 sqrt(VectorSIMD670 a){
		double a_d[670]; a.convert(a_d);
