...
public:
		...
		VectorSIMD478(double a){
			...
			_avx119=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD478(double (&a)[478]){
		...
		VectorSIMD478& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD478& operator += (VectorSIMD478 a){
	...
	inline VectorSIMD478 operator*(double a, VectorSIMD478 b){
		VectorSIMD478 c;
	...
	inline VectorSIMD478 operator*(VectorSIMD478 a ,double b){
		VectorSIMD478 c;
	...
	inline VectorSIMD478 operator*(int a, VectorSIMD478 b){
		if(a==1){return b;}
		VectorSIMD478 c;
	...
	inline VectorSIMD478 operator*(VectorSIMD478 a, int b){
		if(b==1){return a;}
		VectorSIMD478 c;
	...
	inline VectorSIMD478 operator*(VectorSIMD478 a, VectorSIMD478 b){
		VectorSIMD478 c;
	...
	inline VectorSIMD478 exp(VectorSIMD478 a){
		double a_d[478]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD478 sqrt(VectorSIMD478 a){
		double a_d[478]; a.convert(a_d);
