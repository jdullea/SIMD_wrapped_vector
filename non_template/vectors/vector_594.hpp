...
public:
		...
		VectorSIMD594(double a){
			...
			_avx148=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD594(double (&a)[594]){
		...
		VectorSIMD594& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD594& operator += (VectorSIMD594 a){
	...
	inline VectorSIMD594 operator*(double a, VectorSIMD594 b){
		VectorSIMD594 c;
	...
	inline VectorSIMD594 operator*(VectorSIMD594 a ,double b){
		VectorSIMD594 c;
	...
	inline VectorSIMD594 operator*(int a, VectorSIMD594 b){
		if(a==1){return b;}
		VectorSIMD594 c;
	...
	inline VectorSIMD594 operator*(VectorSIMD594 a, int b){
		if(b==1){return a;}
		VectorSIMD594 c;
	...
	inline VectorSIMD594 operator*(VectorSIMD594 a, VectorSIMD594 b){
		VectorSIMD594 c;
	...
	inline VectorSIMD594 exp(VectorSIMD594 a){
		double a_d[594]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD594 sqrt(VectorSIMD594 a){
		double a_d[594]; a.convert(a_d);
