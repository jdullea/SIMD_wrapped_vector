...
public:
		...
		VectorSIMD725(double a){
			...
			_avx181=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD725(double (&a)[725]){
		...
		VectorSIMD725& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD725& operator += (VectorSIMD725 a){
	...
	inline VectorSIMD725 operator*(double a, VectorSIMD725 b){
		VectorSIMD725 c;
	...
	inline VectorSIMD725 operator*(VectorSIMD725 a ,double b){
		VectorSIMD725 c;
	...
	inline VectorSIMD725 operator*(int a, VectorSIMD725 b){
		if(a==1){return b;}
		VectorSIMD725 c;
	...
	inline VectorSIMD725 operator*(VectorSIMD725 a, int b){
		if(b==1){return a;}
		VectorSIMD725 c;
	...
	inline VectorSIMD725 operator*(VectorSIMD725 a, VectorSIMD725 b){
		VectorSIMD725 c;
	...
	inline VectorSIMD725 exp(VectorSIMD725 a){
		double a_d[725]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD725 sqrt(VectorSIMD725 a){
		double a_d[725]; a.convert(a_d);
