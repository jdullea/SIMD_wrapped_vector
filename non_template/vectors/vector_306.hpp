...
public:
		...
		VectorSIMD306(double a){
			...
			_avx76=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD306(double (&a)[306]){
		...
		VectorSIMD306& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD306& operator += (VectorSIMD306 a){
	...
	inline VectorSIMD306 operator*(double a, VectorSIMD306 b){
		VectorSIMD306 c;
	...
	inline VectorSIMD306 operator*(VectorSIMD306 a ,double b){
		VectorSIMD306 c;
	...
	inline VectorSIMD306 operator*(int a, VectorSIMD306 b){
		if(a==1){return b;}
		VectorSIMD306 c;
	...
	inline VectorSIMD306 operator*(VectorSIMD306 a, int b){
		if(b==1){return a;}
		VectorSIMD306 c;
	...
	inline VectorSIMD306 operator*(VectorSIMD306 a, VectorSIMD306 b){
		VectorSIMD306 c;
	...
	inline VectorSIMD306 exp(VectorSIMD306 a){
		double a_d[306]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD306 sqrt(VectorSIMD306 a){
		double a_d[306]; a.convert(a_d);
