...
public:
		...
		VectorSIMD627(double a){
			...
			_avx156=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD627(double (&a)[627]){
		...
		VectorSIMD627& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD627& operator += (VectorSIMD627 a){
	...
	inline VectorSIMD627 operator*(double a, VectorSIMD627 b){
		VectorSIMD627 c;
	...
	inline VectorSIMD627 operator*(VectorSIMD627 a ,double b){
		VectorSIMD627 c;
	...
	inline VectorSIMD627 operator*(int a, VectorSIMD627 b){
		if(a==1){return b;}
		VectorSIMD627 c;
	...
	inline VectorSIMD627 operator*(VectorSIMD627 a, int b){
		if(b==1){return a;}
		VectorSIMD627 c;
	...
	inline VectorSIMD627 operator*(VectorSIMD627 a, VectorSIMD627 b){
		VectorSIMD627 c;
	...
	inline VectorSIMD627 exp(VectorSIMD627 a){
		double a_d[627]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD627 sqrt(VectorSIMD627 a){
		double a_d[627]; a.convert(a_d);
