...
public:
		...
		VectorSIMD963(double a){
			...
			_avx240=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD963(double (&a)[963]){
		...
		VectorSIMD963& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD963& operator += (VectorSIMD963 a){
	...
	inline VectorSIMD963 operator*(double a, VectorSIMD963 b){
		VectorSIMD963 c;
	...
	inline VectorSIMD963 operator*(VectorSIMD963 a ,double b){
		VectorSIMD963 c;
	...
	inline VectorSIMD963 operator*(int a, VectorSIMD963 b){
		if(a==1){return b;}
		VectorSIMD963 c;
	...
	inline VectorSIMD963 operator*(VectorSIMD963 a, int b){
		if(b==1){return a;}
		VectorSIMD963 c;
	...
	inline VectorSIMD963 operator*(VectorSIMD963 a, VectorSIMD963 b){
		VectorSIMD963 c;
	...
	inline VectorSIMD963 exp(VectorSIMD963 a){
		double a_d[963]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD963 sqrt(VectorSIMD963 a){
		double a_d[963]; a.convert(a_d);
