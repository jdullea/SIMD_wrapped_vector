...
public:
		...
		VectorSIMD284& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD284& operator += (VectorSIMD284 a){
	...
	inline VectorSIMD284 operator*(double a, VectorSIMD284 b){
		VectorSIMD284 c;
	...
	inline VectorSIMD284 operator*(VectorSIMD284 a ,double b){
		VectorSIMD284 c;
	...
	inline VectorSIMD284 operator*(int a, VectorSIMD284 b){
		if(a==1){return b;}
		VectorSIMD284 c;
	...
	inline VectorSIMD284 operator*(VectorSIMD284 a, int b){
		if(b==1){return a;}
		VectorSIMD284 c;
	...
	inline VectorSIMD284 operator*(VectorSIMD284 a, VectorSIMD284 b){
		VectorSIMD284 c;
	...
	inline VectorSIMD284 exp(VectorSIMD284 a){
		double a_d[284]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD284 sqrt(VectorSIMD284 a){
		double a_d[284]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD284 a){ 
		double ad[284];
		a.convert(ad);
