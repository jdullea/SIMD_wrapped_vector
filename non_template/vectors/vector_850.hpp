...
public:
		...
		VectorSIMD850(double a){
			...
			_avx212=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD850(double (&a)[850]){
		...
		VectorSIMD850& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD850& operator += (VectorSIMD850 a){
	...
	inline VectorSIMD850 operator*(double a, VectorSIMD850 b){
		VectorSIMD850 c;
	...
	inline VectorSIMD850 operator*(VectorSIMD850 a ,double b){
		VectorSIMD850 c;
	...
	inline VectorSIMD850 operator*(int a, VectorSIMD850 b){
		if(a==1){return b;}
		VectorSIMD850 c;
	...
	inline VectorSIMD850 operator*(VectorSIMD850 a, int b){
		if(b==1){return a;}
		VectorSIMD850 c;
	...
	inline VectorSIMD850 operator*(VectorSIMD850 a, VectorSIMD850 b){
		VectorSIMD850 c;
	...
	inline VectorSIMD850 exp(VectorSIMD850 a){
		double a_d[850]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD850 sqrt(VectorSIMD850 a){
		double a_d[850]; a.convert(a_d);
