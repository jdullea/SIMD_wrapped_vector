...
public:
		...
		VectorSIMD848& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD848& operator += (VectorSIMD848 a){
	...
	inline VectorSIMD848 operator*(double a, VectorSIMD848 b){
		VectorSIMD848 c;
	...
	inline VectorSIMD848 operator*(VectorSIMD848 a ,double b){
		VectorSIMD848 c;
	...
	inline VectorSIMD848 operator*(int a, VectorSIMD848 b){
		if(a==1){return b;}
		VectorSIMD848 c;
	...
	inline VectorSIMD848 operator*(VectorSIMD848 a, int b){
		if(b==1){return a;}
		VectorSIMD848 c;
	...
	inline VectorSIMD848 operator*(VectorSIMD848 a, VectorSIMD848 b){
		VectorSIMD848 c;
	...
	inline VectorSIMD848 exp(VectorSIMD848 a){
		double a_d[848]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD848 sqrt(VectorSIMD848 a){
		double a_d[848]; a.convert(a_d);
