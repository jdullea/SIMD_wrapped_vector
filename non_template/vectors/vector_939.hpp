...
public:
		...
		VectorSIMD939(double a){
			...
			_avx234=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD939(double (&a)[939]){
		...
		VectorSIMD939& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD939& operator += (VectorSIMD939 a){
	...
	inline VectorSIMD939 operator*(double a, VectorSIMD939 b){
		VectorSIMD939 c;
	...
	inline VectorSIMD939 operator*(VectorSIMD939 a ,double b){
		VectorSIMD939 c;
	...
	inline VectorSIMD939 operator*(int a, VectorSIMD939 b){
		if(a==1){return b;}
		VectorSIMD939 c;
	...
	inline VectorSIMD939 operator*(VectorSIMD939 a, int b){
		if(b==1){return a;}
		VectorSIMD939 c;
	...
	inline VectorSIMD939 operator*(VectorSIMD939 a, VectorSIMD939 b){
		VectorSIMD939 c;
	...
	inline VectorSIMD939 exp(VectorSIMD939 a){
		double a_d[939]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD939 sqrt(VectorSIMD939 a){
		double a_d[939]; a.convert(a_d);
