...
public:
		...
		VectorSIMD430(double a){
			...
			_avx107=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD430(double (&a)[430]){
		...
		VectorSIMD430& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD430& operator += (VectorSIMD430 a){
	...
	inline VectorSIMD430 operator*(double a, VectorSIMD430 b){
		VectorSIMD430 c;
	...
	inline VectorSIMD430 operator*(VectorSIMD430 a ,double b){
		VectorSIMD430 c;
	...
	inline VectorSIMD430 operator*(int a, VectorSIMD430 b){
		if(a==1){return b;}
		VectorSIMD430 c;
	...
	inline VectorSIMD430 operator*(VectorSIMD430 a, int b){
		if(b==1){return a;}
		VectorSIMD430 c;
	...
	inline VectorSIMD430 operator*(VectorSIMD430 a, VectorSIMD430 b){
		VectorSIMD430 c;
	...
	inline VectorSIMD430 exp(VectorSIMD430 a){
		double a_d[430]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD430 sqrt(VectorSIMD430 a){
		double a_d[430]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD430 a){ 
		double ad[430];
		a.convert(ad);
