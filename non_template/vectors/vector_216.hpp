...
public:
		...
		VectorSIMD216& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD216& operator += (VectorSIMD216 a){
	...
	inline VectorSIMD216 operator*(double a, VectorSIMD216 b){
		VectorSIMD216 c;
	...
	inline VectorSIMD216 operator*(VectorSIMD216 a ,double b){
		VectorSIMD216 c;
	...
	inline VectorSIMD216 operator*(int a, VectorSIMD216 b){
		if(a==1){return b;}
		VectorSIMD216 c;
	...
	inline VectorSIMD216 operator*(VectorSIMD216 a, int b){
		if(b==1){return a;}
		VectorSIMD216 c;
	...
	inline VectorSIMD216 operator*(VectorSIMD216 a, VectorSIMD216 b){
		VectorSIMD216 c;
	...
	inline VectorSIMD216 exp(VectorSIMD216 a){
		double a_d[216]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD216 sqrt(VectorSIMD216 a){
		double a_d[216]; a.convert(a_d);
