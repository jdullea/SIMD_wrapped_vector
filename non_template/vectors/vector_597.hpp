...
public:
		...
		VectorSIMD597(double a){
			...
			_avx149=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD597(double (&a)[597]){
		...
		VectorSIMD597& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD597& operator += (VectorSIMD597 a){
	...
	inline VectorSIMD597 operator*(double a, VectorSIMD597 b){
		VectorSIMD597 c;
	...
	inline VectorSIMD597 operator*(VectorSIMD597 a ,double b){
		VectorSIMD597 c;
	...
	inline VectorSIMD597 operator*(int a, VectorSIMD597 b){
		if(a==1){return b;}
		VectorSIMD597 c;
	...
	inline VectorSIMD597 operator*(VectorSIMD597 a, int b){
		if(b==1){return a;}
		VectorSIMD597 c;
	...
	inline VectorSIMD597 operator*(VectorSIMD597 a, VectorSIMD597 b){
		VectorSIMD597 c;
	...
	inline VectorSIMD597 exp(VectorSIMD597 a){
		double a_d[597]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD597 sqrt(VectorSIMD597 a){
		double a_d[597]; a.convert(a_d);
