...
public:
		...
		VectorSIMD589(double a){
			...
			_avx147=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD589(double (&a)[589]){
		...
		VectorSIMD589& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD589& operator += (VectorSIMD589 a){
	...
	inline VectorSIMD589 operator*(double a, VectorSIMD589 b){
		VectorSIMD589 c;
	...
	inline VectorSIMD589 operator*(VectorSIMD589 a ,double b){
		VectorSIMD589 c;
	...
	inline VectorSIMD589 operator*(int a, VectorSIMD589 b){
		if(a==1){return b;}
		VectorSIMD589 c;
	...
	inline VectorSIMD589 operator*(VectorSIMD589 a, int b){
		if(b==1){return a;}
		VectorSIMD589 c;
	...
	inline VectorSIMD589 operator*(VectorSIMD589 a, VectorSIMD589 b){
		VectorSIMD589 c;
	...
	inline VectorSIMD589 exp(VectorSIMD589 a){
		double a_d[589]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD589 sqrt(VectorSIMD589 a){
		double a_d[589]; a.convert(a_d);
