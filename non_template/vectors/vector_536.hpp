...
public:
		...
		VectorSIMD536& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD536& operator += (VectorSIMD536 a){
	...
	inline VectorSIMD536 operator*(double a, VectorSIMD536 b){
		VectorSIMD536 c;
	...
	inline VectorSIMD536 operator*(VectorSIMD536 a ,double b){
		VectorSIMD536 c;
	...
	inline VectorSIMD536 operator*(int a, VectorSIMD536 b){
		if(a==1){return b;}
		VectorSIMD536 c;
	...
	inline VectorSIMD536 operator*(VectorSIMD536 a, int b){
		if(b==1){return a;}
		VectorSIMD536 c;
	...
	inline VectorSIMD536 operator*(VectorSIMD536 a, VectorSIMD536 b){
		VectorSIMD536 c;
	...
	inline VectorSIMD536 exp(VectorSIMD536 a){
		double a_d[536]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD536 sqrt(VectorSIMD536 a){
		double a_d[536]; a.convert(a_d);
