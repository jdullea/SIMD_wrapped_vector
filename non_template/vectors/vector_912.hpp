...
public:
		...
		VectorSIMD912& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD912& operator += (VectorSIMD912 a){
	...
	inline VectorSIMD912 operator*(double a, VectorSIMD912 b){
		VectorSIMD912 c;
	...
	inline VectorSIMD912 operator*(VectorSIMD912 a ,double b){
		VectorSIMD912 c;
	...
	inline VectorSIMD912 operator*(int a, VectorSIMD912 b){
		if(a==1){return b;}
		VectorSIMD912 c;
	...
	inline VectorSIMD912 operator*(VectorSIMD912 a, int b){
		if(b==1){return a;}
		VectorSIMD912 c;
	...
	inline VectorSIMD912 operator*(VectorSIMD912 a, VectorSIMD912 b){
		VectorSIMD912 c;
	...
	inline VectorSIMD912 exp(VectorSIMD912 a){
		double a_d[912]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD912 sqrt(VectorSIMD912 a){
		double a_d[912]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD912 a){ 
		double ad[912];
		a.convert(ad);
