...
public:
		...
		VectorSIMD474(double a){
			...
			_avx118=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD474(double (&a)[474]){
		...
		VectorSIMD474& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD474& operator += (VectorSIMD474 a){
	...
	inline VectorSIMD474 operator*(double a, VectorSIMD474 b){
		VectorSIMD474 c;
	...
	inline VectorSIMD474 operator*(VectorSIMD474 a ,double b){
		VectorSIMD474 c;
	...
	inline VectorSIMD474 operator*(int a, VectorSIMD474 b){
		if(a==1){return b;}
		VectorSIMD474 c;
	...
	inline VectorSIMD474 operator*(VectorSIMD474 a, int b){
		if(b==1){return a;}
		VectorSIMD474 c;
	...
	inline VectorSIMD474 operator*(VectorSIMD474 a, VectorSIMD474 b){
		VectorSIMD474 c;
	...
	inline VectorSIMD474 exp(VectorSIMD474 a){
		double a_d[474]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD474 sqrt(VectorSIMD474 a){
		double a_d[474]; a.convert(a_d);
