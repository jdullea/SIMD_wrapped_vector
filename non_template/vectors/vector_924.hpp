...
public:
		...
		VectorSIMD924& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD924& operator += (VectorSIMD924 a){
	...
	inline VectorSIMD924 operator*(double a, VectorSIMD924 b){
		VectorSIMD924 c;
	...
	inline VectorSIMD924 operator*(VectorSIMD924 a ,double b){
		VectorSIMD924 c;
	...
	inline VectorSIMD924 operator*(int a, VectorSIMD924 b){
		if(a==1){return b;}
		VectorSIMD924 c;
	...
	inline VectorSIMD924 operator*(VectorSIMD924 a, int b){
		if(b==1){return a;}
		VectorSIMD924 c;
	...
	inline VectorSIMD924 operator*(VectorSIMD924 a, VectorSIMD924 b){
		VectorSIMD924 c;
	...
	inline VectorSIMD924 exp(VectorSIMD924 a){
		double a_d[924]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD924 sqrt(VectorSIMD924 a){
		double a_d[924]; a.convert(a_d);
