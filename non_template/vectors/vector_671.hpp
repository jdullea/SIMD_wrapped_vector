...
public:
		...
		VectorSIMD671(double a){
			...
			_avx167=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD671(double (&a)[671]){
		...
		VectorSIMD671& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD671& operator += (VectorSIMD671 a){
	...
	inline VectorSIMD671 operator*(double a, VectorSIMD671 b){
		VectorSIMD671 c;
	...
	inline VectorSIMD671 operator*(VectorSIMD671 a ,double b){
		VectorSIMD671 c;
	...
	inline VectorSIMD671 operator*(int a, VectorSIMD671 b){
		if(a==1){return b;}
		VectorSIMD671 c;
	...
	inline VectorSIMD671 operator*(VectorSIMD671 a, int b){
		if(b==1){return a;}
		VectorSIMD671 c;
	...
	inline VectorSIMD671 operator*(VectorSIMD671 a, VectorSIMD671 b){
		VectorSIMD671 c;
	...
	inline VectorSIMD671 exp(VectorSIMD671 a){
		double a_d[671]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD671 sqrt(VectorSIMD671 a){
		double a_d[671]; a.convert(a_d);
