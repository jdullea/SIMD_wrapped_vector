...
public:
		...
		VectorSIMD881(double a){
			...
			_avx220=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD881(double (&a)[881]){
		...
		VectorSIMD881& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD881& operator += (VectorSIMD881 a){
	...
	inline VectorSIMD881 operator*(double a, VectorSIMD881 b){
		VectorSIMD881 c;
	...
	inline VectorSIMD881 operator*(VectorSIMD881 a ,double b){
		VectorSIMD881 c;
	...
	inline VectorSIMD881 operator*(int a, VectorSIMD881 b){
		if(a==1){return b;}
		VectorSIMD881 c;
	...
	inline VectorSIMD881 operator*(VectorSIMD881 a, int b){
		if(b==1){return a;}
		VectorSIMD881 c;
	...
	inline VectorSIMD881 operator*(VectorSIMD881 a, VectorSIMD881 b){
		VectorSIMD881 c;
	...
	inline VectorSIMD881 exp(VectorSIMD881 a){
		double a_d[881]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD881 sqrt(VectorSIMD881 a){
		double a_d[881]; a.convert(a_d);
