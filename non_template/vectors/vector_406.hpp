...
public:
		...
		VectorSIMD406(double a){
			...
			_avx101=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD406(double (&a)[406]){
		...
		VectorSIMD406& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD406& operator += (VectorSIMD406 a){
	...
	inline VectorSIMD406 operator*(double a, VectorSIMD406 b){
		VectorSIMD406 c;
	...
	inline VectorSIMD406 operator*(VectorSIMD406 a ,double b){
		VectorSIMD406 c;
	...
	inline VectorSIMD406 operator*(int a, VectorSIMD406 b){
		if(a==1){return b;}
		VectorSIMD406 c;
	...
	inline VectorSIMD406 operator*(VectorSIMD406 a, int b){
		if(b==1){return a;}
		VectorSIMD406 c;
	...
	inline VectorSIMD406 operator*(VectorSIMD406 a, VectorSIMD406 b){
		VectorSIMD406 c;
	...
	inline VectorSIMD406 exp(VectorSIMD406 a){
		double a_d[406]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD406 sqrt(VectorSIMD406 a){
		double a_d[406]; a.convert(a_d);
