...
public:
		...
		VectorSIMD904& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD904& operator += (VectorSIMD904 a){
	...
	inline VectorSIMD904 operator*(double a, VectorSIMD904 b){
		VectorSIMD904 c;
	...
	inline VectorSIMD904 operator*(VectorSIMD904 a ,double b){
		VectorSIMD904 c;
	...
	inline VectorSIMD904 operator*(int a, VectorSIMD904 b){
		if(a==1){return b;}
		VectorSIMD904 c;
	...
	inline VectorSIMD904 operator*(VectorSIMD904 a, int b){
		if(b==1){return a;}
		VectorSIMD904 c;
	...
	inline VectorSIMD904 operator*(VectorSIMD904 a, VectorSIMD904 b){
		VectorSIMD904 c;
	...
	inline VectorSIMD904 exp(VectorSIMD904 a){
		double a_d[904]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD904 sqrt(VectorSIMD904 a){
		double a_d[904]; a.convert(a_d);
