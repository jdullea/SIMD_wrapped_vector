...
public:
		...
		VectorSIMD320& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD320& operator += (VectorSIMD320 a){
	...
	inline VectorSIMD320 operator*(double a, VectorSIMD320 b){
		VectorSIMD320 c;
	...
	inline VectorSIMD320 operator*(VectorSIMD320 a ,double b){
		VectorSIMD320 c;
	...
	inline VectorSIMD320 operator*(int a, VectorSIMD320 b){
		if(a==1){return b;}
		VectorSIMD320 c;
	...
	inline VectorSIMD320 operator*(VectorSIMD320 a, int b){
		if(b==1){return a;}
		VectorSIMD320 c;
	...
	inline VectorSIMD320 operator*(VectorSIMD320 a, VectorSIMD320 b){
		VectorSIMD320 c;
	...
	inline VectorSIMD320 exp(VectorSIMD320 a){
		double a_d[320]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD320 sqrt(VectorSIMD320 a){
		double a_d[320]; a.convert(a_d);
