...
public:
		...
		VectorSIMD464& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD464& operator += (VectorSIMD464 a){
	...
	inline VectorSIMD464 operator*(double a, VectorSIMD464 b){
		VectorSIMD464 c;
	...
	inline VectorSIMD464 operator*(VectorSIMD464 a ,double b){
		VectorSIMD464 c;
	...
	inline VectorSIMD464 operator*(int a, VectorSIMD464 b){
		if(a==1){return b;}
		VectorSIMD464 c;
	...
	inline VectorSIMD464 operator*(VectorSIMD464 a, int b){
		if(b==1){return a;}
		VectorSIMD464 c;
	...
	inline VectorSIMD464 operator*(VectorSIMD464 a, VectorSIMD464 b){
		VectorSIMD464 c;
	...
	inline VectorSIMD464 exp(VectorSIMD464 a){
		double a_d[464]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD464 sqrt(VectorSIMD464 a){
		double a_d[464]; a.convert(a_d);
