...
public:
		...
		VectorSIMD345(double a){
			...
			_avx86=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD345(double (&a)[345]){
		...
		VectorSIMD345& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD345& operator += (VectorSIMD345 a){
	...
	inline VectorSIMD345 operator*(double a, VectorSIMD345 b){
		VectorSIMD345 c;
	...
	inline VectorSIMD345 operator*(VectorSIMD345 a ,double b){
		VectorSIMD345 c;
	...
	inline VectorSIMD345 operator*(int a, VectorSIMD345 b){
		if(a==1){return b;}
		VectorSIMD345 c;
	...
	inline VectorSIMD345 operator*(VectorSIMD345 a, int b){
		if(b==1){return a;}
		VectorSIMD345 c;
	...
	inline VectorSIMD345 operator*(VectorSIMD345 a, VectorSIMD345 b){
		VectorSIMD345 c;
	...
	inline VectorSIMD345 exp(VectorSIMD345 a){
		double a_d[345]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD345 sqrt(VectorSIMD345 a){
		double a_d[345]; a.convert(a_d);
