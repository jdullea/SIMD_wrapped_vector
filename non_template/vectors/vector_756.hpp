...
public:
		...
		VectorSIMD756& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD756& operator += (VectorSIMD756 a){
	...
	inline VectorSIMD756 operator*(double a, VectorSIMD756 b){
		VectorSIMD756 c;
	...
	inline VectorSIMD756 operator*(VectorSIMD756 a ,double b){
		VectorSIMD756 c;
	...
	inline VectorSIMD756 operator*(int a, VectorSIMD756 b){
		if(a==1){return b;}
		VectorSIMD756 c;
	...
	inline VectorSIMD756 operator*(VectorSIMD756 a, int b){
		if(b==1){return a;}
		VectorSIMD756 c;
	...
	inline VectorSIMD756 operator*(VectorSIMD756 a, VectorSIMD756 b){
		VectorSIMD756 c;
	...
	inline VectorSIMD756 exp(VectorSIMD756 a){
		double a_d[756]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD756 sqrt(VectorSIMD756 a){
		double a_d[756]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD756 a){ 
		double ad[756];
		a.convert(ad);
