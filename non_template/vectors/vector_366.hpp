...
public:
		...
		VectorSIMD366(double a){
			...
			_avx91=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD366(double (&a)[366]){
		...
		VectorSIMD366& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD366& operator += (VectorSIMD366 a){
	...
	inline VectorSIMD366 operator*(double a, VectorSIMD366 b){
		VectorSIMD366 c;
	...
	inline VectorSIMD366 operator*(VectorSIMD366 a ,double b){
		VectorSIMD366 c;
	...
	inline VectorSIMD366 operator*(int a, VectorSIMD366 b){
		if(a==1){return b;}
		VectorSIMD366 c;
	...
	inline VectorSIMD366 operator*(VectorSIMD366 a, int b){
		if(b==1){return a;}
		VectorSIMD366 c;
	...
	inline VectorSIMD366 operator*(VectorSIMD366 a, VectorSIMD366 b){
		VectorSIMD366 c;
	...
	inline VectorSIMD366 exp(VectorSIMD366 a){
		double a_d[366]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD366 sqrt(VectorSIMD366 a){
		double a_d[366]; a.convert(a_d);
