...
public:
		...
		VectorSIMD457(double a){
			...
			_avx114=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD457(double (&a)[457]){
		...
		VectorSIMD457& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD457& operator += (VectorSIMD457 a){
	...
	inline VectorSIMD457 operator*(double a, VectorSIMD457 b){
		VectorSIMD457 c;
	...
	inline VectorSIMD457 operator*(VectorSIMD457 a ,double b){
		VectorSIMD457 c;
	...
	inline VectorSIMD457 operator*(int a, VectorSIMD457 b){
		if(a==1){return b;}
		VectorSIMD457 c;
	...
	inline VectorSIMD457 operator*(VectorSIMD457 a, int b){
		if(b==1){return a;}
		VectorSIMD457 c;
	...
	inline VectorSIMD457 operator*(VectorSIMD457 a, VectorSIMD457 b){
		VectorSIMD457 c;
	...
	inline VectorSIMD457 exp(VectorSIMD457 a){
		double a_d[457]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD457 sqrt(VectorSIMD457 a){
		double a_d[457]; a.convert(a_d);
