...
public:
		...
		VectorSIMD844& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD844& operator += (VectorSIMD844 a){
	...
	inline VectorSIMD844 operator*(double a, VectorSIMD844 b){
		VectorSIMD844 c;
	...
	inline VectorSIMD844 operator*(VectorSIMD844 a ,double b){
		VectorSIMD844 c;
	...
	inline VectorSIMD844 operator*(int a, VectorSIMD844 b){
		if(a==1){return b;}
		VectorSIMD844 c;
	...
	inline VectorSIMD844 operator*(VectorSIMD844 a, int b){
		if(b==1){return a;}
		VectorSIMD844 c;
	...
	inline VectorSIMD844 operator*(VectorSIMD844 a, VectorSIMD844 b){
		VectorSIMD844 c;
	...
	inline VectorSIMD844 exp(VectorSIMD844 a){
		double a_d[844]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD844 sqrt(VectorSIMD844 a){
		double a_d[844]; a.convert(a_d);
