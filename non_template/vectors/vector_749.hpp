...
public:
		...
		VectorSIMD749(double a){
			...
			_avx187=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD749(double (&a)[749]){
		...
		VectorSIMD749& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD749& operator += (VectorSIMD749 a){
	...
	inline VectorSIMD749 operator*(double a, VectorSIMD749 b){
		VectorSIMD749 c;
	...
	inline VectorSIMD749 operator*(VectorSIMD749 a ,double b){
		VectorSIMD749 c;
	...
	inline VectorSIMD749 operator*(int a, VectorSIMD749 b){
		if(a==1){return b;}
		VectorSIMD749 c;
	...
	inline VectorSIMD749 operator*(VectorSIMD749 a, int b){
		if(b==1){return a;}
		VectorSIMD749 c;
	...
	inline VectorSIMD749 operator*(VectorSIMD749 a, VectorSIMD749 b){
		VectorSIMD749 c;
	...
	inline VectorSIMD749 exp(VectorSIMD749 a){
		double a_d[749]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD749 sqrt(VectorSIMD749 a){
		double a_d[749]; a.convert(a_d);
