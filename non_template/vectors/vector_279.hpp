...
public:
		...
		VectorSIMD279(double a){
			...
			_avx69=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD279(double (&a)[279]){
		...
		VectorSIMD279& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD279& operator += (VectorSIMD279 a){
	...
	inline VectorSIMD279 operator*(double a, VectorSIMD279 b){
		VectorSIMD279 c;
	...
	inline VectorSIMD279 operator*(VectorSIMD279 a ,double b){
		VectorSIMD279 c;
	...
	inline VectorSIMD279 operator*(int a, VectorSIMD279 b){
		if(a==1){return b;}
		VectorSIMD279 c;
	...
	inline VectorSIMD279 operator*(VectorSIMD279 a, int b){
		if(b==1){return a;}
		VectorSIMD279 c;
	...
	inline VectorSIMD279 operator*(VectorSIMD279 a, VectorSIMD279 b){
		VectorSIMD279 c;
	...
	inline VectorSIMD279 exp(VectorSIMD279 a){
		double a_d[279]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD279 sqrt(VectorSIMD279 a){
		double a_d[279]; a.convert(a_d);
