...
public:
		...
		VectorSIMD949(double a){
			...
			_avx237=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD949(double (&a)[949]){
		...
		VectorSIMD949& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD949& operator += (VectorSIMD949 a){
	...
	inline VectorSIMD949 operator*(double a, VectorSIMD949 b){
		VectorSIMD949 c;
	...
	inline VectorSIMD949 operator*(VectorSIMD949 a ,double b){
		VectorSIMD949 c;
	...
	inline VectorSIMD949 operator*(int a, VectorSIMD949 b){
		if(a==1){return b;}
		VectorSIMD949 c;
	...
	inline VectorSIMD949 operator*(VectorSIMD949 a, int b){
		if(b==1){return a;}
		VectorSIMD949 c;
	...
	inline VectorSIMD949 operator*(VectorSIMD949 a, VectorSIMD949 b){
		VectorSIMD949 c;
	...
	inline VectorSIMD949 exp(VectorSIMD949 a){
		double a_d[949]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD949 sqrt(VectorSIMD949 a){
		double a_d[949]; a.convert(a_d);
