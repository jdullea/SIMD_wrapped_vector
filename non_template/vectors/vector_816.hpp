...
public:
		...
		VectorSIMD816& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD816& operator += (VectorSIMD816 a){
	...
	inline VectorSIMD816 operator*(double a, VectorSIMD816 b){
		VectorSIMD816 c;
	...
	inline VectorSIMD816 operator*(VectorSIMD816 a ,double b){
		VectorSIMD816 c;
	...
	inline VectorSIMD816 operator*(int a, VectorSIMD816 b){
		if(a==1){return b;}
		VectorSIMD816 c;
	...
	inline VectorSIMD816 operator*(VectorSIMD816 a, int b){
		if(b==1){return a;}
		VectorSIMD816 c;
	...
	inline VectorSIMD816 operator*(VectorSIMD816 a, VectorSIMD816 b){
		VectorSIMD816 c;
	...
	inline VectorSIMD816 exp(VectorSIMD816 a){
		double a_d[816]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD816 sqrt(VectorSIMD816 a){
		double a_d[816]; a.convert(a_d);
