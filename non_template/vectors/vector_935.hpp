...
public:
		...
		VectorSIMD935(double a){
			...
			_avx233=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD935(double (&a)[935]){
		...
		VectorSIMD935& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD935& operator += (VectorSIMD935 a){
	...
	inline VectorSIMD935 operator*(double a, VectorSIMD935 b){
		VectorSIMD935 c;
	...
	inline VectorSIMD935 operator*(VectorSIMD935 a ,double b){
		VectorSIMD935 c;
	...
	inline VectorSIMD935 operator*(int a, VectorSIMD935 b){
		if(a==1){return b;}
		VectorSIMD935 c;
	...
	inline VectorSIMD935 operator*(VectorSIMD935 a, int b){
		if(b==1){return a;}
		VectorSIMD935 c;
	...
	inline VectorSIMD935 operator*(VectorSIMD935 a, VectorSIMD935 b){
		VectorSIMD935 c;
	...
	inline VectorSIMD935 exp(VectorSIMD935 a){
		double a_d[935]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD935 sqrt(VectorSIMD935 a){
		double a_d[935]; a.convert(a_d);
