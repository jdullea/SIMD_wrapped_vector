...
public:
		...
		VectorSIMD717(double a){
			...
			_avx179=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD717(double (&a)[717]){
		...
		VectorSIMD717& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD717& operator += (VectorSIMD717 a){
	...
	inline VectorSIMD717 operator*(double a, VectorSIMD717 b){
		VectorSIMD717 c;
	...
	inline VectorSIMD717 operator*(VectorSIMD717 a ,double b){
		VectorSIMD717 c;
	...
	inline VectorSIMD717 operator*(int a, VectorSIMD717 b){
		if(a==1){return b;}
		VectorSIMD717 c;
	...
	inline VectorSIMD717 operator*(VectorSIMD717 a, int b){
		if(b==1){return a;}
		VectorSIMD717 c;
	...
	inline VectorSIMD717 operator*(VectorSIMD717 a, VectorSIMD717 b){
		VectorSIMD717 c;
	...
	inline VectorSIMD717 exp(VectorSIMD717 a){
		double a_d[717]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD717 sqrt(VectorSIMD717 a){
		double a_d[717]; a.convert(a_d);
