...
public:
		...
		VectorSIMD880& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD880& operator += (VectorSIMD880 a){
	...
	inline VectorSIMD880 operator*(double a, VectorSIMD880 b){
		VectorSIMD880 c;
	...
	inline VectorSIMD880 operator*(VectorSIMD880 a ,double b){
		VectorSIMD880 c;
	...
	inline VectorSIMD880 operator*(int a, VectorSIMD880 b){
		if(a==1){return b;}
		VectorSIMD880 c;
	...
	inline VectorSIMD880 operator*(VectorSIMD880 a, int b){
		if(b==1){return a;}
		VectorSIMD880 c;
	...
	inline VectorSIMD880 operator*(VectorSIMD880 a, VectorSIMD880 b){
		VectorSIMD880 c;
	...
	inline VectorSIMD880 exp(VectorSIMD880 a){
		double a_d[880]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD880 sqrt(VectorSIMD880 a){
		double a_d[880]; a.convert(a_d);
