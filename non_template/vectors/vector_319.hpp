...
public:
		...
		VectorSIMD319(double a){
			...
			_avx79=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD319(double (&a)[319]){
		...
		VectorSIMD319& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD319& operator += (VectorSIMD319 a){
	...
	inline VectorSIMD319 operator*(double a, VectorSIMD319 b){
		VectorSIMD319 c;
	...
	inline VectorSIMD319 operator*(VectorSIMD319 a ,double b){
		VectorSIMD319 c;
	...
	inline VectorSIMD319 operator*(int a, VectorSIMD319 b){
		if(a==1){return b;}
		VectorSIMD319 c;
	...
	inline VectorSIMD319 operator*(VectorSIMD319 a, int b){
		if(b==1){return a;}
		VectorSIMD319 c;
	...
	inline VectorSIMD319 operator*(VectorSIMD319 a, VectorSIMD319 b){
		VectorSIMD319 c;
	...
	inline VectorSIMD319 exp(VectorSIMD319 a){
		double a_d[319]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD319 sqrt(VectorSIMD319 a){
		double a_d[319]; a.convert(a_d);
