...
public:
		...
		VectorSIMD669(double a){
			...
			_avx167=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD669(double (&a)[669]){
		...
		VectorSIMD669& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD669& operator += (VectorSIMD669 a){
	...
	inline VectorSIMD669 operator*(double a, VectorSIMD669 b){
		VectorSIMD669 c;
	...
	inline VectorSIMD669 operator*(VectorSIMD669 a ,double b){
		VectorSIMD669 c;
	...
	inline VectorSIMD669 operator*(int a, VectorSIMD669 b){
		if(a==1){return b;}
		VectorSIMD669 c;
	...
	inline VectorSIMD669 operator*(VectorSIMD669 a, int b){
		if(b==1){return a;}
		VectorSIMD669 c;
	...
	inline VectorSIMD669 operator*(VectorSIMD669 a, VectorSIMD669 b){
		VectorSIMD669 c;
	...
	inline VectorSIMD669 exp(VectorSIMD669 a){
		double a_d[669]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD669 sqrt(VectorSIMD669 a){
		double a_d[669]; a.convert(a_d);
