...
public:
		...
		VectorSIMD1005(double a){
			...
			_avx251=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD1005(double (&a)[1005]){
		...
		VectorSIMD1005& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1005& operator += (VectorSIMD1005 a){
	...
	inline VectorSIMD1005 operator*(double a, VectorSIMD1005 b){
		VectorSIMD1005 c;
	...
	inline VectorSIMD1005 operator*(VectorSIMD1005 a ,double b){
		VectorSIMD1005 c;
	...
	inline VectorSIMD1005 operator*(int a, VectorSIMD1005 b){
		if(a==1){return b;}
		VectorSIMD1005 c;
	...
	inline VectorSIMD1005 operator*(VectorSIMD1005 a, int b){
		if(b==1){return a;}
		VectorSIMD1005 c;
	...
	inline VectorSIMD1005 operator*(VectorSIMD1005 a, VectorSIMD1005 b){
		VectorSIMD1005 c;
	...
	inline VectorSIMD1005 exp(VectorSIMD1005 a){
		double a_d[1005]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1005 r(a_d);
		return r;
	}

	inline VectorSIMD1005 sqrt(VectorSIMD1005 a){
		double a_d[1005]; a.convert(a_d);
