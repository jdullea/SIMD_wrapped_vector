...
public:
		...
		VectorSIMD852& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD852& operator += (VectorSIMD852 a){
	...
	inline VectorSIMD852 operator*(double a, VectorSIMD852 b){
		VectorSIMD852 c;
	...
	inline VectorSIMD852 operator*(VectorSIMD852 a ,double b){
		VectorSIMD852 c;
	...
	inline VectorSIMD852 operator*(int a, VectorSIMD852 b){
		if(a==1){return b;}
		VectorSIMD852 c;
	...
	inline VectorSIMD852 operator*(VectorSIMD852 a, int b){
		if(b==1){return a;}
		VectorSIMD852 c;
	...
	inline VectorSIMD852 operator*(VectorSIMD852 a, VectorSIMD852 b){
		VectorSIMD852 c;
	...
	inline VectorSIMD852 exp(VectorSIMD852 a){
		double a_d[852]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD852 sqrt(VectorSIMD852 a){
		double a_d[852]; a.convert(a_d);
