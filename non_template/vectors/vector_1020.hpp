...
public:
		...
		VectorSIMD1020& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD1020& operator += (VectorSIMD1020 a){
	...
	inline VectorSIMD1020 operator*(double a, VectorSIMD1020 b){
		VectorSIMD1020 c;
	...
	inline VectorSIMD1020 operator*(VectorSIMD1020 a ,double b){
		VectorSIMD1020 c;
	...
	inline VectorSIMD1020 operator*(int a, VectorSIMD1020 b){
		if(a==1){return b;}
		VectorSIMD1020 c;
	...
	inline VectorSIMD1020 operator*(VectorSIMD1020 a, int b){
		if(b==1){return a;}
		VectorSIMD1020 c;
	...
	inline VectorSIMD1020 operator*(VectorSIMD1020 a, VectorSIMD1020 b){
		VectorSIMD1020 c;
	...
	inline VectorSIMD1020 exp(VectorSIMD1020 a){
		double a_d[1020]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
		...
		VectorSIMD1020 r(a_d);
		return r;
	}

	inline VectorSIMD1020 sqrt(VectorSIMD1020 a){
		double a_d[1020]; a.convert(a_d);
