...
public:
		...
		VectorSIMD208& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD208& operator += (VectorSIMD208 a){
	...
	inline VectorSIMD208 operator*(double a, VectorSIMD208 b){
		VectorSIMD208 c;
	...
	inline VectorSIMD208 operator*(VectorSIMD208 a ,double b){
		VectorSIMD208 c;
	...
	inline VectorSIMD208 operator*(int a, VectorSIMD208 b){
		if(a==1){return b;}
		VectorSIMD208 c;
	...
	inline VectorSIMD208 operator*(VectorSIMD208 a, int b){
		if(b==1){return a;}
		VectorSIMD208 c;
	...
	inline VectorSIMD208 operator*(VectorSIMD208 a, VectorSIMD208 b){
		VectorSIMD208 c;
	...
	inline VectorSIMD208 exp(VectorSIMD208 a){
		double a_d[208]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD208 sqrt(VectorSIMD208 a){
		double a_d[208]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD208 a){ 
		double ad[208];
		a.convert(ad);
