...
public:
		...
		VectorSIMD985(double a){
			...
			_avx246=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD985(double (&a)[985]){
		...
		VectorSIMD985& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD985& operator += (VectorSIMD985 a){
	...
	inline VectorSIMD985 operator*(double a, VectorSIMD985 b){
		VectorSIMD985 c;
	...
	inline VectorSIMD985 operator*(VectorSIMD985 a ,double b){
		VectorSIMD985 c;
	...
	inline VectorSIMD985 operator*(int a, VectorSIMD985 b){
		if(a==1){return b;}
		VectorSIMD985 c;
	...
	inline VectorSIMD985 operator*(VectorSIMD985 a, int b){
		if(b==1){return a;}
		VectorSIMD985 c;
	...
	inline VectorSIMD985 operator*(VectorSIMD985 a, VectorSIMD985 b){
		VectorSIMD985 c;
	...
	inline VectorSIMD985 exp(VectorSIMD985 a){
		double a_d[985]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD985 sqrt(VectorSIMD985 a){
		double a_d[985]; a.convert(a_d);
