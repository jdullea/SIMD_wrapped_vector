...
public:
		...
		VectorSIMD476& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD476& operator += (VectorSIMD476 a){
	...
	inline VectorSIMD476 operator*(double a, VectorSIMD476 b){
		VectorSIMD476 c;
	...
	inline VectorSIMD476 operator*(VectorSIMD476 a ,double b){
		VectorSIMD476 c;
	...
	inline VectorSIMD476 operator*(int a, VectorSIMD476 b){
		if(a==1){return b;}
		VectorSIMD476 c;
	...
	inline VectorSIMD476 operator*(VectorSIMD476 a, int b){
		if(b==1){return a;}
		VectorSIMD476 c;
	...
	inline VectorSIMD476 operator*(VectorSIMD476 a, VectorSIMD476 b){
		VectorSIMD476 c;
	...
	inline VectorSIMD476 exp(VectorSIMD476 a){
		double a_d[476]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD476 sqrt(VectorSIMD476 a){
		double a_d[476]; a.convert(a_d);
