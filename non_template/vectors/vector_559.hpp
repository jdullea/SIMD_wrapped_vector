...
public:
		...
		VectorSIMD559(double a){
			...
			_avx139=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD559(double (&a)[559]){
		...
		VectorSIMD559& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD559& operator += (VectorSIMD559 a){
	...
	inline VectorSIMD559 operator*(double a, VectorSIMD559 b){
		VectorSIMD559 c;
	...
	inline VectorSIMD559 operator*(VectorSIMD559 a ,double b){
		VectorSIMD559 c;
	...
	inline VectorSIMD559 operator*(int a, VectorSIMD559 b){
		if(a==1){return b;}
		VectorSIMD559 c;
	...
	inline VectorSIMD559 operator*(VectorSIMD559 a, int b){
		if(b==1){return a;}
		VectorSIMD559 c;
	...
	inline VectorSIMD559 operator*(VectorSIMD559 a, VectorSIMD559 b){
		VectorSIMD559 c;
	...
	inline VectorSIMD559 exp(VectorSIMD559 a){
		double a_d[559]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD559 sqrt(VectorSIMD559 a){
		double a_d[559]; a.convert(a_d);
