...
public:
		...
		VectorSIMD926(double a){
			...
			_avx231=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD926(double (&a)[926]){
		...
		VectorSIMD926& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD926& operator += (VectorSIMD926 a){
	...
	inline VectorSIMD926 operator*(double a, VectorSIMD926 b){
		VectorSIMD926 c;
	...
	inline VectorSIMD926 operator*(VectorSIMD926 a ,double b){
		VectorSIMD926 c;
	...
	inline VectorSIMD926 operator*(int a, VectorSIMD926 b){
		if(a==1){return b;}
		VectorSIMD926 c;
	...
	inline VectorSIMD926 operator*(VectorSIMD926 a, int b){
		if(b==1){return a;}
		VectorSIMD926 c;
	...
	inline VectorSIMD926 operator*(VectorSIMD926 a, VectorSIMD926 b){
		VectorSIMD926 c;
	...
	inline VectorSIMD926 exp(VectorSIMD926 a){
		double a_d[926]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD926 sqrt(VectorSIMD926 a){
		double a_d[926]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD926 a){ 
		double ad[926];
		a.convert(ad);
