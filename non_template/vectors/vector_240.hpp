...
public:
		...
		VectorSIMD240& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD240& operator += (VectorSIMD240 a){
	...
	inline VectorSIMD240 operator*(double a, VectorSIMD240 b){
		VectorSIMD240 c;
	...
	inline VectorSIMD240 operator*(VectorSIMD240 a ,double b){
		VectorSIMD240 c;
	...
	inline VectorSIMD240 operator*(int a, VectorSIMD240 b){
		if(a==1){return b;}
		VectorSIMD240 c;
	...
	inline VectorSIMD240 operator*(VectorSIMD240 a, int b){
		if(b==1){return a;}
		VectorSIMD240 c;
	...
	inline VectorSIMD240 operator*(VectorSIMD240 a, VectorSIMD240 b){
		VectorSIMD240 c;
	...
	inline VectorSIMD240 exp(VectorSIMD240 a){
		double a_d[240]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD240 sqrt(VectorSIMD240 a){
		double a_d[240]; a.convert(a_d);
