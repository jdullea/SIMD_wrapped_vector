...
public:
		...
		VectorSIMD610(double a){
			...
			_avx152=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD610(double (&a)[610]){
		...
		VectorSIMD610& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD610& operator += (VectorSIMD610 a){
	...
	inline VectorSIMD610 operator*(double a, VectorSIMD610 b){
		VectorSIMD610 c;
	...
	inline VectorSIMD610 operator*(VectorSIMD610 a ,double b){
		VectorSIMD610 c;
	...
	inline VectorSIMD610 operator*(int a, VectorSIMD610 b){
		if(a==1){return b;}
		VectorSIMD610 c;
	...
	inline VectorSIMD610 operator*(VectorSIMD610 a, int b){
		if(b==1){return a;}
		VectorSIMD610 c;
	...
	inline VectorSIMD610 operator*(VectorSIMD610 a, VectorSIMD610 b){
		VectorSIMD610 c;
	...
	inline VectorSIMD610 exp(VectorSIMD610 a){
		double a_d[610]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD610 sqrt(VectorSIMD610 a){
		double a_d[610]; a.convert(a_d);
