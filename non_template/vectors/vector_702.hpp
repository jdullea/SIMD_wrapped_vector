...
public:
		...
		VectorSIMD702(double a){
			...
			_avx175=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD702(double (&a)[702]){
		...
		VectorSIMD702& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD702& operator += (VectorSIMD702 a){
	...
	inline VectorSIMD702 operator*(double a, VectorSIMD702 b){
		VectorSIMD702 c;
	...
	inline VectorSIMD702 operator*(VectorSIMD702 a ,double b){
		VectorSIMD702 c;
	...
	inline VectorSIMD702 operator*(int a, VectorSIMD702 b){
		if(a==1){return b;}
		VectorSIMD702 c;
	...
	inline VectorSIMD702 operator*(VectorSIMD702 a, int b){
		if(b==1){return a;}
		VectorSIMD702 c;
	...
	inline VectorSIMD702 operator*(VectorSIMD702 a, VectorSIMD702 b){
		VectorSIMD702 c;
	...
	inline VectorSIMD702 exp(VectorSIMD702 a){
		double a_d[702]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD702 sqrt(VectorSIMD702 a){
		double a_d[702]; a.convert(a_d);
