...
public:
		...
		VectorSIMD676& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD676& operator += (VectorSIMD676 a){
	...
	inline VectorSIMD676 operator*(double a, VectorSIMD676 b){
		VectorSIMD676 c;
	...
	inline VectorSIMD676 operator*(VectorSIMD676 a ,double b){
		VectorSIMD676 c;
	...
	inline VectorSIMD676 operator*(int a, VectorSIMD676 b){
		if(a==1){return b;}
		VectorSIMD676 c;
	...
	inline VectorSIMD676 operator*(VectorSIMD676 a, int b){
		if(b==1){return a;}
		VectorSIMD676 c;
	...
	inline VectorSIMD676 operator*(VectorSIMD676 a, VectorSIMD676 b){
		VectorSIMD676 c;
	...
	inline VectorSIMD676 exp(VectorSIMD676 a){
		double a_d[676]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD676 sqrt(VectorSIMD676 a){
		double a_d[676]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD676 a){ 
		double ad[676];
		a.convert(ad);
