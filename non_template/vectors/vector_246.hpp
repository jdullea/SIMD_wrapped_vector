...
public:
		...
		VectorSIMD246(double a){
			...
			_avx61=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD246(double (&a)[246]){
		...
		VectorSIMD246& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD246& operator += (VectorSIMD246 a){
	...
	inline VectorSIMD246 operator*(double a, VectorSIMD246 b){
		VectorSIMD246 c;
	...
	inline VectorSIMD246 operator*(VectorSIMD246 a ,double b){
		VectorSIMD246 c;
	...
	inline VectorSIMD246 operator*(int a, VectorSIMD246 b){
		if(a==1){return b;}
		VectorSIMD246 c;
	...
	inline VectorSIMD246 operator*(VectorSIMD246 a, int b){
		if(b==1){return a;}
		VectorSIMD246 c;
	...
	inline VectorSIMD246 operator*(VectorSIMD246 a, VectorSIMD246 b){
		VectorSIMD246 c;
	...
	inline VectorSIMD246 exp(VectorSIMD246 a){
		double a_d[246]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD246 sqrt(VectorSIMD246 a){
		double a_d[246]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD246 a){ 
		double ad[246];
		a.convert(ad);
