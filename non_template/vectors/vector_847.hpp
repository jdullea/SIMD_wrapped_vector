...
public:
		...
		VectorSIMD847(double a){
			...
			_avx211=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD847(double (&a)[847]){
		...
		VectorSIMD847& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD847& operator += (VectorSIMD847 a){
	...
	inline VectorSIMD847 operator*(double a, VectorSIMD847 b){
		VectorSIMD847 c;
	...
	inline VectorSIMD847 operator*(VectorSIMD847 a ,double b){
		VectorSIMD847 c;
	...
	inline VectorSIMD847 operator*(int a, VectorSIMD847 b){
		if(a==1){return b;}
		VectorSIMD847 c;
	...
	inline VectorSIMD847 operator*(VectorSIMD847 a, int b){
		if(b==1){return a;}
		VectorSIMD847 c;
	...
	inline VectorSIMD847 operator*(VectorSIMD847 a, VectorSIMD847 b){
		VectorSIMD847 c;
	...
	inline VectorSIMD847 exp(VectorSIMD847 a){
		double a_d[847]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD847 sqrt(VectorSIMD847 a){
		double a_d[847]; a.convert(a_d);
