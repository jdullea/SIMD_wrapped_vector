...
public:
		...
		VectorSIMD587(double a){
			...
			_avx146=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD587(double (&a)[587]){
		...
		VectorSIMD587& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD587& operator += (VectorSIMD587 a){
	...
	inline VectorSIMD587 operator*(double a, VectorSIMD587 b){
		VectorSIMD587 c;
	...
	inline VectorSIMD587 operator*(VectorSIMD587 a ,double b){
		VectorSIMD587 c;
	...
	inline VectorSIMD587 operator*(int a, VectorSIMD587 b){
		if(a==1){return b;}
		VectorSIMD587 c;
	...
	inline VectorSIMD587 operator*(VectorSIMD587 a, int b){
		if(b==1){return a;}
		VectorSIMD587 c;
	...
	inline VectorSIMD587 operator*(VectorSIMD587 a, VectorSIMD587 b){
		VectorSIMD587 c;
	...
	inline VectorSIMD587 exp(VectorSIMD587 a){
		double a_d[587]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD587 sqrt(VectorSIMD587 a){
		double a_d[587]; a.convert(a_d);
