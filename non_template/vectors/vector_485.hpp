...
public:
		...
		VectorSIMD485(double a){
			...
			_avx121=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD485(double (&a)[485]){
		...
		VectorSIMD485& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD485& operator += (VectorSIMD485 a){
	...
	inline VectorSIMD485 operator*(double a, VectorSIMD485 b){
		VectorSIMD485 c;
	...
	inline VectorSIMD485 operator*(VectorSIMD485 a ,double b){
		VectorSIMD485 c;
	...
	inline VectorSIMD485 operator*(int a, VectorSIMD485 b){
		if(a==1){return b;}
		VectorSIMD485 c;
	...
	inline VectorSIMD485 operator*(VectorSIMD485 a, int b){
		if(b==1){return a;}
		VectorSIMD485 c;
	...
	inline VectorSIMD485 operator*(VectorSIMD485 a, VectorSIMD485 b){
		VectorSIMD485 c;
	...
	inline VectorSIMD485 exp(VectorSIMD485 a){
		double a_d[485]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD485 sqrt(VectorSIMD485 a){
		double a_d[485]; a.convert(a_d);
