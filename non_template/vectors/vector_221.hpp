...
public:
		...
		VectorSIMD221(double a){
			...
			_avx55=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD221(double (&a)[221]){
		...
		VectorSIMD221& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD221& operator += (VectorSIMD221 a){
	...
	inline VectorSIMD221 operator*(double a, VectorSIMD221 b){
		VectorSIMD221 c;
	...
	inline VectorSIMD221 operator*(VectorSIMD221 a ,double b){
		VectorSIMD221 c;
	...
	inline VectorSIMD221 operator*(int a, VectorSIMD221 b){
		if(a==1){return b;}
		VectorSIMD221 c;
	...
	inline VectorSIMD221 operator*(VectorSIMD221 a, int b){
		if(b==1){return a;}
		VectorSIMD221 c;
	...
	inline VectorSIMD221 operator*(VectorSIMD221 a, VectorSIMD221 b){
		VectorSIMD221 c;
	...
	inline VectorSIMD221 exp(VectorSIMD221 a){
		double a_d[221]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD221 sqrt(VectorSIMD221 a){
		double a_d[221]; a.convert(a_d);
