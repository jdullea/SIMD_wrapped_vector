...
public:
		...
		VectorSIMD772& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD772& operator += (VectorSIMD772 a){
	...
	inline VectorSIMD772 operator*(double a, VectorSIMD772 b){
		VectorSIMD772 c;
	...
	inline VectorSIMD772 operator*(VectorSIMD772 a ,double b){
		VectorSIMD772 c;
	...
	inline VectorSIMD772 operator*(int a, VectorSIMD772 b){
		if(a==1){return b;}
		VectorSIMD772 c;
	...
	inline VectorSIMD772 operator*(VectorSIMD772 a, int b){
		if(b==1){return a;}
		VectorSIMD772 c;
	...
	inline VectorSIMD772 operator*(VectorSIMD772 a, VectorSIMD772 b){
		VectorSIMD772 c;
	...
	inline VectorSIMD772 exp(VectorSIMD772 a){
		double a_d[772]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD772 sqrt(VectorSIMD772 a){
		double a_d[772]; a.convert(a_d);
