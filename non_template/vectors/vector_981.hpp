...
public:
		...
		VectorSIMD981(double a){
			...
			_avx245=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD981(double (&a)[981]){
		...
		VectorSIMD981& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD981& operator += (VectorSIMD981 a){
	...
	inline VectorSIMD981 operator*(double a, VectorSIMD981 b){
		VectorSIMD981 c;
	...
	inline VectorSIMD981 operator*(VectorSIMD981 a ,double b){
		VectorSIMD981 c;
	...
	inline VectorSIMD981 operator*(int a, VectorSIMD981 b){
		if(a==1){return b;}
		VectorSIMD981 c;
	...
	inline VectorSIMD981 operator*(VectorSIMD981 a, int b){
		if(b==1){return a;}
		VectorSIMD981 c;
	...
	inline VectorSIMD981 operator*(VectorSIMD981 a, VectorSIMD981 b){
		VectorSIMD981 c;
	...
	inline VectorSIMD981 exp(VectorSIMD981 a){
		double a_d[981]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD981 sqrt(VectorSIMD981 a){
		double a_d[981]; a.convert(a_d);
