...
public:
		...
		VectorSIMD694(double a){
			...
			_avx173=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD694(double (&a)[694]){
		...
		VectorSIMD694& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD694& operator += (VectorSIMD694 a){
	...
	inline VectorSIMD694 operator*(double a, VectorSIMD694 b){
		VectorSIMD694 c;
	...
	inline VectorSIMD694 operator*(VectorSIMD694 a ,double b){
		VectorSIMD694 c;
	...
	inline VectorSIMD694 operator*(int a, VectorSIMD694 b){
		if(a==1){return b;}
		VectorSIMD694 c;
	...
	inline VectorSIMD694 operator*(VectorSIMD694 a, int b){
		if(b==1){return a;}
		VectorSIMD694 c;
	...
	inline VectorSIMD694 operator*(VectorSIMD694 a, VectorSIMD694 b){
		VectorSIMD694 c;
	...
	inline VectorSIMD694 exp(VectorSIMD694 a){
		double a_d[694]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD694 sqrt(VectorSIMD694 a){
		double a_d[694]; a.convert(a_d);
