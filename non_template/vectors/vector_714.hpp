...
public:
		...
		VectorSIMD714(double a){
			...
			_avx178=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD714(double (&a)[714]){
		...
		VectorSIMD714& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD714& operator += (VectorSIMD714 a){
	...
	inline VectorSIMD714 operator*(double a, VectorSIMD714 b){
		VectorSIMD714 c;
	...
	inline VectorSIMD714 operator*(VectorSIMD714 a ,double b){
		VectorSIMD714 c;
	...
	inline VectorSIMD714 operator*(int a, VectorSIMD714 b){
		if(a==1){return b;}
		VectorSIMD714 c;
	...
	inline VectorSIMD714 operator*(VectorSIMD714 a, int b){
		if(b==1){return a;}
		VectorSIMD714 c;
	...
	inline VectorSIMD714 operator*(VectorSIMD714 a, VectorSIMD714 b){
		VectorSIMD714 c;
	...
	inline VectorSIMD714 exp(VectorSIMD714 a){
		double a_d[714]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD714 sqrt(VectorSIMD714 a){
		double a_d[714]; a.convert(a_d);
