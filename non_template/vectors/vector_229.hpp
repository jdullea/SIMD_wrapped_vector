...
public:
		...
		VectorSIMD229(double a){
			...
			_avx57=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD229(double (&a)[229]){
		...
		VectorSIMD229& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD229& operator += (VectorSIMD229 a){
	...
	inline VectorSIMD229 operator*(double a, VectorSIMD229 b){
		VectorSIMD229 c;
	...
	inline VectorSIMD229 operator*(VectorSIMD229 a ,double b){
		VectorSIMD229 c;
	...
	inline VectorSIMD229 operator*(int a, VectorSIMD229 b){
		if(a==1){return b;}
		VectorSIMD229 c;
	...
	inline VectorSIMD229 operator*(VectorSIMD229 a, int b){
		if(b==1){return a;}
		VectorSIMD229 c;
	...
	inline VectorSIMD229 operator*(VectorSIMD229 a, VectorSIMD229 b){
		VectorSIMD229 c;
	...
	inline VectorSIMD229 exp(VectorSIMD229 a){
		double a_d[229]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD229 sqrt(VectorSIMD229 a){
		double a_d[229]; a.convert(a_d);
