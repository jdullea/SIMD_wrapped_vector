...
public:
		...
		VectorSIMD450(double a){
			...
			_avx112=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD450(double (&a)[450]){
		...
		VectorSIMD450& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD450& operator += (VectorSIMD450 a){
	...
	inline VectorSIMD450 operator*(double a, VectorSIMD450 b){
		VectorSIMD450 c;
	...
	inline VectorSIMD450 operator*(VectorSIMD450 a ,double b){
		VectorSIMD450 c;
	...
	inline VectorSIMD450 operator*(int a, VectorSIMD450 b){
		if(a==1){return b;}
		VectorSIMD450 c;
	...
	inline VectorSIMD450 operator*(VectorSIMD450 a, int b){
		if(b==1){return a;}
		VectorSIMD450 c;
	...
	inline VectorSIMD450 operator*(VectorSIMD450 a, VectorSIMD450 b){
		VectorSIMD450 c;
	...
	inline VectorSIMD450 exp(VectorSIMD450 a){
		double a_d[450]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD450 sqrt(VectorSIMD450 a){
		double a_d[450]; a.convert(a_d);
