...
public:
		...
		VectorSIMD249(double a){
			...
			_avx62=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD249(double (&a)[249]){
		...
		VectorSIMD249& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD249& operator += (VectorSIMD249 a){
	...
	inline VectorSIMD249 operator*(double a, VectorSIMD249 b){
		VectorSIMD249 c;
	...
	inline VectorSIMD249 operator*(VectorSIMD249 a ,double b){
		VectorSIMD249 c;
	...
	inline VectorSIMD249 operator*(int a, VectorSIMD249 b){
		if(a==1){return b;}
		VectorSIMD249 c;
	...
	inline VectorSIMD249 operator*(VectorSIMD249 a, int b){
		if(b==1){return a;}
		VectorSIMD249 c;
	...
	inline VectorSIMD249 operator*(VectorSIMD249 a, VectorSIMD249 b){
		VectorSIMD249 c;
	...
	inline VectorSIMD249 exp(VectorSIMD249 a){
		double a_d[249]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD249 sqrt(VectorSIMD249 a){
		double a_d[249]; a.convert(a_d);
