...
public:
		...
		VectorSIMD402(double a){
			...
			_avx100=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD402(double (&a)[402]){
		...
		VectorSIMD402& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD402& operator += (VectorSIMD402 a){
	...
	inline VectorSIMD402 operator*(double a, VectorSIMD402 b){
		VectorSIMD402 c;
	...
	inline VectorSIMD402 operator*(VectorSIMD402 a ,double b){
		VectorSIMD402 c;
	...
	inline VectorSIMD402 operator*(int a, VectorSIMD402 b){
		if(a==1){return b;}
		VectorSIMD402 c;
	...
	inline VectorSIMD402 operator*(VectorSIMD402 a, int b){
		if(b==1){return a;}
		VectorSIMD402 c;
	...
	inline VectorSIMD402 operator*(VectorSIMD402 a, VectorSIMD402 b){
		VectorSIMD402 c;
	...
	inline VectorSIMD402 exp(VectorSIMD402 a){
		double a_d[402]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD402 sqrt(VectorSIMD402 a){
		double a_d[402]; a.convert(a_d);
