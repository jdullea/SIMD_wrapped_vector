...
public:
		...
		VectorSIMD792& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD792& operator += (VectorSIMD792 a){
	...
	inline VectorSIMD792 operator*(double a, VectorSIMD792 b){
		VectorSIMD792 c;
	...
	inline VectorSIMD792 operator*(VectorSIMD792 a ,double b){
		VectorSIMD792 c;
	...
	inline VectorSIMD792 operator*(int a, VectorSIMD792 b){
		if(a==1){return b;}
		VectorSIMD792 c;
	...
	inline VectorSIMD792 operator*(VectorSIMD792 a, int b){
		if(b==1){return a;}
		VectorSIMD792 c;
	...
	inline VectorSIMD792 operator*(VectorSIMD792 a, VectorSIMD792 b){
		VectorSIMD792 c;
	...
	inline VectorSIMD792 exp(VectorSIMD792 a){
		double a_d[792]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD792 sqrt(VectorSIMD792 a){
		double a_d[792]; a.convert(a_d);
