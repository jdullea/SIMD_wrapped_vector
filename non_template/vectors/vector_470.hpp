...
public:
		...
		VectorSIMD470(double a){
			...
			_avx117=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD470(double (&a)[470]){
		...
		VectorSIMD470& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD470& operator += (VectorSIMD470 a){
	...
	inline VectorSIMD470 operator*(double a, VectorSIMD470 b){
		VectorSIMD470 c;
	...
	inline VectorSIMD470 operator*(VectorSIMD470 a ,double b){
		VectorSIMD470 c;
	...
	inline VectorSIMD470 operator*(int a, VectorSIMD470 b){
		if(a==1){return b;}
		VectorSIMD470 c;
	...
	inline VectorSIMD470 operator*(VectorSIMD470 a, int b){
		if(b==1){return a;}
		VectorSIMD470 c;
	...
	inline VectorSIMD470 operator*(VectorSIMD470 a, VectorSIMD470 b){
		VectorSIMD470 c;
	...
	inline VectorSIMD470 exp(VectorSIMD470 a){
		double a_d[470]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD470 sqrt(VectorSIMD470 a){
		double a_d[470]; a.convert(a_d);
