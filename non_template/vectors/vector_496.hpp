...
public:
		...
		VectorSIMD496& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD496& operator += (VectorSIMD496 a){
	...
	inline VectorSIMD496 operator*(double a, VectorSIMD496 b){
		VectorSIMD496 c;
	...
	inline VectorSIMD496 operator*(VectorSIMD496 a ,double b){
		VectorSIMD496 c;
	...
	inline VectorSIMD496 operator*(int a, VectorSIMD496 b){
		if(a==1){return b;}
		VectorSIMD496 c;
	...
	inline VectorSIMD496 operator*(VectorSIMD496 a, int b){
		if(b==1){return a;}
		VectorSIMD496 c;
	...
	inline VectorSIMD496 operator*(VectorSIMD496 a, VectorSIMD496 b){
		VectorSIMD496 c;
	...
	inline VectorSIMD496 exp(VectorSIMD496 a){
		double a_d[496]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD496 sqrt(VectorSIMD496 a){
		double a_d[496]; a.convert(a_d);
