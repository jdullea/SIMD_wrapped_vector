...
public:
		...
		VectorSIMD718(double a){
			...
			_avx179=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD718(double (&a)[718]){
		...
		VectorSIMD718& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD718& operator += (VectorSIMD718 a){
	...
	inline VectorSIMD718 operator*(double a, VectorSIMD718 b){
		VectorSIMD718 c;
	...
	inline VectorSIMD718 operator*(VectorSIMD718 a ,double b){
		VectorSIMD718 c;
	...
	inline VectorSIMD718 operator*(int a, VectorSIMD718 b){
		if(a==1){return b;}
		VectorSIMD718 c;
	...
	inline VectorSIMD718 operator*(VectorSIMD718 a, int b){
		if(b==1){return a;}
		VectorSIMD718 c;
	...
	inline VectorSIMD718 operator*(VectorSIMD718 a, VectorSIMD718 b){
		VectorSIMD718 c;
	...
	inline VectorSIMD718 exp(VectorSIMD718 a){
		double a_d[718]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD718 sqrt(VectorSIMD718 a){
		double a_d[718]; a.convert(a_d);
