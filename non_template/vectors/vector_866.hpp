...
public:
		...
		VectorSIMD866(double a){
			...
			_avx216=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD866(double (&a)[866]){
		...
		VectorSIMD866& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD866& operator += (VectorSIMD866 a){
	...
	inline VectorSIMD866 operator*(double a, VectorSIMD866 b){
		VectorSIMD866 c;
	...
	inline VectorSIMD866 operator*(VectorSIMD866 a ,double b){
		VectorSIMD866 c;
	...
	inline VectorSIMD866 operator*(int a, VectorSIMD866 b){
		if(a==1){return b;}
		VectorSIMD866 c;
	...
	inline VectorSIMD866 operator*(VectorSIMD866 a, int b){
		if(b==1){return a;}
		VectorSIMD866 c;
	...
	inline VectorSIMD866 operator*(VectorSIMD866 a, VectorSIMD866 b){
		VectorSIMD866 c;
	...
	inline VectorSIMD866 exp(VectorSIMD866 a){
		double a_d[866]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD866 sqrt(VectorSIMD866 a){
		double a_d[866]; a.convert(a_d);
