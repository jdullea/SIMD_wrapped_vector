...
public:
		...
		VectorSIMD257(double a){
			...
			_avx64=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD257(double (&a)[257]){
		...
		VectorSIMD257& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD257& operator += (VectorSIMD257 a){
	...
	inline VectorSIMD257 operator*(double a, VectorSIMD257 b){
		VectorSIMD257 c;
	...
	inline VectorSIMD257 operator*(VectorSIMD257 a ,double b){
		VectorSIMD257 c;
	...
	inline VectorSIMD257 operator*(int a, VectorSIMD257 b){
		if(a==1){return b;}
		VectorSIMD257 c;
	...
	inline VectorSIMD257 operator*(VectorSIMD257 a, int b){
		if(b==1){return a;}
		VectorSIMD257 c;
	...
	inline VectorSIMD257 operator*(VectorSIMD257 a, VectorSIMD257 b){
		VectorSIMD257 c;
	...
	inline VectorSIMD257 exp(VectorSIMD257 a){
		double a_d[257]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD257 sqrt(VectorSIMD257 a){
		double a_d[257]; a.convert(a_d);
