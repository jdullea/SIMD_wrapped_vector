...
public:
		...
		VectorSIMD813(double a){
			...
			_avx203=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD813(double (&a)[813]){
		...
		VectorSIMD813& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD813& operator += (VectorSIMD813 a){
	...
	inline VectorSIMD813 operator*(double a, VectorSIMD813 b){
		VectorSIMD813 c;
	...
	inline VectorSIMD813 operator*(VectorSIMD813 a ,double b){
		VectorSIMD813 c;
	...
	inline VectorSIMD813 operator*(int a, VectorSIMD813 b){
		if(a==1){return b;}
		VectorSIMD813 c;
	...
	inline VectorSIMD813 operator*(VectorSIMD813 a, int b){
		if(b==1){return a;}
		VectorSIMD813 c;
	...
	inline VectorSIMD813 operator*(VectorSIMD813 a, VectorSIMD813 b){
		VectorSIMD813 c;
	...
	inline VectorSIMD813 exp(VectorSIMD813 a){
		double a_d[813]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD813 sqrt(VectorSIMD813 a){
		double a_d[813]; a.convert(a_d);
