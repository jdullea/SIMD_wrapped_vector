...
public:
		...
		VectorSIMD689(double a){
			...
			_avx172=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD689(double (&a)[689]){
		...
		VectorSIMD689& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD689& operator += (VectorSIMD689 a){
	...
	inline VectorSIMD689 operator*(double a, VectorSIMD689 b){
		VectorSIMD689 c;
	...
	inline VectorSIMD689 operator*(VectorSIMD689 a ,double b){
		VectorSIMD689 c;
	...
	inline VectorSIMD689 operator*(int a, VectorSIMD689 b){
		if(a==1){return b;}
		VectorSIMD689 c;
	...
	inline VectorSIMD689 operator*(VectorSIMD689 a, int b){
		if(b==1){return a;}
		VectorSIMD689 c;
	...
	inline VectorSIMD689 operator*(VectorSIMD689 a, VectorSIMD689 b){
		VectorSIMD689 c;
	...
	inline VectorSIMD689 exp(VectorSIMD689 a){
		double a_d[689]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD689 sqrt(VectorSIMD689 a){
		double a_d[689]; a.convert(a_d);
