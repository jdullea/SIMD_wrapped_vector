...
public:
		...
		VectorSIMD342(double a){
			...
			_avx85=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD342(double (&a)[342]){
		...
		VectorSIMD342& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD342& operator += (VectorSIMD342 a){
	...
	inline VectorSIMD342 operator*(double a, VectorSIMD342 b){
		VectorSIMD342 c;
	...
	inline VectorSIMD342 operator*(VectorSIMD342 a ,double b){
		VectorSIMD342 c;
	...
	inline VectorSIMD342 operator*(int a, VectorSIMD342 b){
		if(a==1){return b;}
		VectorSIMD342 c;
	...
	inline VectorSIMD342 operator*(VectorSIMD342 a, int b){
		if(b==1){return a;}
		VectorSIMD342 c;
	...
	inline VectorSIMD342 operator*(VectorSIMD342 a, VectorSIMD342 b){
		VectorSIMD342 c;
	...
	inline VectorSIMD342 exp(VectorSIMD342 a){
		double a_d[342]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD342 sqrt(VectorSIMD342 a){
		double a_d[342]; a.convert(a_d);
