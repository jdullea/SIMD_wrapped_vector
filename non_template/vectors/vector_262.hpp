...
public:
		...
		VectorSIMD262(double a){
			...
			_avx65=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD262(double (&a)[262]){
		...
		VectorSIMD262& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD262& operator += (VectorSIMD262 a){
	...
	inline VectorSIMD262 operator*(double a, VectorSIMD262 b){
		VectorSIMD262 c;
	...
	inline VectorSIMD262 operator*(VectorSIMD262 a ,double b){
		VectorSIMD262 c;
	...
	inline VectorSIMD262 operator*(int a, VectorSIMD262 b){
		if(a==1){return b;}
		VectorSIMD262 c;
	...
	inline VectorSIMD262 operator*(VectorSIMD262 a, int b){
		if(b==1){return a;}
		VectorSIMD262 c;
	...
	inline VectorSIMD262 operator*(VectorSIMD262 a, VectorSIMD262 b){
		VectorSIMD262 c;
	...
	inline VectorSIMD262 exp(VectorSIMD262 a){
		double a_d[262]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD262 sqrt(VectorSIMD262 a){
		double a_d[262]; a.convert(a_d);
