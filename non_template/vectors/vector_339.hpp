...
public:
		...
		VectorSIMD339(double a){
			...
			_avx84=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD339(double (&a)[339]){
		...
		VectorSIMD339& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD339& operator += (VectorSIMD339 a){
	...
	inline VectorSIMD339 operator*(double a, VectorSIMD339 b){
		VectorSIMD339 c;
	...
	inline VectorSIMD339 operator*(VectorSIMD339 a ,double b){
		VectorSIMD339 c;
	...
	inline VectorSIMD339 operator*(int a, VectorSIMD339 b){
		if(a==1){return b;}
		VectorSIMD339 c;
	...
	inline VectorSIMD339 operator*(VectorSIMD339 a, int b){
		if(b==1){return a;}
		VectorSIMD339 c;
	...
	inline VectorSIMD339 operator*(VectorSIMD339 a, VectorSIMD339 b){
		VectorSIMD339 c;
	...
	inline VectorSIMD339 exp(VectorSIMD339 a){
		double a_d[339]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD339 sqrt(VectorSIMD339 a){
		double a_d[339]; a.convert(a_d);
