...
public:
		...
		VectorSIMD326(double a){
			...
			_avx81=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD326(double (&a)[326]){
		...
		VectorSIMD326& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD326& operator += (VectorSIMD326 a){
	...
	inline VectorSIMD326 operator*(double a, VectorSIMD326 b){
		VectorSIMD326 c;
	...
	inline VectorSIMD326 operator*(VectorSIMD326 a ,double b){
		VectorSIMD326 c;
	...
	inline VectorSIMD326 operator*(int a, VectorSIMD326 b){
		if(a==1){return b;}
		VectorSIMD326 c;
	...
	inline VectorSIMD326 operator*(VectorSIMD326 a, int b){
		if(b==1){return a;}
		VectorSIMD326 c;
	...
	inline VectorSIMD326 operator*(VectorSIMD326 a, VectorSIMD326 b){
		VectorSIMD326 c;
	...
	inline VectorSIMD326 exp(VectorSIMD326 a){
		double a_d[326]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD326 sqrt(VectorSIMD326 a){
		double a_d[326]; a.convert(a_d);
