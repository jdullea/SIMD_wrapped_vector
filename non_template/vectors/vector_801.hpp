...
public:
		...
		VectorSIMD801(double a){
			...
			_avx200=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD801(double (&a)[801]){
		...
		VectorSIMD801& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD801& operator += (VectorSIMD801 a){
	...
	inline VectorSIMD801 operator*(double a, VectorSIMD801 b){
		VectorSIMD801 c;
	...
	inline VectorSIMD801 operator*(VectorSIMD801 a ,double b){
		VectorSIMD801 c;
	...
	inline VectorSIMD801 operator*(int a, VectorSIMD801 b){
		if(a==1){return b;}
		VectorSIMD801 c;
	...
	inline VectorSIMD801 operator*(VectorSIMD801 a, int b){
		if(b==1){return a;}
		VectorSIMD801 c;
	...
	inline VectorSIMD801 operator*(VectorSIMD801 a, VectorSIMD801 b){
		VectorSIMD801 c;
	...
	inline VectorSIMD801 exp(VectorSIMD801 a){
		double a_d[801]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD801 sqrt(VectorSIMD801 a){
		double a_d[801]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD801 a){ 
		double ad[801];
		a.convert(ad);
