...
public:
		...
		VectorSIMD805(double a){
			...
			_avx201=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD805(double (&a)[805]){
		...
		VectorSIMD805& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD805& operator += (VectorSIMD805 a){
	...
	inline VectorSIMD805 operator*(double a, VectorSIMD805 b){
		VectorSIMD805 c;
	...
	inline VectorSIMD805 operator*(VectorSIMD805 a ,double b){
		VectorSIMD805 c;
	...
	inline VectorSIMD805 operator*(int a, VectorSIMD805 b){
		if(a==1){return b;}
		VectorSIMD805 c;
	...
	inline VectorSIMD805 operator*(VectorSIMD805 a, int b){
		if(b==1){return a;}
		VectorSIMD805 c;
	...
	inline VectorSIMD805 operator*(VectorSIMD805 a, VectorSIMD805 b){
		VectorSIMD805 c;
	...
	inline VectorSIMD805 exp(VectorSIMD805 a){
		double a_d[805]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD805 sqrt(VectorSIMD805 a){
		double a_d[805]; a.convert(a_d);
