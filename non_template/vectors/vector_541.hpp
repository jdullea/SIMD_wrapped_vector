...
public:
		...
		VectorSIMD541(double a){
			...
			_avx135=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD541(double (&a)[541]){
		...
		VectorSIMD541& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD541& operator += (VectorSIMD541 a){
	...
	inline VectorSIMD541 operator*(double a, VectorSIMD541 b){
		VectorSIMD541 c;
	...
	inline VectorSIMD541 operator*(VectorSIMD541 a ,double b){
		VectorSIMD541 c;
	...
	inline VectorSIMD541 operator*(int a, VectorSIMD541 b){
		if(a==1){return b;}
		VectorSIMD541 c;
	...
	inline VectorSIMD541 operator*(VectorSIMD541 a, int b){
		if(b==1){return a;}
		VectorSIMD541 c;
	...
	inline VectorSIMD541 operator*(VectorSIMD541 a, VectorSIMD541 b){
		VectorSIMD541 c;
	...
	inline VectorSIMD541 exp(VectorSIMD541 a){
		double a_d[541]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD541 sqrt(VectorSIMD541 a){
		double a_d[541]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD541 a){ 
		double ad[541];
		a.convert(ad);
