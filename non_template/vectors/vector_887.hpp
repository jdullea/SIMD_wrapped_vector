...
public:
		...
		VectorSIMD887(double a){
			...
			_avx221=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD887(double (&a)[887]){
		...
		VectorSIMD887& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD887& operator += (VectorSIMD887 a){
	...
	inline VectorSIMD887 operator*(double a, VectorSIMD887 b){
		VectorSIMD887 c;
	...
	inline VectorSIMD887 operator*(VectorSIMD887 a ,double b){
		VectorSIMD887 c;
	...
	inline VectorSIMD887 operator*(int a, VectorSIMD887 b){
		if(a==1){return b;}
		VectorSIMD887 c;
	...
	inline VectorSIMD887 operator*(VectorSIMD887 a, int b){
		if(b==1){return a;}
		VectorSIMD887 c;
	...
	inline VectorSIMD887 operator*(VectorSIMD887 a, VectorSIMD887 b){
		VectorSIMD887 c;
	...
	inline VectorSIMD887 exp(VectorSIMD887 a){
		double a_d[887]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD887 sqrt(VectorSIMD887 a){
		double a_d[887]; a.convert(a_d);
