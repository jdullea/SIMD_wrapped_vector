...
public:
		...
		VectorSIMD876& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD876& operator += (VectorSIMD876 a){
	...
	inline VectorSIMD876 operator*(double a, VectorSIMD876 b){
		VectorSIMD876 c;
	...
	inline VectorSIMD876 operator*(VectorSIMD876 a ,double b){
		VectorSIMD876 c;
	...
	inline VectorSIMD876 operator*(int a, VectorSIMD876 b){
		if(a==1){return b;}
		VectorSIMD876 c;
	...
	inline VectorSIMD876 operator*(VectorSIMD876 a, int b){
		if(b==1){return a;}
		VectorSIMD876 c;
	...
	inline VectorSIMD876 operator*(VectorSIMD876 a, VectorSIMD876 b){
		VectorSIMD876 c;
	...
	inline VectorSIMD876 exp(VectorSIMD876 a){
		double a_d[876]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD876 sqrt(VectorSIMD876 a){
		double a_d[876]; a.convert(a_d);
