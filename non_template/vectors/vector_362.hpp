...
public:
		...
		VectorSIMD362(double a){
			...
			_avx90=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD362(double (&a)[362]){
		...
		VectorSIMD362& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD362& operator += (VectorSIMD362 a){
	...
	inline VectorSIMD362 operator*(double a, VectorSIMD362 b){
		VectorSIMD362 c;
	...
	inline VectorSIMD362 operator*(VectorSIMD362 a ,double b){
		VectorSIMD362 c;
	...
	inline VectorSIMD362 operator*(int a, VectorSIMD362 b){
		if(a==1){return b;}
		VectorSIMD362 c;
	...
	inline VectorSIMD362 operator*(VectorSIMD362 a, int b){
		if(b==1){return a;}
		VectorSIMD362 c;
	...
	inline VectorSIMD362 operator*(VectorSIMD362 a, VectorSIMD362 b){
		VectorSIMD362 c;
	...
	inline VectorSIMD362 exp(VectorSIMD362 a){
		double a_d[362]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD362 sqrt(VectorSIMD362 a){
		double a_d[362]; a.convert(a_d);
