...
public:
		...
		VectorSIMD711(double a){
			...
			_avx177=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD711(double (&a)[711]){
		...
		VectorSIMD711& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD711& operator += (VectorSIMD711 a){
	...
	inline VectorSIMD711 operator*(double a, VectorSIMD711 b){
		VectorSIMD711 c;
	...
	inline VectorSIMD711 operator*(VectorSIMD711 a ,double b){
		VectorSIMD711 c;
	...
	inline VectorSIMD711 operator*(int a, VectorSIMD711 b){
		if(a==1){return b;}
		VectorSIMD711 c;
	...
	inline VectorSIMD711 operator*(VectorSIMD711 a, int b){
		if(b==1){return a;}
		VectorSIMD711 c;
	...
	inline VectorSIMD711 operator*(VectorSIMD711 a, VectorSIMD711 b){
		VectorSIMD711 c;
	...
	inline VectorSIMD711 exp(VectorSIMD711 a){
		double a_d[711]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD711 sqrt(VectorSIMD711 a){
		double a_d[711]; a.convert(a_d);
