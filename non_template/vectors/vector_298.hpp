...
public:
		...
		VectorSIMD298(double a){
			...
			_avx74=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD298(double (&a)[298]){
		...
		VectorSIMD298& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD298& operator += (VectorSIMD298 a){
	...
	inline VectorSIMD298 operator*(double a, VectorSIMD298 b){
		VectorSIMD298 c;
	...
	inline VectorSIMD298 operator*(VectorSIMD298 a ,double b){
		VectorSIMD298 c;
	...
	inline VectorSIMD298 operator*(int a, VectorSIMD298 b){
		if(a==1){return b;}
		VectorSIMD298 c;
	...
	inline VectorSIMD298 operator*(VectorSIMD298 a, int b){
		if(b==1){return a;}
		VectorSIMD298 c;
	...
	inline VectorSIMD298 operator*(VectorSIMD298 a, VectorSIMD298 b){
		VectorSIMD298 c;
	...
	inline VectorSIMD298 exp(VectorSIMD298 a){
		double a_d[298]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD298 sqrt(VectorSIMD298 a){
		double a_d[298]; a.convert(a_d);
