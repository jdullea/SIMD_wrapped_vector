...
public:
		...
		VectorSIMD405(double a){
			...
			_avx101=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD405(double (&a)[405]){
		...
		VectorSIMD405& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD405& operator += (VectorSIMD405 a){
	...
	inline VectorSIMD405 operator*(double a, VectorSIMD405 b){
		VectorSIMD405 c;
	...
	inline VectorSIMD405 operator*(VectorSIMD405 a ,double b){
		VectorSIMD405 c;
	...
	inline VectorSIMD405 operator*(int a, VectorSIMD405 b){
		if(a==1){return b;}
		VectorSIMD405 c;
	...
	inline VectorSIMD405 operator*(VectorSIMD405 a, int b){
		if(b==1){return a;}
		VectorSIMD405 c;
	...
	inline VectorSIMD405 operator*(VectorSIMD405 a, VectorSIMD405 b){
		VectorSIMD405 c;
	...
	inline VectorSIMD405 exp(VectorSIMD405 a){
		double a_d[405]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD405 sqrt(VectorSIMD405 a){
		double a_d[405]; a.convert(a_d);
