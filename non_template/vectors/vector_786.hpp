...
public:
		...
		VectorSIMD786(double a){
			...
			_avx196=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD786(double (&a)[786]){
		...
		VectorSIMD786& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD786& operator += (VectorSIMD786 a){
	...
	inline VectorSIMD786 operator*(double a, VectorSIMD786 b){
		VectorSIMD786 c;
	...
	inline VectorSIMD786 operator*(VectorSIMD786 a ,double b){
		VectorSIMD786 c;
	...
	inline VectorSIMD786 operator*(int a, VectorSIMD786 b){
		if(a==1){return b;}
		VectorSIMD786 c;
	...
	inline VectorSIMD786 operator*(VectorSIMD786 a, int b){
		if(b==1){return a;}
		VectorSIMD786 c;
	...
	inline VectorSIMD786 operator*(VectorSIMD786 a, VectorSIMD786 b){
		VectorSIMD786 c;
	...
	inline VectorSIMD786 exp(VectorSIMD786 a){
		double a_d[786]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD786 sqrt(VectorSIMD786 a){
		double a_d[786]; a.convert(a_d);
