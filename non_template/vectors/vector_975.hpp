...
public:
		...
		VectorSIMD975(double a){
			...
			_avx243=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD975(double (&a)[975]){
		...
		VectorSIMD975& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD975& operator += (VectorSIMD975 a){
	...
	inline VectorSIMD975 operator*(double a, VectorSIMD975 b){
		VectorSIMD975 c;
	...
	inline VectorSIMD975 operator*(VectorSIMD975 a ,double b){
		VectorSIMD975 c;
	...
	inline VectorSIMD975 operator*(int a, VectorSIMD975 b){
		if(a==1){return b;}
		VectorSIMD975 c;
	...
	inline VectorSIMD975 operator*(VectorSIMD975 a, int b){
		if(b==1){return a;}
		VectorSIMD975 c;
	...
	inline VectorSIMD975 operator*(VectorSIMD975 a, VectorSIMD975 b){
		VectorSIMD975 c;
	...
	inline VectorSIMD975 exp(VectorSIMD975 a){
		double a_d[975]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD975 sqrt(VectorSIMD975 a){
		double a_d[975]; a.convert(a_d);
