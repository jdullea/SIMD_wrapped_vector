...
public:
		...
		VectorSIMD350(double a){
			...
			_avx87=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD350(double (&a)[350]){
		...
		VectorSIMD350& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD350& operator += (VectorSIMD350 a){
	...
	inline VectorSIMD350 operator*(double a, VectorSIMD350 b){
		VectorSIMD350 c;
	...
	inline VectorSIMD350 operator*(VectorSIMD350 a ,double b){
		VectorSIMD350 c;
	...
	inline VectorSIMD350 operator*(int a, VectorSIMD350 b){
		if(a==1){return b;}
		VectorSIMD350 c;
	...
	inline VectorSIMD350 operator*(VectorSIMD350 a, int b){
		if(b==1){return a;}
		VectorSIMD350 c;
	...
	inline VectorSIMD350 operator*(VectorSIMD350 a, VectorSIMD350 b){
		VectorSIMD350 c;
	...
	inline VectorSIMD350 exp(VectorSIMD350 a){
		double a_d[350]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD350 sqrt(VectorSIMD350 a){
		double a_d[350]; a.convert(a_d);
