...
public:
		...
		VectorSIMD812& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD812& operator += (VectorSIMD812 a){
	...
	inline VectorSIMD812 operator*(double a, VectorSIMD812 b){
		VectorSIMD812 c;
	...
	inline VectorSIMD812 operator*(VectorSIMD812 a ,double b){
		VectorSIMD812 c;
	...
	inline VectorSIMD812 operator*(int a, VectorSIMD812 b){
		if(a==1){return b;}
		VectorSIMD812 c;
	...
	inline VectorSIMD812 operator*(VectorSIMD812 a, int b){
		if(b==1){return a;}
		VectorSIMD812 c;
	...
	inline VectorSIMD812 operator*(VectorSIMD812 a, VectorSIMD812 b){
		VectorSIMD812 c;
	...
	inline VectorSIMD812 exp(VectorSIMD812 a){
		double a_d[812]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD812 sqrt(VectorSIMD812 a){
		double a_d[812]; a.convert(a_d);
