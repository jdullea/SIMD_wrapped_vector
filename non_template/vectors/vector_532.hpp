...
public:
		...
		VectorSIMD532& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD532& operator += (VectorSIMD532 a){
	...
	inline VectorSIMD532 operator*(double a, VectorSIMD532 b){
		VectorSIMD532 c;
	...
	inline VectorSIMD532 operator*(VectorSIMD532 a ,double b){
		VectorSIMD532 c;
	...
	inline VectorSIMD532 operator*(int a, VectorSIMD532 b){
		if(a==1){return b;}
		VectorSIMD532 c;
	...
	inline VectorSIMD532 operator*(VectorSIMD532 a, int b){
		if(b==1){return a;}
		VectorSIMD532 c;
	...
	inline VectorSIMD532 operator*(VectorSIMD532 a, VectorSIMD532 b){
		VectorSIMD532 c;
	...
	inline VectorSIMD532 exp(VectorSIMD532 a){
		double a_d[532]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD532 sqrt(VectorSIMD532 a){
		double a_d[532]; a.convert(a_d);
