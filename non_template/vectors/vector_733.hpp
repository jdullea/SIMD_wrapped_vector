...
public:
		...
		VectorSIMD733(double a){
			...
			_avx183=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD733(double (&a)[733]){
		...
		VectorSIMD733& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD733& operator += (VectorSIMD733 a){
	...
	inline VectorSIMD733 operator*(double a, VectorSIMD733 b){
		VectorSIMD733 c;
	...
	inline VectorSIMD733 operator*(VectorSIMD733 a ,double b){
		VectorSIMD733 c;
	...
	inline VectorSIMD733 operator*(int a, VectorSIMD733 b){
		if(a==1){return b;}
		VectorSIMD733 c;
	...
	inline VectorSIMD733 operator*(VectorSIMD733 a, int b){
		if(b==1){return a;}
		VectorSIMD733 c;
	...
	inline VectorSIMD733 operator*(VectorSIMD733 a, VectorSIMD733 b){
		VectorSIMD733 c;
	...
	inline VectorSIMD733 exp(VectorSIMD733 a){
		double a_d[733]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD733 sqrt(VectorSIMD733 a){
		double a_d[733]; a.convert(a_d);
