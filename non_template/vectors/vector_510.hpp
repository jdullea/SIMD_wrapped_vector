...
public:
		...
		VectorSIMD510(double a){
			...
			_avx127=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD510(double (&a)[510]){
		...
		VectorSIMD510& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD510& operator += (VectorSIMD510 a){
	...
	inline VectorSIMD510 operator*(double a, VectorSIMD510 b){
		VectorSIMD510 c;
	...
	inline VectorSIMD510 operator*(VectorSIMD510 a ,double b){
		VectorSIMD510 c;
	...
	inline VectorSIMD510 operator*(int a, VectorSIMD510 b){
		if(a==1){return b;}
		VectorSIMD510 c;
	...
	inline VectorSIMD510 operator*(VectorSIMD510 a, int b){
		if(b==1){return a;}
		VectorSIMD510 c;
	...
	inline VectorSIMD510 operator*(VectorSIMD510 a, VectorSIMD510 b){
		VectorSIMD510 c;
	...
	inline VectorSIMD510 exp(VectorSIMD510 a){
		double a_d[510]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD510 sqrt(VectorSIMD510 a){
		double a_d[510]; a.convert(a_d);
