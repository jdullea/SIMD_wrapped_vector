...
public:
		...
		VectorSIMD635(double a){
			...
			_avx158=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD635(double (&a)[635]){
		...
		VectorSIMD635& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD635& operator += (VectorSIMD635 a){
	...
	inline VectorSIMD635 operator*(double a, VectorSIMD635 b){
		VectorSIMD635 c;
	...
	inline VectorSIMD635 operator*(VectorSIMD635 a ,double b){
		VectorSIMD635 c;
	...
	inline VectorSIMD635 operator*(int a, VectorSIMD635 b){
		if(a==1){return b;}
		VectorSIMD635 c;
	...
	inline VectorSIMD635 operator*(VectorSIMD635 a, int b){
		if(b==1){return a;}
		VectorSIMD635 c;
	...
	inline VectorSIMD635 operator*(VectorSIMD635 a, VectorSIMD635 b){
		VectorSIMD635 c;
	...
	inline VectorSIMD635 exp(VectorSIMD635 a){
		double a_d[635]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD635 sqrt(VectorSIMD635 a){
		double a_d[635]; a.convert(a_d);
