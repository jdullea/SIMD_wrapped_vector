...
public:
		...
		VectorSIMD248& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD248& operator += (VectorSIMD248 a){
	...
	inline VectorSIMD248 operator*(double a, VectorSIMD248 b){
		VectorSIMD248 c;
	...
	inline VectorSIMD248 operator*(VectorSIMD248 a ,double b){
		VectorSIMD248 c;
	...
	inline VectorSIMD248 operator*(int a, VectorSIMD248 b){
		if(a==1){return b;}
		VectorSIMD248 c;
	...
	inline VectorSIMD248 operator*(VectorSIMD248 a, int b){
		if(b==1){return a;}
		VectorSIMD248 c;
	...
	inline VectorSIMD248 operator*(VectorSIMD248 a, VectorSIMD248 b){
		VectorSIMD248 c;
	...
	inline VectorSIMD248 exp(VectorSIMD248 a){
		double a_d[248]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD248 sqrt(VectorSIMD248 a){
		double a_d[248]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD248 a){ 
		double ad[248];
		a.convert(ad);
