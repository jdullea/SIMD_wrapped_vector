...
public:
		...
		VectorSIMD514(double a){
			...
			_avx128=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD514(double (&a)[514]){
		...
		VectorSIMD514& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD514& operator += (VectorSIMD514 a){
	...
	inline VectorSIMD514 operator*(double a, VectorSIMD514 b){
		VectorSIMD514 c;
	...
	inline VectorSIMD514 operator*(VectorSIMD514 a ,double b){
		VectorSIMD514 c;
	...
	inline VectorSIMD514 operator*(int a, VectorSIMD514 b){
		if(a==1){return b;}
		VectorSIMD514 c;
	...
	inline VectorSIMD514 operator*(VectorSIMD514 a, int b){
		if(b==1){return a;}
		VectorSIMD514 c;
	...
	inline VectorSIMD514 operator*(VectorSIMD514 a, VectorSIMD514 b){
		VectorSIMD514 c;
	...
	inline VectorSIMD514 exp(VectorSIMD514 a){
		double a_d[514]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD514 sqrt(VectorSIMD514 a){
		double a_d[514]; a.convert(a_d);
