...
public:
		...
		VectorSIMD948& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD948& operator += (VectorSIMD948 a){
	...
	inline VectorSIMD948 operator*(double a, VectorSIMD948 b){
		VectorSIMD948 c;
	...
	inline VectorSIMD948 operator*(VectorSIMD948 a ,double b){
		VectorSIMD948 c;
	...
	inline VectorSIMD948 operator*(int a, VectorSIMD948 b){
		if(a==1){return b;}
		VectorSIMD948 c;
	...
	inline VectorSIMD948 operator*(VectorSIMD948 a, int b){
		if(b==1){return a;}
		VectorSIMD948 c;
	...
	inline VectorSIMD948 operator*(VectorSIMD948 a, VectorSIMD948 b){
		VectorSIMD948 c;
	...
	inline VectorSIMD948 exp(VectorSIMD948 a){
		double a_d[948]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD948 sqrt(VectorSIMD948 a){
		double a_d[948]; a.convert(a_d);
