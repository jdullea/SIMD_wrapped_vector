...
public:
		...
		VectorSIMD347(double a){
			...
			_avx86=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD347(double (&a)[347]){
		...
		VectorSIMD347& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD347& operator += (VectorSIMD347 a){
	...
	inline VectorSIMD347 operator*(double a, VectorSIMD347 b){
		VectorSIMD347 c;
	...
	inline VectorSIMD347 operator*(VectorSIMD347 a ,double b){
		VectorSIMD347 c;
	...
	inline VectorSIMD347 operator*(int a, VectorSIMD347 b){
		if(a==1){return b;}
		VectorSIMD347 c;
	...
	inline VectorSIMD347 operator*(VectorSIMD347 a, int b){
		if(b==1){return a;}
		VectorSIMD347 c;
	...
	inline VectorSIMD347 operator*(VectorSIMD347 a, VectorSIMD347 b){
		VectorSIMD347 c;
	...
	inline VectorSIMD347 exp(VectorSIMD347 a){
		double a_d[347]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD347 sqrt(VectorSIMD347 a){
		double a_d[347]; a.convert(a_d);
