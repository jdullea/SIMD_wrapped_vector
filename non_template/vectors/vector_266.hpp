...
public:
		...
		VectorSIMD266(double a){
			...
			_avx66=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD266(double (&a)[266]){
		...
		VectorSIMD266& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD266& operator += (VectorSIMD266 a){
	...
	inline VectorSIMD266 operator*(double a, VectorSIMD266 b){
		VectorSIMD266 c;
	...
	inline VectorSIMD266 operator*(VectorSIMD266 a ,double b){
		VectorSIMD266 c;
	...
	inline VectorSIMD266 operator*(int a, VectorSIMD266 b){
		if(a==1){return b;}
		VectorSIMD266 c;
	...
	inline VectorSIMD266 operator*(VectorSIMD266 a, int b){
		if(b==1){return a;}
		VectorSIMD266 c;
	...
	inline VectorSIMD266 operator*(VectorSIMD266 a, VectorSIMD266 b){
		VectorSIMD266 c;
	...
	inline VectorSIMD266 exp(VectorSIMD266 a){
		double a_d[266]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD266 sqrt(VectorSIMD266 a){
		double a_d[266]; a.convert(a_d);
