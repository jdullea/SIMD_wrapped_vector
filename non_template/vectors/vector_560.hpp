...
public:
		...
		VectorSIMD560& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD560& operator += (VectorSIMD560 a){
	...
	inline VectorSIMD560 operator*(double a, VectorSIMD560 b){
		VectorSIMD560 c;
	...
	inline VectorSIMD560 operator*(VectorSIMD560 a ,double b){
		VectorSIMD560 c;
	...
	inline VectorSIMD560 operator*(int a, VectorSIMD560 b){
		if(a==1){return b;}
		VectorSIMD560 c;
	...
	inline VectorSIMD560 operator*(VectorSIMD560 a, int b){
		if(b==1){return a;}
		VectorSIMD560 c;
	...
	inline VectorSIMD560 operator*(VectorSIMD560 a, VectorSIMD560 b){
		VectorSIMD560 c;
	...
	inline VectorSIMD560 exp(VectorSIMD560 a){
		double a_d[560]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD560 sqrt(VectorSIMD560 a){
		double a_d[560]; a.convert(a_d);
