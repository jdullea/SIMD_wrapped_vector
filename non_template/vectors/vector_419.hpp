...
public:
		...
		VectorSIMD419(double a){
			...
			_avx104=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD419(double (&a)[419]){
		...
		VectorSIMD419& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD419& operator += (VectorSIMD419 a){
	...
	inline VectorSIMD419 operator*(double a, VectorSIMD419 b){
		VectorSIMD419 c;
	...
	inline VectorSIMD419 operator*(VectorSIMD419 a ,double b){
		VectorSIMD419 c;
	...
	inline VectorSIMD419 operator*(int a, VectorSIMD419 b){
		if(a==1){return b;}
		VectorSIMD419 c;
	...
	inline VectorSIMD419 operator*(VectorSIMD419 a, int b){
		if(b==1){return a;}
		VectorSIMD419 c;
	...
	inline VectorSIMD419 operator*(VectorSIMD419 a, VectorSIMD419 b){
		VectorSIMD419 c;
	...
	inline VectorSIMD419 exp(VectorSIMD419 a){
		double a_d[419]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD419 sqrt(VectorSIMD419 a){
		double a_d[419]; a.convert(a_d);
