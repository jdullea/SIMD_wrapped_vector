...
public:
		...
		VectorSIMD708& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD708& operator += (VectorSIMD708 a){
	...
	inline VectorSIMD708 operator*(double a, VectorSIMD708 b){
		VectorSIMD708 c;
	...
	inline VectorSIMD708 operator*(VectorSIMD708 a ,double b){
		VectorSIMD708 c;
	...
	inline VectorSIMD708 operator*(int a, VectorSIMD708 b){
		if(a==1){return b;}
		VectorSIMD708 c;
	...
	inline VectorSIMD708 operator*(VectorSIMD708 a, int b){
		if(b==1){return a;}
		VectorSIMD708 c;
	...
	inline VectorSIMD708 operator*(VectorSIMD708 a, VectorSIMD708 b){
		VectorSIMD708 c;
	...
	inline VectorSIMD708 exp(VectorSIMD708 a){
		double a_d[708]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD708 sqrt(VectorSIMD708 a){
		double a_d[708]; a.convert(a_d);
