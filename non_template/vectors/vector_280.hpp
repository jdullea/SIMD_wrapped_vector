...
public:
		...
		VectorSIMD280& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD280& operator += (VectorSIMD280 a){
	...
	inline VectorSIMD280 operator*(double a, VectorSIMD280 b){
		VectorSIMD280 c;
	...
	inline VectorSIMD280 operator*(VectorSIMD280 a ,double b){
		VectorSIMD280 c;
	...
	inline VectorSIMD280 operator*(int a, VectorSIMD280 b){
		if(a==1){return b;}
		VectorSIMD280 c;
	...
	inline VectorSIMD280 operator*(VectorSIMD280 a, int b){
		if(b==1){return a;}
		VectorSIMD280 c;
	...
	inline VectorSIMD280 operator*(VectorSIMD280 a, VectorSIMD280 b){
		VectorSIMD280 c;
	...
	inline VectorSIMD280 exp(VectorSIMD280 a){
		double a_d[280]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD280 sqrt(VectorSIMD280 a){
		double a_d[280]; a.convert(a_d);
