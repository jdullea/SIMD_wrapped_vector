...
public:
		...
		VectorSIMD740& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD740& operator += (VectorSIMD740 a){
	...
	inline VectorSIMD740 operator*(double a, VectorSIMD740 b){
		VectorSIMD740 c;
	...
	inline VectorSIMD740 operator*(VectorSIMD740 a ,double b){
		VectorSIMD740 c;
	...
	inline VectorSIMD740 operator*(int a, VectorSIMD740 b){
		if(a==1){return b;}
		VectorSIMD740 c;
	...
	inline VectorSIMD740 operator*(VectorSIMD740 a, int b){
		if(b==1){return a;}
		VectorSIMD740 c;
	...
	inline VectorSIMD740 operator*(VectorSIMD740 a, VectorSIMD740 b){
		VectorSIMD740 c;
	...
	inline VectorSIMD740 exp(VectorSIMD740 a){
		double a_d[740]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD740 sqrt(VectorSIMD740 a){
		double a_d[740]; a.convert(a_d);
