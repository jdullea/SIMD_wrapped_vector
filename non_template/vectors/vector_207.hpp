...
public:
		...
		VectorSIMD207(double a){
			...
			_avx51=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD207(double (&a)[207]){
		...
		VectorSIMD207& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD207& operator += (VectorSIMD207 a){
	...
	inline VectorSIMD207 operator*(double a, VectorSIMD207 b){
		VectorSIMD207 c;
	...
	inline VectorSIMD207 operator*(VectorSIMD207 a ,double b){
		VectorSIMD207 c;
	...
	inline VectorSIMD207 operator*(int a, VectorSIMD207 b){
		if(a==1){return b;}
		VectorSIMD207 c;
	...
	inline VectorSIMD207 operator*(VectorSIMD207 a, int b){
		if(b==1){return a;}
		VectorSIMD207 c;
	...
	inline VectorSIMD207 operator*(VectorSIMD207 a, VectorSIMD207 b){
		VectorSIMD207 c;
	...
	inline VectorSIMD207 exp(VectorSIMD207 a){
		double a_d[207]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD207 sqrt(VectorSIMD207 a){
		double a_d[207]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD207 a){ 
		double ad[207];
		a.convert(ad);
