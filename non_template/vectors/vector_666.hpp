...
public:
		...
		VectorSIMD666(double a){
			...
			_avx166=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD666(double (&a)[666]){
		...
		VectorSIMD666& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD666& operator += (VectorSIMD666 a){
	...
	inline VectorSIMD666 operator*(double a, VectorSIMD666 b){
		VectorSIMD666 c;
	...
	inline VectorSIMD666 operator*(VectorSIMD666 a ,double b){
		VectorSIMD666 c;
	...
	inline VectorSIMD666 operator*(int a, VectorSIMD666 b){
		if(a==1){return b;}
		VectorSIMD666 c;
	...
	inline VectorSIMD666 operator*(VectorSIMD666 a, int b){
		if(b==1){return a;}
		VectorSIMD666 c;
	...
	inline VectorSIMD666 operator*(VectorSIMD666 a, VectorSIMD666 b){
		VectorSIMD666 c;
	...
	inline VectorSIMD666 exp(VectorSIMD666 a){
		double a_d[666]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD666 sqrt(VectorSIMD666 a){
		double a_d[666]; a.convert(a_d);
