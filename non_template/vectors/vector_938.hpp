...
public:
		...
		VectorSIMD938(double a){
			...
			_avx234=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD938(double (&a)[938]){
		...
		VectorSIMD938& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD938& operator += (VectorSIMD938 a){
	...
	inline VectorSIMD938 operator*(double a, VectorSIMD938 b){
		VectorSIMD938 c;
	...
	inline VectorSIMD938 operator*(VectorSIMD938 a ,double b){
		VectorSIMD938 c;
	...
	inline VectorSIMD938 operator*(int a, VectorSIMD938 b){
		if(a==1){return b;}
		VectorSIMD938 c;
	...
	inline VectorSIMD938 operator*(VectorSIMD938 a, int b){
		if(b==1){return a;}
		VectorSIMD938 c;
	...
	inline VectorSIMD938 operator*(VectorSIMD938 a, VectorSIMD938 b){
		VectorSIMD938 c;
	...
	inline VectorSIMD938 exp(VectorSIMD938 a){
		double a_d[938]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD938 sqrt(VectorSIMD938 a){
		double a_d[938]; a.convert(a_d);
