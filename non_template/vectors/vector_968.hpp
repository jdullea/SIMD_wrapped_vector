...
public:
		...
		VectorSIMD968& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD968& operator += (VectorSIMD968 a){
	...
	inline VectorSIMD968 operator*(double a, VectorSIMD968 b){
		VectorSIMD968 c;
	...
	inline VectorSIMD968 operator*(VectorSIMD968 a ,double b){
		VectorSIMD968 c;
	...
	inline VectorSIMD968 operator*(int a, VectorSIMD968 b){
		if(a==1){return b;}
		VectorSIMD968 c;
	...
	inline VectorSIMD968 operator*(VectorSIMD968 a, int b){
		if(b==1){return a;}
		VectorSIMD968 c;
	...
	inline VectorSIMD968 operator*(VectorSIMD968 a, VectorSIMD968 b){
		VectorSIMD968 c;
	...
	inline VectorSIMD968 exp(VectorSIMD968 a){
		double a_d[968]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD968 sqrt(VectorSIMD968 a){
		double a_d[968]; a.convert(a_d);
