...
public:
		...
		VectorSIMD70(double a){
			...
			_avx17=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD70(double (&a)[70]){
		...
		VectorSIMD70(double _0,double _1,double _2,double _3,double _4,double _5,double _6,double _7,double _8,double _9,double _10,double _11,double _12,double _13,double _14,double _15,double _16,double _17,double _18,double _19,double _20,double _21,double _22,double _23,double _24,double _25,double _26,double _27,double _28,double _29,double _30,double _31,double _32,double _33,double _34,double _35,double _36,double _37,double _38,double _39,double _40,double _41,double _42,double _43,double _44,double _45,double _46,double _47,double _48,double _49,double _50,double _51,double _52,double _53,double _54,double _55,double _56,double _57,double _58,double _59,double _60,double _61,double _62,double _63,double _64,double _65,double _66,double _67,double _68,double _69){
			...
			_avx17=_mm256_set_pd( 0,0,_69,_68);
		}

		VectorSIMD70(__m256d _0,__m256d _1,__m256d _2,__m256d _3,__m256d _4,__m256d _5,__m256d _6,__m256d _7,__m256d _8,__m256d _9,__m256d _10,__m256d _11,__m256d _12,__m256d _13,__m256d _14,__m256d _15,__m256d _16,__m256d _17){
			_avx0= _0;
			_avx1= _1;
			_avx2= _2;
			_avx3= _3;
		...
		VectorSIMD70& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD70& operator += (VectorSIMD70 a){
	...
	inline VectorSIMD70 operator*(double a, VectorSIMD70 b){
		VectorSIMD70 c;
	...
	inline VectorSIMD70 operator*(VectorSIMD70 a ,double b){
		VectorSIMD70 c;
	...
	inline VectorSIMD70 operator*(int a, VectorSIMD70 b){
		if(a==1){return b;}
		VectorSIMD70 c;
	...
	inline VectorSIMD70 operator*(VectorSIMD70 a, int b){
		if(b==1){return a;}
		VectorSIMD70 c;
	...
	inline VectorSIMD70 operator*(VectorSIMD70 a, VectorSIMD70 b){
		VectorSIMD70 c;
	...
	inline VectorSIMD70 exp(VectorSIMD70 a){
		double a_d[70]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD70 sqrt(VectorSIMD70 a){
		double a_d[70]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD70 a){ 
		double ad[70];
		a.convert(ad);
