...
public:
		...
		VectorSIMD400& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD400& operator += (VectorSIMD400 a){
	...
	inline VectorSIMD400 operator*(double a, VectorSIMD400 b){
		VectorSIMD400 c;
	...
	inline VectorSIMD400 operator*(VectorSIMD400 a ,double b){
		VectorSIMD400 c;
	...
	inline VectorSIMD400 operator*(int a, VectorSIMD400 b){
		if(a==1){return b;}
		VectorSIMD400 c;
	...
	inline VectorSIMD400 operator*(VectorSIMD400 a, int b){
		if(b==1){return a;}
		VectorSIMD400 c;
	...
	inline VectorSIMD400 operator*(VectorSIMD400 a, VectorSIMD400 b){
		VectorSIMD400 c;
	...
	inline VectorSIMD400 exp(VectorSIMD400 a){
		double a_d[400]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD400 sqrt(VectorSIMD400 a){
		double a_d[400]; a.convert(a_d);
	...
	inline std::ostream& operator<<(std::ostream& os, VectorSIMD400 a){ 
		double ad[400];
		a.convert(ad);
