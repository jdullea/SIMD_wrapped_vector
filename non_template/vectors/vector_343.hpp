...
public:
		...
		VectorSIMD343(double a){
			...
			_avx85=_mm256_set_pd(0,a,a,a);
		}

		VectorSIMD343(double (&a)[343]){
		...
		VectorSIMD343& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD343& operator += (VectorSIMD343 a){
	...
	inline VectorSIMD343 operator*(double a, VectorSIMD343 b){
		VectorSIMD343 c;
	...
	inline VectorSIMD343 operator*(VectorSIMD343 a ,double b){
		VectorSIMD343 c;
	...
	inline VectorSIMD343 operator*(int a, VectorSIMD343 b){
		if(a==1){return b;}
		VectorSIMD343 c;
	...
	inline VectorSIMD343 operator*(VectorSIMD343 a, int b){
		if(b==1){return a;}
		VectorSIMD343 c;
	...
	inline VectorSIMD343 operator*(VectorSIMD343 a, VectorSIMD343 b){
		VectorSIMD343 c;
	...
	inline VectorSIMD343 exp(VectorSIMD343 a){
		double a_d[343]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD343 sqrt(VectorSIMD343 a){
		double a_d[343]; a.convert(a_d);
