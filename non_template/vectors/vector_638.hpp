...
public:
		...
		VectorSIMD638(double a){
			...
			_avx159=_mm256_set_pd(0,0,a,a);
		}

		VectorSIMD638(double (&a)[638]){
		...
		VectorSIMD638& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD638& operator += (VectorSIMD638 a){
	...
	inline VectorSIMD638 operator*(double a, VectorSIMD638 b){
		VectorSIMD638 c;
	...
	inline VectorSIMD638 operator*(VectorSIMD638 a ,double b){
		VectorSIMD638 c;
	...
	inline VectorSIMD638 operator*(int a, VectorSIMD638 b){
		if(a==1){return b;}
		VectorSIMD638 c;
	...
	inline VectorSIMD638 operator*(VectorSIMD638 a, int b){
		if(b==1){return a;}
		VectorSIMD638 c;
	...
	inline VectorSIMD638 operator*(VectorSIMD638 a, VectorSIMD638 b){
		VectorSIMD638 c;
	...
	inline VectorSIMD638 exp(VectorSIMD638 a){
		double a_d[638]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD638 sqrt(VectorSIMD638 a){
		double a_d[638]; a.convert(a_d);
