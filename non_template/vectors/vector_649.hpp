...
public:
		...
		VectorSIMD649(double a){
			...
			_avx162=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD649(double (&a)[649]){
		...
		VectorSIMD649& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD649& operator += (VectorSIMD649 a){
	...
	inline VectorSIMD649 operator*(double a, VectorSIMD649 b){
		VectorSIMD649 c;
	...
	inline VectorSIMD649 operator*(VectorSIMD649 a ,double b){
		VectorSIMD649 c;
	...
	inline VectorSIMD649 operator*(int a, VectorSIMD649 b){
		if(a==1){return b;}
		VectorSIMD649 c;
	...
	inline VectorSIMD649 operator*(VectorSIMD649 a, int b){
		if(b==1){return a;}
		VectorSIMD649 c;
	...
	inline VectorSIMD649 operator*(VectorSIMD649 a, VectorSIMD649 b){
		VectorSIMD649 c;
	...
	inline VectorSIMD649 exp(VectorSIMD649 a){
		double a_d[649]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD649 sqrt(VectorSIMD649 a){
		double a_d[649]; a.convert(a_d);
