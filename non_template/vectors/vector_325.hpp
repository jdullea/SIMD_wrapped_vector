...
public:
		...
		VectorSIMD325(double a){
			...
			_avx81=_mm256_set_pd(0,0,0,a);
		}

		VectorSIMD325(double (&a)[325]){
		...
		VectorSIMD325& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD325& operator += (VectorSIMD325 a){
	...
	inline VectorSIMD325 operator*(double a, VectorSIMD325 b){
		VectorSIMD325 c;
	...
	inline VectorSIMD325 operator*(VectorSIMD325 a ,double b){
		VectorSIMD325 c;
	...
	inline VectorSIMD325 operator*(int a, VectorSIMD325 b){
		if(a==1){return b;}
		VectorSIMD325 c;
	...
	inline VectorSIMD325 operator*(VectorSIMD325 a, int b){
		if(b==1){return a;}
		VectorSIMD325 c;
	...
	inline VectorSIMD325 operator*(VectorSIMD325 a, VectorSIMD325 b){
		VectorSIMD325 c;
	...
	inline VectorSIMD325 exp(VectorSIMD325 a){
		double a_d[325]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD325 sqrt(VectorSIMD325 a){
		double a_d[325]; a.convert(a_d);
