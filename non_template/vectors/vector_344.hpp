...
public:
		...
		VectorSIMD344& operator=(double a){
			_avx0 = _mm256_set_pd(a,a,a,a);
			_avx1 = _mm256_set_pd(a,a,a,a);
			_avx2 = _mm256_set_pd(a,a,a,a);
			_avx3 = _mm256_set_pd(a,a,a,a);
		...
		VectorSIMD344& operator += (VectorSIMD344 a){
	...
	inline VectorSIMD344 operator*(double a, VectorSIMD344 b){
		VectorSIMD344 c;
	...
	inline VectorSIMD344 operator*(VectorSIMD344 a ,double b){
		VectorSIMD344 c;
	...
	inline VectorSIMD344 operator*(int a, VectorSIMD344 b){
		if(a==1){return b;}
		VectorSIMD344 c;
	...
	inline VectorSIMD344 operator*(VectorSIMD344 a, int b){
		if(b==1){return a;}
		VectorSIMD344 c;
	...
	inline VectorSIMD344 operator*(VectorSIMD344 a, VectorSIMD344 b){
		VectorSIMD344 c;
	...
	inline VectorSIMD344 exp(VectorSIMD344 a){
		double a_d[344]; a.convert(a_d);
		a_d[0] = std::exp(a_d[0]);
		a_d[1] = std::exp(a_d[1]);
		a_d[2] = std::exp(a_d[2]);
		a_d[3] = std::exp(a_d[3]);
	...
	inline VectorSIMD344 sqrt(VectorSIMD344 a){
		double a_d[344]; a.convert(a_d);
